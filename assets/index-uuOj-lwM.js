...
void main() {
	...
	`}class cf extends Wn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},s=[n,n,n,n,n,n];this.texture=new Vh(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},s=new Ci(5,5,5),r=new qn({name:"CubemapFromEquirect",uniforms:Vs(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:nn,blending:ai});r.uniforms.tEquirect.value=t;const a=new It(s,r),o=t.minFilter;return t.minFilter===ii&&(t.minFilter=Rt),new Sg(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,s=!0){const r=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,s);e.setRenderTarget(r)}}function Lx(i){let e=new WeakMap,t=new WeakMap,n=null;function s(h,f=!1){return h==null?null:f?a(h):r(h)}function r(h){if(h&&h.isTexture){const f=h.mapping;if(f===no||f===io)if(e.has(h)){const p=e.get(h).texture;return o(p,h.mapping)}else{const p=h.image;if(p&&p.height>0){const v=new cf(p.height);return v.fromEquirectangularTexture(i,h),e.set(h,v),h.addEventListener("dispose",c),o(v.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const f=h.mapping,p=f===no||f===io,v=f===Yi||f===Fs;if(p||v){let g=t.get(h);const m=g!==void 0?g.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==m)return n===null&&(n=new cd(i)),g=p?n.fromEquirectangular(h,g):n.fromCubemap(h,g),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),g.texture;if(g!==void 0)return g.texture;{const T=h.image;return p&&T&&T.height>0||v&&T&&l(T)?(n===null&&(n=new cd(i)),g=p?n.fromEquirectangular(h):n.fromCubemap(h),g.texture.pmremVersion=h.pmremVersion,t.set(h,g),h.addEventListener("dispose",u),g.texture):null}}}return h}function o(h,f){return f===no?h.mapping=Yi:f===io&&(h.mapping=Fs),h}function l(h){let f=0;const p=6;for(let v=0;v<p;v++)h[v]!==void 0&&f++;return f===p}function c(h){const f=h.target;f.removeEventListener("dispose",c);const p=e.get(f);p!==void 0&&(e.delete(f),p.dispose())}function u(h){const f=h.target;f.removeEventListener("dispose",u);const p=t.get(f);p!==void 0&&(t.delete(f),p.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:s,dispose:d}}function Dx(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&Is("WebGLRenderer: "+n+" extension not supported."),s}}}function Nx(i,e,t,n){const s={},r=new WeakMap;function a(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const p in h.attributes)e.remove(h.attributes[p]);h.removeEventListener("dispose",a),delete s[h.id];const f=r.get(h);f&&(e.remove(f),r.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(d,h){return s[h.id]===!0||(h.addEventListener("dispose",a),s[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const f in h)e.update(h[f],i.ARRAY_BUFFER)}function c(d){const h=[],f=d.index,p=d.attributes.position;let v=0;if(p===void 0)return;if(f!==null){const T=f.array;v=f.version;for(let b=0,x=T.length;b<x;b+=3){const A=T[b+0],E=T[b+1],P=T[b+2];h.push(A,E,E,P,P,A)}}else{const T=p.array;v=p.version;for(let b=0,x=T.length/3-1;b<x;b+=3){const A=b+0,E=b+1,P=b+2;h.push(A,E,E,P,P,A)}}const g=new(p.count>=65535?Oh:Uh)(h,1);g.version=v;const m=r.get(d);m&&e.remove(m),r.set(d,g)}function u(d){const h=r.get(d);if(h){const f=d.index;f!==null&&h.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:o,update:l,getWireframeAttribute:u}}function Ux(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,h){i.drawElements(n,h,r,d*a),t.update(h,n,1)}function c(d,h,f){f!==0&&(i.drawElementsInstanced(n,h,r,d*a,f),t.update(h,n,f))}function u(d,h,f){if(f===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,r,d,0,f);let v=0;for(let g=0;g<f;g++)v+=h[g];t.update(v,n,1)}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function Ox(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:qe("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function Fx(i,e,t){const n=new WeakMap,s=new gt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==d){let I=function(){y.dispose(),n.delete(o),o.removeEventListener("dispose",I)};var f=I;h!==void 0&&h.texture.dispose();const p=o.morphAttributes.position!==void 0,v=o.morphAttributes.normal!==void 0,g=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let x=0;p===!0&&(x=1),v===!0&&(x=2),g===!0&&(x=3);let A=o.attributes.position.count*x,E=1;A>e.maxTextureSize&&(E=Math.ceil(A/e.maxTextureSize),A=e.maxTextureSize);const P=new Float32Array(A*E*4*d),y=new Dh(P,A,E,d);y.type=mn,y.needsUpdate=!0;const M=x*4;for(let R=0;R<d;R++){const D=m[R],U=T[R],q=b[R],N=A*E*4*R;for(let O=0;O<D.count;O++){const k=O*M;p===!0&&(s.fromBufferAttribute(D,O),P[N+k+0]=s.x,P[N+k+1]=s.y,P[N+k+2]=s.z,P[N+k+3]=0),v===!0&&(s.fromBufferAttribute(U,O),P[N+k+4]=s.x,P[N+k+5]=s.y,P[N+k+6]=s.z,P[N+k+7]=0),g===!0&&(s.fromBufferAttribute(q,O),P[N+k+8]=s.x,P[N+k+9]=s.y,P[N+k+10]=s.z,P[N+k+11]=q.itemSize===4?s.w:1)}}h={count:d,texture:y,size:new Te(A,E)},n.set(o,h),o.addEventListener("dispose",I)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let g=0;g<c.length;g++)p+=c[g];const v=o.morphTargetsRelative?1:1-p;l.getUniforms().setValue(i,"morphTargetBaseInfluence",v),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:r}}function kx(i,e,t,n,s){let r=new WeakMap;function a(c){const u=s.render.frame,d=c.geometry,h=e.get(c,d);if(r.get(h)!==u&&(e.update(h),r.set(h,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),r.get(c)!==u&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),r.set(c,u))),c.isSkinnedMesh){const f=c.skeleton;r.get(f)!==u&&(f.update(),r.set(f,u))}return h}function o(){r=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const Bx={[mh]:"LINEAR_TONE_MAPPING",[gh]:"REINHARD_TONE_MAPPING",[_h]:"CINEON_TONE_MAPPING",[xh]:"ACES_FILMIC_TONE_MAPPING",[yh]:"AGX_TONE_MAPPING",[Mh]:"NEUTRAL_TONE_MAPPING",[vh]:"CUSTOM_TONE_MAPPING"};function zx(i,e,t,n,s,r){const a=new Wn(e,t,{type:i,depthBuffer:s,stencilBuffer:r,samples:n?4:0,depthTexture:s?new zs(e,t):void 0}),o=new Wn(e,t,{type:ci,depthBuffer:!1,stencilBuffer:!1}),l=new tn;l.setAttribute("position",new Vt([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new Vt([0,2,0,0,2,0],2));const c=new tg({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new It(l,c),d=new Za(-1,1,1,-1,0,1);let h=null,f=null,p=!1,v,g=null,m=[],T=!1;this.setSize=function(b,x){a.setSize(b,x),o.setSize(b,x);for(let A=0;A<m.length;A++){const E=m[A];E.setSize&&E.setSize(b,x)}},this.setEffects=function(b){m=b,T=m.length>0&&m[0].isRenderPass===!0;const x=a.width,A=a.height;for(let E=0;E<m.length;E++){const P=m[E];P.setSize&&P.setSize(x,A)}},this.begin=function(b,x){if(p||b.toneMapping===Gn&&m.length===0)return!1;if(g=x,x!==null){const A=x.width,E=x.height;(a.width!==A||a.height!==E)&&this.setSize(A,E)}return T===!1&&b.setRenderTarget(a),v=b.toneMapping,b.toneMapping=Gn,!0},this.hasRenderPass=function(){return T},this.end=function(b,x){b.toneMapping=v,p=!0;let A=a,E=o;for(let P=0;P<m.length;P++){const y=m[P];if(y.enabled!==!1&&(y.render(b,E,A,x),y.needsSwap!==!1)){const M=A;A=E,E=M}}if(h!==b.outputColorSpace||f!==b.toneMapping){h=b.outputColorSpace,f=b.toneMapping,c.defines={},rt.getTransfer(h)===ht&&(c.defines.SRGB_TRANSFER="");const P=Bx[f];P&&(c.defines[P]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=A.texture,b.setRenderTarget(g),b.render(u,d),g=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const uf=new kt,jl=new zs(1,1),df=new Dh,hf=new qp,ff=new Vh,fd=[],pd=[],md=new Float32Array(16),gd=new Float32Array(9),_d=new Float32Array(4);function Ks(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=fd[s];if(r===void 0&&(r=new Float32Array(s),fd[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Bt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function zt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function ja(i,e){let t=pd[e];t===void 0&&(t=new Int32Array(e),pd[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Hx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Vx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2fv(this.addr,e),zt(t,e)}}function Gx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Bt(t,e))return;i.uniform3fv(this.addr,e),zt(t,e)}}function Wx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4fv(this.addr,e),zt(t,e)}}function Xx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),zt(t,e)}else{if(Bt(t,n))return;_d.set(n),i.uniformMatrix2fv(this.addr,!1,_d),zt(t,n)}}function qx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),zt(t,e)}else{if(Bt(t,n))return;gd.set(n),i.uniformMatrix3fv(this.addr,!1,gd),zt(t,n)}}function Yx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Bt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),zt(t,e)}else{if(Bt(t,n))return;md.set(n),i.uniformMatrix4fv(this.addr,!1,md),zt(t,n)}}function Kx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function $x(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2iv(this.addr,e),zt(t,e)}}function Zx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;i.uniform3iv(this.addr,e),zt(t,e)}}function Jx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4iv(this.addr,e),zt(t,e)}}function jx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Qx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Bt(t,e))return;i.uniform2uiv(this.addr,e),zt(t,e)}}function ev(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Bt(t,e))return;i.uniform3uiv(this.addr,e),zt(t,e)}}function tv(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Bt(t,e))return;i.uniform4uiv(this.addr,e),zt(t,e)}}function nv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(jl.compareFunction=t.isReversedDepthBuffer()?Tc:bc,r=jl):r=uf,t.setTexture2D(e||r,s)}function iv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||hf,s)}function sv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||ff,s)}function rv(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||df,s)}function av(i){switch(i){case 5126:return Hx;case 35664:return Vx;case 35665:return Gx;case 35666:return Wx;case 35674:return Xx;case 35675:return qx;case 35676:return Yx;case 5124:case 35670:return Kx;case 35667:case 35671:return $x;case 35668:case 35672:return Zx;case 35669:case 35673:return Jx;case 5125:return jx;case 36294:return Qx;case 36295:return ev;case 36296:return tv;case 35678:case 36198:case 36298:case 36306:case 35682:return nv;case 35679:case 36299:case 36307:return iv;case 35680:case 36300:case 36308:case 36293:return sv;case 36289:case 36303:case 36311:case 36292:return rv}}function ov(i,e){i.uniform1fv(this.addr,e)}function lv(i,e){const t=Ks(e,this.size,2);i.uniform2fv(this.addr,t)}function cv(i,e){const t=Ks(e,this.size,3);i.uniform3fv(this.addr,t)}function uv(i,e){const t=Ks(e,this.size,4);i.uniform4fv(this.addr,t)}function dv(i,e){const t=Ks(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function hv(i,e){const t=Ks(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function fv(i,e){const t=Ks(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function pv(i,e){i.uniform1iv(this.addr,e)}function mv(i,e){i.uniform2iv(this.addr,e)}function gv(i,e){i.uniform3iv(this.addr,e)}function _v(i,e){i.uniform4iv(this.addr,e)}function xv(i,e){i.uniform1uiv(this.addr,e)}function vv(i,e){i.uniform2uiv(this.addr,e)}function yv(i,e){i.uniform3uiv(this.addr,e)}function Mv(i,e){i.uniform4uiv(this.addr,e)}function Sv(i,e,t){const n=this.cache,s=e.length,r=ja(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=jl:a=uf;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function bv(i,e,t){const n=this.cache,s=e.length,r=ja(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||hf,r[a])}function Tv(i,e,t){const n=this.cache,s=e.length,r=ja(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||ff,r[a])}function Ev(i,e,t){const n=this.cache,s=e.length,r=ja(t,s);Bt(n,r)||(i.uniform1iv(this.addr,r),zt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||df,r[a])}function Av(i){switch(i){case 5126:return ov;case 35664:return lv;case 35665:return cv;case 35666:return uv;case 35674:return dv;case 35675:return hv;case 35676:return fv;case 5124:case 35670:return pv;case 35667:case 35671:return mv;case 35668:case 35672:return gv;case 35669:case 35673:return _v;case 5125:return xv;case 36294:return vv;case 36295:return yv;case 36296:return Mv;case 35678:case 36198:case 36298:case 36306:case 35682:return Sv;case 35679:case 36299:case 36307:return bv;case 35680:case 36300:case 36308:case 36293:return Tv;case 36289:case 36303:case 36311:case 36292:return Ev}}class wv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=av(t.type)}}class Rv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Av(t.type)}}class Cv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Ho=/(\w+)(\])?(\[|\.)?/g;function xd(i,e){i.seq.push(e),i.map[e.id]=e}function Pv(i,e,t){const n=i.name,s=n.length;for(Ho.lastIndex=0;;){const r=Ho.exec(n),a=Ho.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){xd(t,c===void 0?new wv(o,i,e):new Rv(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new Cv(o),xd(t,d)),t=d}}}class Pa{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);Pv(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function vd(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Iv=37297;let Lv=0;function Dv(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const yd=new $e;function Nv(i){rt._getMatrix(yd,rt.workingColorSpace,i);const e=`mat3( ${yd.elements.map(t=>t.toFixed(4))} )`;switch(rt.getTransfer(i)){case Ba:return[e,"LinearTransferOETF"];case ht:return[e,"sRGBTransferOETF"];default:return Ie("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Md(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+Dv(i.getShaderSource(e),o)}else return r}function Uv(i,e){const t=Nv(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Ov={[mh]:"Linear",[gh]:"Reinhard",[_h]:"Cineon",[xh]:"ACESFilmic",[yh]:"AgX",[Mh]:"Neutral",[vh]:"Custom"};function Fv(i,e){const t=Ov[e];return t===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const xa=new z;function kv(){rt.getLuminanceCoefficients(xa);const i=xa.x.toFixed(4),e=xa.y.toFixed(4),t=xa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Bv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(gr).join(`
`)}function zv(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Hv(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function gr(i){return i!==""}function Sd(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function bd(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Vv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ql(i){return i.replace(Vv,Wv)}const Gv=new Map;function Wv(i,e){let t=et[e];if(t===void 0){const n=Gv.get(e);if(n!==void 0)t=et[n],Ie('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return Ql(t)}const Xv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Td(i){return i.replace(Xv,qv)}function qv(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ed(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const Yv={[Ta]:"SHADOWMAP_TYPE_PCF",[fr]:"SHADOWMAP_TYPE_VSM"};function Kv(i){return Yv[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const $v={[Yi]:"ENVMAP_TYPE_CUBE",[Fs]:"ENVMAP_TYPE_CUBE",[Ka]:"ENVMAP_TYPE_CUBE_UV"};function Zv(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":$v[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Jv={[Fs]:"ENVMAP_MODE_REFRACTION"};function jv(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Jv[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Qv={[ph]:"ENVMAP_BLENDING_MULTIPLY",[rp]:"ENVMAP_BLENDING_MIX",[ap]:"ENVMAP_BLENDING_ADD"};function ey(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Qv[i.combine]||"ENVMAP_BLENDING_NONE"}function ty(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function ny(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Kv(t),c=Zv(t),u=jv(t),d=ey(t),h=ty(t),f=Bv(t),p=zv(r),v=s.createProgram();let g,m,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+m);const b=T+g+a,x=T+m+o,A=vd(s,s.VERTEX_SHADER,b),E=vd(s,s.FRAGMENT_SHADER,x);s.attachShader(v,A),s.attachShader(v,E),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function P(R){if(i.debug.checkShaderErrors){const D=s.getProgramInfoLog(v)||"",U=s.getShaderInfoLog(A)||"",q=s.getShaderInfoLog(E)||"",N=D.trim(),O=U.trim(),k=q.trim();let V=!0,j=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(V=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,A,E);else{const Y=Md(s,A,"vertex"),ee=Md(s,E,"fragment");qe("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
void main() {
  ...
  `,i.appendChild(n);const s=n.querySelector(".hud-hearts"),r=n.querySelector(".hud-toasts"),a=n.querySelector(".hud-items"),o=n.querySelector(".hud-stats"),l=n.querySelector(".hud-near"),c=n.querySelector(".hud-minimap"),u=n.querySelector(".hud-wallet"),d=n.querySelector(".hud-boss"),h=[...n.querySelectorAll(".hud-usable")],f=[...n.querySelectorAll(".hud-usable-icon")],p=[...n.querySelectorAll(".hud-usable-cd")],v=n.querySelector(".hud-center"),g=n.querySelector(".hud-msg"),m=n.querySelector(".hud-sub"),T=n.querySelector(".hud-seed");let b=-1,x=-1,A=-1,E="",P=-1;const y=["",""],M=[-1,-1];let I="",R="",D="",U="",q="",N="",O=null,k=!0;window.addEventListener("keydown",Y=>{Y.code==="Tab"&&(Y.preventDefault(),k=!k,o.hidden=!k)});function V(Y,ee){const le=document.createElement("div");for(le.className="hud-toast"+(ee==="delta"?" hud-toast-delta":""),le.textContent=Y,r.appendChild(le);r.children.length>6;)r.firstChild?.remove();setTimeout(()=>le.remove(),2600)}function j(Y,ee="#e24b4a",le="#f6a5a4"){const Le=`<path d="${lh}" fill="rgba(0,0,0,0.45)" stroke="rgba(0,0,0,0.6)" stroke-width="1"/>`,ot=Y===1?' style="clip-path: inset(0 50% 0 0)"':"",ze=Y>0?`<path d="${lh}" fill="${ee}"${ot}/><path d="M6 6.2 A2.4 2.4 0 0 1 9 4.8" stroke="${le}" stroke-width="1.4" fill="none"${ot}/>`:"";return`<svg viewBox="0 0 20 18" class="hud-heart">${Le}${ze}</svg>`}return{update(Y){const ee=Y.player.halfHearts,le=Y.player.maxHalfHearts,Le=Y.player.armor;if(ee!==b||le!==x||Le!==A){b=ee,x=le,A=Le;const B=Math.ceil(le/2);let L="";for(let C=0;C<B;C++)L+=j(Math.min(2,Math.max(0,ee-C*2)));for(let C=0;C<Math.ceil(Le/2);C++)L+=j(Math.min(2,Math.max(0,Le-C*2)),"#9fb8c8","#dfeef7");s.innerHTML=L}if([Y.player.usable,Y.player.usable2].forEach((B,L)=>{const C=B?.itemId??"";if(C!==y[L]&&(y[L]=C,h[L].hidden=!B,B&&(f[L].src=br(B.itemId))),B){const H=Math.ceil(B.cooldown/Zi);H!==M[L]&&(M[L]=H,p[L].textContent=H>0?String(H):""),h[L].classList.toggle("ready",B.cooldown===0),h[L].classList.toggle("active",B.activeTicks>0)}}),Y.status!==E)if(E=Y.status,v.classList.toggle("has-msg",Y.status!=="playing"),Y.status==="victory"){const B=t(),L=B.filter(xe=>xe.type==="enemy_killed").length,C=B.filter(xe=>xe.type==="damage_taken").length,H=B.filter(xe=>xe.type==="heart_collected").length,ne=B.filter(xe=>xe.type==="item_bought").length,se=Math.floor(Y.tick/3600),ce=Math.floor(Y.tick%3600/60);g.textContent="¡El Pozo superado!",m.innerHTML=`<div class="hud-run-summary"><div>tiempo <b>${se}:${String(ce).padStart(2,"0")}</b></div><div>abatidos <b>${L}</b> · golpes recibidos <b>${C}</b></div><div>items <b>${Y.player.items.length}</b> · compras <b>${ne}</b> · corazones <b>${H}</b></div><div>cristales <b class="hud-wallet-crystal">◆ ${Y.player.crystals}</b></div><div style="margin-top:6px">R para otra run</div></div>`}else Y.status==="dead"?(g.textContent="Kai se derritió…",m.textContent="R para reintentar"):(g.textContent="",m.textContent="");const ot=Y.player.items.join(",");if(ot!==I){const B=Y.player.items.length>I.split(",").filter(Boolean).length;if(I=ot,a.innerHTML=Y.player.items.map(L=>{const C=ln(L),H=`<b>${C.nombre}</b>`+_b(C,Y.stats.luck).map(ne=>`<div>· ${ne}</div>`).join("");return`<div class="hud-item"><img src="${br(L)}" alt="${C.nombre}" /><div class="hud-item-tip">${H}</div></div>`}).join(""),B&&O){const L=ln(Y.player.items[Y.player.items.length-1]).nombre;V(L);for(const C of oh(O,Y.stats))V(C,"delta")}}O={...Y.stats};const ze=Y.stats,ie=[ze.maxHalfHearts,ze.damage,ze.fireRate,ze.range,ze.shotSpeed,ze.moveSpeed,ze.luck,ze.projectiles].join("|");if(ie!==R){R=ie;const B=[["❤️","Vida",ni(ze.maxHalfHearts/2),"corazones máximos"],["⚔️","Daño",ni(ze.damage),"daño por proyectil"],["💧","Caudal",`${ni(ze.fireRate)}/s`,"disparos por segundo (cadencia)"],["🏹","Alcance",ni(ze.range),"tiles antes de caer en charco"],["💨","Presión",ni(ze.shotSpeed),"velocidad del proyectil"],["👢","Velocidad",ni(ze.moveSpeed),"velocidad de movimiento"],["🍀","Suerte",ni(ze.luck),"escala los procs y la calidad de drops"],["🔱","Chorros",ni(ze.projectiles),"proyectiles por disparo"]];o.innerHTML='<div class="hud-stats-title">stats · Tab</div>'+B.map(([L,C,H,ne])=>`<div class="hud-stats-row" title="${ne}"><span class="hud-stats-icon">${L}</span><span class="hud-stats-name">${C}</span><span class="hud-stats-value">${H}</span></div>`).join("")}let de=null,ue=1.25;for(const B of Y.pickups){const L=Math.hypot(B.x-Y.player.x,B.y-Y.player.y);L<ue&&(ue=L,de=B)}const Ve=de?`${de.id}:${de.itemId}:${de.price?Y.player.crystals>=de.price?"ok":"no":""}`:"";if(Ve!==D&&(D=Ve,l.hidden=!de,de)){const B=ln(de.itemId),L=Cf(B,Y.stats.luck).map(ne=>`<div>· ${ne}</div>`).join("");let C="";if(B.categoria!=="usable"){const ne=Or([...Y.player.items,de.itemId]),se=oh(Y.stats,ne);C=se.length?se.map(ce=>`<div class="hud-near-diff">${ce}</div>`).join(""):""}const H=de.price?`<div class="hud-near-price ${Y.player.crystals>=de.price?"ok":"no"}">◆ ${de.price} cristales — ${Y.player.crystals>=de.price?"pulsa E para comprar":"no te alcanza"}</div>`:"";l.innerHTML=`<img src="${br(B.id)}" alt="" /><div><b>${B.nombre}</b> <span class="hud-near-rar">${gb[B.rareza]}</span>${H}${C}${L}<i>«${B.descripcion}»</i></div>`}const Ke=`${Y.player.crystals}:${Y.player.keys}`;Ke!==q&&(q=Ke,u.innerHTML=`<span class="hud-wallet-crystal">◆</span> ${Y.player.crystals}`+(Y.player.keys>0?` &nbsp;<span class="hud-wallet-key">⚷</span> ${Y.player.keys}`:""));const Fe=Y.enemies.some(B=>B.kind==="gorko"),vt=`${Y.seed}:${Y.floor.level}`;Fe&&N!==vt&&(N=vt,d.hidden=!1,d.innerHTML='<div class="hud-boss-name">GORKO</div><div class="hud-boss-sub">el Sapo Glotón</div>',setTimeout(()=>{d.hidden=!0},2800));const Qe=`${Y.floor.level}:${Y.floor.current}:`+Y.floor.rooms.map(B=>(B.visited?"v":".")+(B.cleared?"c":".")).join("");if(Qe!==U){U=Qe;const B=Y.floor.rooms.filter(Se=>Se.visited),L=new Set;for(const Se of B){L.add(Se.id);for(const Re of Object.values(Se.doors))Re>=0&&L.add(Re)}const C=Y.floor.rooms.filter(Se=>L.has(Se.id)),H=Math.min(...C.map(Se=>Se.gx)),ne=Math.min(...C.map(Se=>Se.gy)),se={treasure:"♦",shop:"$",boss:"☠"},ce=19;c.innerHTML=C.map(Se=>{const Re=["hud-map-cell",Se.id===Y.floor.current?"current":"",Se.visited?"visited":"known",Se.cleared?"cleared":""].filter(Boolean).join(" "),w=Se.visited||Se.kind!=="boss"?se[Se.kind]??"":se.boss;return`<div class="${Re}" style="left:${(Se.gx-H)*ce}px;top:${(Se.gy-ne)*ce}px">${w}</div>`}).join("");const xe=(Math.max(...C.map(Se=>Se.gx))-H+1)*ce,F=(Math.max(...C.map(Se=>Se.gy))-ne+1)*ce;c.style.width=`${xe}px`,c.style.height=`${F}px`}const lt=Y.seed*10+Y.floor.level;lt!==P&&(P=lt,T.textContent=`seed ${Y.seed} · nivel ${Y.floor.level} · sim v${e}`)},onEvents(Y){for(const ee of Y)if(ee.type==="proc_triggered"&&ee.efecto==="critico")V("¡Crítico!");else if(ee.type==="usable_activated"){const le=Li.get(ee.itemId);V(`¡${le?.nombre??"Usable"}!`)}else ee.type==="item_bought"?V(`Comprado: −${ee.price} ◆`,"delta"):ee.type==="key_collected"?V("Llave del tesoro","delta"):ee.type==="door_unlocked"&&V("El tesoro se abre…","delta")}}}const ch={KeyW:"up",ArrowUp:"up",KeyS:"down",ArrowDown:"down",KeyA:"left",ArrowLeft:"left",KeyD:"right",ArrowRight:"right"};function vb(i,e,t){const n=i.live,s=new Fg,r=new Te,a=new Mi(new z(0,1,0),0),o=new z;let l=!1,c=!1,u=!1;window.addEventListener("keydown",f=>{const p=ch[f.code];p?(n[p]=!0,f.preventDefault()):f.code==="Space"?(u=!0,n.use=u||c,f.preventDefault()):f.code==="ShiftLeft"||f.code==="ShiftRight"?n.dash=!0:f.code==="KeyE"?n.interact=!0:f.code==="KeyQ"?n.use2=!0:f.code==="KeyR"&&!f.repeat&&i.reset()}),window.addEventListener("keyup",f=>{const p=ch[f.code];p&&(n[p]=!1),f.code==="Space"&&(u=!1,n.use=u||c),(f.code==="ShiftLeft"||f.code==="ShiftRight")&&(n.dash=!1),f.code==="KeyE"&&(n.interact=!1),f.code==="KeyQ"&&(n.use2=!1)}),window.addEventListener("blur",()=>{n.up=n.down=n.left=n.right=!1,l=c=u=!1,n.fire=n.dash=n.use=n.interact=!1}),e.addEventListener("contextmenu",f=>f.preventDefault());function d(f){const p=e.getBoundingClientRect();p.width===0||p.height===0||(r.set((f.clientX-p.left)/p.width*2-1,-((f.clientY-p.top)/p.height)*2+1),s.setFromCamera(r,t),s.ray.intersectPlane(a,o)&&(n.aimX=o.x,n.aimY=o.z))}const h=()=>document.body.classList.contains("touch-mode");window.addEventListener("pointermove",f=>{h()||d(f)}),window.addEventListener("pointerdown",f=>{h()||(f.button===0?(l=!0,n.fire=!0,d(f)):f.button===2&&(c=!0,n.use=u||c))}),window.addEventListener("pointerup",f=>{h()||(f.button===0?(l=!1,n.fire=l):f.button===2&&(c=!1,n.use=u||c))})}const yb=[[3.5,1],[Xe-3.5,1]],Qo=1;function Mb(i){i.add(new yg(16767398,.7));const e=new af(9414856,.22);e.position.set(Xe/2,6,He+8),e.target.position.set(Xe/2,0,He/2),i.add(e,e.target);const t=yb.map(([s,r])=>{const a=new Zl(Ge.torch,12,11,2);a.position.set(s,Qo,r+.35),i.add(a);const o=new Rs(new Xi({map:Sb(),blending:tl,depthWrite:!1}));return o.position.set(s,Qo+.08,r+.18),o.scale.set(.32,.5,1),i.add(o),{light:a,flame:o,baseY:Qo}}),n=new Zl(Ge.shine,3.2,5,2);return n.position.set(3.5,.7,He/2),i.add(n),{update(s){const r=.8+.2*Math.sin(s.tick*.31)*Math.sin(s.tick*.13);for(const o of t)o.light.intensity=12*r,o.flame.scale.set(.32,.5*(.85+.3*r),1),o.flame.position.y=o.baseY+.08+.02*r;const a=s.player;if(n.position.set(a.x,.7,a.y),s.status==="dead"){const o=s.tick-a.deathTick;n.intensity=Math.floor(o/14)%2===0?1.8:.6}else n.intensity=3.2}}}function Sb(){const[i,e]=qt(16,24),t=e.createRadialGradient(8,14,1,8,14,10);return t.addColorStop(0,ct(Ge.torchBright)),t.addColorStop(.45,ct(Ge.torch)),t.addColorStop(1,"rgba(232,161,60,0)"),e.fillStyle=t,e.fillRect(0,0,16,24),e.fillStyle=ct(Ge.torch),e.beginPath(),e.moveTo(8,2),e.quadraticCurveTo(12,10,8,16),e.quadraticCurveTo(4,10,8,2),e.fill(),e.fillStyle=ct(Ge.torchBright),e.beginPath(),e.ellipse(8,13,2.4,4,0,0,Math.PI*2),e.fill(),Yt(i)}const fc={},Wc=[];{const i=new Gc,e=(t,n)=>{i.load(n,s=>{fc[t]={scene:s.scene,animations:s.animations};for(const r of Wc)r()})};e("puerta","assets/models/portal_puerta.glb"),e("reja","assets/models/portal_reja.glb")}let Na=null;new Gc().load("assets/models/trampilla_escalera.glb",e=>{Na=e.scene;for(const t of Wc)t()});const bb={1:16777215,2:15919832,3:13625544,4:15519936,5:12563672},uh=40,Tb=55,el=1.15,Eb=1.45,Ab=1.9,dh=.1,hh=.6,wb=1.15,Rb=.9,Cb=.45;function Pb(){const i=new em;i.background=new Ye(Ge.dungeonBg);const e=new Rc(Ge.dungeonBg,14,30);i.fog=e;const t=Ib(i),n=new z(Xe/2,0,He/2),s=new jt(uh,1,.1,100),r=new z,a=Wl.degToRad(Tb),o=new z(n.x,0,n.z);let l=20,c=Xe/2,u=He/2,d=960,h=576,f=!1;function p(){r.set(o.x,l*Math.sin(a),o.z+l*Math.cos(a)),s.position.copy(r),s.lookAt(o)}function v(T,b){d=T,h=b,s.aspect=T/Math.max(1,b);const x=Math.tan(Wl.degToRad(uh/2)),A=x*s.aspect,E=(Xe/2+el)/A,P=(He/2+el)*Math.sin(a)/x+(He/2+el)*Math.cos(a);f=document.body.classList.contains("touch-mode"),l=Math.max(E,P)/(f?Ab:Eb),c=A*l,u=x*l/Math.sin(a),e.near=l-2,e.far=l+15,p(),s.updateProjectionMatrix()}function g(T,b,x){const A=b-hh,E=x-b+hh;return A>=E?x/2:Math.min(E,Math.max(A,T))}function m(T){document.body.classList.contains("touch-mode")!==f&&v(d,h);const b=g(T.player.x,c,Xe),x=g(T.player.y,u,He);o.x+=(b-o.x)*dh,o.z+=(x-o.z)*dh,p()}return{scene:i,camera:s,center:n,cameraHome:r,resize:v,updateRoom:T=>{t.update(T),m(T)}}}function Ib(i){const e=BS(Xe,He),t=new qi({map:e.texture,roughness:.92,metalness:0}),n=new Pi(Xe,He),s=1.7,r=new Kh;r.moveTo(-Xe/2,-He/2),r.lineTo(Xe/2,-He/2),r.lineTo(Xe/2,He/2),r.lineTo(-Xe/2,He/2);const a=new Yl;a.moveTo(-s/2,-s/2),a.lineTo(s/2,-s/2),a.lineTo(s/2,s/2),a.lineTo(-s/2,s/2),r.holes.push(a);const o=new Oc(r);{const M=o.attributes.uv,I=o.attributes.position;for(let R=0;R<M.count;R++)M.setXY(R,(I.getX(R)+Xe/2)/Xe,(I.getY(R)+He/2)/He)}const l=new It(n,t);l.rotation.x=-Math.PI/2,l.position.set(Xe/2,0,He/2),i.add(l);const c=new Map;function u(M){const I=Math.max(1,Math.round(M));let R=c.get(I);return R||(R=new qi({map:Zd(I,2),roughness:1,metalness:0}),c.set(I,R)),R}const d=new Map;function h(M){const I=Math.max(1,Math.round(M));let R=d.get(I);return R||(R=new qi({map:Zd(I,1),roughness:1,metalness:0}),d.set(I,R)),R}const f=new _n({color:Ge.torch}),p=new An;i.add(p);const v=[],g=new kg;let m=null,T="";Wc.push(()=>{T=""});function b(){for(const M of[...p.children])p.remove(M),M.traverse(I=>{I instanceof It&&I.geometry.dispose()});v.length=0,m=null}function x(M,I,R,D,U,q){const N=new It(new Ci(M,I,R),q);return N.position.set(D,I/2,U),p.add(N),N}function A(M,I){const R=M==="n"?wb:M==="s"?Cb:Rb,D=M==="n"||M==="s",U=M==="n"?.5:He-.5,q=M==="w"?.5:Xe-.5,N=D?Xe/2:He/2,O=D?Xe:He-2,k=D?0:1;if(!I){D?x(O,R,1,Xe/2,U,u(O)):x(1,R,O,q,He/2,u(O));return}const V=N-Ai-k,j=k+O-(N+Ai);D?(x(V,R,1,k+V/2,U,u(V)),x(j,R,1,N+Ai+j/2,U,u(j))):(x(1,R,V,q,k+V/2,u(V)),x(1,R,j,q,N+Ai+j/2,u(j)))}function E(M,I){const R=I==="puerta"?fc.puerta:fc.reja;if(!R)return;const D=R.scene.clone(!0),q=new Qt().setFromObject(R.scene).getSize(new z),N=2.6/Math.max(.001,q.x);D.scale.setScalar(N);const O=new Qt().setFromObject(D),k=O.getCenter(new z);D.position.sub(new z(k.x,O.min.y,k.z));const V=new An;V.add(D);const Y=M==="n"||M==="s"?Xe/2:He/2;M==="n"&&V.position.set(Y,0,.55),M==="s"&&V.position.set(Y,0,He-.55),M==="e"&&(V.position.set(Xe-.55,0,Y),V.rotation.y=-Math.PI/2),M==="w"&&(V.position.set(.55,0,Y),V.rotation.y=Math.PI/2),p.add(V);const ee={side:M,variant:I,wrapper:V,mixer:null,clips:null,barsNode:null,barsY0:0,open:null};I==="puerta"&&R.animations.length?(ee.mixer=new Og(D),ee.clips=R.animations):(D.traverse(le=>{le.name==="gate"&&(ee.barsNode=le)}),ee.barsNode&&(ee.barsY0=ee.barsNode.position.y)),v.push(ee)}function P(M,I,R){if(M.mixer&&M.clips){const D=Wa.findByName(M.clips,I?"open":"close");if(!D)return;M.mixer.stopAllAction();const U=M.mixer.clipAction(D);U.setLoop(Ph,1),U.clampWhenFinished=!0,U.play(),R&&M.mixer.update(D.duration)}}function y(M){b();const I=M.floor.rooms[M.floor.current],R=bb[M.floor.level]??16777215;t.color.setHex(R),e.repaint(I.seed);for(const D of["n","s","e","w"]){const U=I.doors[D];if(A(D,U>=0),U>=0){const q=M.floor.rooms[U].locked;E(D,q?"reja":"puerta")}}for(const D of M.obstacles)D.invisible||x(D.w,.55,D.h,D.x+D.w/2,D.y+D.h/2,h(D.w));if(I.kind==="boss"){const D=new An,U=new It(new Ci(1.7,.05,1.7),new _n({color:262657}));if(U.position.set(Xe/2,-1.3,He/2),D.add(U),Na){const N=Na.clone(!0),k=new Qt().setFromObject(Na).getSize(new z),V=1.55/Math.max(.001,Math.max(k.x,k.z));N.scale.setScalar(V);const j=new Qt().setFromObject(N),Y=j.getCenter(new z);N.position.sub(new z(Y.x,j.min.y,Y.z)),N.position.y-=k.y*V-.04,D.add(N),N.position.x+=Xe/2,N.position.z+=He/2}const q=new It(new Uc(.95,1.05,24),f);q.rotation.x=-Math.PI/2,q.position.set(Xe/2,.013,He/2),D.add(q),D.visible=!1,p.add(D),m=D}for(const D of c.values())D.color.setHex(R);for(const D of d.values())D.color.setHex(R),D.color.multiplyScalar(1.18)}return{update(M){const I=`${M.seed}:${M.floor.level}:${M.floor.current}`;I!==T&&(T=I,y(M));const R=g.getDelta(),D=M.floor.rooms[M.floor.current];for(const N of v){const O=D.doors[N.side],k=O>=0&&M.floor.rooms[O].locked,V=D.cleared&&!k;if(N.variant==="puerta")N.open===null?P(N,V,!0):V!==N.open&&P(N,V,!1),N.mixer?.update(R);else if(N.barsNode){const j=N.barsY0+(V?.9:0);N.open===null?N.barsNode.position.y=j:N.barsNode.position.y+=(j-N.barsNode.position.y)*.08}N.open=V}m&&(m.visible=M.floor.trapdoorOpen);const q=D.kind==="boss"&&M.floor.trapdoorOpen?o:n;l.geometry!==q&&(l.geometry=q)}}}function Lb(i,e){const t=jM(),n=ZM(e,lc(t));KM(n,La);const s=new Ny({antialias:!1});s.setPixelRatio(1),i.appendChild(s.domElement);const r=Pb(),a=Mb(r.scene),o=eb(r.scene,OS());vb(n,s.domElement,r.camera);const l=xb(i,La,()=>n.telemetry),c=fb(n,r),u=tS(i),d=ub(i,n,t,La,u);let h=null;function f(m){if(m&&!h&&(h=hb(i,n)),document.body.classList.toggle("touch-mode",m),!m){const T=n.live;T.left=T.right=T.up=T.down=T.fire=!1}}db()?f(!0):new URLSearchParams(location.search).get("touch")!=="0"&&(window.addEventListener("touchstart",()=>f(!0)),window.addEventListener("pointermove",m=>{m.pointerType==="mouse"&&document.body.classList.contains("touch-mode")&&f(!1)}));function p(){const m=i.clientWidth||960,T=i.clientHeight||576;s.setSize(m,T),r.resize(m,T)}new ResizeObserver(p).observe(i),p();let v=performance.now();function g(m){const T=m-v;v=m;const b=n.frame(T);c.onEvents(b),l.onEvents(b),u.onEvents(b),r.updateRoom(n.sim.state),a.update(n.sim.state),o.update(n.sim.state),l.update(n.sim.state),d.update(n.sim.state),u.update(n.sim.state),h?.update(n.sim.state),c.update(T,r.camera),s.render(r.scene,r.camera),requestAnimationFrame(g)}requestAnimationFrame(g)}const Db=new URLSearchParams(location.search),fh=Db.get("seed"),Pf=fh!==null?Number(fh)>>>0:Date.now()>>>0;Lb(document.getElementById("game"),Pf);console.info(`%cKai · Fase 0.5 · seed=${Pf} · API de tester en window.__game`,"color:#e8a13c");

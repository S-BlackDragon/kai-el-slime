...
`)+`
`+m);const T=S+g+a,_=S+m+o,A=vd(s,s.VERTEX_SHADER,T),w=vd(s,s.FRAGMENT_SHADER,_);s.attachShader(y,A),s.attachShader(y,w),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function I(E){if(i.debug.checkShaderErrors){const L=s.getProgramInfoLog(y)||"",H=s.getShaderInfoLog(A)||"",X=s.getShaderInfoLog(w)||"",U=L.trim(),W=H.trim(),G=X.trim();let J=!0,re=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,A,w);else{const $=Md(s,A,"vertex"),oe=Md(s,w,"fragment");Ge("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+$+`
`+oe)}else U!==""?Ie("WebGLProgram: Program Info Log:",U):(W===""||G==="")&&(re=!1);re&&(E.diagnostics={runnable:J,programLog:U,vertexShader:{log:W,prefix:g},fragmentShader:{log:G,prefix:m}})}s.deleteShader(A),s.deleteShader(w),M=new Ca(s,y),v=Vv(s,y)}let M;this.getUniforms=function(){return M===void 0&&I(this),M};let v;this.getAttributes=function(){return v===void 0&&I(this),v};let R=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return R===!1&&(R=s.getProgramParameter(y,Lv)),R},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(y),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Dv++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=A,this.fragmentShader=w,this}let sy=0;class ry{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){const s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new ay(e),t.set(e,n)),n}}class ay{constructor(e){this.id=sy++,this.code=e,this.usedTimes=0}}function oy(i){return i===Yi||i===Oa||i===Fa}function cy(i,e,t,n,s,r){const a=new wl,o=new ry,c=new Set,l=[],u=new Map,d=n.logarithmicDepthBuffer;let h=n.precision;const f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function p(M){return c.add(M),M===0?"uv":`uv${M}`}function y(M,v,R,E,L,H){const X=E.fog,U=L.geometry,W=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?E.environment:null,G=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap,J=e.get(M.envMap||W,G),re=J&&J.mapping===Ka?J.image.height:null,$=f[M.type];M.precision!==null&&(h=n.getMaxPrecision(M.precision),h!==M.precision&&Ie("WebGLProgram.getParameters:",M.precision,"not supported, using",h,"instead."));const oe=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,he=oe!==void 0?oe.length:0;let Qe=0;U.morphAttributes.position!==void 0&&(Qe=1),U.morphAttributes.normal!==void 0&&(Qe=2),U.morphAttributes.color!==void 0&&(Qe=3);let lt,Be,te,ue;if($){const Ce=Bn[$];lt=Ce.vertexShader,Be=Ce.fragmentShader}else{lt=M.vertexShader,Be=M.fragmentShader;const Ce=o.getVertexShaderStage(M),Ct=o.getFragmentShaderStage(M);o.update(M,Ce,Ct),te=Ce.id,ue=Ct.id}const le=i.getRenderTarget(),ze=i.state.buffers.depth.getReversed(),Xe=L.isInstancedMesh===!0,Oe=L.isBatchedMesh===!0,vt=!!M.map,je=!!M.matcap,ot=!!J,O=!!M.aoMap,D=!!M.lightMap,P=!!M.bumpMap&&M.wireframe===!1,k=!!M.normalMap,ee=!!M.displacementMap,ne=!!M.emissiveMap,ce=!!M.metalnessMap,xe=!!M.roughnessMap,N=M.anisotropy>0,Se=M.clearcoat>0,Re=M.dispersion>0,C=M.iridescence>0,x=M.sheen>0,V=M.transmission>0,q=N&&!!M.anisotropyMap,j=Se&&!!M.clearcoatMap,de=Se&&!!M.clearcoatNormalMap,pe=Se&&!!M.clearcoatRoughnessMap,Q=C&&!!M.iridescenceMap,se=C&&!!M.iridescenceThicknessMap,me=x&&!!M.sheenColorMap,De=x&&!!M.sheenRoughnessMap,ve=!!M.specularMap,ge=!!M.specularColorMap,Fe=!!M.specularIntensityMap,Ve=V&&!!M.transmissionMap,Ze=V&&!!M.thicknessMap,B=!!M.gradientMap,fe=!!M.alphaMap,ie=M.alphaTest>0,_e=!!M.alphaHash,Ee=!!M.extensions;let ae=Gn;M.toneMapped&&(le===null||le.isXRRenderTarget===!0)&&(ae=i.toneMapping);const Le={shaderID:$,shaderType:M.type,shaderName:M.name,vertexShader:lt,fragmentShader:Be,defines:M.defines,customVertexShaderID:te,customFragmentShaderID:ue,isRawShaderMaterial:M.isRawShaderMaterial===!0,glslVersion:M.glslVersion,precision:h,batching:Oe,batchingColor:Oe&&L._colorsTexture!==null,instancing:Xe,instancingColor:Xe&&L.instanceColor!==null,instancingMorph:Xe&&L.morphTexture!==null,outputColorSpace:le===null?i.outputColorSpace:le.isXRRenderTarget===!0?le.texture.colorSpace:rt.workingColorSpace,alphaToCoverage:!!M.alphaToCoverage,map:vt,matcap:je,envMap:ot,envMapMode:ot&&J.mapping,envMapCubeUVHeight:re,aoMap:O,lightMap:D,bumpMap:P,normalMap:k,displacementMap:ee,emissiveMap:ne,normalMapObjectSpace:k&&M.normalMapType===pp,normalMapTangentSpace:k&&M.normalMapType===Gc,packedNormalMap:k&&M.normalMapType===Gc&&oy(M.normalMap.format),metalnessMap:ce,roughnessMap:xe,anisotropy:N,anisotropyMap:q,clearcoat:Se,clearcoatMap:j,clearcoatNormalMap:de,clearcoatRoughnessMap:pe,dispersion:Re,iridescence:C,iridescenceMap:Q,iridescenceThicknessMap:se,sheen:x,sheenColorMap:me,sheenRoughnessMap:De,specularMap:ve,specularColorMap:ge,specularIntensityMap:Fe,transmission:V,transmissionMap:Ve,thicknessMap:Ze,gradientMap:B,opaque:M.transparent===!1&&M.blending===Ps&&M.alphaToCoverage===!1,alphaMap:fe,alphaTest:ie,alphaHash:_e,combine:M.combine,mapUv:vt&&p(M.map.channel),aoMapUv:O&&p(M.aoMap.channel),lightMapUv:D&&p(M.lightMap.channel),bumpMapUv:P&&p(M.bumpMap.channel),normalMapUv:k&&p(M.normalMap.channel),displacementMapUv:ee&&p(M.displacementMap.channel),emissiveMapUv:ne&&p(M.emissiveMap.channel),metalnessMapUv:ce&&p(M.metalnessMap.channel),roughnessMapUv:xe&&p(M.roughnessMap.channel),anisotropyMapUv:q&&p(M.anisotropyMap.channel),clearcoatMapUv:j&&p(M.clearcoatMap.channel),clearcoatNormalMapUv:de&&p(M.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:pe&&p(M.clearcoatRoughnessMap.channel),iridescenceMapUv:Q&&p(M.iridescenceMap.channel),iridescenceThicknessMapUv:se&&p(M.iridescenceThicknessMap.channel),sheenColorMapUv:me&&p(M.sheenColorMap.channel),sheenRoughnessMapUv:De&&p(M.sheenRoughnessMap.channel),specularMapUv:ve&&p(M.specularMap.channel),specularColorMapUv:ge&&p(M.specularColorMap.channel),specularIntensityMapUv:Fe&&p(M.specularIntensityMap.channel),transmissionMapUv:Ve&&p(M.transmissionMap.channel),thicknessMapUv:Ze&&p(M.thicknessMap.channel),alphaMapUv:fe&&p(M.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(k||N),vertexNormals:!!U.attributes.normal,vertexColors:M.vertexColors,vertexAlphas:M.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,pointsUvs:L.isPoints===!0&&!!U.attributes.uv&&(vt||fe),fog:!!X,useFog:M.fog===!0,fogExp2:!!X&&X.isFogExp2,flatShading:M.wireframe===!1&&(M.flatShading===!0||U.attributes.normal===void 0&&k===!1&&(M.isMeshLambertMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isMeshPhysicalMaterial)),sizeAttenuation:M.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:ze,skinning:L.isSkinnedMesh===!0,hasPositionAttribute:U.attributes.position!==void 0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:he,morphTextureStride:Qe,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numLightProbeGrids:H.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:M.dithering,shadowMapEnabled:i.shadowMap.enabled&&R.length>0,shadowMapType:i.shadowMap.type,toneMapping:ae,decodeVideoTexture:vt&&M.map.isVideoTexture===!0&&rt.getTransfer(M.map.colorSpace)===ht,decodeVideoTextureEmissive:ne&&M.emissiveMap.isVideoTexture===!0&&rt.getTransfer(M.emissiveMap.colorSpace)===ht,premultipliedAlpha:M.premultipliedAlpha,doubleSided:M.side===zn,flipSided:M.side===nn,useDepthPacking:M.depthPacking>=0,depthPacking:M.depthPacking||0,index0AttributeName:M.index0AttributeName,extensionClipCullDistance:Ee&&M.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ee&&M.extensions.multiDraw===!0||Oe)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:M.customProgramCacheKey()};return Le.vertexUv1s=c.has(1),Le.vertexUv2s=c.has(2),Le.vertexUv3s=c.has(3),c.clear(),Le}function g(M){const v=[];if(M.shaderID?v.push(M.shaderID):(v.push(M.customVertexShaderID),v.push(M.customFragmentShaderID)),M.defines!==void 0)for(const R in M.defines)v.push(R),v.push(M.defines[R]);return M.isRawShaderMaterial===!1&&(m(v,M),S(v,M),v.push(i.outputColorSpace)),v.push(M.customProgramCacheKey),v.join()}function m(M,v){M.push(v.precision),M.push(v.outputColorSpace),M.push(v.envMapMode),M.push(v.envMapCubeUVHeight),M.push(v.mapUv),M.push(v.alphaMapUv),M.push(v.lightMapUv),M.push(v.aoMapUv),M.push(v.bumpMapUv),M.push(v.normalMapUv),M.push(v.displacementMapUv),M.push(v.emissiveMapUv),M.push(v.metalnessMapUv),M.push(v.roughnessMapUv),M.push(v.anisotropyMapUv),M.push(v.clearcoatMapUv),M.push(v.clearcoatNormalMapUv),M.push(v.clearcoatRoughnessMapUv),M.push(v.iridescenceMapUv),M.push(v.iridescenceThicknessMapUv),M.push(v.sheenColorMapUv),M.push(v.sheenRoughnessMapUv),M.push(v.specularMapUv),M.push(v.specularColorMapUv),M.push(v.specularIntensityMapUv),M.push(v.transmissionMapUv),M.push(v.thicknessMapUv),M.push(v.combine),M.push(v.fogExp2),M.push(v.sizeAttenuation),M.push(v.morphTargetsCount),M.push(v.morphAttributeCount),M.push(v.numDirLights),M.push(v.numPointLights),M.push(v.numSpotLights),M.push(v.numSpotLightMaps),M.push(v.numHemiLights),M.push(v.numRectAreaLights),M.push(v.numDirLightShadows),M.push(v.numPointLightShadows),M.push(v.numSpotLightShadows),M.push(v.numSpotLightShadowsWithMaps),M.push(v.numLightProbes),M.push(v.shadowMapType),M.push(v.toneMapping),M.push(v.numClippingPlanes),M.push(v.numClipIntersection),M.push(v.depthPacking)}function S(M,v){a.disableAll(),v.instancing&&a.enable(0),v.instancingColor&&a.enable(1),v.instancingMorph&&a.enable(2),v.matcap&&a.enable(3),v.envMap&&a.enable(4),v.normalMapObjectSpace&&a.enable(5),v.normalMapTangentSpace&&a.enable(6),v.clearcoat&&a.enable(7),v.iridescence&&a.enable(8),v.alphaTest&&a.enable(9),v.vertexColors&&a.enable(10),v.vertexAlphas&&a.enable(11),v.vertexUv1s&&a.enable(12),v.vertexUv2s&&a.enable(13),v.vertexUv3s&&a.enable(14),v.vertexTangents&&a.enable(15),v.anisotropy&&a.enable(16),v.alphaHash&&a.enable(17),v.batching&&a.enable(18),v.dispersion&&a.enable(19),v.batchingColor&&a.enable(20),v.gradientMap&&a.enable(21),v.packedNormalMap&&a.enable(22),v.vertexNormals&&a.enable(23),M.push(a.mask),a.disableAll(),v.fog&&a.enable(0),v.useFog&&a.enable(1),v.flatShading&&a.enable(2),v.logarithmicDepthBuffer&&a.enable(3),v.reversedDepthBuffer&&a.enable(4),v.skinning&&a.enable(5),v.morphTargets&&a.enable(6),v.morphNormals&&a.enable(7),v.morphColors&&a.enable(8),v.premultipliedAlpha&&a.enable(9),v.shadowMapEnabled&&a.enable(10),v.doubleSided&&a.enable(11),v.flipSided&&a.enable(12),v.useDepthPacking&&a.enable(13),v.dithering&&a.enable(14),v.transmission&&a.enable(15),v.sheen&&a.enable(16),v.opaque&&a.enable(17),v.pointsUvs&&a.enable(18),v.decodeVideoTexture&&a.enable(19),v.decodeVideoTextureEmissive&&a.enable(20),v.alphaToCoverage&&a.enable(21),v.numLightProbeGrids>0&&a.enable(22),v.hasPositionAttribute&&a.enable(23),M.push(a.mask)}function T(M){const v=f[M.type];let R;if(v){const E=Bn[v];R=Qm.clone(E.uniforms)}else R=M.uniforms;return R}function _(M,v){let R=u.get(v);return R!==void 0?++R.usedTimes:(R=new iy(i,v,M,s),l.push(R),u.set(v,R)),R}function A(M){if(--M.usedTimes===0){const v=l.indexOf(M);l[v]=l[l.length-1],l.pop(),u.delete(M.cacheKey),M.destroy()}}function w(M){o.remove(M)}function I(){o.dispose()}return{getParameters:y,getProgramCacheKey:g,getUniforms:T,acquireProgram:_,releaseProgram:A,releaseShaderCache:w,programs:l,dispose:I}}function ly(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,c){i.get(a)[o]=c}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function uy(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function Ad(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function wd(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h){let f=0;return h.isInstancedMesh&&(f+=2),h.isSkinnedMesh&&(f+=1),f}function o(h,f,p,y,g,m){let S=i[e];return S===void 0?(S={id:h.id,object:h,geometry:f,material:p,materialVariant:a(h),groupOrder:y,renderOrder:h.renderOrder,z:g,group:m},i[e]=S):(S.id=h.id,S.object=h,S.geometry=f,S.material=p,S.materialVariant=a(h),S.groupOrder=y,S.renderOrder=h.renderOrder,S.z=g,S.group=m),e++,S}function c(h,f,p,y,g,m){const S=o(h,f,p,y,g,m);p.transmission>0?n.push(S):p.transparent===!0?s.push(S):t.push(S)}function l(h,f,p,y,g,m){const S=o(h,f,p,y,g,m);p.transmission>0?n.unshift(S):p.transparent===!0?s.unshift(S):t.unshift(S)}function u(h,f,p){t.length>1&&t.sort(h||uy),n.length>1&&n.sort(f||Ad),s.length>1&&s.sort(f||Ad),p&&(t.reverse(),n.reverse(),s.reverse())}function d(){for(let h=e,f=i.length;h<f;h++){const p=i[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:c,unshift:l,finish:d,sort:u}}function dy(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new wd,i.set(n,[a])):s>=r.length?(a=new wd,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function hy(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new F,color:new We};break;case"SpotLight":t={position:new F,direction:new F,color:new We,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new F,color:new We,distance:0,decay:0};break;case"HemisphereLight":t={direction:new F,skyColor:new We,groundColor:new We};break;case"RectAreaLight":t={color:new We,position:new F,halfWidth:new F,halfHeight:new F};break}return i[e.id]=t,t}}}function fy(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let py=0;function my(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function gy(i){const e=new hy,t=fy(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new F);const s=new F,r=new $e,a=new $e;function o(l){let u=0,d=0,h=0;for(let v=0;v<9;v++)n.probe[v].set(0,0,0);let f=0,p=0,y=0,g=0,m=0,S=0,T=0,_=0,A=0,w=0,I=0;l.sort(my);for(let v=0,R=l.length;v<R;v++){const E=l[v],L=E.color,H=E.intensity,X=E.distance;let U=null;if(E.shadow&&E.shadow.map&&(E.shadow.map.texture.format===Yi?U=E.shadow.map.texture:U=E.shadow.map.depthTexture||E.shadow.map.texture),E.isAmbientLight)u+=L.r*H,d+=L.g*H,h+=L.b*H;else if(E.isLightProbe){for(let W=0;W<9;W++)n.probe[W].addScaledVector(E.sh.coefficients[W],H);I++}else if(E.isDirectionalLight){const W=e.get(E);if(W.color.copy(E.color).multiplyScalar(E.intensity),E.castShadow){const G=E.shadow,J=t.get(E);J.shadowIntensity=G.intensity,J.shadowBias=G.bias,J.shadowNormalBias=G.normalBias,J.shadowRadius=G.radius,J.shadowMapSize=G.mapSize,n.directionalShadow[f]=J,n.directionalShadowMap[f]=U,n.directionalShadowMatrix[f]=E.shadow.matrix,S++}n.directional[f]=W,f++}else if(E.isSpotLight){const W=e.get(E);W.position.setFromMatrixPosition(E.matrixWorld),W.color.copy(L).multiplyScalar(H),W.distance=X,W.coneCos=Math.cos(E.angle),W.penumbraCos=Math.cos(E.angle*(1-E.penumbra)),W.decay=E.decay,n.spot[y]=W;const G=E.shadow;if(E.map&&(n.spotLightMap[A]=E.map,A++,G.updateMatrices(E),E.castShadow&&w++),n.spotLightMatrix[y]=G.matrix,E.castShadow){const J=t.get(E);J.shadowIntensity=G.intensity,J.shadowBias=G.bias,J.shadowNormalBias=G.normalBias,J.shadowRadius=G.radius,J.shadowMapSize=G.mapSize,n.spotShadow[y]=J,n.spotShadowMap[y]=U,_++}y++}else if(E.isRectAreaLight){const W=e.get(E);W.color.copy(L).multiplyScalar(H),W.halfWidth.set(E.width*.5,0,0),W.halfHeight.set(0,E.height*.5,0),n.rectArea[g]=W,g++}else if(E.isPointLight){const W=e.get(E);if(W.color.copy(E.color).multiplyScalar(E.intensity),W.distance=E.distance,W.decay=E.decay,E.castShadow){const G=E.shadow,J=t.get(E);J.shadowIntensity=G.intensity,J.shadowBias=G.bias,J.shadowNormalBias=G.normalBias,J.shadowRadius=G.radius,J.shadowMapSize=G.mapSize,J.shadowCameraNear=G.camera.near,J.shadowCameraFar=G.camera.far,n.pointShadow[p]=J,n.pointShadowMap[p]=U,n.pointShadowMatrix[p]=E.shadow.matrix,T++}n.point[p]=W,p++}else if(E.isHemisphereLight){const W=e.get(E);W.skyColor.copy(E.color).multiplyScalar(H),W.groundColor.copy(E.groundColor).multiplyScalar(H),n.hemi[m]=W,m++}}g>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ye.LTC_FLOAT_1,n.rectAreaLTC2=ye.LTC_FLOAT_2):(n.rectAreaLTC1=ye.LTC_HALF_1,n.rectAreaLTC2=ye.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=d,n.ambient[2]=h;const M=n.hash;(M.directionalLength!==f||M.pointLength!==p||M.spotLength!==y||M.rectAreaLength!==g||M.hemiLength!==m||M.numDirectionalShadows!==S||M.numPointShadows!==T||M.numSpotShadows!==_||M.numSpotMaps!==A||M.numLightProbes!==I)&&(n.directional.length=f,n.spot.length=y,n.rectArea.length=g,n.point.length=p,n.hemi.length=m,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.pointShadow.length=T,n.pointShadowMap.length=T,n.spotShadow.length=_,n.spotShadowMap.length=_,n.directionalShadowMatrix.length=S,n.pointShadowMatrix.length=T,n.spotLightMatrix.length=_+A-w,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=I,M.directionalLength=f,M.pointLength=p,M.spotLength=y,M.rectAreaLength=g,M.hemiLength=m,M.numDirectionalShadows=S,M.numPointShadows=T,M.numSpotShadows=_,M.numSpotMaps=A,M.numLightProbes=I,n.version=py++)}function c(l,u){let d=0,h=0,f=0,p=0,y=0;const g=u.matrixWorldInverse;for(let m=0,S=l.length;m<S;m++){const T=l[m];if(T.isDirectionalLight){const _=n.directional[d];_.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),_.direction.sub(s),_.direction.transformDirection(g),d++}else if(T.isSpotLight){const _=n.spot[f];_.position.setFromMatrixPosition(T.matrixWorld),_.position.applyMatrix4(g),_.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),_.direction.sub(s),_.direction.transformDirection(g),f++}else if(T.isRectAreaLight){const _=n.rectArea[p];_.position.setFromMatrixPosition(T.matrixWorld),_.position.applyMatrix4(g),a.identity(),r.copy(T.matrixWorld),r.premultiply(g),a.extractRotation(r),_.halfWidth.set(T.width*.5,0,0),_.halfHeight.set(0,T.height*.5,0),_.halfWidth.applyMatrix4(a),_.halfHeight.applyMatrix4(a),p++}else if(T.isPointLight){const _=n.point[h];_.position.setFromMatrixPosition(T.matrixWorld),_.position.applyMatrix4(g),h++}else if(T.isHemisphereLight){const _=n.hemi[y];_.direction.setFromMatrixPosition(T.matrixWorld),_.direction.transformDirection(g),y++}}}return{setup:o,setupView:c,state:n}}function Rd(i){const e=new gy(i),t=[],n=[],s=[];function r(h){d.camera=h,t.length=0,n.length=0,s.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function c(h){s.push(h)}function l(){e.setup(t)}function u(h){e.setupView(t,h)}const d={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:l,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function _y(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Rd(i),e.set(s,[o])):r>=a.length?(o=new Rd(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const xy=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,yy=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],My=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],Cd=new $e,or=new F,Vo=new F;function Sy(i,e,t){let n=new Il;const s=new Te,r=new Te,a=new gt,o=new ig,c=new sg,l={},u=t.maxTextureSize,d={[ci]:nn,[nn]:ci,[zn]:zn},h=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:xy,fragmentShader:vy}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const p=new tn;p.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new It(p,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ba;let m=this.type;this.render=function(w,I,M){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;this.type===Hf&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ba);const v=i.getRenderTarget(),R=i.getActiveCubeFace(),E=i.getActiveMipmapLevel(),L=i.state;L.setBlending(ai),L.buffers.depth.getReversed()===!0?L.buffers.color.setClear(0,0,0,0):L.buffers.color.setClear(1,1,1,1),L.buffers.depth.setTest(!0),L.setScissorTest(!1);const H=m!==this.type;H&&I.traverse(function(X){X.material&&(Array.isArray(X.material)?X.material.forEach(U=>U.needsUpdate=!0):X.material.needsUpdate=!0)});for(let X=0,U=w.length;X<U;X++){const W=w[X],G=W.shadow;if(G===void 0){Ie("WebGLShadowMap:",W,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const J=G.getFrameExtents();s.multiply(J),r.copy(G.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/J.x),s.x=r.x*J.x,G.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/J.y),s.y=r.y*J.y,G.mapSize.y=r.y));const re=i.state.buffers.depth.getReversed();if(G.camera._reversedDepth=re,G.map===null||H===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===fr){if(W.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Wn(s.x,s.y,{format:Yi,type:li,minFilter:Rt,magFilter:Rt,generateMipmaps:!1}),G.map.texture.name=W.name+".shadowMap",G.map.depthTexture=new zs(s.x,s.y,pn),G.map.depthTexture.name=W.name+".shadowMapDepth",G.map.depthTexture.format=ui,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=wt,G.map.depthTexture.magFilter=wt}else W.isPointLight?(G.map=new uf(s.x),G.map.depthTexture=new vm(s.x,Xn)):(G.map=new Wn(s.x,s.y),G.map.depthTexture=new zs(s.x,s.y,Xn)),G.map.depthTexture.name=W.name+".shadowMap",G.map.depthTexture.format=ui,this.type===ba?(G.map.depthTexture.compareFunction=re?Tl:bl,G.map.depthTexture.minFilter=Rt,G.map.depthTexture.magFilter=Rt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=wt,G.map.depthTexture.magFilter=wt);G.camera.updateProjectionMatrix()}const $=G.map.isWebGLCubeRenderTarget?6:1;for(let oe=0;oe<$;oe++){if(G.map.isWebGLCubeRenderTarget)i.setRenderTarget(G.map,oe),i.clear();else{oe===0&&(i.setRenderTarget(G.map),i.clear());const he=G.getViewport(oe);a.set(r.x*he.x,r.y*he.y,r.x*he.z,r.y*he.w),L.viewport(a)}if(W.isPointLight){const he=G.camera,Qe=G.matrix,lt=W.distance||he.far;lt!==he.far&&(he.far=lt,he.updateProjectionMatrix()),or.setFromMatrixPosition(W.matrixWorld),he.position.copy(or),Vo.copy(he.position),Vo.add(yy[oe]),he.up.copy(My[oe]),he.lookAt(Vo),he.updateMatrixWorld(),Qe.makeTranslation(-or.x,-or.y,-or.z),Cd.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),G._frustum.setFromProjectionMatrix(Cd,he.coordinateSystem,he.reversedDepth)}else G.updateMatrices(W);n=G.getFrustum(),_(I,M,G.camera,W,this.type)}G.isPointLightShadow!==!0&&this.type===fr&&S(G,M),G.needsUpdate=!1}m=this.type,g.needsUpdate=!1,i.setRenderTarget(v,R,E)};function S(w,I){const M=e.update(y);h.defines.VSM_SAMPLES!==w.blurSamples&&(h.defines.VSM_SAMPLES=w.blurSamples,f.defines.VSM_SAMPLES=w.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Wn(s.x,s.y,{format:Yi,type:li})),h.uniforms.shadow_pass.value=w.map.depthTexture,h.uniforms.resolution.value=w.mapSize,h.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(I,null,M,h,y,null),f.uniforms.shadow_pass.value=w.mapPass.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(I,null,M,f,y,null)}function T(w,I,M,v){let R=null;const E=M.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(E!==void 0)R=E;else if(R=M.isPointLight===!0?c:o,i.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){const L=R.uuid,H=I.uuid;let X=l[L];X===void 0&&(X={},l[L]=X);let U=X[H];U===void 0&&(U=R.clone(),X[H]=U,I.addEventListener("dispose",A)),R=U}if(R.visible=I.visible,R.wireframe=I.wireframe,v===fr?R.side=I.shadowSide!==null?I.shadowSide:I.side:R.side=I.shadowSide!==null?I.shadowSide:d[I.side],R.alphaMap=I.alphaMap,R.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,R.map=I.map,R.clipShadows=I.clipShadows,R.clippingPlanes=I.clippingPlanes,R.clipIntersection=I.clipIntersection,R.displacementMap=I.displacementMap,R.displacementScale=I.displacementScale,R.displacementBias=I.displacementBias,R.wireframeLinewidth=I.wireframeLinewidth,R.linewidth=I.linewidth,M.isPointLight===!0&&R.isMeshDistanceMaterial===!0){const L=i.properties.get(R);L.light=M}return R}function _(w,I,M,v,R){if(w.visible===!1)return;if(w.layers.test(I.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&R===fr)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(M.matrixWorldInverse,w.matrixWorld);const H=e.update(w),X=w.material;if(Array.isArray(X)){const U=H.groups;for(let W=0,G=U.length;W<G;W++){const J=U[W],re=X[J.materialIndex];if(re&&re.visible){const $=T(w,re,v,R);w.onBeforeShadow(i,w,I,M,H,$,J),i.renderBufferDirect(M,null,H,$,w,J),w.onAfterShadow(i,w,I,M,H,$,J)}}}else if(X.visible){const U=T(w,X,v,R);w.onBeforeShadow(i,w,I,M,H,U,null),i.renderBufferDirect(M,null,H,U,w,null),w.onAfterShadow(i,w,I,M,H,U,null)}}const L=w.children;for(let H=0,X=L.length;H<X;H++)_(L[H],I,M,v,R)}function A(w){w.target.removeEventListener("dispose",A);for(const M in l){const v=l[M],R=w.target.uuid;R in v&&(v[R].dispose(),delete v[R])}}}function by(i,e){function t(){let B=!1;const fe=new gt;let ie=null;const _e=new gt(0,0,0,0);return{setMask:function(Ee){ie!==Ee&&!B&&(i.colorMask(Ee,Ee,Ee,Ee),ie=Ee)},setLocked:function(Ee){B=Ee},setClear:function(Ee,ae,Le,Ce,Ct){Ct===!0&&(Ee*=Ce,ae*=Ce,Le*=Ce),fe.set(Ee,ae,Le,Ce),_e.equals(fe)===!1&&(i.clearColor(Ee,ae,Le,Ce),_e.copy(fe))},reset:function(){B=!1,ie=null,_e.set(-1,0,0,0)}}}function n(){let B=!1,fe=!1,ie=null,_e=null,Ee=null;return{setReversed:function(ae){if(fe!==ae){const Le=e.get("EXT_clip_control");ae?Le.clipControlEXT(Le.LOWER_LEFT_EXT,Le.ZERO_TO_ONE_EXT):Le.clipControlEXT(Le.LOWER_LEFT_EXT,Le.NEGATIVE_ONE_TO_ONE_EXT),fe=ae;const Ce=Ee;Ee=null,this.setClear(Ce)}},getReversed:function(){return fe},setTest:function(ae){ae?le(i.DEPTH_TEST):ze(i.DEPTH_TEST)},setMask:function(ae){ie!==ae&&!B&&(i.depthMask(ae),ie=ae)},setFunc:function(ae){if(fe&&(ae=Ep[ae]),_e!==ae){switch(ae){case rc:i.depthFunc(i.NEVER);break;case ac:i.depthFunc(i.ALWAYS);break;case oc:i.depthFunc(i.LESS);break;case Os:i.depthFunc(i.LEQUAL);break;case cc:i.depthFunc(i.EQUAL);break;case lc:i.depthFunc(i.GEQUAL);break;case uc:i.depthFunc(i.GREATER);break;case dc:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_e=ae}},setLocked:function(ae){B=ae},setClear:function(ae){Ee!==ae&&(Ee=ae,fe&&(ae=1-ae),i.clearDepth(ae))},reset:function(){B=!1,ie=null,_e=null,Ee=null,fe=!1}}}function s(){let B=!1,fe=null,ie=null,_e=null,Ee=null,ae=null,Le=null,Ce=null,Ct=null;return{setTest:function(yt){B||(yt?le(i.STENCIL_TEST):ze(i.STENCIL_TEST))},setMask:function(yt){fe!==yt&&!B&&(i.stencilMask(yt),fe=yt)},setFunc:function(yt,Dn,Nn){(ie!==yt||_e!==Dn||Ee!==Nn)&&(i.stencilFunc(yt,Dn,Nn),ie=yt,_e=Dn,Ee=Nn)},setOp:function(yt,Dn,Nn){(ae!==yt||Le!==Dn||Ce!==Nn)&&(i.stencilOp(yt,Dn,Nn),ae=yt,Le=Dn,Ce=Nn)},setLocked:function(yt){B=yt},setClear:function(yt){Ct!==yt&&(i.clearStencil(yt),Ct=yt)},reset:function(){B=!1,fe=null,ie=null,_e=null,Ee=null,ae=null,Le=null,Ce=null,Ct=null}}}const r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let u={},d={},h={},f=new WeakMap,p=[],y=null,g=!1,m=null,S=null,T=null,_=null,A=null,w=null,I=null,M=new We(0,0,0),v=0,R=!1,E=null,L=null,H=null,X=null,U=null;const W=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,J=0;const re=i.getParameter(i.VERSION);re.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(re)[1]),G=J>=1):re.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(re)[1]),G=J>=2);let $=null,oe={};const he=i.getParameter(i.SCISSOR_BOX),Qe=i.getParameter(i.VIEWPORT),lt=new gt().fromArray(he),Be=new gt().fromArray(Qe);function te(B,fe,ie,_e){const Ee=new Uint8Array(4),ae=i.createTexture();i.bindTexture(B,ae),i.texParameteri(B,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(B,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Le=0;Le<ie;Le++)B===i.TEXTURE_3D||B===i.TEXTURE_2D_ARRAY?i.texImage3D(fe,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(fe+Le,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return ae}const ue={};ue[i.TEXTURE_2D]=te(i.TEXTURE_2D,i.TEXTURE_2D,1),ue[i.TEXTURE_CUBE_MAP]=te(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ue[i.TEXTURE_2D_ARRAY]=te(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ue[i.TEXTURE_3D]=te(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),le(i.DEPTH_TEST),a.setFunc(Os),P(!1),k(ru),le(i.CULL_FACE),O(ai);function le(B){u[B]!==!0&&(i.enable(B),u[B]=!0)}function ze(B){u[B]!==!1&&(i.disable(B),u[B]=!1)}function Xe(B,fe){return h[B]!==fe?(i.bindFramebuffer(B,fe),h[B]=fe,B===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=fe),B===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=fe),!0):!1}function Oe(B,fe){let ie=p,_e=!1;if(B){ie=f.get(fe),ie===void 0&&(ie=[],f.set(fe,ie));const Ee=B.textures;if(ie.length!==Ee.length||ie[0]!==i.COLOR_ATTACHMENT0){for(let ae=0,Le=Ee.length;ae<Le;ae++)ie[ae]=i.COLOR_ATTACHMENT0+ae;ie.length=Ee.length,_e=!0}}else ie[0]!==i.BACK&&(ie[0]=i.BACK,_e=!0);_e&&i.drawBuffers(ie)}function vt(B){return y!==B?(i.useProgram(B),y=B,!0):!1}const je={[zi]:i.FUNC_ADD,[Gf]:i.FUNC_SUBTRACT,[Wf]:i.FUNC_REVERSE_SUBTRACT};je[Xf]=i.MIN,je[qf]=i.MAX;const ot={[Yf]:i.ZERO,[Kf]:i.ONE,[$f]:i.SRC_COLOR,[ic]:i.SRC_ALPHA,[tp]:i.SRC_ALPHA_SATURATE,[Qf]:i.DST_COLOR,[Jf]:i.DST_ALPHA,[Zf]:i.ONE_MINUS_SRC_COLOR,[sc]:i.ONE_MINUS_SRC_ALPHA,[ep]:i.ONE_MINUS_DST_COLOR,[jf]:i.ONE_MINUS_DST_ALPHA,[np]:i.CONSTANT_COLOR,[ip]:i.ONE_MINUS_CONSTANT_COLOR,[sp]:i.CONSTANT_ALPHA,[rp]:i.ONE_MINUS_CONSTANT_ALPHA};function O(B,fe,ie,_e,Ee,ae,Le,Ce,Ct,yt){if(B===ai){g===!0&&(ze(i.BLEND),g=!1);return}if(g===!1&&(le(i.BLEND),g=!0),B!==Vf){if(B!==m||yt!==R){if((S!==zi||A!==zi)&&(i.blendEquation(i.FUNC_ADD),S=zi,A=zi),yt)switch(B){case Ps:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nc:i.blendFunc(i.ONE,i.ONE);break;case au:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ou:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ge("WebGLState: Invalid blending: ",B);break}else switch(B){case Ps:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nc:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case au:Ge("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ou:Ge("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ge("WebGLState: Invalid blending: ",B);break}T=null,_=null,w=null,I=null,M.set(0,0,0),v=0,m=B,R=yt}return}Ee=Ee||fe,ae=ae||ie,Le=Le||_e,(fe!==S||Ee!==A)&&(i.blendEquationSeparate(je[fe],je[Ee]),S=fe,A=Ee),(ie!==T||_e!==_||ae!==w||Le!==I)&&(i.blendFuncSeparate(ot[ie],ot[_e],ot[ae],ot[Le]),T=ie,_=_e,w=ae,I=Le),(Ce.equals(M)===!1||Ct!==v)&&(i.blendColor(Ce.r,Ce.g,Ce.b,Ct),M.copy(Ce),v=Ct),m=B,R=!1}function D(B,fe){B.side===zn?ze(i.CULL_FACE):le(i.CULL_FACE);let ie=B.side===nn;fe&&(ie=!ie),P(ie),B.blending===Ps&&B.transparent===!1?O(ai):O(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),a.setFunc(B.depthFunc),a.setTest(B.depthTest),a.setMask(B.depthWrite),r.setMask(B.colorWrite);const _e=B.stencilWrite;o.setTest(_e),_e&&(o.setMask(B.stencilWriteMask),o.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),o.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),ne(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?le(i.SAMPLE_ALPHA_TO_COVERAGE):ze(i.SAMPLE_ALPHA_TO_COVERAGE)}function P(B){E!==B&&(B?i.frontFace(i.CW):i.frontFace(i.CCW),E=B)}function k(B){B!==Bf?(le(i.CULL_FACE),B!==L&&(B===ru?i.cullFace(i.BACK):B===zf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ze(i.CULL_FACE),L=B}function ee(B){B!==H&&(G&&i.lineWidth(B),H=B)}function ne(B,fe,ie){B?(le(i.POLYGON_OFFSET_FILL),(X!==fe||U!==ie)&&(X=fe,U=ie,a.getReversed()&&(fe=-fe),i.polygonOffset(fe,ie))):ze(i.POLYGON_OFFSET_FILL)}function ce(B){B?le(i.SCISSOR_TEST):ze(i.SCISSOR_TEST)}function xe(B){B===void 0&&(B=i.TEXTURE0+W-1),$!==B&&(i.activeTexture(B),$=B)}function N(B,fe,ie){ie===void 0&&($===null?ie=i.TEXTURE0+W-1:ie=$);let _e=oe[ie];_e===void 0&&(_e={type:void 0,texture:void 0},oe[ie]=_e),(_e.type!==B||_e.texture!==fe)&&($!==ie&&(i.activeTexture(ie),$=ie),i.bindTexture(B,fe||ue[B]),_e.type=B,_e.texture=fe)}function Se(){const B=oe[$];B!==void 0&&B.type!==void 0&&(i.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function Re(){try{i.compressedTexImage2D(...arguments)}catch(B){Ge("WebGLState:",B)}}function C(){try{i.compressedTexImage3D(...arguments)}catch(B){Ge("WebGLState:",B)}}function x(){try{i.texSubImage2D(...arguments)}catch(B){Ge("WebGLState:",B)}}function V(){try{i.texSubImage3D(...arguments)}catch(B){Ge("WebGLState:",B)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(B){Ge("WebGLState:",B)}}function j(){try{i.compressedTexSubImage3D(...arguments)}catch(B){Ge("WebGLState:",B)}}function de(){try{i.texStorage2D(...arguments)}catch(B){Ge("WebGLState:",B)}}function pe(){try{i.texStorage3D(...arguments)}catch(B){Ge("WebGLState:",B)}}function Q(){try{i.texImage2D(...arguments)}catch(B){Ge("WebGLState:",B)}}function se(){try{i.texImage3D(...arguments)}catch(B){Ge("WebGLState:",B)}}function me(B){return d[B]!==void 0?d[B]:i.getParameter(B)}function De(B,fe){d[B]!==fe&&(i.pixelStorei(B,fe),d[B]=fe)}function ve(B){lt.equals(B)===!1&&(i.scissor(B.x,B.y,B.z,B.w),lt.copy(B))}function ge(B){Be.equals(B)===!1&&(i.viewport(B.x,B.y,B.z,B.w),Be.copy(B))}function Fe(B,fe){let ie=l.get(fe);ie===void 0&&(ie=new WeakMap,l.set(fe,ie));let _e=ie.get(B);_e===void 0&&(_e=i.getUniformBlockIndex(fe,B.name),ie.set(B,_e))}function Ve(B,fe){const _e=l.get(fe).get(B);c.get(fe)!==_e&&(i.uniformBlockBinding(fe,_e,B.__bindingPointIndex),c.set(fe,_e))}function Ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},d={},$=null,oe={},h={},f=new WeakMap,p=[],y=null,g=!1,m=null,S=null,T=null,_=null,A=null,w=null,I=null,M=new We(0,0,0),v=0,R=!1,E=null,L=null,H=null,X=null,U=null,lt.set(0,0,i.canvas.width,i.canvas.height),Be.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:le,disable:ze,bindFramebuffer:Xe,drawBuffers:Oe,useProgram:vt,setBlending:O,setMaterial:D,setFlipSided:P,setCullFace:k,setLineWidth:ee,setPolygonOffset:ne,setScissorTest:ce,activeTexture:xe,bindTexture:N,unbindTexture:Se,compressedTexImage2D:Re,compressedTexImage3D:C,texImage2D:Q,texImage3D:se,pixelStorei:De,getParameter:me,updateUBOMapping:Fe,uniformBlockBinding:Ve,texStorage2D:de,texStorage3D:pe,texSubImage2D:x,texSubImage3D:V,compressedTexSubImage2D:q,compressedTexSubImage3D:j,scissor:ve,viewport:ge,reset:Ze}}function Ty(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Te,u=new WeakMap,d=new Set;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(C,x){return p?new OffscreenCanvas(C,x):Rr("canvas")}function g(C,x,V){let q=1;const j=Re(C);if((j.width>V||j.height>V)&&(q=V/Math.max(j.width,j.height)),q<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const de=Math.floor(q*j.width),pe=Math.floor(q*j.height);h===void 0&&(h=y(de,pe));const Q=x?y(de,pe):h;return Q.width=de,Q.height=pe,Q.getContext("2d").drawImage(C,0,0,de,pe),Ie("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+de+"x"+pe+")."),Q}else return"data"in C&&Ie("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),C;return C}function m(C){return C.generateMipmaps}function S(C){i.generateMipmap(C)}function T(C){return C.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?i.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function _(C,x,V,q,j,de=!1){if(C!==null){if(i[C]!==void 0)return i[C];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let pe;q&&(pe=e.get("EXT_texture_norm16"),pe||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=x;if(x===i.RED&&(V===i.FLOAT&&(Q=i.R32F),V===i.HALF_FLOAT&&(Q=i.R16F),V===i.UNSIGNED_BYTE&&(Q=i.R8),V===i.UNSIGNED_SHORT&&pe&&(Q=pe.R16_EXT),V===i.SHORT&&pe&&(Q=pe.R16_SNORM_EXT)),x===i.RED_INTEGER&&(V===i.UNSIGNED_BYTE&&(Q=i.R8UI),V===i.UNSIGNED_SHORT&&(Q=i.R16UI),V===i.UNSIGNED_INT&&(Q=i.R32UI),V===i.BYTE&&(Q=i.R8I),V===i.SHORT&&(Q=i.R16I),V===i.INT&&(Q=i.R32I)),x===i.RG&&(V===i.FLOAT&&(Q=i.RG32F),V===i.HALF_FLOAT&&(Q=i.RG16F),V===i.UNSIGNED_BYTE&&(Q=i.RG8),V===i.UNSIGNED_SHORT&&pe&&(Q=pe.RG16_EXT),V===i.SHORT&&pe&&(Q=pe.RG16_SNORM_EXT)),x===i.RG_INTEGER&&(V===i.UNSIGNED_BYTE&&(Q=i.RG8UI),V===i.UNSIGNED_SHORT&&(Q=i.RG16UI),V===i.UNSIGNED_INT&&(Q=i.RG32UI),V===i.BYTE&&(Q=i.RG8I),V===i.SHORT&&(Q=i.RG16I),V===i.INT&&(Q=i.RG32I)),x===i.RGB_INTEGER&&(V===i.UNSIGNED_BYTE&&(Q=i.RGB8UI),V===i.UNSIGNED_SHORT&&(Q=i.RGB16UI),V===i.UNSIGNED_INT&&(Q=i.RGB32UI),V===i.BYTE&&(Q=i.RGB8I),V===i.SHORT&&(Q=i.RGB16I),V===i.INT&&(Q=i.RGB32I)),x===i.RGBA_INTEGER&&(V===i.UNSIGNED_BYTE&&(Q=i.RGBA8UI),V===i.UNSIGNED_SHORT&&(Q=i.RGBA16UI),V===i.UNSIGNED_INT&&(Q=i.RGBA32UI),V===i.BYTE&&(Q=i.RGBA8I),V===i.SHORT&&(Q=i.RGBA16I),V===i.INT&&(Q=i.RGBA32I)),x===i.RGB&&(V===i.UNSIGNED_SHORT&&pe&&(Q=pe.RGB16_EXT),V===i.SHORT&&pe&&(Q=pe.RGB16_SNORM_EXT),V===i.UNSIGNED_INT_5_9_9_9_REV&&(Q=i.RGB9_E5),V===i.UNSIGNED_INT_10F_11F_11F_REV&&(Q=i.R11F_G11F_B10F)),x===i.RGBA){const se=de?Ba:rt.getTransfer(j);V===i.FLOAT&&(Q=i.RGBA32F),V===i.HALF_FLOAT&&(Q=i.RGBA16F),V===i.UNSIGNED_BYTE&&(Q=se===ht?i.SRGB8_ALPHA8:i.RGBA8),V===i.UNSIGNED_SHORT&&pe&&(Q=pe.RGBA16_EXT),V===i.SHORT&&pe&&(Q=pe.RGBA16_SNORM_EXT),V===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),V===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function A(C,x){let V;return C?x===null||x===Xn||x===Tr?V=i.DEPTH24_STENCIL8:x===pn?V=i.DEPTH32F_STENCIL8:x===br&&(V=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Xn||x===Tr?V=i.DEPTH_COMPONENT24:x===pn?V=i.DEPTH_COMPONENT32F:x===br&&(V=i.DEPTH_COMPONENT16),V}function w(C,x){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==wt&&C.minFilter!==Rt?Math.log2(Math.max(x.width,x.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?x.mipmaps.length:1}function I(C){const x=C.target;x.removeEventListener("dispose",I),v(x),x.isVideoTexture&&u.delete(x),x.isHTMLTexture&&d.delete(x)}function M(C){const x=C.target;x.removeEventListener("dispose",M),E(x)}function v(C){const x=n.get(C);if(x.__webglInit===void 0)return;const V=C.source,q=f.get(V);if(q){const j=q[x.__cacheKey];j.usedTimes--,j.usedTimes===0&&R(C),Object.keys(q).length===0&&f.delete(V)}n.remove(C)}function R(C){const x=n.get(C);i.deleteTexture(x.__webglTexture);const V=C.source,q=f.get(V);delete q[x.__cacheKey],a.memory.textures--}function E(C){const x=n.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),n.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(x.__webglFramebuffer[q]))for(let j=0;j<x.__webglFramebuffer[q].length;j++)i.deleteFramebuffer(x.__webglFramebuffer[q][j]);else i.deleteFramebuffer(x.__webglFramebuffer[q]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[q])}else{if(Array.isArray(x.__webglFramebuffer))for(let q=0;q<x.__webglFramebuffer.length;q++)i.deleteFramebuffer(x.__webglFramebuffer[q]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let q=0;q<x.__webglColorRenderbuffer.length;q++)x.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[q]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const V=C.textures;for(let q=0,j=V.length;q<j;q++){const de=n.get(V[q]);de.__webglTexture&&(i.deleteTexture(de.__webglTexture),a.memory.textures--),n.remove(V[q])}n.remove(C)}let L=0;function H(){L=0}function X(){return L}function U(C){L=C}function W(){const C=L;return C>=s.maxTextures&&Ie("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),L+=1,C}function G(C){const x=[];return x.push(C.wrapS),x.push(C.wrapT),x.push(C.wrapR||0),x.push(C.magFilter),x.push(C.minFilter),x.push(C.anisotropy),x.push(C.internalFormat),x.push(C.format),x.push(C.type),x.push(C.generateMipmaps),x.push(C.premultiplyAlpha),x.push(C.flipY),x.push(C.unpackAlignment),x.push(C.colorSpace),x.join()}function J(C,x){const V=n.get(C);if(C.isVideoTexture&&N(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&V.__version!==C.version){const q=C.image;if(q===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{ze(V,C,x);return}}else C.isExternalTexture&&(V.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,V.__webglTexture,i.TEXTURE0+x)}function re(C,x){const V=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&V.__version!==C.version){ze(V,C,x);return}else C.isExternalTexture&&(V.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,V.__webglTexture,i.TEXTURE0+x)}function $(C,x){const V=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&V.__version!==C.version){ze(V,C,x);return}t.bindTexture(i.TEXTURE_3D,V.__webglTexture,i.TEXTURE0+x)}function oe(C,x){const V=n.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&V.__version!==C.version){Xe(V,C,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,V.__webglTexture,i.TEXTURE0+x)}const he={[ks]:i.REPEAT,[Hn]:i.CLAMP_TO_EDGE,[Ua]:i.MIRRORED_REPEAT},Qe={[wt]:i.NEAREST,[Th]:i.NEAREST_MIPMAP_NEAREST,[pr]:i.NEAREST_MIPMAP_LINEAR,[Rt]:i.LINEAR,[Ta]:i.LINEAR_MIPMAP_NEAREST,[ii]:i.LINEAR_MIPMAP_LINEAR},lt={[mp]:i.NEVER,[yp]:i.ALWAYS,[gp]:i.LESS,[bl]:i.LEQUAL,[_p]:i.EQUAL,[Tl]:i.GEQUAL,[xp]:i.GREATER,[vp]:i.NOTEQUAL};function Be(C,x){if(x.type===pn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===Rt||x.magFilter===Ta||x.magFilter===pr||x.magFilter===ii||x.minFilter===Rt||x.minFilter===Ta||x.minFilter===pr||x.minFilter===ii)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(C,i.TEXTURE_WRAP_S,he[x.wrapS]),i.texParameteri(C,i.TEXTURE_WRAP_T,he[x.wrapT]),(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)&&i.texParameteri(C,i.TEXTURE_WRAP_R,he[x.wrapR]),i.texParameteri(C,i.TEXTURE_MAG_FILTER,Qe[x.magFilter]),i.texParameteri(C,i.TEXTURE_MIN_FILTER,Qe[x.minFilter]),x.compareFunction&&(i.texParameteri(C,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(C,i.TEXTURE_COMPARE_FUNC,lt[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===wt||x.minFilter!==pr&&x.minFilter!==ii||x.type===pn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const V=e.get("EXT_texture_filter_anisotropic");i.texParameterf(C,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,s.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function te(C,x){let V=!1;C.__webglInit===void 0&&(C.__webglInit=!0,x.addEventListener("dispose",I));const q=x.source;let j=f.get(q);j===void 0&&(j={},f.set(q,j));const de=G(x);if(de!==C.__cacheKey){j[de]===void 0&&(j[de]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,V=!0),j[de].usedTimes++;const pe=j[C.__cacheKey];pe!==void 0&&(j[C.__cacheKey].usedTimes--,pe.usedTimes===0&&R(x)),C.__cacheKey=de,C.__webglTexture=j[de].texture}return V}function ue(C,x,V){return Math.floor(Math.floor(C/V)/x)}function le(C,x,V,q){const de=C.updateRanges;if(de.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,x.width,x.height,V,q,x.data);else{de.sort((De,ve)=>De.start-ve.start);let pe=0;for(let De=1;De<de.length;De++){const ve=de[pe],ge=de[De],Fe=ve.start+ve.count,Ve=ue(ge.start,x.width,4),Ze=ue(ve.start,x.width,4);ge.start<=Fe+1&&Ve===Ze&&ue(ge.start+ge.count-1,x.width,4)===Ve?ve.count=Math.max(ve.count,ge.start+ge.count-ve.start):(++pe,de[pe]=ge)}de.length=pe+1;const Q=t.getParameter(i.UNPACK_ROW_LENGTH),se=t.getParameter(i.UNPACK_SKIP_PIXELS),me=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,x.width);for(let De=0,ve=de.length;De<ve;De++){const ge=de[De],Fe=Math.floor(ge.start/4),Ve=Math.ceil(ge.count/4),Ze=Fe%x.width,B=Math.floor(Fe/x.width),fe=Ve,ie=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ze),t.pixelStorei(i.UNPACK_SKIP_ROWS,B),t.texSubImage2D(i.TEXTURE_2D,0,Ze,B,fe,ie,V,q,x.data)}C.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Q),t.pixelStorei(i.UNPACK_SKIP_PIXELS,se),t.pixelStorei(i.UNPACK_SKIP_ROWS,me)}}function ze(C,x,V){let q=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(q=i.TEXTURE_3D);const j=te(C,x),de=x.source;t.bindTexture(q,C.__webglTexture,i.TEXTURE0+V);const pe=n.get(de);if(de.version!==pe.__version||j===!0){if(t.activeTexture(i.TEXTURE0+V),(typeof ImageBitmap<"u"&&x.image instanceof ImageBitmap)===!1){const ie=rt.getPrimaries(rt.workingColorSpace),_e=x.colorSpace===Si?null:rt.getPrimaries(x.colorSpace),Ee=x.colorSpace===Si||ie===_e?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}t.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment);let se=g(x.image,!1,s.maxTextureSize);se=Se(x,se);const me=r.convert(x.format,x.colorSpace),De=r.convert(x.type);let ve=_(x.internalFormat,me,De,x.normalized,x.colorSpace,x.isVideoTexture);Be(q,x);let ge;const Fe=x.mipmaps,Ve=x.isVideoTexture!==!0,Ze=pe.__version===void 0||j===!0,B=de.dataReady,fe=w(x,se);if(x.isDepthTexture)ve=A(x.format===Vi,x.type),Ze&&(Ve?t.texStorage2D(i.TEXTURE_2D,1,ve,se.width,se.height):t.texImage2D(i.TEXTURE_2D,0,ve,se.width,se.height,0,me,De,null));else if(x.isDataTexture)if(Fe.length>0){Ve&&Ze&&t.texStorage2D(i.TEXTURE_2D,fe,ve,Fe[0].width,Fe[0].height);for(let ie=0,_e=Fe.length;ie<_e;ie++)ge=Fe[ie],Ve?B&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,ge.width,ge.height,me,De,ge.data):t.texImage2D(i.TEXTURE_2D,ie,ve,ge.width,ge.height,0,me,De,ge.data);x.generateMipmaps=!1}else Ve?(Ze&&t.texStorage2D(i.TEXTURE_2D,fe,ve,se.width,se.height),B&&le(x,se,me,De)):t.texImage2D(i.TEXTURE_2D,0,ve,se.width,se.height,0,me,De,se.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Ve&&Ze&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,ve,Fe[0].width,Fe[0].height,se.depth);for(let ie=0,_e=Fe.length;ie<_e;ie++)if(ge=Fe[ie],x.format!==mn)if(me!==null)if(Ve){if(B)if(x.layerUpdates.size>0){const Ee=ad(ge.width,ge.height,x.format,x.type);for(const ae of x.layerUpdates){const Le=ge.data.subarray(ae*Ee/ge.data.BYTES_PER_ELEMENT,(ae+1)*Ee/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,ae,ge.width,ge.height,1,me,Le)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,0,ge.width,ge.height,se.depth,me,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,ie,ve,ge.width,ge.height,se.depth,0,ge.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?B&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,ie,0,0,0,ge.width,ge.height,se.depth,me,De,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,ie,ve,ge.width,ge.height,se.depth,0,me,De,ge.data)}else{Ve&&Ze&&t.texStorage2D(i.TEXTURE_2D,fe,ve,Fe[0].width,Fe[0].height);for(let ie=0,_e=Fe.length;ie<_e;ie++)ge=Fe[ie],x.format!==mn?me!==null?Ve?B&&t.compressedTexSubImage2D(i.TEXTURE_2D,ie,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,ie,ve,ge.width,ge.height,0,ge.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?B&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,ge.width,ge.height,me,De,ge.data):t.texImage2D(i.TEXTURE_2D,ie,ve,ge.width,ge.height,0,me,De,ge.data)}else if(x.isDataArrayTexture)if(Ve){if(Ze&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,ve,se.width,se.height,se.depth),B)if(x.layerUpdates.size>0){const ie=ad(se.width,se.height,x.format,x.type);for(const _e of x.layerUpdates){const Ee=se.data.subarray(_e*ie/se.data.BYTES_PER_ELEMENT,(_e+1)*ie/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_e,se.width,se.height,1,me,De,Ee)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,me,De,se.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ve,se.width,se.height,se.depth,0,me,De,se.data);else if(x.isData3DTexture)Ve?(Ze&&t.texStorage3D(i.TEXTURE_3D,fe,ve,se.width,se.height,se.depth),B&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,me,De,se.data)):t.texImage3D(i.TEXTURE_3D,0,ve,se.width,se.height,se.depth,0,me,De,se.data);else if(x.isFramebufferTexture){if(Ze)if(Ve)t.texStorage2D(i.TEXTURE_2D,fe,ve,se.width,se.height);else{let ie=se.width,_e=se.height;for(let Ee=0;Ee<fe;Ee++)t.texImage2D(i.TEXTURE_2D,Ee,ve,ie,_e,0,me,De,null),ie>>=1,_e>>=1}}else if(x.isHTMLTexture){if("texElementImage2D"in i){const ie=i.canvas;if(ie.hasAttribute("layoutsubtree")||ie.setAttribute("layoutsubtree","true"),se.parentNode!==ie){ie.appendChild(se),d.add(x),ie.onpaint=_e=>{const Ee=_e.changedElements;for(const ae of d)Ee.includes(ae.image)&&(ae.needsUpdate=!0)},ie.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,se);else{const Ee=i.RGBA,ae=i.RGBA,Le=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Ee,ae,Le,se)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Ve&&Ze){const ie=Re(Fe[0]);t.texStorage2D(i.TEXTURE_2D,fe,ve,ie.width,ie.height)}for(let ie=0,_e=Fe.length;ie<_e;ie++)ge=Fe[ie],Ve?B&&t.texSubImage2D(i.TEXTURE_2D,ie,0,0,me,De,ge):t.texImage2D(i.TEXTURE_2D,ie,ve,me,De,ge);x.generateMipmaps=!1}else if(Ve){if(Ze){const ie=Re(se);t.texStorage2D(i.TEXTURE_2D,fe,ve,ie.width,ie.height)}B&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,De,se)}else t.texImage2D(i.TEXTURE_2D,0,ve,me,De,se);m(x)&&S(q),pe.__version=de.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function Xe(C,x,V){if(x.image.length!==6)return;const q=te(C,x),j=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+V);const de=n.get(j);if(j.version!==de.__version||q===!0){t.activeTexture(i.TEXTURE0+V);const pe=rt.getPrimaries(rt.workingColorSpace),Q=x.colorSpace===Si?null:rt.getPrimaries(x.colorSpace),se=x.colorSpace===Si||pe===Q?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);const me=x.isCompressedTexture||x.image[0].isCompressedTexture,De=x.image[0]&&x.image[0].isDataTexture,ve=[];for(let ae=0;ae<6;ae++)!me&&!De?ve[ae]=g(x.image[ae],!0,s.maxCubemapSize):ve[ae]=De?x.image[ae].image:x.image[ae],ve[ae]=Se(x,ve[ae]);const ge=ve[0],Fe=r.convert(x.format,x.colorSpace),Ve=r.convert(x.type),Ze=_(x.internalFormat,Fe,Ve,x.normalized,x.colorSpace),B=x.isVideoTexture!==!0,fe=de.__version===void 0||q===!0,ie=j.dataReady;let _e=w(x,ge);Be(i.TEXTURE_CUBE_MAP,x);let Ee;if(me){B&&fe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ze,ge.width,ge.height);for(let ae=0;ae<6;ae++){Ee=ve[ae].mipmaps;for(let Le=0;Le<Ee.length;Le++){const Ce=Ee[Le];x.format!==mn?Fe!==null?B?ie&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,0,0,Ce.width,Ce.height,Fe,Ce.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,Ze,Ce.width,Ce.height,0,Ce.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):B?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,0,0,Ce.width,Ce.height,Fe,Ve,Ce.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,Ze,Ce.width,Ce.height,0,Fe,Ve,Ce.data)}}}else{if(Ee=x.mipmaps,B&&fe){Ee.length>0&&_e++;const ae=Re(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ze,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(De){B?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,ve[ae].width,ve[ae].height,Fe,Ve,ve[ae].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,ve[ae].width,ve[ae].height,0,Fe,Ve,ve[ae].data);for(let Le=0;Le<Ee.length;Le++){const Ct=Ee[Le].image[ae].image;B?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,0,0,Ct.width,Ct.height,Fe,Ve,Ct.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,Ze,Ct.width,Ct.height,0,Fe,Ve,Ct.data)}}else{B?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Fe,Ve,ve[ae]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,Fe,Ve,ve[ae]);for(let Le=0;Le<Ee.length;Le++){const Ce=Ee[Le];B?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,0,0,Fe,Ve,Ce.image[ae]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,Ze,Fe,Ve,Ce.image[ae])}}}m(x)&&S(i.TEXTURE_CUBE_MAP),de.__version=j.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function Oe(C,x,V,q,j,de){const pe=r.convert(V.format,V.colorSpace),Q=r.convert(V.type),se=_(V.internalFormat,pe,Q,V.normalized,V.colorSpace),me=n.get(x),De=n.get(V);if(De.__renderTarget=x,!me.__hasExternalTextures){const ve=Math.max(1,x.width>>de),ge=Math.max(1,x.height>>de);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?t.texImage3D(j,de,se,ve,ge,x.depth,0,pe,Q,null):t.texImage2D(j,de,se,ve,ge,0,pe,Q,null)}t.bindFramebuffer(i.FRAMEBUFFER,C),xe(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,j,De.__webglTexture,0,ce(x)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,j,De.__webglTexture,de),t.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(C,x,V){if(i.bindRenderbuffer(i.RENDERBUFFER,C),x.depthBuffer){const q=x.depthTexture,j=q&&q.isDepthTexture?q.type:null,de=A(x.stencilBuffer,j),pe=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;xe(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ce(x),de,x.width,x.height):V?i.renderbufferStorageMultisample(i.RENDERBUFFER,ce(x),de,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,de,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,pe,i.RENDERBUFFER,C)}else{const q=x.textures;for(let j=0;j<q.length;j++){const de=q[j],pe=r.convert(de.format,de.colorSpace),Q=r.convert(de.type),se=_(de.internalFormat,pe,Q,de.normalized,de.colorSpace);xe(x)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ce(x),se,x.width,x.height):V?i.renderbufferStorageMultisample(i.RENDERBUFFER,ce(x),se,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,se,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function je(C,x,V){const q=x.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,C),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const j=n.get(x.depthTexture);if(j.__renderTarget=x,(!j.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),q){if(j.__webglInit===void 0&&(j.__webglInit=!0,x.depthTexture.addEventListener("dispose",I)),j.__webglTexture===void 0){j.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),Be(i.TEXTURE_CUBE_MAP,x.depthTexture);const me=r.convert(x.depthTexture.format),De=r.convert(x.depthTexture.type);let ve;x.depthTexture.format===ui?ve=i.DEPTH_COMPONENT24:x.depthTexture.format===Vi&&(ve=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ve,x.width,x.height,0,me,De,null)}}else J(x.depthTexture,0);const de=j.__webglTexture,pe=ce(x),Q=q?i.TEXTURE_CUBE_MAP_POSITIVE_X+V:i.TEXTURE_2D,se=x.depthTexture.format===Vi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(x.depthTexture.format===ui)xe(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,se,Q,de,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,se,Q,de,0);else if(x.depthTexture.format===Vi)xe(x)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,se,Q,de,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,se,Q,de,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function ot(C){const x=n.get(C),V=C.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==C.depthTexture){const q=C.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),q){const j=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,q.removeEventListener("dispose",j)};q.addEventListener("dispose",j),x.__depthDisposeCallback=j}x.__boundDepthTexture=q}if(C.depthTexture&&!x.__autoAllocateDepthBuffer)if(V)for(let q=0;q<6;q++)je(x.__webglFramebuffer[q],C,q);else{const q=C.texture.mipmaps;q&&q.length>0?je(x.__webglFramebuffer[0],C,0):je(x.__webglFramebuffer,C,0)}else if(V){x.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[q]),x.__webglDepthbuffer[q]===void 0)x.__webglDepthbuffer[q]=i.createRenderbuffer(),vt(x.__webglDepthbuffer[q],C,!1);else{const j=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=x.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,de),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,de)}}else{const q=C.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=i.createRenderbuffer(),vt(x.__webglDepthbuffer,C,!1);else{const j=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=x.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,de),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,de)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function O(C,x,V){const q=n.get(C);x!==void 0&&Oe(q.__webglFramebuffer,C,C.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),V!==void 0&&ot(C)}function D(C){const x=C.texture,V=n.get(C),q=n.get(x);C.addEventListener("dispose",M);const j=C.textures,de=C.isWebGLCubeRenderTarget===!0,pe=j.length>1;if(pe||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=x.version,a.memory.textures++),de){V.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(x.mipmaps&&x.mipmaps.length>0){V.__webglFramebuffer[Q]=[];for(let se=0;se<x.mipmaps.length;se++)V.__webglFramebuffer[Q][se]=i.createFramebuffer()}else V.__webglFramebuffer[Q]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){V.__webglFramebuffer=[];for(let Q=0;Q<x.mipmaps.length;Q++)V.__webglFramebuffer[Q]=i.createFramebuffer()}else V.__webglFramebuffer=i.createFramebuffer();if(pe)for(let Q=0,se=j.length;Q<se;Q++){const me=n.get(j[Q]);me.__webglTexture===void 0&&(me.__webglTexture=i.createTexture(),a.memory.textures++)}if(C.samples>0&&xe(C)===!1){V.__webglMultisampledFramebuffer=i.createFramebuffer(),V.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let Q=0;Q<j.length;Q++){const se=j[Q];V.__webglColorRenderbuffer[Q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,V.__webglColorRenderbuffer[Q]);const me=r.convert(se.format,se.colorSpace),De=r.convert(se.type),ve=_(se.internalFormat,me,De,se.normalized,se.colorSpace,C.isXRRenderTarget===!0),ge=ce(C);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ve,C.width,C.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,V.__webglColorRenderbuffer[Q])}i.bindRenderbuffer(i.RENDERBUFFER,null),C.depthBuffer&&(V.__webglDepthRenderbuffer=i.createRenderbuffer(),vt(V.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(de){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Be(i.TEXTURE_CUBE_MAP,x);for(let Q=0;Q<6;Q++)if(x.mipmaps&&x.mipmaps.length>0)for(let se=0;se<x.mipmaps.length;se++)Oe(V.__webglFramebuffer[Q][se],C,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,se);else Oe(V.__webglFramebuffer[Q],C,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);m(x)&&S(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let Q=0,se=j.length;Q<se;Q++){const me=j[Q],De=n.get(me);let ve=i.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ve=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,De.__webglTexture),Be(ve,me),Oe(V.__webglFramebuffer,C,me,i.COLOR_ATTACHMENT0+Q,ve,0),m(me)&&S(ve)}t.unbindTexture()}else{let Q=i.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Q=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Q,q.__webglTexture),Be(Q,x),x.mipmaps&&x.mipmaps.length>0)for(let se=0;se<x.mipmaps.length;se++)Oe(V.__webglFramebuffer[se],C,x,i.COLOR_ATTACHMENT0,Q,se);else Oe(V.__webglFramebuffer,C,x,i.COLOR_ATTACHMENT0,Q,0);m(x)&&S(Q),t.unbindTexture()}C.depthBuffer&&ot(C)}function P(C){const x=C.textures;for(let V=0,q=x.length;V<q;V++){const j=x[V];if(m(j)){const de=T(C),pe=n.get(j).__webglTexture;t.bindTexture(de,pe),S(de),t.unbindTexture()}}}const k=[],ee=[];function ne(C){if(C.samples>0){if(xe(C)===!1){const x=C.textures,V=C.width,q=C.height;let j=i.COLOR_BUFFER_BIT;const de=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pe=n.get(C),Q=x.length>1;if(Q)for(let me=0;me<x.length;me++)t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const se=C.texture.mipmaps;se&&se.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let me=0;me<x.length;me++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),Q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const De=n.get(x[me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,De,0)}i.blitFramebuffer(0,0,V,q,0,0,V,q,j,i.NEAREST),c===!0&&(k.length=0,ee.length=0,k.push(i.COLOR_ATTACHMENT0+me),C.depthBuffer&&C.resolveDepthBuffer===!1&&(k.push(de),ee.push(de),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ee)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,k))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Q)for(let me=0;me<x.length;me++){t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const De=n.get(x[me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,De,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&c){const x=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function ce(C){return Math.min(s.maxSamples,C.samples)}function xe(C){const x=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function N(C){const x=a.render.frame;u.get(C)!==x&&(u.set(C,x),C.update())}function Se(C,x){const V=C.colorSpace,q=C.format,j=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||V!==cn&&V!==Si&&(rt.getTransfer(V)===ht?(q!==mn||j!==on)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ge("WebGLTextures: Unsupported texture color space:",V)),x}function Re(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(l.width=C.naturalWidth||C.width,l.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(l.width=C.displayWidth,l.height=C.displayHeight):(l.width=C.width,l.height=C.height),l}this.allocateTextureUnit=W,this.resetTextureUnits=H,this.getTextureUnits=X,this.setTextureUnits=U,this.setTexture2D=J,this.setTexture2DArray=re,this.setTexture3D=$,this.setTextureCube=oe,this.rebindTextures=O,this.setupRenderTarget=D,this.updateRenderTargetMipmap=P,this.updateMultisampleRenderTarget=ne,this.setupDepthRenderbuffer=ot,this.setupFrameBufferTexture=Oe,this.useMultisampledRTT=xe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Ey(i,e){function t(n,s=Si){let r;const a=rt.getTransfer(s);if(n===on)return i.UNSIGNED_BYTE;if(n===gl)return i.UNSIGNED_SHORT_4_4_4_4;if(n===_l)return i.UNSIGNED_SHORT_5_5_5_1;if(n===wh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Rh)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Eh)return i.BYTE;if(n===Ah)return i.SHORT;if(n===br)return i.UNSIGNED_SHORT;if(n===ml)return i.INT;if(n===Xn)return i.UNSIGNED_INT;if(n===pn)return i.FLOAT;if(n===li)return i.HALF_FLOAT;if(n===Ch)return i.ALPHA;if(n===Ph)return i.RGB;if(n===mn)return i.RGBA;if(n===ui)return i.DEPTH_COMPONENT;if(n===Vi)return i.DEPTH_STENCIL;if(n===xl)return i.RED;if(n===vl)return i.RED_INTEGER;if(n===Yi)return i.RG;if(n===yl)return i.RG_INTEGER;if(n===Ml)return i.RGBA_INTEGER;if(n===Ea||n===Aa||n===wa||n===Ra)if(a===ht)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Ea)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Aa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===wa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ra)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Ea)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Aa)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===wa)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ra)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===hc||n===fc||n===pc||n===mc)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===hc)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===fc)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===pc)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===mc)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===gc||n===_c||n===xc||n===vc||n===yc||n===Oa||n===Mc)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===gc||n===_c)return a===ht?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===xc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===vc)return r.COMPRESSED_R11_EAC;if(n===yc)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Oa)return r.COMPRESSED_RG11_EAC;if(n===Mc)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Sc||n===bc||n===Tc||n===Ec||n===Ac||n===wc||n===Rc||n===Cc||n===Pc||n===Ic||n===Lc||n===Dc||n===Nc||n===Uc)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Sc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===bc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Tc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ec)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ac)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===wc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Rc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Cc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Pc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ic)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Lc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Dc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Nc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Uc)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Oc||n===Fc||n===kc)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Oc)return a===ht?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Fc)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===kc)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Bc||n===zc||n===Fa||n===Hc)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Bc)return r.COMPRESSED_RED_RGTC1_EXT;if(n===zc)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Fa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Hc)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Tr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Ay=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      </div>`,s.querySelector(".level-go").addEventListener("click",()=>{f(),e.paused=!1}),s.querySelector(".level-exit").addEventListener("click",()=>{o=!0,d()})}function g(S){return S==="slot_usable_2"?"2º slot de usable (tecla Q)":S==="cristales"?null:vn(S).nombre}function m(S){a=!0;const T=S.status==="victory";let _="";if(S.chest?.opened){const A=g(S.chest.reward);_=A?`<div class="refuge-chest">📦 Cofre del Nido: <b>${A}</b><div class="refuge-desc">desbloqueado PARA SIEMPRE — ya está en el pool</div></div>`:'<div class="refuge-chest">📦 Cofre del Nido: cristales<div class="refuge-desc">ya lo has desbloqueado todo</div></div>'}else T&&(_='<div class="refuge-chest refuge-chest-missed">El cofre del Nido se quedó sin abrir…</div>');s.innerHTML=`
  ...
  `,i.appendChild(n);const s=n.querySelector(".hud-hearts"),r=n.querySelector(".hud-toasts"),a=n.querySelector(".hud-items"),o=n.querySelector(".hud-stats"),c=n.querySelector(".hud-near"),l=n.querySelector(".hud-minimap"),u=n.querySelector(".hud-wallet"),d=n.querySelector(".hud-boss"),h=[...n.querySelectorAll(".hud-usable")],f=[...n.querySelectorAll(".hud-usable-icon")],p=[...n.querySelectorAll(".hud-usable-cd")],y=n.querySelector(".hud-center"),g=n.querySelector(".hud-msg"),m=n.querySelector(".hud-sub"),S=n.querySelector(".hud-seed");let T=-1,_=-1,A=-1,w="",I=-1;const M=["",""],v=[-1,-1];let R="",E="",L="",H="",X="",U="",W=null,G=!0;window.addEventListener("keydown",$=>{$.code==="Tab"&&($.preventDefault(),G=!G,o.hidden=!G)});function J($,oe){const he=document.createElement("div");for(he.className="hud-toast"+(oe==="delta"?" hud-toast-delta":""),he.textContent=$,r.appendChild(he);r.children.length>6;)r.firstChild?.remove();setTimeout(()=>he.remove(),2600)}function re($,oe="#e24b4a",he="#f6a5a4"){const Qe=`<path d="${lh}" fill="rgba(0,0,0,0.45)" stroke="rgba(0,0,0,0.6)" stroke-width="1"/>`,lt=$===1?' style="clip-path: inset(0 50% 0 0)"':"",Be=$>0?`<path d="${lh}" fill="${oe}"${lt}/><path d="M6 6.2 A2.4 2.4 0 0 1 9 4.8" stroke="${he}" stroke-width="1.4" fill="none"${lt}/>`:"";return`<svg viewBox="0 0 20 18" class="hud-heart">${Qe}${Be}</svg>`}return{update($){const oe=$.player.halfHearts,he=$.player.maxHalfHearts,Qe=$.player.armor;if(oe!==T||he!==_||Qe!==A){T=oe,_=he,A=Qe;const O=Math.ceil(he/2);let D="";for(let P=0;P<O;P++)D+=re(Math.min(2,Math.max(0,oe-P*2)));for(let P=0;P<Math.ceil(Qe/2);P++)D+=re(Math.min(2,Math.max(0,Qe-P*2)),"#9fb8c8","#dfeef7");s.innerHTML=D}if([$.player.usable,$.player.usable2].forEach((O,D)=>{const P=O?.itemId??"";if(P!==M[D]&&(M[D]=P,h[D].hidden=!O,O&&(f[D].src=Da(O.itemId))),O){const k=Math.ceil(O.cooldown/$i);k!==v[D]&&(v[D]=k,p[D].textContent=k>0?String(k):""),h[D].classList.toggle("ready",O.cooldown===0),h[D].classList.toggle("active",O.activeTicks>0)}}),$.status!==w)if(w=$.status,y.classList.toggle("has-msg",$.status!=="playing"),$.status==="victory"){const O=t(),D=O.filter(xe=>xe.type==="enemy_killed").length,P=O.filter(xe=>xe.type==="damage_taken").length,k=O.filter(xe=>xe.type==="heart_collected").length,ee=O.filter(xe=>xe.type==="item_bought").length,ne=Math.floor($.tick/3600),ce=Math.floor($.tick%3600/60);g.textContent="¡El Pozo superado!",m.innerHTML=`<div class="hud-run-summary"><div>tiempo <b>${ne}:${String(ce).padStart(2,"0")}</b></div><div>abatidos <b>${D}</b> · golpes recibidos <b>${P}</b></div><div>items <b>${$.player.items.length}</b> · compras <b>${ee}</b> · corazones <b>${k}</b></div><div>cristales <b class="hud-wallet-crystal">◆ ${$.player.crystals}</b></div><div style="margin-top:6px">R para otra run</div></div>`}else $.status==="dead"?(g.textContent="Kai se derritió…",m.textContent="R para reintentar"):(g.textContent="",m.textContent="");const lt=$.player.items.join(",");if(lt!==R){const O=$.player.items.length>R.split(",").filter(Boolean).length;if(R=lt,a.innerHTML=$.player.items.map(D=>{const P=vn(D),k=`<b>${P.nombre}</b>`+gb(P,$.stats.luck).map(ee=>`<div>· ${ee}</div>`).join("");return`<div class="hud-item"><img src="${Da(D)}" alt="${P.nombre}" /><div class="hud-item-tip">${k}</div></div>`}).join(""),O&&W){const D=vn($.player.items[$.player.items.length-1]).nombre;J(D);for(const P of ch(W,$.stats))J(P,"delta")}}W={...$.stats};const Be=$.stats,te=[Be.maxHalfHearts,Be.damage,Be.fireRate,Be.range,Be.shotSpeed,Be.moveSpeed,Be.luck,Be.projectiles].join("|");if(te!==E){E=te;const O=[["❤️","Vida",ni(Be.maxHalfHearts/2),"corazones máximos"],["⚔️","Daño",ni(Be.damage),"daño por proyectil"],["💧","Caudal",`${ni(Be.fireRate)}/s`,"disparos por segundo (cadencia)"],["🏹","Alcance",ni(Be.range),"tiles antes de caer en charco"],["💨","Presión",ni(Be.shotSpeed),"velocidad del proyectil"],["👢","Velocidad",ni(Be.moveSpeed),"velocidad de movimiento"],["🍀","Suerte",ni(Be.luck),"escala los procs y la calidad de drops"],["🔱","Chorros",ni(Be.projectiles),"proyectiles por disparo"]];o.innerHTML='<div class="hud-stats-title">stats · Tab</div>'+O.map(([D,P,k,ee])=>`<div class="hud-stats-row" title="${ee}"><span class="hud-stats-icon">${D}</span><span class="hud-stats-name">${P}</span><span class="hud-stats-value">${k}</span></div>`).join("")}let ue=null,le=1.25;for(const O of $.pickups){const D=Math.hypot(O.x-$.player.x,O.y-$.player.y);D<le&&(le=D,ue=O)}const ze=ue?`${ue.id}:${ue.itemId}:${ue.price?$.player.crystals>=ue.price?"ok":"no":""}`:"";if(ze!==L&&(L=ze,c.hidden=!ue,ue)){const O=vn(ue.itemId),D=Pf(O,$.stats.luck).map(ee=>`<div>· ${ee}</div>`).join("");let P="";if(O.categoria!=="usable"){const ee=Ur([...$.player.items,ue.itemId]),ne=ch($.stats,ee);P=ne.length?ne.map(ce=>`<div class="hud-near-diff">${ce}</div>`).join(""):""}const k=ue.price?`<div class="hud-near-price ${$.player.crystals>=ue.price?"ok":"no"}">◆ ${ue.price} cristales — ${$.player.crystals>=ue.price?"pulsa E para comprar":"no te alcanza"}</div>`:"";c.innerHTML=`<img src="${Da(O.id)}" alt="" /><div><b>${O.nombre}</b> <span class="hud-near-rar">${mb[O.rareza]}</span>${k}${P}${D}<i>«${O.descripcion}»</i></div>`}const Xe=`${$.player.crystals}:${$.player.keys}`;Xe!==X&&(X=Xe,u.innerHTML=`<span class="hud-wallet-crystal">◆</span> ${$.player.crystals}`+($.player.keys>0?` &nbsp;<span class="hud-wallet-key">⚷</span> ${$.player.keys}`:""));const Oe=$.enemies.some(O=>O.kind==="gorko"),vt=`${$.seed}:${$.floor.level}`;Oe&&U!==vt&&(U=vt,d.hidden=!1,d.innerHTML='<div class="hud-boss-name">GORKO</div><div class="hud-boss-sub">el Sapo Glotón</div>',setTimeout(()=>{d.hidden=!0},2800));const je=`${$.floor.level}:${$.floor.current}:`+$.floor.rooms.map(O=>(O.visited?"v":".")+(O.cleared?"c":".")).join("");if(je!==H){H=je;const O=$.floor.rooms.filter(Se=>Se.visited),D=new Set;for(const Se of O){D.add(Se.id);for(const Re of Object.values(Se.doors))Re>=0&&D.add(Re)}const P=$.floor.rooms.filter(Se=>D.has(Se.id)),k=Math.min(...P.map(Se=>Se.gx)),ee=Math.min(...P.map(Se=>Se.gy)),ne={treasure:"♦",shop:"$",boss:"☠"},ce=19;l.innerHTML=P.map(Se=>{const Re=["hud-map-cell",Se.id===$.floor.current?"current":"",Se.visited?"visited":"known",Se.cleared?"cleared":""].filter(Boolean).join(" "),C=Se.visited||Se.kind!=="boss"?ne[Se.kind]??"":ne.boss;return`<div class="${Re}" style="left:${(Se.gx-k)*ce}px;top:${(Se.gy-ee)*ce}px">${C}</div>`}).join("");const xe=(Math.max(...P.map(Se=>Se.gx))-k+1)*ce,N=(Math.max(...P.map(Se=>Se.gy))-ee+1)*ce;l.style.width=`${xe}px`,l.style.height=`${N}px`}const ot=$.seed*10+$.floor.level;ot!==I&&(I=ot,S.textContent=`seed ${$.seed} · nivel ${$.floor.level} · sim v${e}`)},onEvents($){for(const oe of $)if(oe.type==="proc_triggered"&&oe.efecto==="critico")J("¡Crítico!");else if(oe.type==="usable_activated"){const he=Ji.get(oe.itemId);J(`¡${he?.nombre??"Usable"}!`)}else oe.type==="item_bought"?J(`Comprado: −${oe.price} ◆`,"delta"):oe.type==="key_collected"?J("Llave del tesoro","delta"):oe.type==="door_unlocked"&&J("El tesoro se abre…","delta")}}}const uh={KeyW:"up",ArrowUp:"up",KeyS:"down",ArrowDown:"down",KeyA:"left",ArrowLeft:"left",KeyD:"right",ArrowRight:"right"};function xb(i,e,t){const n=i.live,s=new kg,r=new Te,a=new Mi(new F(0,1,0),0),o=new F;let c=!1,l=!1,u=!1;window.addEventListener("keydown",f=>{const p=uh[f.code];p?(n[p]=!0,f.preventDefault()):f.code==="Space"?(u=!0,n.use=u||l,f.preventDefault()):f.code==="ShiftLeft"||f.code==="ShiftRight"?n.dash=!0:f.code==="KeyE"?n.interact=!0:f.code==="KeyQ"?n.use2=!0:f.code==="KeyR"&&!f.repeat&&i.reset()}),window.addEventListener("keyup",f=>{const p=uh[f.code];p&&(n[p]=!1),f.code==="Space"&&(u=!1,n.use=u||l),(f.code==="ShiftLeft"||f.code==="ShiftRight")&&(n.dash=!1),f.code==="KeyE"&&(n.interact=!1),f.code==="KeyQ"&&(n.use2=!1)}),window.addEventListener("blur",()=>{n.up=n.down=n.left=n.right=!1,c=l=u=!1,n.fire=n.dash=n.use=n.interact=!1}),e.addEventListener("contextmenu",f=>f.preventDefault());function d(f){const p=e.getBoundingClientRect();p.width===0||p.height===0||(r.set((f.clientX-p.left)/p.width*2-1,-((f.clientY-p.top)/p.height)*2+1),s.setFromCamera(r,t),s.ray.intersectPlane(a,o)&&(n.aimX=o.x,n.aimY=o.z))}const h=()=>document.body.classList.contains("touch-mode");window.addEventListener("pointermove",f=>{h()||d(f)}),window.addEventListener("pointerdown",f=>{h()||(f.button===0?(c=!0,n.fire=!0,d(f)):f.button===2&&(l=!0,n.use=u||l))}),window.addEventListener("pointerup",f=>{h()||(f.button===0?(c=!1,n.fire=c):f.button===2&&(l=!1,n.use=u||l))})}const vb=[[3.5,1],[Ye-3.5,1]],ec=1;function yb(i){i.add(new Mg(16767398,.7));const e=new of(9414856,.22);e.position.set(Ye/2,6,qe+8),e.target.position.set(Ye/2,0,qe/2),i.add(e,e.target);const t=vb.map(([s,r])=>{const a=new Jc(He.torch,12,11,2);a.position.set(s,ec,r+.35),i.add(a);const o=new Rs(new Gi({map:Mb(),blending:nc,depthWrite:!1}));return o.position.set(s,ec+.08,r+.18),o.scale.set(.32,.5,1),i.add(o),{light:a,flame:o,baseY:ec}}),n=new Jc(He.shine,3.2,5,2);return n.position.set(3.5,.7,qe/2),i.add(n),{update(s){const r=.8+.2*Math.sin(s.tick*.31)*Math.sin(s.tick*.13);for(const o of t)o.light.intensity=12*r,o.flame.scale.set(.32,.5*(.85+.3*r),1),o.flame.position.y=o.baseY+.08+.02*r;const a=s.player;if(n.position.set(a.x,.7,a.y),s.status==="dead"){const o=s.tick-a.deathTick;n.intensity=Math.floor(o/14)%2===0?1.8:.6}else n.intensity=3.2}}}function Mb(){const[i,e]=qt(16,24),t=e.createRadialGradient(8,14,1,8,14,10);return t.addColorStop(0,ct(He.torchBright)),t.addColorStop(.45,ct(He.torch)),t.addColorStop(1,"rgba(232,161,60,0)"),e.fillStyle=t,e.fillRect(0,0,16,24),e.fillStyle=ct(He.torch),e.beginPath(),e.moveTo(8,2),e.quadraticCurveTo(12,10,8,16),e.quadraticCurveTo(4,10,8,2),e.fill(),e.fillStyle=ct(He.torchBright),e.beginPath(),e.ellipse(8,13,2.4,4,0,0,Math.PI*2),e.fill(),Yt(i)}const fl={},Wl=[];{const i=new Gl,e=(t,n)=>{i.load(n,s=>{fl[t]={scene:s.scene,animations:s.animations};for(const r of Wl)r()})};e("puerta","assets/models/portal_puerta.glb"),e("reja","assets/models/portal_reja.glb")}let Na=null;new Gl().load("assets/models/trampilla_escalera.glb",e=>{Na=e.scene;for(const t of Wl)t()});const Sb={1:16777215,2:15919832,3:13625544,4:15519936,5:12563672},dh=40,bb=55,tc=1.15,Tb=1.45,Eb=1.9,hh=.1,fh=.6,Ab=1.15,wb=.9,Rb=.45;function Cb(){const i=new tm;i.background=new We(He.dungeonBg);const e=new Rl(He.dungeonBg,14,30);i.fog=e;const t=Pb(i),n=new F(Ye/2,0,qe/2),s=new jt(dh,1,.1,100),r=new F,a=Xc.degToRad(bb),o=new F(n.x,0,n.z);let c=20,l=Ye/2,u=qe/2,d=960,h=576,f=!1;function p(){r.set(o.x,c*Math.sin(a),o.z+c*Math.cos(a)),s.position.copy(r),s.lookAt(o)}function y(S,T){d=S,h=T,s.aspect=S/Math.max(1,T);const _=Math.tan(Xc.degToRad(dh/2)),A=_*s.aspect,w=(Ye/2+tc)/A,I=(qe/2+tc)*Math.sin(a)/_+(qe/2+tc)*Math.cos(a);f=document.body.classList.contains("touch-mode"),c=Math.max(w,I)/(f?Eb:Tb),l=A*c,u=_*c/Math.sin(a),e.near=c-2,e.far=c+15,p(),s.updateProjectionMatrix()}function g(S,T,_){const A=T-fh,w=_-T+fh;return A>=w?_/2:Math.min(w,Math.max(A,S))}function m(S){document.body.classList.contains("touch-mode")!==f&&y(d,h);const T=g(S.player.x,l,Ye),_=g(S.player.y,u,qe);o.x+=(T-o.x)*hh,o.z+=(_-o.z)*hh,p()}return{scene:i,camera:s,center:n,cameraHome:r,resize:y,updateRoom:S=>{t.update(S),m(S)}}}function Pb(i){const e=VS(Ye,qe),t=new Wi({map:e.texture,roughness:.92,metalness:0}),n=new Ci(Ye,qe),s=1.7,r=new $h;r.moveTo(-Ye/2,-qe/2),r.lineTo(Ye/2,-qe/2),r.lineTo(Ye/2,qe/2),r.lineTo(-Ye/2,qe/2);const a=new Kc;a.moveTo(-s/2,-s/2),a.lineTo(s/2,-s/2),a.lineTo(s/2,s/2),a.lineTo(-s/2,s/2),r.holes.push(a);const o=new Ol(r);{const v=o.attributes.uv,R=o.attributes.position;for(let E=0;E<v.count;E++)v.setXY(E,(R.getX(E)+Ye/2)/Ye,(R.getY(E)+qe/2)/qe)}const c=new It(n,t);c.rotation.x=-Math.PI/2,c.position.set(Ye/2,0,qe/2),i.add(c);const l=new Map;function u(v){const R=Math.max(1,Math.round(v));let E=l.get(R);return E||(E=new Wi({map:Qd(R,2),roughness:1,metalness:0}),l.set(R,E)),E}const d=new Map;function h(v){const R=Math.max(1,Math.round(v));let E=d.get(R);return E||(E=new Wi({map:Qd(R,1),roughness:1,metalness:0}),d.set(R,E)),E}const f=new gn({color:He.torch}),p=new An;i.add(p);const y=[],g=new Bg;let m=null,S="";Wl.push(()=>{S=""});function T(){for(const v of[...p.children])p.remove(v),v.traverse(R=>{R instanceof It&&R.geometry.dispose()});y.length=0,m=null}function _(v,R,E,L,H,X){const U=new It(new Ri(v,R,E),X);return U.position.set(L,R/2,H),p.add(U),U}function A(v,R){const E=v==="n"?Ab:v==="s"?Rb:wb,L=v==="n"||v==="s",H=v==="n"?.5:qe-.5,X=v==="w"?.5:Ye-.5,U=L?Ye/2:qe/2,W=L?Ye:qe-2,G=L?0:1;if(!R){L?_(W,E,1,Ye/2,H,u(W)):_(1,E,W,X,qe/2,u(W));return}const J=U-Ai-G,re=G+W-(U+Ai);L?(_(J,E,1,G+J/2,H,u(J)),_(re,E,1,U+Ai+re/2,H,u(re))):(_(1,E,J,X,G+J/2,u(J)),_(1,E,re,X,U+Ai+re/2,u(re)))}function w(v,R){const E=R==="puerta"?fl.puerta:fl.reja;if(!E)return;const L=E.scene.clone(!0),X=new Qt().setFromObject(E.scene).getSize(new F),U=2.6/Math.max(.001,X.x);L.scale.setScalar(U);const W=new Qt().setFromObject(L),G=W.getCenter(new F);L.position.sub(new F(G.x,W.min.y,G.z));const J=new An;J.add(L);const $=v==="n"||v==="s"?Ye/2:qe/2;v==="n"&&J.position.set($,0,.55),v==="s"&&J.position.set($,0,qe-.55),v==="e"&&(J.position.set(Ye-.55,0,$),J.rotation.y=-Math.PI/2),v==="w"&&(J.position.set(.55,0,$),J.rotation.y=Math.PI/2),p.add(J);const oe={side:v,variant:R,wrapper:J,mixer:null,clips:null,barsNode:null,barsY0:0,open:null};R==="puerta"&&E.animations.length?(oe.mixer=new Fg(L),oe.clips=E.animations):(L.traverse(he=>{he.name==="gate"&&(oe.barsNode=he)}),oe.barsNode&&(oe.barsY0=oe.barsNode.position.y)),y.push(oe)}function I(v,R,E){if(v.mixer&&v.clips){const L=Wa.findByName(v.clips,R?"open":"close");if(!L)return;v.mixer.stopAllAction();const H=v.mixer.clipAction(L);H.setLoop(Ih,1),H.clampWhenFinished=!0,H.play(),E&&v.mixer.update(L.duration)}}function M(v){T();const R=v.floor.rooms[v.floor.current],E=Sb[v.floor.level]??16777215;t.color.setHex(E),e.repaint(R.seed);for(const L of["n","s","e","w"]){const H=R.doors[L];if(A(L,H>=0),H>=0){const X=v.floor.rooms[H].locked;w(L,X?"reja":"puerta")}}for(const L of v.obstacles)L.invisible||_(L.w,.55,L.h,L.x+L.w/2,L.y+L.h/2,h(L.w));if(R.kind==="boss"){const L=new An,H=new It(new Ri(1.7,.05,1.7),new gn({color:262657}));if(H.position.set(Ye/2,-1.3,qe/2),L.add(H),Na){const U=Na.clone(!0),G=new Qt().setFromObject(Na).getSize(new F),J=1.55/Math.max(.001,Math.max(G.x,G.z));U.scale.setScalar(J);const re=new Qt().setFromObject(U),$=re.getCenter(new F);U.position.sub(new F($.x,re.min.y,$.z)),U.position.y-=G.y*J-.04,L.add(U),U.position.x+=Ye/2,U.position.z+=qe/2}const X=new It(new Ul(.95,1.05,24),f);X.rotation.x=-Math.PI/2,X.position.set(Ye/2,.013,qe/2),L.add(X),L.visible=!1,p.add(L),m=L}for(const L of l.values())L.color.setHex(E);for(const L of d.values())L.color.setHex(E),L.color.multiplyScalar(1.18)}return{update(v){const R=`${v.seed}:${v.floor.level}:${v.floor.current}`;R!==S&&(S=R,M(v));const E=g.getDelta(),L=v.floor.rooms[v.floor.current];for(const U of y){const W=L.doors[U.side],G=W>=0&&v.floor.rooms[W].locked,J=L.cleared&&!G;if(U.variant==="puerta")U.open===null?I(U,J,!0):J!==U.open&&I(U,J,!1),U.mixer?.update(E);else if(U.barsNode){const re=U.barsY0+(J?.9:0);U.open===null?U.barsNode.position.y=re:U.barsNode.position.y+=(re-U.barsNode.position.y)*.08}U.open=J}m&&(m.visible=v.floor.trapdoorOpen);const X=L.kind==="boss"&&v.floor.trapdoorOpen?o:n;c.geometry!==X&&(c.geometry=X)}}}function Ib(i,e){const t=JM(),n=$M(e,cl(t));YM(n,Ia);const s=new Uy({antialias:!1});s.setPixelRatio(1),i.appendChild(s.domElement);const r=Cb(),a=yb(r.scene),o=ib(r.scene,BS());xb(n,s.domElement,r.camera);const c=_b(i,Ia,()=>n.telemetry),l=sS(n,r),u=eS(i),d=tS(i,n,t,Ia);let h=null;function f(m){if(m&&!h&&(h=iS(i,n)),document.body.classList.toggle("touch-mode",m),!m){const S=n.live;S.left=S.right=S.up=S.down=S.fire=!1}}nS()?f(!0):new URLSearchParams(location.search).get("touch")!=="0"&&(window.addEventListener("touchstart",()=>f(!0)),window.addEventListener("pointermove",m=>{m.pointerType==="mouse"&&document.body.classList.contains("touch-mode")&&f(!1)}));function p(){const m=i.clientWidth||960,S=i.clientHeight||576;s.setSize(m,S),r.resize(m,S)}new ResizeObserver(p).observe(i),p();let y=performance.now();function g(m){const S=m-y;y=m;const T=n.frame(S);l.onEvents(T),c.onEvents(T),u.onEvents(T),r.updateRoom(n.sim.state),a.update(n.sim.state),o.update(n.sim.state),c.update(n.sim.state),d.update(n.sim.state),u.update(n.sim.state),h?.update(n.sim.state),l.update(S,r.camera),s.render(r.scene,r.camera),requestAnimationFrame(g)}requestAnimationFrame(g)}const Lb=new URLSearchParams(location.search),ph=Lb.get("seed"),If=ph!==null?Number(ph)>>>0:Date.now()>>>0;Ib(document.getElementById("game"),If);console.info(`%cKai · Fase 0.5 · seed=${If} · API de tester en window.__game`,"color:#e8a13c");

...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function Gm(n,e,t){const i=new Float32Array(bi),r=new V(0,1,0);return new Dn({name:"SphericalGaussianBlur",defines:{n:bi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:Vs(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function lc(){return new Dn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vs(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function cc(){return new Dn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vs(),fragmentShader:`
	...
	`}class kd extends Pn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Cd(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new hi(5,5,5),s=new Dn({name:"CubemapFromEquirect",uniforms:gr(i.uniforms),vertexShader:i.vertexShader,fragmentShader:i.fragmentShader,side:Yt,blending:Vn});s.uniforms.tEquirect.value=t;const a=new Ct(r,s),o=t.minFilter;return t.minFilter===Ei&&(t.minFilter=Pt),new Yf(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,i=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,i,r);e.setRenderTarget(s)}}function Vm(n){let e=new WeakMap,t=new WeakMap,i=null;function r(d,h=!1){return d==null?null:h?a(d):s(d)}function s(d){if(d&&d.isTexture){const h=d.mapping;if(h===Ks||h===Zs)if(e.has(d)){const x=e.get(d).texture;return o(x,d.mapping)}else{const x=d.image;if(x&&x.height>0){const b=new kd(x.height);return b.fromEquirectangularTexture(n,d),e.set(d,b),d.addEventListener("dispose",c),o(b.texture,d.mapping)}else return null}}return d}function a(d){if(d&&d.isTexture){const h=d.mapping,x=h===Ks||h===Zs,b=h===Ai||h===pr;if(x||b){let m=t.get(d);const p=m!==void 0?m.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==p)return i===null&&(i=new ac(n)),m=x?i.fromEquirectangular(d,m):i.fromCubemap(d,m),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),m.texture;if(m!==void 0)return m.texture;{const S=d.image;return x&&S&&S.height>0||b&&S&&l(S)?(i===null&&(i=new ac(n)),m=x?i.fromEquirectangular(d):i.fromCubemap(d),m.texture.pmremVersion=d.pmremVersion,t.set(d,m),d.addEventListener("dispose",u),m.texture):null}}}return d}function o(d,h){return h===Ks?d.mapping=Ai:h===Zs&&(d.mapping=pr),d}function l(d){let h=0;const x=6;for(let b=0;b<x;b++)d[b]!==void 0&&h++;return h===x}function c(d){const h=d.target;h.removeEventListener("dispose",c);const x=e.get(h);x!==void 0&&(e.delete(h),x.dispose())}function u(d){const h=d.target;h.removeEventListener("dispose",u);const x=t.get(h);x!==void 0&&(t.delete(h),x.dispose())}function f(){e=new WeakMap,t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:f}}function Wm(n){const e={};function t(i){if(e[i]!==void 0)return e[i];const r=n.getExtension(i);return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const r=t(i);return r===null&&lr("WebGLRenderer: "+i+" extension not supported."),r}}}function Xm(n,e,t,i){const r={},s=new WeakMap;function a(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const x in d.attributes)e.remove(d.attributes[x]);d.removeEventListener("dispose",a),delete r[d.id];const h=s.get(d);h&&(e.remove(h),s.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(f,d){return r[d.id]===!0||(d.addEventListener("dispose",a),r[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const h in d)e.update(d[h],n.ARRAY_BUFFER)}function c(f){const d=[],h=f.index,x=f.attributes.position;let b=0;if(x===void 0)return;if(h!==null){const S=h.array;b=h.version;for(let P=0,v=S.length;P<v;P+=3){const C=S[P+0],A=S[P+1],L=S[P+2];d.push(C,A,A,L,L,C)}}else{const S=x.array;b=x.version;for(let P=0,v=S.length/3-1;P<v;P+=3){const C=P+0,A=P+1,L=P+2;d.push(C,A,A,L,L,C)}}const m=new(x.count>=65535?wd:Td)(d,1);m.version=b;const p=s.get(f);p&&e.remove(p),s.set(f,m)}function u(f){const d=s.get(f);if(d){const h=f.index;h!==null&&d.version<h.version&&c(f)}else c(f);return s.get(f)}return{get:o,update:l,getWireframeAttribute:u}}function qm(n,e,t){let i;function r(f){i=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,d){n.drawElements(i,d,s,f*a),t.update(d,i,1)}function c(f,d,h){h!==0&&(n.drawElementsInstanced(i,d,s,f*a,h),t.update(d,i,h))}function u(f,d,h){if(h===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,d,0,s,f,0,h);let b=0;for(let m=0;m<h;m++)b+=d[m];t.update(b,i,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u}function Ym(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(s/3);break;case n.LINES:t.lines+=o*(s/2);break;case n.LINE_STRIP:t.lines+=o*(s-1);break;case n.LINE_LOOP:t.lines+=o*s;break;case n.POINTS:t.points+=o*s;break;default:tt("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function $m(n,e,t){const i=new WeakMap,r=new St;function s(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let d=i.get(o);if(d===void 0||d.count!==f){let w=function(){_.dispose(),i.delete(o),o.removeEventListener("dispose",w)};var h=w;d!==void 0&&d.texture.dispose();const x=o.morphAttributes.position!==void 0,b=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],S=o.morphAttributes.normal||[],P=o.morphAttributes.color||[];let v=0;x===!0&&(v=1),b===!0&&(v=2),m===!0&&(v=3);let C=o.attributes.position.count*v,A=1;C>e.maxTextureSize&&(A=Math.ceil(C/e.maxTextureSize),C=e.maxTextureSize);const L=new Float32Array(C*A*4*f),_=new bd(L,C,A,f);_.type=An,_.needsUpdate=!0;const M=v*4;for(let E=0;E<f;E++){const D=p[E],z=S[E],W=P[E],k=C*A*4*E;for(let $=0;$<D.count;$++){const G=$*M;x===!0&&(r.fromBufferAttribute(D,$),L[k+G+0]=r.x,L[k+G+1]=r.y,L[k+G+2]=r.z,L[k+G+3]=0),b===!0&&(r.fromBufferAttribute(z,$),L[k+G+4]=r.x,L[k+G+5]=r.y,L[k+G+6]=r.z,L[k+G+7]=0),m===!0&&(r.fromBufferAttribute(W,$),L[k+G+8]=r.x,L[k+G+9]=r.y,L[k+G+10]=r.z,L[k+G+11]=W.itemSize===4?r.w:1)}}d={count:f,texture:_,size:new We(C,A)},i.set(o,d),o.addEventListener("dispose",w)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let x=0;for(let m=0;m<c.length;m++)x+=c[m];const b=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(n,"morphTargetBaseInfluence",b),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:s}}function Km(n,e,t,i,r){let s=new WeakMap;function a(c){const u=r.render.frame,f=c.geometry,d=e.get(c,f);if(s.get(d)!==u&&(e.update(d),s.set(d,u)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==u&&(t.update(c.instanceMatrix,n.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,n.ARRAY_BUFFER),s.set(c,u))),c.isSkinnedMesh){const h=c.skeleton;s.get(h)!==u&&(h.update(),s.set(h,u))}return d}function o(){s=new WeakMap}function l(c){const u=c.target;u.removeEventListener("dispose",l),i.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const Zm={[od]:"LINEAR_TONE_MAPPING",[ld]:"REINHARD_TONE_MAPPING",[cd]:"CINEON_TONE_MAPPING",[dd]:"ACES_FILMIC_TONE_MAPPING",[fd]:"AGX_TONE_MAPPING",[hd]:"NEUTRAL_TONE_MAPPING",[ud]:"CUSTOM_TONE_MAPPING"};function Jm(n,e,t,i,r,s){const a=new Pn(e,t,{type:n,depthBuffer:r,stencilBuffer:s,samples:i?4:0,depthTexture:r?new mr(e,t):void 0}),o=new Pn(e,t,{type:qn,depthBuffer:!1,stencilBuffer:!1}),l=new Mn;l.setAttribute("position",new sn([-1,3,0,-1,-1,0,3,-1,0],3)),l.setAttribute("uv",new sn([0,2,0,0,2,0],2));const c=new kf({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Ct(l,c),f=new Nd(-1,1,1,-1,0,1);let d=null,h=null,x=!1,b,m=null,p=[],S=!1;this.setSize=function(P,v){a.setSize(P,v),o.setSize(P,v);for(let C=0;C<p.length;C++){const A=p[C];A.setSize&&A.setSize(P,v)}},this.setEffects=function(P){p=P,S=p.length>0&&p[0].isRenderPass===!0;const v=a.width,C=a.height;for(let A=0;A<p.length;A++){const L=p[A];L.setSize&&L.setSize(v,C)}},this.begin=function(P,v){if(x||P.toneMapping===Cn&&p.length===0)return!1;if(m=v,v!==null){const C=v.width,A=v.height;(a.width!==C||a.height!==A)&&this.setSize(C,A)}return S===!1&&P.setRenderTarget(a),b=P.toneMapping,P.toneMapping=Cn,!0},this.hasRenderPass=function(){return S},this.end=function(P,v){P.toneMapping=b,x=!0;let C=a,A=o;for(let L=0;L<p.length;L++){const _=p[L];if(_.enabled!==!1&&(_.render(P,A,C,v),_.needsSwap!==!1)){const M=C;C=A,A=M}}if(d!==P.outputColorSpace||h!==P.toneMapping){d=P.outputColorSpace,h=P.toneMapping,c.defines={},nt.getTransfer(d)===ct&&(c.defines.SRGB_TRANSFER="");const L=Zm[h];L&&(c.defines[L]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=C.texture,P.setRenderTarget(m),P.render(u,f),m=null,x=!1},this.isCompositing=function(){return x},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Bd=new Ot,Io=new mr(1,1),zd=new bd,Hd=new hf,Gd=new Cd,dc=[],uc=[],fc=new Float32Array(16),hc=new Float32Array(9),pc=new Float32Array(4);function Mr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=dc[r];if(s===void 0&&(s=new Float32Array(r),dc[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function Lt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Dt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Ws(n,e){let t=uc[e];t===void 0&&(t=new Int32Array(e),uc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Qm(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function jm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2fv(this.addr,e),Dt(t,e)}}function eg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;n.uniform3fv(this.addr,e),Dt(t,e)}}function tg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4fv(this.addr,e),Dt(t,e)}}function ng(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;pc.set(i),n.uniformMatrix2fv(this.addr,!1,pc),Dt(t,i)}}function ig(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;hc.set(i),n.uniformMatrix3fv(this.addr,!1,hc),Dt(t,i)}}function rg(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Lt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,i))return;fc.set(i),n.uniformMatrix4fv(this.addr,!1,fc),Dt(t,i)}}function sg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function ag(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2iv(this.addr,e),Dt(t,e)}}function og(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3iv(this.addr,e),Dt(t,e)}}function lg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4iv(this.addr,e),Dt(t,e)}}function cg(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function dg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;n.uniform2uiv(this.addr,e),Dt(t,e)}}function ug(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;n.uniform3uiv(this.addr,e),Dt(t,e)}}function fg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;n.uniform4uiv(this.addr,e),Dt(t,e)}}function hg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(Io.compareFunction=t.isReversedDepthBuffer()?Jo:Zo,s=Io):s=Bd,t.setTexture2D(e||s,r)}function pg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Hd,r)}function mg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Gd,r)}function gg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||zd,r)}function _g(n){switch(n){case 5126:return Qm;case 35664:return jm;case 35665:return eg;case 35666:return tg;case 35674:return ng;case 35675:return ig;case 35676:return rg;case 5124:case 35670:return sg;case 35667:case 35671:return ag;case 35668:case 35672:return og;case 35669:case 35673:return lg;case 5125:return cg;case 36294:return dg;case 36295:return ug;case 36296:return fg;case 35678:case 36198:case 36298:case 36306:case 35682:return hg;case 35679:case 36299:case 36307:return pg;case 35680:case 36300:case 36308:case 36293:return mg;case 36289:case 36303:case 36311:case 36292:return gg}}function xg(n,e){n.uniform1fv(this.addr,e)}function vg(n,e){const t=Mr(e,this.size,2);n.uniform2fv(this.addr,t)}function Mg(n,e){const t=Mr(e,this.size,3);n.uniform3fv(this.addr,t)}function yg(n,e){const t=Mr(e,this.size,4);n.uniform4fv(this.addr,t)}function Sg(n,e){const t=Mr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function bg(n,e){const t=Mr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Eg(n,e){const t=Mr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Tg(n,e){n.uniform1iv(this.addr,e)}function wg(n,e){n.uniform2iv(this.addr,e)}function Ag(n,e){n.uniform3iv(this.addr,e)}function Rg(n,e){n.uniform4iv(this.addr,e)}function Cg(n,e){n.uniform1uiv(this.addr,e)}function Pg(n,e){n.uniform2uiv(this.addr,e)}function Ig(n,e){n.uniform3uiv(this.addr,e)}function Lg(n,e){n.uniform4uiv(this.addr,e)}function Dg(n,e,t){const i=this.cache,r=e.length,s=Ws(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));let a;this.type===n.SAMPLER_2D_SHADOW?a=Io:a=Bd;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function Ug(n,e,t){const i=this.cache,r=e.length,s=Ws(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Hd,s[a])}function Ng(n,e,t){const i=this.cache,r=e.length,s=Ws(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Gd,s[a])}function Fg(n,e,t){const i=this.cache,r=e.length,s=Ws(t,r);Lt(i,s)||(n.uniform1iv(this.addr,s),Dt(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||zd,s[a])}function Og(n){switch(n){case 5126:return xg;case 35664:return vg;case 35665:return Mg;case 35666:return yg;case 35674:return Sg;case 35675:return bg;case 35676:return Eg;case 5124:case 35670:return Tg;case 35667:case 35671:return wg;case 35668:case 35672:return Ag;case 35669:case 35673:return Rg;case 5125:return Cg;case 36294:return Pg;case 36295:return Ig;case 36296:return Lg;case 35678:case 36198:case 36298:case 36306:case 35682:return Dg;case 35679:case 36299:case 36307:return Ug;case 35680:case 36300:case 36308:case 36293:return Ng;case 36289:case 36303:case 36311:case 36292:return Fg}}class kg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=_g(t.type)}}class Bg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Og(t.type)}}class zg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const Aa=/(\w+)(\])?(\[|\.)?/g;function mc(n,e){n.seq.push(e),n.map[e.id]=e}function Hg(n,e,t){const i=n.name,r=i.length;for(Aa.lastIndex=0;;){const s=Aa.exec(i),a=Aa.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){mc(t,c===void 0?new kg(o,n,e):new Bg(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new zg(o),mc(t,f)),t=f}}}class Cs{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);Hg(o,l,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function gc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Gg=37297;let Vg=0;function Wg(n,e){const t=n.split(`
...
`)}const Yg={[od]:"Linear",[ld]:"Reinhard",[cd]:"Cineon",[dd]:"ACESFilmic",[fd]:"AgX",[hd]:"Neutral",[ud]:"Custom"};function $g(n,e){const t=Yg[e];return t===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const xs=new V;function Kg(){nt.getLuminanceCoefficients(xs);const n=xs.x.toFixed(4),e=xs.y.toFixed(4),t=xs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const P=S+m+a,v=S+p+o,C=gc(r,r.VERTEX_SHADER,P),A=gc(r,r.FRAGMENT_SHADER,v);r.attachShader(b,C),r.attachShader(b,A),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.hasPositionAttribute===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function L(E){if(n.debug.checkShaderErrors){const D=r.getProgramInfoLog(b)||"",z=r.getShaderInfoLog(C)||"",W=r.getShaderInfoLog(A)||"",k=D.trim(),$=z.trim(),G=W.trim();let Q=!0,ae=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(Q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,b,C,A);else{const Z=xc(r,C,"vertex"),oe=xc(r,A,"fragment");tt("WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
}`,P0=[new V(1,0,0),new V(-1,0,0),new V(0,1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1)],I0=[new V(0,-1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1),new V(0,-1,0),new V(0,-1,0)],wc=new yt,Cr=new V,Ra=new V;function L0(n,e,t){let i=new il;const r=new We,s=new We,a=new St,o=new Bf,l=new zf,c={},u=t.maxTextureSize,f={[ui]:Yt,[Yt]:ui,[fn]:fn},d=new Dn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new We},radius:{value:4}},vertexShader:R0,fragmentShader:C0}),h=d.clone();h.defines.HORIZONTAL_PASS=1;const x=new Mn;x.setAttribute("position",new mn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new Ct(x,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Es;let p=this.type;this.render=function(A,L,_){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;this.type===uu&&(He("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Es);const M=n.getRenderTarget(),w=n.getActiveCubeFace(),E=n.getActiveMipmapLevel(),D=n.state;D.setBlending(Vn),D.buffers.depth.getReversed()===!0?D.buffers.color.setClear(0,0,0,0):D.buffers.color.setClear(1,1,1,1),D.buffers.depth.setTest(!0),D.setScissorTest(!1);const z=p!==this.type;z&&L.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(k=>k.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,k=A.length;W<k;W++){const $=A[W],G=$.shadow;if(G===void 0){He("WebGLShadowMap:",$,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const Q=G.getFrameExtents();r.multiply(Q),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/Q.x),r.x=s.x*Q.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/Q.y),r.y=s.y*Q.y,G.mapSize.y=s.y));const ae=n.state.buffers.depth.getReversed();if(G.camera._reversedDepth=ae,G.map===null||z===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Ur){if($.isPointLight){He("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Pn(r.x,r.y,{format:Ri,type:qn,minFilter:Pt,magFilter:Pt,generateMipmaps:!1}),G.map.texture.name=$.name+".shadowMap",G.map.depthTexture=new mr(r.x,r.y,An),G.map.depthTexture.name=$.name+".shadowMapDepth",G.map.depthTexture.format=Yn,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=bt,G.map.depthTexture.magFilter=bt}else $.isPointLight?(G.map=new kd(r.x),G.map.depthTexture=new Df(r.x,Ln)):(G.map=new Pn(r.x,r.y),G.map.depthTexture=new mr(r.x,r.y,Ln)),G.map.depthTexture.name=$.name+".shadowMap",G.map.depthTexture.format=Yn,this.type===Es?(G.map.depthTexture.compareFunction=ae?Jo:Zo,G.map.depthTexture.minFilter=Pt,G.map.depthTexture.magFilter=Pt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=bt,G.map.depthTexture.magFilter=bt);G.camera.updateProjectionMatrix()}const Z=G.map.isWebGLCubeRenderTarget?6:1;for(let oe=0;oe<Z;oe++){if(G.map.isWebGLCubeRenderTarget)n.setRenderTarget(G.map,oe),n.clear();else{oe===0&&(n.setRenderTarget(G.map),n.clear());const he=G.getViewport(oe);a.set(s.x*he.x,s.y*he.y,s.x*he.z,s.y*he.w),D.viewport(a)}if($.isPointLight){const he=G.camera,$e=G.matrix,ot=$.distance||he.far;ot!==he.far&&(he.far=ot,he.updateProjectionMatrix()),Cr.setFromMatrixPosition($.matrixWorld),he.position.copy(Cr),Ra.copy(he.position),Ra.add(P0[oe]),he.up.copy(I0[oe]),he.lookAt(Ra),he.updateMatrixWorld(),$e.makeTranslation(-Cr.x,-Cr.y,-Cr.z),wc.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),G._frustum.setFromProjectionMatrix(wc,he.coordinateSystem,he.reversedDepth)}else G.updateMatrices($);i=G.getFrustum(),v(L,_,G.camera,$,this.type)}G.isPointLightShadow!==!0&&this.type===Ur&&S(G,_),G.needsUpdate=!1}p=this.type,m.needsUpdate=!1,n.setRenderTarget(M,w,E)};function S(A,L){const _=e.update(b);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,h.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,h.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Pn(r.x,r.y,{format:Ri,type:qn})),d.uniforms.shadow_pass.value=A.map.depthTexture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(L,null,_,d,b,null),h.uniforms.shadow_pass.value=A.mapPass.texture,h.uniforms.resolution.value=A.mapSize,h.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(L,null,_,h,b,null)}function P(A,L,_,M){let w=null;const E=_.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(E!==void 0)w=E;else if(w=_.isPointLight===!0?l:o,n.localClippingEnabled&&L.clipShadows===!0&&Array.isArray(L.clippingPlanes)&&L.clippingPlanes.length!==0||L.displacementMap&&L.displacementScale!==0||L.alphaMap&&L.alphaTest>0||L.map&&L.alphaTest>0||L.alphaToCoverage===!0){const D=w.uuid,z=L.uuid;let W=c[D];W===void 0&&(W={},c[D]=W);let k=W[z];k===void 0&&(k=w.clone(),W[z]=k,L.addEventListener("dispose",C)),w=k}if(w.visible=L.visible,w.wireframe=L.wireframe,M===Ur?w.side=L.shadowSide!==null?L.shadowSide:L.side:w.side=L.shadowSide!==null?L.shadowSide:f[L.side],w.alphaMap=L.alphaMap,w.alphaTest=L.alphaToCoverage===!0?.5:L.alphaTest,w.map=L.map,w.clipShadows=L.clipShadows,w.clippingPlanes=L.clippingPlanes,w.clipIntersection=L.clipIntersection,w.displacementMap=L.displacementMap,w.displacementScale=L.displacementScale,w.displacementBias=L.displacementBias,w.wireframeLinewidth=L.wireframeLinewidth,w.linewidth=L.linewidth,_.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const D=n.properties.get(w);D.light=_}return w}function v(A,L,_,M,w){if(A.visible===!1)return;if(A.layers.test(L.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&w===Ur)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,A.matrixWorld);const z=e.update(A),W=A.material;if(Array.isArray(W)){const k=z.groups;for(let $=0,G=k.length;$<G;$++){const Q=k[$],ae=W[Q.materialIndex];if(ae&&ae.visible){const Z=P(A,ae,M,w);A.onBeforeShadow(n,A,L,_,z,Z,Q),n.renderBufferDirect(_,null,z,Z,A,Q),A.onAfterShadow(n,A,L,_,z,Z,Q)}}}else if(W.visible){const k=P(A,W,M,w);A.onBeforeShadow(n,A,L,_,z,k,null),n.renderBufferDirect(_,null,z,k,A,null),A.onAfterShadow(n,A,L,_,z,k,null)}}const D=A.children;for(let z=0,W=D.length;z<W;z++)v(D[z],L,_,M,w)}function C(A){A.target.removeEventListener("dispose",C);for(const _ in c){const M=c[_],w=A.target.uuid;w in M&&(M[w].dispose(),delete M[w])}}}function D0(n,e){function t(){let O=!1;const fe=new St;let te=null;const _e=new St(0,0,0,0);return{setMask:function(Ee){te!==Ee&&!O&&(n.colorMask(Ee,Ee,Ee,Ee),te=Ee)},setLocked:function(Ee){O=Ee},setClear:function(Ee,se,Pe,Re,Et){Et===!0&&(Ee*=Re,se*=Re,Pe*=Re),fe.set(Ee,se,Pe,Re),_e.equals(fe)===!1&&(n.clearColor(Ee,se,Pe,Re),_e.copy(fe))},reset:function(){O=!1,te=null,_e.set(-1,0,0,0)}}}function i(){let O=!1,fe=!1,te=null,_e=null,Ee=null;return{setReversed:function(se){if(fe!==se){const Pe=e.get("EXT_clip_control");se?Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.ZERO_TO_ONE_EXT):Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.NEGATIVE_ONE_TO_ONE_EXT),fe=se;const Re=Ee;Ee=null,this.setClear(Re)}},getReversed:function(){return fe},setTest:function(se){se?le(n.DEPTH_TEST):ke(n.DEPTH_TEST)},setMask:function(se){te!==se&&!O&&(n.depthMask(se),te=se)},setFunc:function(se){if(fe&&(se=Wu[se]),_e!==se){switch(se){case Ga:n.depthFunc(n.NEVER);break;case Va:n.depthFunc(n.ALWAYS);break;case Wa:n.depthFunc(n.LESS);break;case hr:n.depthFunc(n.LEQUAL);break;case Xa:n.depthFunc(n.EQUAL);break;case qa:n.depthFunc(n.GEQUAL);break;case Ya:n.depthFunc(n.GREATER);break;case $a:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}_e=se}},setLocked:function(se){O=se},setClear:function(se){Ee!==se&&(Ee=se,fe&&(se=1-se),n.clearDepth(se))},reset:function(){O=!1,te=null,_e=null,Ee=null,fe=!1}}}function r(){let O=!1,fe=null,te=null,_e=null,Ee=null,se=null,Pe=null,Re=null,Et=null;return{setTest:function(gt){O||(gt?le(n.STENCIL_TEST):ke(n.STENCIL_TEST))},setMask:function(gt){fe!==gt&&!O&&(n.stencilMask(gt),fe=gt)},setFunc:function(gt,yn,Sn){(te!==gt||_e!==yn||Ee!==Sn)&&(n.stencilFunc(gt,yn,Sn),te=gt,_e=yn,Ee=Sn)},setOp:function(gt,yn,Sn){(se!==gt||Pe!==yn||Re!==Sn)&&(n.stencilOp(gt,yn,Sn),se=gt,Pe=yn,Re=Sn)},setLocked:function(gt){O=gt},setClear:function(gt){Et!==gt&&(n.clearStencil(gt),Et=gt)},reset:function(){O=!1,fe=null,te=null,_e=null,Ee=null,se=null,Pe=null,Re=null,Et=null}}}const s=new t,a=new i,o=new r,l=new WeakMap,c=new WeakMap;let u={},f={},d={},h=new WeakMap,x=[],b=null,m=!1,p=null,S=null,P=null,v=null,C=null,A=null,L=null,_=new et(0,0,0),M=0,w=!1,E=null,D=null,z=null,W=null,k=null;const $=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,Q=0;const ae=n.getParameter(n.VERSION);ae.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(ae)[1]),G=Q>=1):ae.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(ae)[1]),G=Q>=2);let Z=null,oe={};const he=n.getParameter(n.SCISSOR_BOX),$e=n.getParameter(n.VIEWPORT),ot=new St().fromArray(he),Oe=new St().fromArray($e);function ee(O,fe,te,_e){const Ee=new Uint8Array(4),se=n.createTexture();n.bindTexture(O,se),n.texParameteri(O,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(O,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Pe=0;Pe<te;Pe++)O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?n.texImage3D(fe,0,n.RGBA,1,1,_e,0,n.RGBA,n.UNSIGNED_BYTE,Ee):n.texImage2D(fe+Pe,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,Ee);return se}const ce={};ce[n.TEXTURE_2D]=ee(n.TEXTURE_2D,n.TEXTURE_2D,1),ce[n.TEXTURE_CUBE_MAP]=ee(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),ce[n.TEXTURE_2D_ARRAY]=ee(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),ce[n.TEXTURE_3D]=ee(n.TEXTURE_3D,n.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),le(n.DEPTH_TEST),a.setFunc(hr),R(!1),F(bl),le(n.CULL_FACE),N(Vn);function le(O){u[O]!==!0&&(n.enable(O),u[O]=!0)}function ke(O){u[O]!==!1&&(n.disable(O),u[O]=!1)}function Ge(O,fe){return d[O]!==fe?(n.bindFramebuffer(O,fe),d[O]=fe,O===n.DRAW_FRAMEBUFFER&&(d[n.FRAMEBUFFER]=fe),O===n.FRAMEBUFFER&&(d[n.DRAW_FRAMEBUFFER]=fe),!0):!1}function Ue(O,fe){let te=x,_e=!1;if(O){te=h.get(fe),te===void 0&&(te=[],h.set(fe,te));const Ee=O.textures;if(te.length!==Ee.length||te[0]!==n.COLOR_ATTACHMENT0){for(let se=0,Pe=Ee.length;se<Pe;se++)te[se]=n.COLOR_ATTACHMENT0+se;te.length=Ee.length,_e=!0}}else te[0]!==n.BACK&&(te[0]=n.BACK,_e=!0);_e&&n.drawBuffers(te)}function mt(O){return b!==O?(n.useProgram(O),b=O,!0):!1}const Ye={[Si]:n.FUNC_ADD,[hu]:n.FUNC_SUBTRACT,[pu]:n.FUNC_REVERSE_SUBTRACT};Ye[mu]=n.MIN,Ye[gu]=n.MAX;const st={[_u]:n.ZERO,[xu]:n.ONE,[vu]:n.SRC_COLOR,[za]:n.SRC_ALPHA,[Tu]:n.SRC_ALPHA_SATURATE,[bu]:n.DST_COLOR,[yu]:n.DST_ALPHA,[Mu]:n.ONE_MINUS_SRC_COLOR,[Ha]:n.ONE_MINUS_SRC_ALPHA,[Eu]:n.ONE_MINUS_DST_COLOR,[Su]:n.ONE_MINUS_DST_ALPHA,[wu]:n.CONSTANT_COLOR,[Au]:n.ONE_MINUS_CONSTANT_COLOR,[Ru]:n.CONSTANT_ALPHA,[Cu]:n.ONE_MINUS_CONSTANT_ALPHA};function N(O,fe,te,_e,Ee,se,Pe,Re,Et,gt){if(O===Vn){m===!0&&(ke(n.BLEND),m=!1);return}if(m===!1&&(le(n.BLEND),m=!0),O!==fu){if(O!==p||gt!==w){if((S!==Si||C!==Si)&&(n.blendEquation(n.FUNC_ADD),S=Si,C=Si),gt)switch(O){case or:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ba:n.blendFunc(n.ONE,n.ONE);break;case El:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Tl:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:tt("WebGLState: Invalid blending: ",O);break}else switch(O){case or:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ba:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case El:tt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Tl:tt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:tt("WebGLState: Invalid blending: ",O);break}P=null,v=null,A=null,L=null,_.set(0,0,0),M=0,p=O,w=gt}return}Ee=Ee||fe,se=se||te,Pe=Pe||_e,(fe!==S||Ee!==C)&&(n.blendEquationSeparate(Ye[fe],Ye[Ee]),S=fe,C=Ee),(te!==P||_e!==v||se!==A||Pe!==L)&&(n.blendFuncSeparate(st[te],st[_e],st[se],st[Pe]),P=te,v=_e,A=se,L=Pe),(Re.equals(_)===!1||Et!==M)&&(n.blendColor(Re.r,Re.g,Re.b,Et),_.copy(Re),M=Et),p=O,w=!1}function I(O,fe){O.side===fn?ke(n.CULL_FACE):le(n.CULL_FACE);let te=O.side===Yt;fe&&(te=!te),R(te),O.blending===or&&O.transparent===!1?N(Vn):N(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),a.setFunc(O.depthFunc),a.setTest(O.depthTest),a.setMask(O.depthWrite),s.setMask(O.colorWrite);const _e=O.stencilWrite;o.setTest(_e),_e&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),ie(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?le(n.SAMPLE_ALPHA_TO_COVERAGE):ke(n.SAMPLE_ALPHA_TO_COVERAGE)}function R(O){E!==O&&(O?n.frontFace(n.CW):n.frontFace(n.CCW),E=O)}function F(O){O!==cu?(le(n.CULL_FACE),O!==D&&(O===bl?n.cullFace(n.BACK):O===du?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):ke(n.CULL_FACE),D=O}function ne(O){O!==z&&(G&&n.lineWidth(O),z=O)}function ie(O,fe,te){O?(le(n.POLYGON_OFFSET_FILL),(W!==fe||k!==te)&&(W=fe,k=te,a.getReversed()&&(fe=-fe),n.polygonOffset(fe,te))):ke(n.POLYGON_OFFSET_FILL)}function de(O){O?le(n.SCISSOR_TEST):ke(n.SCISSOR_TEST)}function ye(O){O===void 0&&(O=n.TEXTURE0+$-1),Z!==O&&(n.activeTexture(O),Z=O)}function U(O,fe,te){te===void 0&&(Z===null?te=n.TEXTURE0+$-1:te=Z);let _e=oe[te];_e===void 0&&(_e={type:void 0,texture:void 0},oe[te]=_e),(_e.type!==O||_e.texture!==fe)&&(Z!==te&&(n.activeTexture(te),Z=te),n.bindTexture(O,fe||ce[O]),_e.type=O,_e.texture=fe)}function Se(){const O=oe[Z];O!==void 0&&O.type!==void 0&&(n.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function Ae(){try{n.compressedTexImage2D(...arguments)}catch(O){tt("WebGLState:",O)}}function T(){try{n.compressedTexImage3D(...arguments)}catch(O){tt("WebGLState:",O)}}function g(){try{n.texSubImage2D(...arguments)}catch(O){tt("WebGLState:",O)}}function H(){try{n.texSubImage3D(...arguments)}catch(O){tt("WebGLState:",O)}}function X(){try{n.compressedTexSubImage2D(...arguments)}catch(O){tt("WebGLState:",O)}}function J(){try{n.compressedTexSubImage3D(...arguments)}catch(O){tt("WebGLState:",O)}}function ue(){try{n.texStorage2D(...arguments)}catch(O){tt("WebGLState:",O)}}function pe(){try{n.texStorage3D(...arguments)}catch(O){tt("WebGLState:",O)}}function j(){try{n.texImage2D(...arguments)}catch(O){tt("WebGLState:",O)}}function re(){try{n.texImage3D(...arguments)}catch(O){tt("WebGLState:",O)}}function me(O){return f[O]!==void 0?f[O]:n.getParameter(O)}function Ie(O,fe){f[O]!==fe&&(n.pixelStorei(O,fe),f[O]=fe)}function xe(O){ot.equals(O)===!1&&(n.scissor(O.x,O.y,O.z,O.w),ot.copy(O))}function ge(O){Oe.equals(O)===!1&&(n.viewport(O.x,O.y,O.z,O.w),Oe.copy(O))}function Ne(O,fe){let te=c.get(fe);te===void 0&&(te=new WeakMap,c.set(fe,te));let _e=te.get(O);_e===void 0&&(_e=n.getUniformBlockIndex(fe,O.name),te.set(O,_e))}function ze(O,fe){const _e=c.get(fe).get(O);l.get(fe)!==_e&&(n.uniformBlockBinding(fe,_e,O.__bindingPointIndex),l.set(fe,_e))}function Xe(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),u={},f={},Z=null,oe={},d={},h=new WeakMap,x=[],b=null,m=!1,p=null,S=null,P=null,v=null,C=null,A=null,L=null,_=new et(0,0,0),M=0,w=!1,E=null,D=null,z=null,W=null,k=null,ot.set(0,0,n.canvas.width,n.canvas.height),Oe.set(0,0,n.canvas.width,n.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:le,disable:ke,bindFramebuffer:Ge,drawBuffers:Ue,useProgram:mt,setBlending:N,setMaterial:I,setFlipSided:R,setCullFace:F,setLineWidth:ne,setPolygonOffset:ie,setScissorTest:de,activeTexture:ye,bindTexture:U,unbindTexture:Se,compressedTexImage2D:Ae,compressedTexImage3D:T,texImage2D:j,texImage3D:re,pixelStorei:Ie,getParameter:me,updateUBOMapping:Ne,uniformBlockBinding:ze,texStorage2D:ue,texStorage3D:pe,texSubImage2D:g,texSubImage3D:H,compressedTexSubImage2D:X,compressedTexSubImage3D:J,scissor:xe,viewport:ge,reset:Xe}}function U0(n,e,t,i,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new We,u=new WeakMap,f=new Set;let d;const h=new WeakMap;let x=!1;try{x=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(T,g){return x?new OffscreenCanvas(T,g):Gr("canvas")}function m(T,g,H){let X=1;const J=Ae(T);if((J.width>H||J.height>H)&&(X=H/Math.max(J.width,J.height)),X<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ue=Math.floor(X*J.width),pe=Math.floor(X*J.height);d===void 0&&(d=b(ue,pe));const j=g?b(ue,pe):d;return j.width=ue,j.height=pe,j.getContext("2d").drawImage(T,0,0,ue,pe),He("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ue+"x"+pe+")."),j}else return"data"in T&&He("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),T;return T}function p(T){return T.generateMipmaps}function S(T){n.generateMipmap(T)}function P(T){return T.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?n.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function v(T,g,H,X,J,ue=!1){if(T!==null){if(n[T]!==void 0)return n[T];He("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let pe;X&&(pe=e.get("EXT_texture_norm16"),pe||He("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=g;if(g===n.RED&&(H===n.FLOAT&&(j=n.R32F),H===n.HALF_FLOAT&&(j=n.R16F),H===n.UNSIGNED_BYTE&&(j=n.R8),H===n.UNSIGNED_SHORT&&pe&&(j=pe.R16_EXT),H===n.SHORT&&pe&&(j=pe.R16_SNORM_EXT)),g===n.RED_INTEGER&&(H===n.UNSIGNED_BYTE&&(j=n.R8UI),H===n.UNSIGNED_SHORT&&(j=n.R16UI),H===n.UNSIGNED_INT&&(j=n.R32UI),H===n.BYTE&&(j=n.R8I),H===n.SHORT&&(j=n.R16I),H===n.INT&&(j=n.R32I)),g===n.RG&&(H===n.FLOAT&&(j=n.RG32F),H===n.HALF_FLOAT&&(j=n.RG16F),H===n.UNSIGNED_BYTE&&(j=n.RG8),H===n.UNSIGNED_SHORT&&pe&&(j=pe.RG16_EXT),H===n.SHORT&&pe&&(j=pe.RG16_SNORM_EXT)),g===n.RG_INTEGER&&(H===n.UNSIGNED_BYTE&&(j=n.RG8UI),H===n.UNSIGNED_SHORT&&(j=n.RG16UI),H===n.UNSIGNED_INT&&(j=n.RG32UI),H===n.BYTE&&(j=n.RG8I),H===n.SHORT&&(j=n.RG16I),H===n.INT&&(j=n.RG32I)),g===n.RGB_INTEGER&&(H===n.UNSIGNED_BYTE&&(j=n.RGB8UI),H===n.UNSIGNED_SHORT&&(j=n.RGB16UI),H===n.UNSIGNED_INT&&(j=n.RGB32UI),H===n.BYTE&&(j=n.RGB8I),H===n.SHORT&&(j=n.RGB16I),H===n.INT&&(j=n.RGB32I)),g===n.RGBA_INTEGER&&(H===n.UNSIGNED_BYTE&&(j=n.RGBA8UI),H===n.UNSIGNED_SHORT&&(j=n.RGBA16UI),H===n.UNSIGNED_INT&&(j=n.RGBA32UI),H===n.BYTE&&(j=n.RGBA8I),H===n.SHORT&&(j=n.RGBA16I),H===n.INT&&(j=n.RGBA32I)),g===n.RGB&&(H===n.UNSIGNED_SHORT&&pe&&(j=pe.RGB16_EXT),H===n.SHORT&&pe&&(j=pe.RGB16_SNORM_EXT),H===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),H===n.UNSIGNED_INT_10F_11F_11F_REV&&(j=n.R11F_G11F_B10F)),g===n.RGBA){const re=ue?Fs:nt.getTransfer(J);H===n.FLOAT&&(j=n.RGBA32F),H===n.HALF_FLOAT&&(j=n.RGBA16F),H===n.UNSIGNED_BYTE&&(j=re===ct?n.SRGB8_ALPHA8:n.RGBA8),H===n.UNSIGNED_SHORT&&pe&&(j=pe.RGBA16_EXT),H===n.SHORT&&pe&&(j=pe.RGBA16_SNORM_EXT),H===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),H===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function C(T,g){let H;return T?g===null||g===Ln||g===zr?H=n.DEPTH24_STENCIL8:g===An?H=n.DEPTH32F_STENCIL8:g===Br&&(H=n.DEPTH24_STENCIL8,He("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Ln||g===zr?H=n.DEPTH_COMPONENT24:g===An?H=n.DEPTH_COMPONENT32F:g===Br&&(H=n.DEPTH_COMPONENT16),H}function A(T,g){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==bt&&T.minFilter!==Pt?Math.log2(Math.max(g.width,g.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?g.mipmaps.length:1}function L(T){const g=T.target;g.removeEventListener("dispose",L),M(g),g.isVideoTexture&&u.delete(g),g.isHTMLTexture&&f.delete(g)}function _(T){const g=T.target;g.removeEventListener("dispose",_),E(g)}function M(T){const g=i.get(T);if(g.__webglInit===void 0)return;const H=T.source,X=h.get(H);if(X){const J=X[g.__cacheKey];J.usedTimes--,J.usedTimes===0&&w(T),Object.keys(X).length===0&&h.delete(H)}i.remove(T)}function w(T){const g=i.get(T);n.deleteTexture(g.__webglTexture);const H=T.source,X=h.get(H);delete X[g.__cacheKey],a.memory.textures--}function E(T){const g=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(g.__webglFramebuffer[X]))for(let J=0;J<g.__webglFramebuffer[X].length;J++)n.deleteFramebuffer(g.__webglFramebuffer[X][J]);else n.deleteFramebuffer(g.__webglFramebuffer[X]);g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer[X])}else{if(Array.isArray(g.__webglFramebuffer))for(let X=0;X<g.__webglFramebuffer.length;X++)n.deleteFramebuffer(g.__webglFramebuffer[X]);else n.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&n.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&n.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let X=0;X<g.__webglColorRenderbuffer.length;X++)g.__webglColorRenderbuffer[X]&&n.deleteRenderbuffer(g.__webglColorRenderbuffer[X]);g.__webglDepthRenderbuffer&&n.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const H=T.textures;for(let X=0,J=H.length;X<J;X++){const ue=i.get(H[X]);ue.__webglTexture&&(n.deleteTexture(ue.__webglTexture),a.memory.textures--),i.remove(H[X])}i.remove(T)}let D=0;function z(){D=0}function W(){return D}function k(T){D=T}function $(){const T=D;return T>=r.maxTextures&&He("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),D+=1,T}function G(T){const g=[];return g.push(T.wrapS),g.push(T.wrapT),g.push(T.wrapR||0),g.push(T.magFilter),g.push(T.minFilter),g.push(T.anisotropy),g.push(T.internalFormat),g.push(T.format),g.push(T.type),g.push(T.generateMipmaps),g.push(T.premultiplyAlpha),g.push(T.flipY),g.push(T.unpackAlignment),g.push(T.colorSpace),g.join()}function Q(T,g){const H=i.get(T);if(T.isVideoTexture&&U(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&H.__version!==T.version){const X=T.image;if(X===null)He("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)He("WebGLRenderer: Texture marked for update but image is incomplete");else{ke(H,T,g);return}}else T.isExternalTexture&&(H.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D,H.__webglTexture,n.TEXTURE0+g)}function ae(T,g){const H=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&H.__version!==T.version){ke(H,T,g);return}else T.isExternalTexture&&(H.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(n.TEXTURE_2D_ARRAY,H.__webglTexture,n.TEXTURE0+g)}function Z(T,g){const H=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&H.__version!==T.version){ke(H,T,g);return}t.bindTexture(n.TEXTURE_3D,H.__webglTexture,n.TEXTURE0+g)}function oe(T,g){const H=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&H.__version!==T.version){Ge(H,T,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,H.__webglTexture,n.TEXTURE0+g)}const he={[Ka]:n.REPEAT,[Hn]:n.CLAMP_TO_EDGE,[Za]:n.MIRRORED_REPEAT},$e={[bt]:n.NEAREST,[Lu]:n.NEAREST_MIPMAP_NEAREST,[$r]:n.NEAREST_MIPMAP_LINEAR,[Pt]:n.LINEAR,[Js]:n.LINEAR_MIPMAP_NEAREST,[Ei]:n.LINEAR_MIPMAP_LINEAR},ot={[Nu]:n.NEVER,[zu]:n.ALWAYS,[Fu]:n.LESS,[Zo]:n.LEQUAL,[Ou]:n.EQUAL,[Jo]:n.GEQUAL,[ku]:n.GREATER,[Bu]:n.NOTEQUAL};function Oe(T,g){if(g.type===An&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Pt||g.magFilter===Js||g.magFilter===$r||g.magFilter===Ei||g.minFilter===Pt||g.minFilter===Js||g.minFilter===$r||g.minFilter===Ei)&&He("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(T,n.TEXTURE_WRAP_S,he[g.wrapS]),n.texParameteri(T,n.TEXTURE_WRAP_T,he[g.wrapT]),(T===n.TEXTURE_3D||T===n.TEXTURE_2D_ARRAY)&&n.texParameteri(T,n.TEXTURE_WRAP_R,he[g.wrapR]),n.texParameteri(T,n.TEXTURE_MAG_FILTER,$e[g.magFilter]),n.texParameteri(T,n.TEXTURE_MIN_FILTER,$e[g.minFilter]),g.compareFunction&&(n.texParameteri(T,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(T,n.TEXTURE_COMPARE_FUNC,ot[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===bt||g.minFilter!==$r&&g.minFilter!==Ei||g.type===An&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||i.get(g).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");n.texParameterf(T,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy}}}function ee(T,g){let H=!1;T.__webglInit===void 0&&(T.__webglInit=!0,g.addEventListener("dispose",L));const X=g.source;let J=h.get(X);J===void 0&&(J={},h.set(X,J));const ue=G(g);if(ue!==T.__cacheKey){J[ue]===void 0&&(J[ue]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,H=!0),J[ue].usedTimes++;const pe=J[T.__cacheKey];pe!==void 0&&(J[T.__cacheKey].usedTimes--,pe.usedTimes===0&&w(g)),T.__cacheKey=ue,T.__webglTexture=J[ue].texture}return H}function ce(T,g,H){return Math.floor(Math.floor(T/H)/g)}function le(T,g,H,X){const ue=T.updateRanges;if(ue.length===0)t.texSubImage2D(n.TEXTURE_2D,0,0,0,g.width,g.height,H,X,g.data);else{ue.sort((Ie,xe)=>Ie.start-xe.start);let pe=0;for(let Ie=1;Ie<ue.length;Ie++){const xe=ue[pe],ge=ue[Ie],Ne=xe.start+xe.count,ze=ce(ge.start,g.width,4),Xe=ce(xe.start,g.width,4);ge.start<=Ne+1&&ze===Xe&&ce(ge.start+ge.count-1,g.width,4)===ze?xe.count=Math.max(xe.count,ge.start+ge.count-xe.start):(++pe,ue[pe]=ge)}ue.length=pe+1;const j=t.getParameter(n.UNPACK_ROW_LENGTH),re=t.getParameter(n.UNPACK_SKIP_PIXELS),me=t.getParameter(n.UNPACK_SKIP_ROWS);t.pixelStorei(n.UNPACK_ROW_LENGTH,g.width);for(let Ie=0,xe=ue.length;Ie<xe;Ie++){const ge=ue[Ie],Ne=Math.floor(ge.start/4),ze=Math.ceil(ge.count/4),Xe=Ne%g.width,O=Math.floor(Ne/g.width),fe=ze,te=1;t.pixelStorei(n.UNPACK_SKIP_PIXELS,Xe),t.pixelStorei(n.UNPACK_SKIP_ROWS,O),t.texSubImage2D(n.TEXTURE_2D,0,Xe,O,fe,te,H,X,g.data)}T.clearUpdateRanges(),t.pixelStorei(n.UNPACK_ROW_LENGTH,j),t.pixelStorei(n.UNPACK_SKIP_PIXELS,re),t.pixelStorei(n.UNPACK_SKIP_ROWS,me)}}function ke(T,g,H){let X=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(X=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(X=n.TEXTURE_3D);const J=ee(T,g),ue=g.source;t.bindTexture(X,T.__webglTexture,n.TEXTURE0+H);const pe=i.get(ue);if(ue.version!==pe.__version||J===!0){if(t.activeTexture(n.TEXTURE0+H),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const te=nt.getPrimaries(nt.workingColorSpace),_e=g.colorSpace===ai?null:nt.getPrimaries(g.colorSpace),Ee=g.colorSpace===ai||te===_e?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}t.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment);let re=m(g.image,!1,r.maxTextureSize);re=Se(g,re);const me=s.convert(g.format,g.colorSpace),Ie=s.convert(g.type);let xe=v(g.internalFormat,me,Ie,g.normalized,g.colorSpace,g.isVideoTexture);Oe(X,g);let ge;const Ne=g.mipmaps,ze=g.isVideoTexture!==!0,Xe=pe.__version===void 0||J===!0,O=ue.dataReady,fe=A(g,re);if(g.isDepthTexture)xe=C(g.format===Ti,g.type),Xe&&(ze?t.texStorage2D(n.TEXTURE_2D,1,xe,re.width,re.height):t.texImage2D(n.TEXTURE_2D,0,xe,re.width,re.height,0,me,Ie,null));else if(g.isDataTexture)if(Ne.length>0){ze&&Xe&&t.texStorage2D(n.TEXTURE_2D,fe,xe,Ne[0].width,Ne[0].height);for(let te=0,_e=Ne.length;te<_e;te++)ge=Ne[te],ze?O&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ge.width,ge.height,me,Ie,ge.data):t.texImage2D(n.TEXTURE_2D,te,xe,ge.width,ge.height,0,me,Ie,ge.data);g.generateMipmaps=!1}else ze?(Xe&&t.texStorage2D(n.TEXTURE_2D,fe,xe,re.width,re.height),O&&le(g,re,me,Ie)):t.texImage2D(n.TEXTURE_2D,0,xe,re.width,re.height,0,me,Ie,re.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){ze&&Xe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,fe,xe,Ne[0].width,Ne[0].height,re.depth);for(let te=0,_e=Ne.length;te<_e;te++)if(ge=Ne[te],g.format!==pn)if(me!==null)if(ze){if(O)if(g.layerUpdates.size>0){const Ee=ic(ge.width,ge.height,g.format,g.type);for(const se of g.layerUpdates){const Pe=ge.data.subarray(se*Ee/ge.data.BYTES_PER_ELEMENT,(se+1)*Ee/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,se,ge.width,ge.height,1,me,Pe)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ge.width,ge.height,re.depth,me,ge.data)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,te,xe,ge.width,ge.height,re.depth,0,ge.data,0,0);else He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else ze?O&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,te,0,0,0,ge.width,ge.height,re.depth,me,Ie,ge.data):t.texImage3D(n.TEXTURE_2D_ARRAY,te,xe,ge.width,ge.height,re.depth,0,me,Ie,ge.data)}else{ze&&Xe&&t.texStorage2D(n.TEXTURE_2D,fe,xe,Ne[0].width,Ne[0].height);for(let te=0,_e=Ne.length;te<_e;te++)ge=Ne[te],g.format!==pn?me!==null?ze?O&&t.compressedTexSubImage2D(n.TEXTURE_2D,te,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(n.TEXTURE_2D,te,xe,ge.width,ge.height,0,ge.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ze?O&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,ge.width,ge.height,me,Ie,ge.data):t.texImage2D(n.TEXTURE_2D,te,xe,ge.width,ge.height,0,me,Ie,ge.data)}else if(g.isDataArrayTexture)if(ze){if(Xe&&t.texStorage3D(n.TEXTURE_2D_ARRAY,fe,xe,re.width,re.height,re.depth),O)if(g.layerUpdates.size>0){const te=ic(re.width,re.height,g.format,g.type);for(const _e of g.layerUpdates){const Ee=re.data.subarray(_e*te/re.data.BYTES_PER_ELEMENT,(_e+1)*te/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,_e,re.width,re.height,1,me,Ie,Ee)}g.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,me,Ie,re.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,xe,re.width,re.height,re.depth,0,me,Ie,re.data);else if(g.isData3DTexture)ze?(Xe&&t.texStorage3D(n.TEXTURE_3D,fe,xe,re.width,re.height,re.depth),O&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,me,Ie,re.data)):t.texImage3D(n.TEXTURE_3D,0,xe,re.width,re.height,re.depth,0,me,Ie,re.data);else if(g.isFramebufferTexture){if(Xe)if(ze)t.texStorage2D(n.TEXTURE_2D,fe,xe,re.width,re.height);else{let te=re.width,_e=re.height;for(let Ee=0;Ee<fe;Ee++)t.texImage2D(n.TEXTURE_2D,Ee,xe,te,_e,0,me,Ie,null),te>>=1,_e>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in n){const te=n.canvas;if(te.hasAttribute("layoutsubtree")||te.setAttribute("layoutsubtree","true"),re.parentNode!==te){te.appendChild(re),f.add(g),te.onpaint=_e=>{const Ee=_e.changedElements;for(const se of f)Ee.includes(se.image)&&(se.needsUpdate=!0)},te.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,re);else{const Ee=n.RGBA,se=n.RGBA,Pe=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,Ee,se,Pe,re)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Ne.length>0){if(ze&&Xe){const te=Ae(Ne[0]);t.texStorage2D(n.TEXTURE_2D,fe,xe,te.width,te.height)}for(let te=0,_e=Ne.length;te<_e;te++)ge=Ne[te],ze?O&&t.texSubImage2D(n.TEXTURE_2D,te,0,0,me,Ie,ge):t.texImage2D(n.TEXTURE_2D,te,xe,me,Ie,ge);g.generateMipmaps=!1}else if(ze){if(Xe){const te=Ae(re);t.texStorage2D(n.TEXTURE_2D,fe,xe,te.width,te.height)}O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,me,Ie,re)}else t.texImage2D(n.TEXTURE_2D,0,xe,me,Ie,re);p(g)&&S(X),pe.__version=ue.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function Ge(T,g,H){if(g.image.length!==6)return;const X=ee(T,g),J=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,T.__webglTexture,n.TEXTURE0+H);const ue=i.get(J);if(J.version!==ue.__version||X===!0){t.activeTexture(n.TEXTURE0+H);const pe=nt.getPrimaries(nt.workingColorSpace),j=g.colorSpace===ai?null:nt.getPrimaries(g.colorSpace),re=g.colorSpace===ai||pe===j?n.NONE:n.BROWSER_DEFAULT_WEBGL;t.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,re);const me=g.isCompressedTexture||g.image[0].isCompressedTexture,Ie=g.image[0]&&g.image[0].isDataTexture,xe=[];for(let se=0;se<6;se++)!me&&!Ie?xe[se]=m(g.image[se],!0,r.maxCubemapSize):xe[se]=Ie?g.image[se].image:g.image[se],xe[se]=Se(g,xe[se]);const ge=xe[0],Ne=s.convert(g.format,g.colorSpace),ze=s.convert(g.type),Xe=v(g.internalFormat,Ne,ze,g.normalized,g.colorSpace),O=g.isVideoTexture!==!0,fe=ue.__version===void 0||X===!0,te=J.dataReady;let _e=A(g,ge);Oe(n.TEXTURE_CUBE_MAP,g);let Ee;if(me){O&&fe&&t.texStorage2D(n.TEXTURE_CUBE_MAP,_e,Xe,ge.width,ge.height);for(let se=0;se<6;se++){Ee=xe[se].mipmaps;for(let Pe=0;Pe<Ee.length;Pe++){const Re=Ee[Pe];g.format!==pn?Ne!==null?O?te&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe,0,0,Re.width,Re.height,Ne,Re.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe,Xe,Re.width,Re.height,0,Re.data):He("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):O?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe,0,0,Re.width,Re.height,Ne,ze,Re.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe,Xe,Re.width,Re.height,0,Ne,ze,Re.data)}}}else{if(Ee=g.mipmaps,O&&fe){Ee.length>0&&_e++;const se=Ae(xe[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,_e,Xe,se.width,se.height)}for(let se=0;se<6;se++)if(Ie){O?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,xe[se].width,xe[se].height,Ne,ze,xe[se].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Xe,xe[se].width,xe[se].height,0,Ne,ze,xe[se].data);for(let Pe=0;Pe<Ee.length;Pe++){const Et=Ee[Pe].image[se].image;O?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe+1,0,0,Et.width,Et.height,Ne,ze,Et.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe+1,Xe,Et.width,Et.height,0,Ne,ze,Et.data)}}else{O?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,0,0,Ne,ze,xe[se]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,Xe,Ne,ze,xe[se]);for(let Pe=0;Pe<Ee.length;Pe++){const Re=Ee[Pe];O?te&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe+1,0,0,Ne,ze,Re.image[se]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+se,Pe+1,Xe,Ne,ze,Re.image[se])}}}p(g)&&S(n.TEXTURE_CUBE_MAP),ue.__version=J.version,g.onUpdate&&g.onUpdate(g)}T.__version=g.version}function Ue(T,g,H,X,J,ue){const pe=s.convert(H.format,H.colorSpace),j=s.convert(H.type),re=v(H.internalFormat,pe,j,H.normalized,H.colorSpace),me=i.get(g),Ie=i.get(H);if(Ie.__renderTarget=g,!me.__hasExternalTextures){const xe=Math.max(1,g.width>>ue),ge=Math.max(1,g.height>>ue);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?t.texImage3D(J,ue,re,xe,ge,g.depth,0,pe,j,null):t.texImage2D(J,ue,re,xe,ge,0,pe,j,null)}t.bindFramebuffer(n.FRAMEBUFFER,T),ye(g)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,X,J,Ie.__webglTexture,0,de(g)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,X,J,Ie.__webglTexture,ue),t.bindFramebuffer(n.FRAMEBUFFER,null)}function mt(T,g,H){if(n.bindRenderbuffer(n.RENDERBUFFER,T),g.depthBuffer){const X=g.depthTexture,J=X&&X.isDepthTexture?X.type:null,ue=C(g.stencilBuffer,J),pe=g.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;ye(g)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,de(g),ue,g.width,g.height):H?n.renderbufferStorageMultisample(n.RENDERBUFFER,de(g),ue,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,ue,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,pe,n.RENDERBUFFER,T)}else{const X=g.textures;for(let J=0;J<X.length;J++){const ue=X[J],pe=s.convert(ue.format,ue.colorSpace),j=s.convert(ue.type),re=v(ue.internalFormat,pe,j,ue.normalized,ue.colorSpace);ye(g)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,de(g),re,g.width,g.height):H?n.renderbufferStorageMultisample(n.RENDERBUFFER,de(g),re,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,re,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Ye(T,g,H){const X=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(n.FRAMEBUFFER,T),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const J=i.get(g.depthTexture);if(J.__renderTarget=g,(!J.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),X){if(J.__webglInit===void 0&&(J.__webglInit=!0,g.depthTexture.addEventListener("dispose",L)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),Oe(n.TEXTURE_CUBE_MAP,g.depthTexture);const me=s.convert(g.depthTexture.format),Ie=s.convert(g.depthTexture.type);let xe;g.depthTexture.format===Yn?xe=n.DEPTH_COMPONENT24:g.depthTexture.format===Ti&&(xe=n.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,xe,g.width,g.height,0,me,Ie,null)}}else Q(g.depthTexture,0);const ue=J.__webglTexture,pe=de(g),j=X?n.TEXTURE_CUBE_MAP_POSITIVE_X+H:n.TEXTURE_2D,re=g.depthTexture.format===Ti?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(g.depthTexture.format===Yn)ye(g)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,re,j,ue,0,pe):n.framebufferTexture2D(n.FRAMEBUFFER,re,j,ue,0);else if(g.depthTexture.format===Ti)ye(g)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,re,j,ue,0,pe):n.framebufferTexture2D(n.FRAMEBUFFER,re,j,ue,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function st(T){const g=i.get(T),H=T.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==T.depthTexture){const X=T.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),X){const J=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,X.removeEventListener("dispose",J)};X.addEventListener("dispose",J),g.__depthDisposeCallback=J}g.__boundDepthTexture=X}if(T.depthTexture&&!g.__autoAllocateDepthBuffer)if(H)for(let X=0;X<6;X++)Ye(g.__webglFramebuffer[X],T,X);else{const X=T.texture.mipmaps;X&&X.length>0?Ye(g.__webglFramebuffer[0],T,0):Ye(g.__webglFramebuffer,T,0)}else if(H){g.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[X]),g.__webglDepthbuffer[X]===void 0)g.__webglDepthbuffer[X]=n.createRenderbuffer(),mt(g.__webglDepthbuffer[X],T,!1);else{const J=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer[X];n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,ue)}}else{const X=T.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=n.createRenderbuffer(),mt(g.__webglDepthbuffer,T,!1);else{const J=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ue=g.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ue),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,ue)}}t.bindFramebuffer(n.FRAMEBUFFER,null)}function N(T,g,H){const X=i.get(T);g!==void 0&&Ue(X.__webglFramebuffer,T,T.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),H!==void 0&&st(T)}function I(T){const g=T.texture,H=i.get(T),X=i.get(g);T.addEventListener("dispose",_);const J=T.textures,ue=T.isWebGLCubeRenderTarget===!0,pe=J.length>1;if(pe||(X.__webglTexture===void 0&&(X.__webglTexture=n.createTexture()),X.__version=g.version,a.memory.textures++),ue){H.__webglFramebuffer=[];for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0){H.__webglFramebuffer[j]=[];for(let re=0;re<g.mipmaps.length;re++)H.__webglFramebuffer[j][re]=n.createFramebuffer()}else H.__webglFramebuffer[j]=n.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){H.__webglFramebuffer=[];for(let j=0;j<g.mipmaps.length;j++)H.__webglFramebuffer[j]=n.createFramebuffer()}else H.__webglFramebuffer=n.createFramebuffer();if(pe)for(let j=0,re=J.length;j<re;j++){const me=i.get(J[j]);me.__webglTexture===void 0&&(me.__webglTexture=n.createTexture(),a.memory.textures++)}if(T.samples>0&&ye(T)===!1){H.__webglMultisampledFramebuffer=n.createFramebuffer(),H.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let j=0;j<J.length;j++){const re=J[j];H.__webglColorRenderbuffer[j]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,H.__webglColorRenderbuffer[j]);const me=s.convert(re.format,re.colorSpace),Ie=s.convert(re.type),xe=v(re.internalFormat,me,Ie,re.normalized,re.colorSpace,T.isXRRenderTarget===!0),ge=de(T);n.renderbufferStorageMultisample(n.RENDERBUFFER,ge,xe,T.width,T.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+j,n.RENDERBUFFER,H.__webglColorRenderbuffer[j])}n.bindRenderbuffer(n.RENDERBUFFER,null),T.depthBuffer&&(H.__webglDepthRenderbuffer=n.createRenderbuffer(),mt(H.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ue){t.bindTexture(n.TEXTURE_CUBE_MAP,X.__webglTexture),Oe(n.TEXTURE_CUBE_MAP,g);for(let j=0;j<6;j++)if(g.mipmaps&&g.mipmaps.length>0)for(let re=0;re<g.mipmaps.length;re++)Ue(H.__webglFramebuffer[j][re],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+j,re);else Ue(H.__webglFramebuffer[j],T,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);p(g)&&S(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let j=0,re=J.length;j<re;j++){const me=J[j],Ie=i.get(me);let xe=n.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(xe=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(xe,Ie.__webglTexture),Oe(xe,me),Ue(H.__webglFramebuffer,T,me,n.COLOR_ATTACHMENT0+j,xe,0),p(me)&&S(xe)}t.unbindTexture()}else{let j=n.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(j=T.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(j,X.__webglTexture),Oe(j,g),g.mipmaps&&g.mipmaps.length>0)for(let re=0;re<g.mipmaps.length;re++)Ue(H.__webglFramebuffer[re],T,g,n.COLOR_ATTACHMENT0,j,re);else Ue(H.__webglFramebuffer,T,g,n.COLOR_ATTACHMENT0,j,0);p(g)&&S(j),t.unbindTexture()}T.depthBuffer&&st(T)}function R(T){const g=T.textures;for(let H=0,X=g.length;H<X;H++){const J=g[H];if(p(J)){const ue=P(T),pe=i.get(J).__webglTexture;t.bindTexture(ue,pe),S(ue),t.unbindTexture()}}}const F=[],ne=[];function ie(T){if(T.samples>0){if(ye(T)===!1){const g=T.textures,H=T.width,X=T.height;let J=n.COLOR_BUFFER_BIT;const ue=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,pe=i.get(T),j=g.length>1;if(j)for(let me=0;me<g.length;me++)t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const re=T.texture.mipmaps;re&&re.length>0?t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let me=0;me<g.length;me++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),j){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const Ie=i.get(g[me]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ie,0)}n.blitFramebuffer(0,0,H,X,0,0,H,X,J,n.NEAREST),l===!0&&(F.length=0,ne.length=0,F.push(n.COLOR_ATTACHMENT0+me),T.depthBuffer&&T.resolveDepthBuffer===!1&&(F.push(ue),ne.push(ue),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,ne)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,F))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),j)for(let me=0;me<g.length;me++){t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const Ie=i.get(g[me]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,pe.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+me,n.TEXTURE_2D,Ie,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const g=T.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[g])}}}function de(T){return Math.min(r.maxSamples,T.samples)}function ye(T){const g=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function U(T){const g=a.render.frame;u.get(T)!==g&&(u.set(T,g),T.update())}function Se(T,g){const H=T.colorSpace,X=T.format,J=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||H!==Ns&&H!==ai&&(nt.getTransfer(H)===ct?(X!==pn||J!==Qt)&&He("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):tt("WebGLTextures: Unsupported texture color space:",H)),g}function Ae(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=$,this.resetTextureUnits=z,this.getTextureUnits=W,this.setTextureUnits=k,this.setTexture2D=Q,this.setTexture2DArray=ae,this.setTexture3D=Z,this.setTextureCube=oe,this.rebindTextures=N,this.setupRenderTarget=I,this.updateRenderTargetMipmap=R,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=st,this.setupFrameBufferTexture=Ue,this.useMultisampledRTT=ye,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function N0(n,e){function t(i,r=ai){let s;const a=nt.getTransfer(r);if(i===Qt)return n.UNSIGNED_BYTE;if(i===Xo)return n.UNSIGNED_SHORT_4_4_4_4;if(i===qo)return n.UNSIGNED_SHORT_5_5_5_1;if(i===_d)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===xd)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===md)return n.BYTE;if(i===gd)return n.SHORT;if(i===Br)return n.UNSIGNED_SHORT;if(i===Wo)return n.INT;if(i===Ln)return n.UNSIGNED_INT;if(i===An)return n.FLOAT;if(i===qn)return n.HALF_FLOAT;if(i===vd)return n.ALPHA;if(i===Md)return n.RGB;if(i===pn)return n.RGBA;if(i===Yn)return n.DEPTH_COMPONENT;if(i===Ti)return n.DEPTH_STENCIL;if(i===yd)return n.RED;if(i===Yo)return n.RED_INTEGER;if(i===Ri)return n.RG;if(i===$o)return n.RG_INTEGER;if(i===Ko)return n.RGBA_INTEGER;if(i===Ts||i===ws||i===As||i===Rs)if(a===ct)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ts)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===ws)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===As)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Rs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ts)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===ws)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===As)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Rs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Ja||i===Qa||i===ja||i===eo)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Ja)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Qa)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===ja)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===eo)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===to||i===no||i===io||i===ro||i===so||i===Ds||i===ao)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===to||i===no)return a===ct?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===io)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===ro)return s.COMPRESSED_R11_EAC;if(i===so)return s.COMPRESSED_SIGNED_R11_EAC;if(i===Ds)return s.COMPRESSED_RG11_EAC;if(i===ao)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===oo||i===lo||i===co||i===uo||i===fo||i===ho||i===po||i===mo||i===go||i===_o||i===xo||i===vo||i===Mo||i===yo)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===oo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===lo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===co)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===uo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===fo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ho)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===po)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===mo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===go)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===_o)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===xo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===vo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Mo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===yo)return a===ct?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===So||i===bo||i===Eo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===So)return a===ct?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===bo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Eo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===To||i===wo||i===Us||i===Ao)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===To)return s.COMPRESSED_RED_RGTC1_EXT;if(i===wo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Us)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Ao)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===zr?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}const F0=`
void main() {
...
void main() {
...
}`;class k0{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const i=new Pd(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Dn({vertexShader:F0,fragmentShader:O0,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ct(new In(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class B0 extends Ii{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,c=null,u=null,f=null,d=null,h=null,x=null;const b=typeof XRWebGLBinding<"u",m=new k0,p={},S=t.getContextAttributes();let P=null,v=null;const C=[],A=[],L=new We;let _=null;const M=new Jt;M.viewport=new St;const w=new Jt;w.viewport=new St;const E=[M,w],D=new $f;let z=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ee){let ce=C[ee];return ce===void 0&&(ce=new ia,C[ee]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(ee){let ce=C[ee];return ce===void 0&&(ce=new ia,C[ee]=ce),ce.getGripSpace()},this.getHand=function(ee){let ce=C[ee];return ce===void 0&&(ce=new ia,C[ee]=ce),ce.getHandSpace()};function k(ee){const ce=A.indexOf(ee.inputSource);if(ce===-1)return;const le=C[ce];le!==void 0&&(le.update(ee.inputSource,ee.frame,c||a),le.dispatchEvent({type:ee.type,data:ee.inputSource}))}function $(){r.removeEventListener("select",k),r.removeEventListener("selectstart",k),r.removeEventListener("selectend",k),r.removeEventListener("squeeze",k),r.removeEventListener("squeezestart",k),r.removeEventListener("squeezeend",k),r.removeEventListener("end",$),r.removeEventListener("inputsourceschange",G);for(let ee=0;ee<C.length;ee++){const ce=A[ee];ce!==null&&(A[ee]=null,C[ee].disconnect(ce))}z=null,W=null,m.reset();for(const ee in p)delete p[ee];e.setRenderTarget(P),h=null,d=null,f=null,r=null,v=null,Oe.stop(),i.isPresenting=!1,e.setPixelRatio(_),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ee){s=ee,i.isPresenting===!0&&He("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ee){o=ee,i.isPresenting===!0&&He("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(ee){c=ee},this.getBaseLayer=function(){return d!==null?d:h},this.getBinding=function(){return f===null&&b&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(ee){if(r=ee,r!==null){if(P=e.getRenderTarget(),r.addEventListener("select",k),r.addEventListener("selectstart",k),r.addEventListener("selectend",k),r.addEventListener("squeeze",k),r.addEventListener("squeezestart",k),r.addEventListener("squeezeend",k),r.addEventListener("end",$),r.addEventListener("inputsourceschange",G),S.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(L),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let le=null,ke=null,Ge=null;S.depth&&(Ge=S.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,le=S.stencil?Ti:Yn,ke=S.stencil?zr:Ln);const Ue={colorFormat:t.RGBA8,depthFormat:Ge,scaleFactor:s};f=this.getBinding(),d=f.createProjectionLayer(Ue),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),v=new Pn(d.textureWidth,d.textureHeight,{format:pn,type:Qt,depthTexture:new mr(d.textureWidth,d.textureHeight,ke,void 0,void 0,void 0,void 0,void 0,void 0,le),stencilBuffer:S.stencil,colorSpace:e.outputColorSpace,samples:S.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const le={antialias:S.antialias,alpha:!0,depth:S.depth,stencil:S.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,t,le),r.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),v=new Pn(h.framebufferWidth,h.framebufferHeight,{format:pn,type:Qt,colorSpace:e.outputColorSpace,stencilBuffer:S.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(o),Oe.setContext(r),Oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function G(ee){for(let ce=0;ce<ee.removed.length;ce++){const le=ee.removed[ce],ke=A.indexOf(le);ke>=0&&(A[ke]=null,C[ke].disconnect(le))}for(let ce=0;ce<ee.added.length;ce++){const le=ee.added[ce];let ke=A.indexOf(le);if(ke===-1){for(let Ue=0;Ue<C.length;Ue++)if(Ue>=A.length){A.push(le),ke=Ue;break}else if(A[Ue]===null){A[Ue]=le,ke=Ue;break}if(ke===-1)break}const Ge=C[ke];Ge&&Ge.connect(le)}}const Q=new V,ae=new V;function Z(ee,ce,le){Q.setFromMatrixPosition(ce.matrixWorld),ae.setFromMatrixPosition(le.matrixWorld);const ke=Q.distanceTo(ae),Ge=ce.projectionMatrix.elements,Ue=le.projectionMatrix.elements,mt=Ge[14]/(Ge[10]-1),Ye=Ge[14]/(Ge[10]+1),st=(Ge[9]+1)/Ge[5],N=(Ge[9]-1)/Ge[5],I=(Ge[8]-1)/Ge[0],R=(Ue[8]+1)/Ue[0],F=mt*I,ne=mt*R,ie=ke/(-I+R),de=ie*-I;if(ce.matrixWorld.decompose(ee.position,ee.quaternion,ee.scale),ee.translateX(de),ee.translateZ(ie),ee.matrixWorld.compose(ee.position,ee.quaternion,ee.scale),ee.matrixWorldInverse.copy(ee.matrixWorld).invert(),Ge[10]===-1)ee.projectionMatrix.copy(ce.projectionMatrix),ee.projectionMatrixInverse.copy(ce.projectionMatrixInverse);else{const ye=mt+ie,U=Ye+ie,Se=F-de,Ae=ne+(ke-de),T=st*Ye/U*ye,g=N*Ye/U*ye;ee.projectionMatrix.makePerspective(Se,Ae,T,g,ye,U),ee.projectionMatrixInverse.copy(ee.projectionMatrix).invert()}}function oe(ee,ce){ce===null?ee.matrixWorld.copy(ee.matrix):ee.matrixWorld.multiplyMatrices(ce.matrixWorld,ee.matrix),ee.matrixWorldInverse.copy(ee.matrixWorld).invert()}this.updateCamera=function(ee){if(r===null)return;let ce=ee.near,le=ee.far;m.texture!==null&&(m.depthNear>0&&(ce=m.depthNear),m.depthFar>0&&(le=m.depthFar)),D.near=w.near=M.near=ce,D.far=w.far=M.far=le,(z!==D.near||W!==D.far)&&(r.updateRenderState({depthNear:D.near,depthFar:D.far}),z=D.near,W=D.far),D.layers.mask=ee.layers.mask|6,M.layers.mask=D.layers.mask&-5,w.layers.mask=D.layers.mask&-3;const ke=ee.parent,Ge=D.cameras;oe(D,ke);for(let Ue=0;Ue<Ge.length;Ue++)oe(Ge[Ue],ke);Ge.length===2?Z(D,M,w):D.projectionMatrix.copy(M.projectionMatrix),he(ee,D,ke)};function he(ee,ce,le){le===null?ee.matrix.copy(ce.matrixWorld):(ee.matrix.copy(le.matrixWorld),ee.matrix.invert(),ee.matrix.multiply(ce.matrixWorld)),ee.matrix.decompose(ee.position,ee.quaternion,ee.scale),ee.updateMatrixWorld(!0),ee.projectionMatrix.copy(ce.projectionMatrix),ee.projectionMatrixInverse.copy(ce.projectionMatrixInverse),ee.isPerspectiveCamera&&(ee.fov=Vr*2*Math.atan(1/ee.projectionMatrix.elements[5]),ee.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(!(d===null&&h===null))return l},this.setFoveation=function(ee){l=ee,d!==null&&(d.fixedFoveation=ee),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=ee)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(D)},this.getCameraTexture=function(ee){return p[ee]};let $e=null;function ot(ee,ce){if(u=ce.getViewerPose(c||a),x=ce,u!==null){const le=u.views;h!==null&&(e.setRenderTargetFramebuffer(v,h.framebuffer),e.setRenderTarget(v));let ke=!1;le.length!==D.cameras.length&&(D.cameras.length=0,ke=!0);for(let Ye=0;Ye<le.length;Ye++){const st=le[Ye];let N=null;if(h!==null)N=h.getViewport(st);else{const R=f.getViewSubImage(d,st);N=R.viewport,Ye===0&&(e.setRenderTargetTextures(v,R.colorTexture,R.depthStencilTexture),e.setRenderTarget(v))}let I=E[Ye];I===void 0&&(I=new Jt,I.layers.enable(Ye),I.viewport=new St,E[Ye]=I),I.matrix.fromArray(st.transform.matrix),I.matrix.decompose(I.position,I.quaternion,I.scale),I.projectionMatrix.fromArray(st.projectionMatrix),I.projectionMatrixInverse.copy(I.projectionMatrix).invert(),I.viewport.set(N.x,N.y,N.width,N.height),Ye===0&&(D.matrix.copy(I.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),ke===!0&&D.cameras.push(I)}const Ge=r.enabledFeatures;if(Ge&&Ge.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&b){f=i.getBinding();const Ye=f.getDepthInformation(le[0]);Ye&&Ye.isValid&&Ye.texture&&m.init(Ye,r.renderState)}if(Ge&&Ge.includes("camera-access")&&b){e.state.unbindTexture(),f=i.getBinding();for(let Ye=0;Ye<le.length;Ye++){const st=le[Ye].camera;if(st){let N=p[st];N||(N=new Pd,p[st]=N);const I=f.getCameraImage(st);N.sourceTexture=I}}}}for(let le=0;le<C.length;le++){const ke=A[le],Ge=C[le];ke!==null&&Ge!==void 0&&Ge.update(ke,ce,c||a)}$e&&$e(ee,ce),ce.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ce}),x=null}const Oe=new Fd;Oe.setAnimationLoop(ot),this.setAnimationLoop=function(ee){$e=ee},this.dispose=function(){}}}const z0=new yt,Vd=new Ve;Vd.set(-1,0,0,0,1,0,0,0,1);function H0(n,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,Id(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,S,P,v){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?s(m,p):p.isMeshLambertMaterial?(s(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(s(m,p),f(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&h(m,p,v)):p.isMeshMatcapMaterial?(s(m,p),x(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),b(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,S,P):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Yt&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Yt&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const S=e.get(p),P=S.envMap,v=S.envMapRotation;P&&(m.envMap.value=P,m.envMapRotation.value.setFromMatrix4(z0.makeRotationFromEuler(v)).transpose(),P.isCubeTexture&&P.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Vd),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,S,P){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*S,m.scale.value=P*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function h(m,p,S){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Yt&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=S.texture,m.transmissionSamplerSize.value.set(S.width,S.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,p){p.matcap&&(m.matcap.value=p.matcap)}function b(m,p){const S=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(S.matrixWorld),m.nearDistance.value=S.shadow.camera.near,m.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function G0(n,e,t,i){let r={},s={},a=[];const o=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,C){const A=C.program;i.uniformBlockBinding(v,A)}function c(v,C){let A=r[v.id];A===void 0&&(m(v),A=u(v),r[v.id]=A,v.addEventListener("dispose",S));const L=C.program;i.updateUBOMapping(v,L);const _=e.render.frame;s[v.id]!==_&&(d(v),s[v.id]=_)}function u(v){const C=f();v.__bindingPointIndex=C;const A=n.createBuffer(),L=v.__size,_=v.usage;return n.bindBuffer(n.UNIFORM_BUFFER,A),n.bufferData(n.UNIFORM_BUFFER,L,_),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,C,A),A}function f(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return tt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(v){const C=r[v.id],A=v.uniforms,L=v.__cache;n.bindBuffer(n.UNIFORM_BUFFER,C);for(let _=0,M=A.length;_<M;_++){const w=A[_];if(Array.isArray(w))for(let E=0,D=w.length;E<D;E++)h(w[E],_,E,L);else h(w,_,0,L)}n.bindBuffer(n.UNIFORM_BUFFER,null)}function h(v,C,A,L){if(b(v,C,A,L)===!0){const _=v.__offset,M=v.value;if(Array.isArray(M)){let w=0;for(let E=0;E<M.length;E++){const D=M[E],z=p(D);x(D,v.__data,w),typeof D!="number"&&typeof D!="boolean"&&!D.isMatrix3&&!ArrayBuffer.isView(D)&&(w+=z.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(M,v.__data,0);n.bufferSubData(n.UNIFORM_BUFFER,_,v.__data)}}function x(v,C,A){typeof v=="number"||typeof v=="boolean"?C[0]=v:v.isMatrix3?(C[0]=v.elements[0],C[1]=v.elements[1],C[2]=v.elements[2],C[3]=0,C[4]=v.elements[3],C[5]=v.elements[4],C[6]=v.elements[5],C[7]=0,C[8]=v.elements[6],C[9]=v.elements[7],C[10]=v.elements[8],C[11]=0):ArrayBuffer.isView(v)?C.set(new v.constructor(v.buffer,v.byteOffset,C.length)):v.toArray(C,A)}function b(v,C,A,L){const _=v.value,M=C+"_"+A;if(L[M]===void 0)return typeof _=="number"||typeof _=="boolean"?L[M]=_:ArrayBuffer.isView(_)?L[M]=_.slice():L[M]=_.clone(),!0;{const w=L[M];if(typeof _=="number"||typeof _=="boolean"){if(w!==_)return L[M]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(w.equals(_)===!1)return w.copy(_),!0}}return!1}function m(v){const C=v.uniforms;let A=0;const L=16;for(let M=0,w=C.length;M<w;M++){const E=Array.isArray(C[M])?C[M]:[C[M]];for(let D=0,z=E.length;D<z;D++){const W=E[D],k=Array.isArray(W.value)?W.value:[W.value];for(let $=0,G=k.length;$<G;$++){const Q=k[$],ae=p(Q),Z=A%L,oe=Z%ae.boundary,he=Z+oe;A+=oe,he!==0&&L-he<ae.storage&&(A+=L-he),W.__data=new Float32Array(ae.storage/Float32Array.BYTES_PER_ELEMENT),W.__offset=A,A+=ae.storage}}}const _=A%L;return _>0&&(A+=L-_),v.__size=A,v.__cache={},this}function p(v){const C={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(C.boundary=4,C.storage=4):v.isVector2?(C.boundary=8,C.storage=8):v.isVector3||v.isColor?(C.boundary=16,C.storage=12):v.isVector4?(C.boundary=16,C.storage=16):v.isMatrix3?(C.boundary=48,C.storage=48):v.isMatrix4?(C.boundary=64,C.storage=64):v.isTexture?He("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(C.boundary=16,C.storage=v.byteLength):He("WebGLRenderer: Unsupported uniform value type.",v),C}function S(v){const C=v.target;C.removeEventListener("dispose",S);const A=a.indexOf(C.__bindingPointIndex);a.splice(A,1),n.deleteBuffer(r[C.id]),delete r[C.id],delete s[C.id]}function P(){for(const v in r)n.deleteBuffer(r[v]);a=[],r={},s={}}return{bind:l,update:c,dispose:P}}const V0=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Tn=null;function W0(){return Tn===null&&(Tn=new Rf(V0,16,16,Ri,qn),Tn.name="DFG_LUT",Tn.minFilter=Pt,Tn.magFilter=Pt,Tn.wrapS=Hn,Tn.wrapT=Hn,Tn.generateMipmaps=!1,Tn.needsUpdate=!0),Tn}class X0{constructor(e={}){const{canvas:t=Gu(),context:i=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:d=!1,outputBufferType:h=Qt}=e;this.isWebGLRenderer=!0;let x;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=i.getContextAttributes().alpha}else x=a;const b=h,m=new Set([Ko,$o,Yo]),p=new Set([Qt,Ln,Br,zr,Xo,qo]),S=new Uint32Array(4),P=new Int32Array(4),v=new V;let C=null,A=null;const L=[],_=[];let M=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Cn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const w=this;let E=!1,D=null,z=null,W=null,k=null;this._outputColorSpace=Wt;let $=0,G=0,Q=null,ae=-1,Z=null;const oe=new St,he=new St;let $e=null;const ot=new et(0);let Oe=0,ee=t.width,ce=t.height,le=1,ke=null,Ge=null;const Ue=new St(0,0,ee,ce),mt=new St(0,0,ee,ce);let Ye=!1;const st=new il;let N=!1,I=!1;const R=new yt,F=new V,ne=new St,ie={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let de=!1;function ye(){return Q===null?le:1}let U=i;function Se(y,B){return t.getContext(y,B)}try{const y={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Vo}`),t.addEventListener("webglcontextlost",Et,!1),t.addEventListener("webglcontextrestored",gt,!1),t.addEventListener("webglcontextcreationerror",yn,!1),U===null){const B="webgl2";if(U=Se(B,y),U===null)throw Se(B)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(y){throw tt("WebGLRenderer: "+y.message),y}let Ae,T,g,H,X,J,ue,pe,j,re,me,Ie,xe,ge,Ne,ze,Xe,O,fe,te,_e,Ee,se;function Pe(){Ae=new Wm(U),Ae.init(),_e=new N0(U,Ae),T=new Fm(U,Ae,e,_e),g=new D0(U,Ae),T.reversedDepthBuffer&&d&&g.buffers.depth.setReversed(!0),z=U.createFramebuffer(),W=U.createFramebuffer(),k=U.createFramebuffer(),H=new Ym(U),X=new v0,J=new U0(U,Ae,g,X,T,_e,H),ue=new Vm(w),pe=new Jf(U),Ee=new Um(U,pe),j=new Xm(U,pe,H,Ee),re=new Km(U,j,pe,Ee,H),O=new $m(U,T,J),Ne=new Om(X),me=new x0(w,ue,Ae,T,Ee,Ne),Ie=new H0(w,X),xe=new y0,ge=new A0(Ae),Xe=new Dm(w,ue,g,re,x,l),ze=new L0(w,re,T),se=new G0(U,H,T,g),fe=new Nm(U,Ae,H),te=new qm(U,Ae,H),H.programs=me.programs,w.capabilities=T,w.extensions=Ae,w.properties=X,w.renderLists=xe,w.shadowMap=ze,w.state=g,w.info=H}Pe(),b!==Qt&&(M=new Jm(b,t.width,t.height,o,r,s));const Re=new B0(w,U);this.xr=Re,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const y=Ae.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=Ae.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return le},this.setPixelRatio=function(y){y!==void 0&&(le=y,this.setSize(ee,ce,!1))},this.getSize=function(y){return y.set(ee,ce)},this.setSize=function(y,B,K=!0){if(Re.isPresenting){He("WebGLRenderer: Can't change size while VR device is presenting.");return}ee=y,ce=B,t.width=Math.floor(y*le),t.height=Math.floor(B*le),K===!0&&(t.style.width=y+"px",t.style.height=B+"px"),M!==null&&M.setSize(t.width,t.height),this.setViewport(0,0,y,B)},this.getDrawingBufferSize=function(y){return y.set(ee*le,ce*le).floor()},this.setDrawingBufferSize=function(y,B,K){ee=y,ce=B,le=K,t.width=Math.floor(y*K),t.height=Math.floor(B*K),this.setViewport(0,0,y,B)},this.setEffects=function(y){if(b===Qt){tt("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let B=0;B<y.length;B++)if(y[B].isOutputPass===!0){He("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}M.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(oe)},this.getViewport=function(y){return y.copy(Ue)},this.setViewport=function(y,B,K,q){y.isVector4?Ue.set(y.x,y.y,y.z,y.w):Ue.set(y,B,K,q),g.viewport(oe.copy(Ue).multiplyScalar(le).round())},this.getScissor=function(y){return y.copy(mt)},this.setScissor=function(y,B,K,q){y.isVector4?mt.set(y.x,y.y,y.z,y.w):mt.set(y,B,K,q),g.scissor(he.copy(mt).multiplyScalar(le).round())},this.getScissorTest=function(){return Ye},this.setScissorTest=function(y){g.setScissorTest(Ye=y)},this.setOpaqueSort=function(y){ke=y},this.setTransparentSort=function(y){Ge=y},this.getClearColor=function(y){return y.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(y=!0,B=!0,K=!0){let q=0;if(y){let Y=!1;if(Q!==null){const be=Q.texture.format;Y=m.has(be)}if(Y){const be=Q.texture.type,we=p.has(be),Me=Xe.getClearColor(),Ce=Xe.getClearAlpha(),Le=Me.r,qe=Me.g,Je=Me.b;we?(S[0]=Le,S[1]=qe,S[2]=Je,S[3]=Ce,U.clearBufferuiv(U.COLOR,0,S)):(P[0]=Le,P[1]=qe,P[2]=Je,P[3]=Ce,U.clearBufferiv(U.COLOR,0,P))}else q|=U.COLOR_BUFFER_BIT}B&&(q|=U.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),K&&(q|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),q!==0&&U.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),D=y},this.dispose=function(){t.removeEventListener("webglcontextlost",Et,!1),t.removeEventListener("webglcontextrestored",gt,!1),t.removeEventListener("webglcontextcreationerror",yn,!1),Xe.dispose(),xe.dispose(),ge.dispose(),X.dispose(),ue.dispose(),re.dispose(),Ee.dispose(),se.dispose(),me.dispose(),Re.dispose(),Re.removeEventListener("sessionstart",ml),Re.removeEventListener("sessionend",gl),pi.stop()};function Et(y){y.preventDefault(),Os("WebGLRenderer: Context Lost."),E=!0}function gt(){Os("WebGLRenderer: Context Restored."),E=!1;const y=H.autoReset,B=ze.enabled,K=ze.autoUpdate,q=ze.needsUpdate,Y=ze.type;Pe(),H.autoReset=y,ze.enabled=B,ze.autoUpdate=K,ze.needsUpdate=q,ze.type=Y}function yn(y){tt("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function Sn(y){const B=y.target;B.removeEventListener("dispose",Sn),nu(B)}function nu(y){iu(y),X.remove(y)}function iu(y){const B=X.get(y).programs;B!==void 0&&(B.forEach(function(K){me.releaseProgram(K)}),y.isShaderMaterial&&me.releaseShaderCache(y))}this.renderBufferDirect=function(y,B,K,q,Y,be){B===null&&(B=ie);const we=Y.isMesh&&Y.matrixWorld.determinantAffine()<0,Me=au(y,B,K,q,Y);g.setMaterial(q,we);let Ce=K.index,Le=1;if(q.wireframe===!0){if(Ce=j.getWireframeAttribute(K),Ce===void 0)return;Le=2}const qe=K.drawRange,Je=K.attributes.position;let De=qe.start*Le,ut=(qe.start+qe.count)*Le;be!==null&&(De=Math.max(De,be.start*Le),ut=Math.min(ut,(be.start+be.count)*Le)),Ce!==null?(De=Math.max(De,0),ut=Math.min(ut,Ce.count)):Je!=null&&(De=Math.max(De,0),ut=Math.min(ut,Je.count));const wt=ut-De;if(wt<0||wt===1/0)return;Ee.setup(Y,q,Me,K,Ce);let Tt,ht=fe;if(Ce!==null&&(Tt=pe.get(Ce),ht=te,ht.setIndex(Tt)),Y.isMesh)q.wireframe===!0?(g.setLineWidth(q.wireframeLinewidth*ye()),ht.setMode(U.LINES)):ht.setMode(U.TRIANGLES);else if(Y.isLine){let kt=q.linewidth;kt===void 0&&(kt=1),g.setLineWidth(kt*ye()),Y.isLineSegments?ht.setMode(U.LINES):Y.isLineLoop?ht.setMode(U.LINE_LOOP):ht.setMode(U.LINE_STRIP)}else Y.isPoints?ht.setMode(U.POINTS):Y.isSprite&&ht.setMode(U.TRIANGLES);if(Y.isBatchedMesh)if(Ae.get("WEBGL_multi_draw"))ht.renderMultiDraw(Y._multiDrawStarts,Y._multiDrawCounts,Y._multiDrawCount);else{const kt=Y._multiDrawStarts,Te=Y._multiDrawCounts,$t=Y._multiDrawCount,rt=Ce?pe.get(Ce).bytesPerElement:1,jt=X.get(q).currentProgram.getUniforms();for(let bn=0;bn<$t;bn++)jt.setValue(U,"_gl_DrawID",bn),ht.render(kt[bn]/rt,Te[bn])}else if(Y.isInstancedMesh)ht.renderInstances(De,wt,Y.count);else if(K.isInstancedBufferGeometry){const kt=K._maxInstanceCount!==void 0?K._maxInstanceCount:1/0,Te=Math.min(K.instanceCount,kt);ht.renderInstances(De,wt,Te)}else ht.render(De,wt)};function pl(y,B,K){y.transparent===!0&&y.side===fn&&y.forceSinglePass===!1?(y.side=Yt,y.needsUpdate=!0,Yr(y,B,K),y.side=ui,y.needsUpdate=!0,Yr(y,B,K),y.side=fn):Yr(y,B,K)}this.compile=function(y,B,K=null){K===null&&(K=y),A=ge.get(K),A.init(B),_.push(A),K.traverseVisible(function(Y){Y.isLight&&Y.layers.test(B.layers)&&(A.pushLight(Y),Y.castShadow&&A.pushShadow(Y))}),y!==K&&y.traverseVisible(function(Y){Y.isLight&&Y.layers.test(B.layers)&&(A.pushLight(Y),Y.castShadow&&A.pushShadow(Y))}),A.setupLights();const q=new Set;return y.traverse(function(Y){if(!(Y.isMesh||Y.isPoints||Y.isLine||Y.isSprite))return;const be=Y.material;if(be)if(Array.isArray(be))for(let we=0;we<be.length;we++){const Me=be[we];pl(Me,K,Y),q.add(Me)}else pl(be,K,Y),q.add(be)}),A=_.pop(),q},this.compileAsync=function(y,B,K=null){const q=this.compile(y,B,K);return new Promise(Y=>{function be(){if(q.forEach(function(we){X.get(we).currentProgram.isReady()&&q.delete(we)}),q.size===0){Y(y);return}setTimeout(be,10)}Ae.get("KHR_parallel_shader_compile")!==null?be():setTimeout(be,10)})};let Ys=null;function ru(y){Ys&&Ys(y)}function ml(){pi.stop()}function gl(){pi.start()}const pi=new Fd;pi.setAnimationLoop(ru),typeof self<"u"&&pi.setContext(self),this.setAnimationLoop=function(y){Ys=y,Re.setAnimationLoop(y),y===null?pi.stop():pi.start()},Re.addEventListener("sessionstart",ml),Re.addEventListener("sessionend",gl),this.render=function(y,B){if(B!==void 0&&B.isCamera!==!0){tt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(E===!0)return;D!==null&&D.renderStart(y,B);const K=Re.enabled===!0&&Re.isPresenting===!0,q=M!==null&&(Q===null||K)&&M.begin(w,Q);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),Re.enabled===!0&&Re.isPresenting===!0&&(M===null||M.isCompositing()===!1)&&(Re.cameraAutoUpdate===!0&&Re.updateCamera(B),B=Re.getCamera()),y.isScene===!0&&y.onBeforeRender(w,y,B,Q),A=ge.get(y,_.length),A.init(B),A.state.textureUnits=J.getTextureUnits(),_.push(A),R.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),st.setFromProjectionMatrix(R,Rn,B.reversedDepth),I=this.localClippingEnabled,N=Ne.init(this.clippingPlanes,I),C=xe.get(y,L.length),C.init(),L.push(C),Re.enabled===!0&&Re.isPresenting===!0){const we=w.xr.getDepthSensingMesh();we!==null&&$s(we,B,-1/0,w.sortObjects)}$s(y,B,0,w.sortObjects),C.finish(),w.sortObjects===!0&&C.sort(ke,Ge,B.reversedDepth),de=Re.enabled===!1||Re.isPresenting===!1||Re.hasDepthSensing()===!1,de&&Xe.addToRenderList(C,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),N===!0&&Ne.beginShadows();const Y=A.state.shadowsArray;if(ze.render(Y,y,B),N===!0&&Ne.endShadows(),(q&&M.hasRenderPass())===!1){const we=C.opaque,Me=C.transmissive;if(A.setupLights(),B.isArrayCamera){const Ce=B.cameras;if(Me.length>0)for(let Le=0,qe=Ce.length;Le<qe;Le++){const Je=Ce[Le];xl(we,Me,y,Je)}de&&Xe.render(y);for(let Le=0,qe=Ce.length;Le<qe;Le++){const Je=Ce[Le];_l(C,y,Je,Je.viewport)}}else Me.length>0&&xl(we,Me,y,B),de&&Xe.render(y),_l(C,y,B)}Q!==null&&G===0&&(J.updateMultisampleRenderTarget(Q),J.updateRenderTargetMipmap(Q)),q&&M.end(w),y.isScene===!0&&y.onAfterRender(w,y,B),Ee.resetDefaultState(),ae=-1,Z=null,_.pop(),_.length>0?(A=_[_.length-1],J.setTextureUnits(A.state.textureUnits),N===!0&&Ne.setGlobalState(w.clippingPlanes,A.state.camera)):A=null,L.pop(),L.length>0?C=L[L.length-1]:C=null,D!==null&&D.renderEnd()};function $s(y,B,K,q){if(y.visible===!1)return;if(y.layers.test(B.layers)){if(y.isGroup)K=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(B);else if(y.isLightProbeGrid)A.pushLightProbeGrid(y);else if(y.isLight)A.pushLight(y),y.castShadow&&A.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||st.intersectsSprite(y)){q&&ne.setFromMatrixPosition(y.matrixWorld).applyMatrix4(R);const we=re.update(y),Me=y.material;Me.visible&&C.push(y,we,Me,K,ne.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||st.intersectsObject(y))){const we=re.update(y),Me=y.material;if(q&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),ne.copy(y.boundingSphere.center)):(we.boundingSphere===null&&we.computeBoundingSphere(),ne.copy(we.boundingSphere.center)),ne.applyMatrix4(y.matrixWorld).applyMatrix4(R)),Array.isArray(Me)){const Ce=we.groups;for(let Le=0,qe=Ce.length;Le<qe;Le++){const Je=Ce[Le],De=Me[Je.materialIndex];De&&De.visible&&C.push(y,we,De,K,ne.z,Je)}}else Me.visible&&C.push(y,we,Me,K,ne.z,null)}}const be=y.children;for(let we=0,Me=be.length;we<Me;we++)$s(be[we],B,K,q)}function _l(y,B,K,q){const{opaque:Y,transmissive:be,transparent:we}=y;A.setupLightsView(K),N===!0&&Ne.setGlobalState(w.clippingPlanes,K),q&&g.viewport(oe.copy(q)),Y.length>0&&qr(Y,B,K),be.length>0&&qr(be,B,K),we.length>0&&qr(we,B,K),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function xl(y,B,K,q){if((K.isScene===!0?K.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[q.id]===void 0){const De=Ae.has("EXT_color_buffer_half_float")||Ae.has("EXT_color_buffer_float");A.state.transmissionRenderTarget[q.id]=new Pn(1,1,{generateMipmaps:!0,type:De?qn:Qt,minFilter:Ei,samples:Math.max(4,T.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:nt.workingColorSpace})}const be=A.state.transmissionRenderTarget[q.id],we=q.viewport||oe;be.setSize(we.z*w.transmissionResolutionScale,we.w*w.transmissionResolutionScale);const Me=w.getRenderTarget(),Ce=w.getActiveCubeFace(),Le=w.getActiveMipmapLevel();w.setRenderTarget(be),w.getClearColor(ot),Oe=w.getClearAlpha(),Oe<1&&w.setClearColor(16777215,.5),w.clear(),de&&Xe.render(K);const qe=w.toneMapping;w.toneMapping=Cn;const Je=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),A.setupLightsView(q),N===!0&&Ne.setGlobalState(w.clippingPlanes,q),qr(y,K,q),J.updateMultisampleRenderTarget(be),J.updateRenderTargetMipmap(be),Ae.has("WEBGL_multisampled_render_to_texture")===!1){let De=!1;for(let ut=0,wt=B.length;ut<wt;ut++){const Tt=B[ut],{object:ht,geometry:kt,material:Te,group:$t}=Tt;if(Te.side===fn&&ht.layers.test(q.layers)){const rt=Te.side;Te.side=Yt,Te.needsUpdate=!0,vl(ht,K,q,kt,Te,$t),Te.side=rt,Te.needsUpdate=!0,De=!0}}De===!0&&(J.updateMultisampleRenderTarget(be),J.updateRenderTargetMipmap(be))}w.setRenderTarget(Me,Ce,Le),w.setClearColor(ot,Oe),Je!==void 0&&(q.viewport=Je),w.toneMapping=qe}function qr(y,B,K){const q=B.isScene===!0?B.overrideMaterial:null;for(let Y=0,be=y.length;Y<be;Y++){const we=y[Y],{object:Me,geometry:Ce,group:Le}=we;let qe=we.material;qe.allowOverride===!0&&q!==null&&(qe=q),Me.layers.test(K.layers)&&vl(Me,B,K,Ce,qe,Le)}}function vl(y,B,K,q,Y,be){y.onBeforeRender(w,B,K,q,Y,be),y.modelViewMatrix.multiplyMatrices(K.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),Y.onBeforeRender(w,B,K,q,y,be),Y.transparent===!0&&Y.side===fn&&Y.forceSinglePass===!1?(Y.side=Yt,Y.needsUpdate=!0,w.renderBufferDirect(K,B,q,Y,y,be),Y.side=ui,Y.needsUpdate=!0,w.renderBufferDirect(K,B,q,Y,y,be),Y.side=fn):w.renderBufferDirect(K,B,q,Y,y,be),y.onAfterRender(w,B,K,q,Y,be)}function Yr(y,B,K){B.isScene!==!0&&(B=ie);const q=X.get(y),Y=A.state.lights,be=A.state.shadowsArray,we=Y.state.version,Me=me.getParameters(y,Y.state,be,B,K,A.state.lightProbeGridArray),Ce=me.getProgramCacheKey(Me);let Le=q.programs;q.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?B.environment:null,q.fog=B.fog;const qe=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;q.envMap=ue.get(y.envMap||q.environment,qe),q.envMapRotation=q.environment!==null&&y.envMap===null?B.environmentRotation:y.envMapRotation,Le===void 0&&(y.addEventListener("dispose",Sn),Le=new Map,q.programs=Le);let Je=Le.get(Ce);if(Je!==void 0){if(q.currentProgram===Je&&q.lightsStateVersion===we)return yl(y,Me),Je}else Me.uniforms=me.getUniforms(y),D!==null&&y.isNodeMaterial&&D.build(y,K,Me),y.onBeforeCompile(Me,w),Je=me.acquireProgram(Me,Ce),Le.set(Ce,Je),q.uniforms=Me.uniforms;const De=q.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(De.clippingPlanes=Ne.uniform),yl(y,Me),q.needsLights=lu(y),q.lightsStateVersion=we,q.needsLights&&(De.ambientLightColor.value=Y.state.ambient,De.lightProbe.value=Y.state.probe,De.directionalLights.value=Y.state.directional,De.directionalLightShadows.value=Y.state.directionalShadow,De.spotLights.value=Y.state.spot,De.spotLightShadows.value=Y.state.spotShadow,De.rectAreaLights.value=Y.state.rectArea,De.ltc_1.value=Y.state.rectAreaLTC1,De.ltc_2.value=Y.state.rectAreaLTC2,De.pointLights.value=Y.state.point,De.pointLightShadows.value=Y.state.pointShadow,De.hemisphereLights.value=Y.state.hemi,De.directionalShadowMatrix.value=Y.state.directionalShadowMatrix,De.spotLightMatrix.value=Y.state.spotLightMatrix,De.spotLightMap.value=Y.state.spotLightMap,De.pointShadowMatrix.value=Y.state.pointShadowMatrix),q.lightProbeGrid=A.state.lightProbeGridArray.length>0,q.currentProgram=Je,q.uniformsList=null,Je}function Ml(y){if(y.uniformsList===null){const B=y.currentProgram.getUniforms();y.uniformsList=Cs.seqWithValue(B.seq,y.uniforms)}return y.uniformsList}function yl(y,B){const K=X.get(y);K.outputColorSpace=B.outputColorSpace,K.batching=B.batching,K.batchingColor=B.batchingColor,K.instancing=B.instancing,K.instancingColor=B.instancingColor,K.instancingMorph=B.instancingMorph,K.skinning=B.skinning,K.morphTargets=B.morphTargets,K.morphNormals=B.morphNormals,K.morphColors=B.morphColors,K.morphTargetsCount=B.morphTargetsCount,K.numClippingPlanes=B.numClippingPlanes,K.numIntersection=B.numClipIntersection,K.vertexAlphas=B.vertexAlphas,K.vertexTangents=B.vertexTangents,K.toneMapping=B.toneMapping}function su(y,B){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;v.setFromMatrixPosition(B.matrixWorld);for(let K=0,q=y.length;K<q;K++){const Y=y[K];if(Y.texture!==null&&Y.boundingBox.containsPoint(v))return Y}return null}function au(y,B,K,q,Y){B.isScene!==!0&&(B=ie),J.resetTextureUnits();const be=B.fog,we=q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial?B.environment:null,Me=Q===null?w.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:nt.workingColorSpace,Ce=q.isMeshStandardMaterial||q.isMeshLambertMaterial&&!q.envMap||q.isMeshPhongMaterial&&!q.envMap,Le=ue.get(q.envMap||we,Ce),qe=q.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,Je=!!K.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),De=!!K.morphAttributes.position,ut=!!K.morphAttributes.normal,wt=!!K.morphAttributes.color;let Tt=Cn;q.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(Tt=w.toneMapping);const ht=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,kt=ht!==void 0?ht.length:0,Te=X.get(q),$t=A.state.lights;if(N===!0&&(I===!0||y!==Z)){const _t=y===Z&&q.id===ae;Ne.setState(q,y,_t)}let rt=!1;q.version===Te.__version?(Te.needsLights&&Te.lightsStateVersion!==$t.state.version||Te.outputColorSpace!==Me||Y.isBatchedMesh&&Te.batching===!1||!Y.isBatchedMesh&&Te.batching===!0||Y.isBatchedMesh&&Te.batchingColor===!0&&Y.colorTexture===null||Y.isBatchedMesh&&Te.batchingColor===!1&&Y.colorTexture!==null||Y.isInstancedMesh&&Te.instancing===!1||!Y.isInstancedMesh&&Te.instancing===!0||Y.isSkinnedMesh&&Te.skinning===!1||!Y.isSkinnedMesh&&Te.skinning===!0||Y.isInstancedMesh&&Te.instancingColor===!0&&Y.instanceColor===null||Y.isInstancedMesh&&Te.instancingColor===!1&&Y.instanceColor!==null||Y.isInstancedMesh&&Te.instancingMorph===!0&&Y.morphTexture===null||Y.isInstancedMesh&&Te.instancingMorph===!1&&Y.morphTexture!==null||Te.envMap!==Le||q.fog===!0&&Te.fog!==be||Te.numClippingPlanes!==void 0&&(Te.numClippingPlanes!==Ne.numPlanes||Te.numIntersection!==Ne.numIntersection)||Te.vertexAlphas!==qe||Te.vertexTangents!==Je||Te.morphTargets!==De||Te.morphNormals!==ut||Te.morphColors!==wt||Te.toneMapping!==Tt||Te.morphTargetsCount!==kt||!!Te.lightProbeGrid!=A.state.lightProbeGridArray.length>0)&&(rt=!0):(rt=!0,Te.__version=q.version);let jt=Te.currentProgram;rt===!0&&(jt=Yr(q,B,Y),D&&q.isNodeMaterial&&D.onUpdateProgram(q,jt,Te));let bn=!1,$n=!1,Ui=!1;const pt=jt.getUniforms(),At=Te.uniforms;if(g.useProgram(jt.program)&&(bn=!0,$n=!0,Ui=!0),q.id!==ae&&(ae=q.id,$n=!0),Te.needsLights){const _t=su(A.state.lightProbeGridArray,Y);Te.lightProbeGrid!==_t&&(Te.lightProbeGrid=_t,$n=!0)}if(bn||Z!==y){g.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),pt.setValue(U,"projectionMatrix",y.projectionMatrix),pt.setValue(U,"viewMatrix",y.matrixWorldInverse);const Zn=pt.map.cameraPosition;Zn!==void 0&&Zn.setValue(U,F.setFromMatrixPosition(y.matrixWorld)),T.logarithmicDepthBuffer&&pt.setValue(U,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&pt.setValue(U,"isOrthographic",y.isOrthographicCamera===!0),Z!==y&&(Z=y,$n=!0,Ui=!0)}if(Te.needsLights&&($t.state.directionalShadowMap.length>0&&pt.setValue(U,"directionalShadowMap",$t.state.directionalShadowMap,J),$t.state.spotShadowMap.length>0&&pt.setValue(U,"spotShadowMap",$t.state.spotShadowMap,J),$t.state.pointShadowMap.length>0&&pt.setValue(U,"pointShadowMap",$t.state.pointShadowMap,J)),Y.isSkinnedMesh){pt.setOptional(U,Y,"bindMatrix"),pt.setOptional(U,Y,"bindMatrixInverse");const _t=Y.skeleton;_t&&(_t.boneTexture===null&&_t.computeBoneTexture(),pt.setValue(U,"boneTexture",_t.boneTexture,J))}Y.isBatchedMesh&&(pt.setOptional(U,Y,"batchingTexture"),pt.setValue(U,"batchingTexture",Y._matricesTexture,J),pt.setOptional(U,Y,"batchingIdTexture"),pt.setValue(U,"batchingIdTexture",Y._indirectTexture,J),pt.setOptional(U,Y,"batchingColorTexture"),Y._colorsTexture!==null&&pt.setValue(U,"batchingColorTexture",Y._colorsTexture,J));const Kn=K.morphAttributes;if((Kn.position!==void 0||Kn.normal!==void 0||Kn.color!==void 0)&&O.update(Y,K,jt),($n||Te.receiveShadow!==Y.receiveShadow)&&(Te.receiveShadow=Y.receiveShadow,pt.setValue(U,"receiveShadow",Y.receiveShadow)),(q.isMeshStandardMaterial||q.isMeshLambertMaterial||q.isMeshPhongMaterial)&&q.envMap===null&&B.environment!==null&&(At.envMapIntensity.value=B.environmentIntensity),At.dfgLUT!==void 0&&(At.dfgLUT.value=W0()),$n){if(pt.setValue(U,"toneMappingExposure",w.toneMappingExposure),Te.needsLights&&ou(At,Ui),be&&q.fog===!0&&Ie.refreshFogUniforms(At,be),Ie.refreshMaterialUniforms(At,q,le,ce,A.state.transmissionRenderTarget[y.id]),Te.needsLights&&Te.lightProbeGrid){const _t=Te.lightProbeGrid;At.probesSH.value=_t.texture,At.probesMin.value.copy(_t.boundingBox.min),At.probesMax.value.copy(_t.boundingBox.max),At.probesResolution.value.copy(_t.resolution)}Cs.upload(U,Ml(Te),At,J)}if(q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Cs.upload(U,Ml(Te),At,J),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&pt.setValue(U,"center",Y.center),pt.setValue(U,"modelViewMatrix",Y.modelViewMatrix),pt.setValue(U,"normalMatrix",Y.normalMatrix),pt.setValue(U,"modelMatrix",Y.matrixWorld),q.uniformsGroups!==void 0){const _t=q.uniformsGroups;for(let Zn=0,Ni=_t.length;Zn<Ni;Zn++){const Sl=_t[Zn];se.update(Sl,jt),se.bind(Sl,jt)}}return jt}function ou(y,B){y.ambientLightColor.needsUpdate=B,y.lightProbe.needsUpdate=B,y.directionalLights.needsUpdate=B,y.directionalLightShadows.needsUpdate=B,y.pointLights.needsUpdate=B,y.pointLightShadows.needsUpdate=B,y.spotLights.needsUpdate=B,y.spotLightShadows.needsUpdate=B,y.rectAreaLights.needsUpdate=B,y.hemisphereLights.needsUpdate=B}function lu(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return $},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return Q},this.setRenderTargetTextures=function(y,B,K){const q=X.get(y);q.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,q.__autoAllocateDepthBuffer===!1&&(q.__useRenderToTexture=!1),X.get(y.texture).__webglTexture=B,X.get(y.depthTexture).__webglTexture=q.__autoAllocateDepthBuffer?void 0:K,q.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,B){const K=X.get(y);K.__webglFramebuffer=B,K.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(y,B=0,K=0){Q=y,$=B,G=K;let q=null,Y=!1,be=!1;if(y){const Me=X.get(y);if(Me.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(U.FRAMEBUFFER,Me.__webglFramebuffer),oe.copy(y.viewport),he.copy(y.scissor),$e=y.scissorTest,g.viewport(oe),g.scissor(he),g.setScissorTest($e),ae=-1;return}else if(Me.__webglFramebuffer===void 0)J.setupRenderTarget(y);else if(Me.__hasExternalTextures)J.rebindTextures(y,X.get(y.texture).__webglTexture,X.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){const qe=y.depthTexture;if(Me.__boundDepthTexture!==qe){if(qe!==null&&X.has(qe)&&(y.width!==qe.image.width||y.height!==qe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");J.setupDepthRenderbuffer(y)}}const Ce=y.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(be=!0);const Le=X.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Le[B])?q=Le[B][K]:q=Le[B],Y=!0):y.samples>0&&J.useMultisampledRTT(y)===!1?q=X.get(y).__webglMultisampledFramebuffer:Array.isArray(Le)?q=Le[K]:q=Le,oe.copy(y.viewport),he.copy(y.scissor),$e=y.scissorTest}else oe.copy(Ue).multiplyScalar(le).floor(),he.copy(mt).multiplyScalar(le).floor(),$e=Ye;if(K!==0&&(q=z),g.bindFramebuffer(U.FRAMEBUFFER,q)&&g.drawBuffers(y,q),g.viewport(oe),g.scissor(he),g.setScissorTest($e),Y){const Me=X.get(y.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+B,Me.__webglTexture,K)}else if(be){const Me=B;for(let Ce=0;Ce<y.textures.length;Ce++){const Le=X.get(y.textures[Ce]);U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0+Ce,Le.__webglTexture,K,Me)}}else if(y!==null&&K!==0){const Me=X.get(y.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Me.__webglTexture,K)}ae=-1},this.readRenderTargetPixels=function(y,B,K,q,Y,be,we,Me=0){if(!(y&&y.isWebGLRenderTarget)){tt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ce=X.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&we!==void 0&&(Ce=Ce[we]),Ce){g.bindFramebuffer(U.FRAMEBUFFER,Ce);try{const Le=y.textures[Me],qe=Le.format,Je=Le.type;if(y.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+Me),!T.textureFormatReadable(qe)){tt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!T.textureTypeReadable(Je)){tt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=y.width-q&&K>=0&&K<=y.height-Y&&U.readPixels(B,K,q,Y,_e.convert(qe),_e.convert(Je),be)}finally{const Le=Q!==null?X.get(Q).__webglFramebuffer:null;g.bindFramebuffer(U.FRAMEBUFFER,Le)}}},this.readRenderTargetPixelsAsync=async function(y,B,K,q,Y,be,we,Me=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Ce=X.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&we!==void 0&&(Ce=Ce[we]),Ce)if(B>=0&&B<=y.width-q&&K>=0&&K<=y.height-Y){g.bindFramebuffer(U.FRAMEBUFFER,Ce);const Le=y.textures[Me],qe=Le.format,Je=Le.type;if(y.textures.length>1&&U.readBuffer(U.COLOR_ATTACHMENT0+Me),!T.textureFormatReadable(qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!T.textureTypeReadable(Je))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const De=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,De),U.bufferData(U.PIXEL_PACK_BUFFER,be.byteLength,U.STREAM_READ),U.readPixels(B,K,q,Y,_e.convert(qe),_e.convert(Je),0);const ut=Q!==null?X.get(Q).__webglFramebuffer:null;g.bindFramebuffer(U.FRAMEBUFFER,ut);const wt=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await Vu(U,wt,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,De),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,be),U.deleteBuffer(De),U.deleteSync(wt),be}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,B=null,K=0){const q=Math.pow(2,-K),Y=Math.floor(y.image.width*q),be=Math.floor(y.image.height*q),we=B!==null?B.x:0,Me=B!==null?B.y:0;J.setTexture2D(y,0),U.copyTexSubImage2D(U.TEXTURE_2D,K,0,0,we,Me,Y,be),g.unbindTexture()},this.copyTextureToTexture=function(y,B,K=null,q=null,Y=0,be=0){let we,Me,Ce,Le,qe,Je,De,ut,wt;const Tt=y.isCompressedTexture?y.mipmaps[be]:y.image;if(K!==null)we=K.max.x-K.min.x,Me=K.max.y-K.min.y,Ce=K.isBox3?K.max.z-K.min.z:1,Le=K.min.x,qe=K.min.y,Je=K.isBox3?K.min.z:0;else{const At=Math.pow(2,-Y);we=Math.floor(Tt.width*At),Me=Math.floor(Tt.height*At),y.isDataArrayTexture?Ce=Tt.depth:y.isData3DTexture?Ce=Math.floor(Tt.depth*At):Ce=1,Le=0,qe=0,Je=0}q!==null?(De=q.x,ut=q.y,wt=q.z):(De=0,ut=0,wt=0);const ht=_e.convert(B.format),kt=_e.convert(B.type);let Te;B.isData3DTexture?(J.setTexture3D(B,0),Te=U.TEXTURE_3D):B.isDataArrayTexture||B.isCompressedArrayTexture?(J.setTexture2DArray(B,0),Te=U.TEXTURE_2D_ARRAY):(J.setTexture2D(B,0),Te=U.TEXTURE_2D),g.activeTexture(U.TEXTURE0),g.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,B.flipY),g.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,B.premultiplyAlpha),g.pixelStorei(U.UNPACK_ALIGNMENT,B.unpackAlignment);const $t=g.getParameter(U.UNPACK_ROW_LENGTH),rt=g.getParameter(U.UNPACK_IMAGE_HEIGHT),jt=g.getParameter(U.UNPACK_SKIP_PIXELS),bn=g.getParameter(U.UNPACK_SKIP_ROWS),$n=g.getParameter(U.UNPACK_SKIP_IMAGES);g.pixelStorei(U.UNPACK_ROW_LENGTH,Tt.width),g.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Tt.height),g.pixelStorei(U.UNPACK_SKIP_PIXELS,Le),g.pixelStorei(U.UNPACK_SKIP_ROWS,qe),g.pixelStorei(U.UNPACK_SKIP_IMAGES,Je);const Ui=y.isDataArrayTexture||y.isData3DTexture,pt=B.isDataArrayTexture||B.isData3DTexture;if(y.isDepthTexture){const At=X.get(y),Kn=X.get(B),_t=X.get(At.__renderTarget),Zn=X.get(Kn.__renderTarget);g.bindFramebuffer(U.READ_FRAMEBUFFER,_t.__webglFramebuffer),g.bindFramebuffer(U.DRAW_FRAMEBUFFER,Zn.__webglFramebuffer);for(let Ni=0;Ni<Ce;Ni++)Ui&&(U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,X.get(y).__webglTexture,Y,Je+Ni),U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,X.get(B).__webglTexture,be,wt+Ni)),U.blitFramebuffer(Le,qe,we,Me,De,ut,we,Me,U.DEPTH_BUFFER_BIT,U.NEAREST);g.bindFramebuffer(U.READ_FRAMEBUFFER,null),g.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else if(Y!==0||y.isRenderTargetTexture||X.has(y)){const At=X.get(y),Kn=X.get(B);g.bindFramebuffer(U.READ_FRAMEBUFFER,W),g.bindFramebuffer(U.DRAW_FRAMEBUFFER,k);for(let _t=0;_t<Ce;_t++)Ui?U.framebufferTextureLayer(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,At.__webglTexture,Y,Je+_t):U.framebufferTexture2D(U.READ_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,At.__webglTexture,Y),pt?U.framebufferTextureLayer(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,Kn.__webglTexture,be,wt+_t):U.framebufferTexture2D(U.DRAW_FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_2D,Kn.__webglTexture,be),Y!==0?U.blitFramebuffer(Le,qe,we,Me,De,ut,we,Me,U.COLOR_BUFFER_BIT,U.NEAREST):pt?U.copyTexSubImage3D(Te,be,De,ut,wt+_t,Le,qe,we,Me):U.copyTexSubImage2D(Te,be,De,ut,Le,qe,we,Me);g.bindFramebuffer(U.READ_FRAMEBUFFER,null),g.bindFramebuffer(U.DRAW_FRAMEBUFFER,null)}else pt?y.isDataTexture||y.isData3DTexture?U.texSubImage3D(Te,be,De,ut,wt,we,Me,Ce,ht,kt,Tt.data):B.isCompressedArrayTexture?U.compressedTexSubImage3D(Te,be,De,ut,wt,we,Me,Ce,ht,Tt.data):U.texSubImage3D(Te,be,De,ut,wt,we,Me,Ce,ht,kt,Tt):y.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,be,De,ut,we,Me,ht,kt,Tt.data):y.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,be,De,ut,Tt.width,Tt.height,ht,Tt.data):U.texSubImage2D(U.TEXTURE_2D,be,De,ut,we,Me,ht,kt,Tt);g.pixelStorei(U.UNPACK_ROW_LENGTH,$t),g.pixelStorei(U.UNPACK_IMAGE_HEIGHT,rt),g.pixelStorei(U.UNPACK_SKIP_PIXELS,jt),g.pixelStorei(U.UNPACK_SKIP_ROWS,bn),g.pixelStorei(U.UNPACK_SKIP_IMAGES,$n),be===0&&B.generateMipmaps&&U.generateMipmap(Te),g.unbindTexture()},this.initRenderTarget=function(y){X.get(y).__webglFramebuffer===void 0&&J.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?J.setTextureCube(y,0):y.isData3DTexture?J.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?J.setTexture2DArray(y,0):J.setTexture2D(y,0),g.unbindTexture()},this.resetState=function(){$=0,G=0,Q=null,g.reset(),Ee.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Rn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=nt._getDrawingBufferColorSpace(e),t.unpackColorSpace=nt._getUnpackColorSpace()}}const Ci=60,xt=1/Ci,Do=32,it=17,Qe=10,vt={radius:.35,maxHalfHearts:6,moveSpeed:5,damage:10,fireRate:2,range:6,shotSpeed:9,luck:0},q0=60,Y0=7,dr=.18,Ps=600,Vt={radius:.42,hp:25,moveSpeed:1.6,aggroRange:7,attackRange:5.5,telegraphTicks:24,cooldownTicks:66,spitSpeed:6,spitDamage:1,contactDamage:1},Ac=3.2,Bs=.82,vi={halfHearts:{min:2,max:24},damage:{min:1,max:1/0},fireRate:{min:.5,max:5},range:{min:3,max:12},shotSpeed:{min:5,max:16},moveSpeed:{min:3.5,max:7.5},luck:{min:0,max:10}},$0=6,K0=2.2,Z0=1.6,J0=.11,Pr={damageMult:.5,range:2.5,angleRad:.9,radiusMult:.8},ar={speedMult:.5,radiusMult:1.6,homingRange:4.5,turnRadPerTick:.05,giantRadiusMult:2.2,giantDamageMult:2},Q0=18,j0=240,Ir={ticks:8,speed:14,iframeTicks:12,cooldownTicks:120},Rc=2,e_=3,t_={renacuajo:1,mosca_gorda:1,sapo_escupidor:3,babosa_acorazada:4,sapo_doble:8},Xt={radius:.22,hp:4,contactDamage:1,windupTicks:18,hopTicks:12,hopSpeed:7,pauseTicks:26,aggroRange:9},oi={radius:.28,hp:6,contactDamage:1,speed:1.3,retargetTicks:55,wobble:2.2},ci={radius:.45,hp:30,contactDamage:2,speed:.8,aggroRange:10,turnRadPerTick:.02,backDot:.25},ft={radius:.5,hp:50,contactDamage:2,moveSpeed:1.2,aggroRange:9,attackRange:6,telegraphTicks:24,cooldownTicks:80,spitSpeed:6.5,spitDamage:1,spitSpreadRad:.16,swallowSeekRange:5,swallowRange:1.7,swallowTelegraphTicks:24,healPerSwallow:10,swallowCooldownTicks:140},n_=3,i_=1,Ca={hpPorNivel:.15,velPorNivel:.04,danoExtraDesdeNivel:4},Uo={gigante:{hpMult:2.2,velMult:.85,sizeMult:1.45,danoPlus:1,chanceBase:.03,chancePorNivel:.05,chanceTope:.25},veloz:{hpMult:1,velMult:1.5,sizeMult:.8,danoPlus:0,chanceBase:.03,chancePorNivel:.04,chanceTope:.2}},Wd=99,r_={heart:.06},s_=2,a_={crystal:1,crystal_med:3,crystal_big:5},Pa={big:.1,med:.3},Cc=1.7,Pc=7,o_=.45,Fe={radius:.95,hp:300,contactDamage:2,moveSpeed:1,idleTicks:45,jumpAimTicks:30,airborneTicks:20,slamRadius:1.7,slamDamage:2,tongueAimTicks:24,tongueSpeed:16,tongueDamage:2,tongueRadius:.32,tongueRange:11,summonTicks:20,summonCount:2,maxTadpoles:4,volleyAimTicks:26,volleyCount:7,volleySpreadRad:1.1,volleySpitSpeed:6.5,volleyDamage:1,bellyTicks:90,bellyDamageMult:1.5},l_=[8.5,4.4],c_={x:7.95,y:4.1,w:1.1,h:.8},Ic=[[6.5,6.4],[8.5,6.4],[10.5,6.4]],d_=1.2,u_=1.5,di={hp:20,radius:.42,maxPerRoom:2,chancePerRoom:.75,lootHeart:.25},Lc={comun:60,rara:30,legendaria:10},f_=.75,nn=1,h_=.55,wi=5,p_=[{id:"punos_de_piedra",nombre:"Puños de Piedra",categoria:"pasivo",slot:"brazos",rareza:"comun",precio:4,stats:{dano:4},mults:{cadencia:.8},tags:["empuje"],procs:[],spriteOverlay:"brazos_piedra",descripcion:"Golpea como montaña, dispara como abuela."},{id:"brazos_de_arquero",nombre:"Brazos de Arquero",categoria:"pasivo",slot:"brazos",rareza:"comun",precio:3,stats:{alcance:3,velProyectil:3},mults:{},tags:[],procs:[],spriteOverlay:"brazos_arquero",descripcion:"Brazos tensos como cuerdas: el chorro vuela lejos y rápido."},{id:"piernas_de_renacuajo",nombre:"Piernas de Renacuajo",categoria:"pasivo",slot:"piernas",rareza:"comun",precio:4,stats:{velMovimiento:1.2},mults:{},tags:["rastro_charcos"],procs:[],spriteOverlay:"piernas_renacuajo",descripcion:"Deja un caminito húmedo de pura prisa."},{id:"botas_de_salto",nombre:"Botas de Salto",categoria:"pasivo",slot:"piernas",rareza:"rara",precio:8,stats:{},mults:{},tags:["dash"],procs:[],spriteOverlay:"piernas_botas",descripcion:"Un brinquito con ventaja injusta (Shift)."},{id:"casco_de_lata",nombre:"Casco de Lata",categoria:"pasivo",slot:"cabeza",rareza:"comun",precio:3,stats:{armaduraPorSala:1},mults:{},tags:[],procs:[],spriteOverlay:"cabeza_casco",descripcion:"Una olla abollada que te para el primer golpe."},{id:"ojo_de_cristal",nombre:"Ojo de Cristal",categoria:"pasivo",slot:"cabeza",rareza:"rara",precio:8,stats:{},mults:{},tags:["ver_cofres"],procs:[{efecto:"critico",base:.1,porSuerte:.015,tope:.25}],spriteOverlay:"cabeza_monoculo",descripcion:"Ve el punto débil. A veces incluso lo acierta."},{id:"nucleo_denso",nombre:"Núcleo Denso",categoria:"pasivo",slot:"nucleo",rareza:"rara",precio:9,stats:{corazones:2,velMovimiento:-.8},mults:{},tags:[],procs:[],spriteOverlay:"nucleo_denso",descripcion:"Un núcleo el doble de pesado: aguanta más, corre menos."},{id:"corazon_de_la_gema",nombre:"Corazón de la Gema",categoria:"pasivo",slot:"nucleo",rareza:"legendaria",precio:15,stats:{proyectiles:1},mults:{dano:.75},tags:[],procs:[],spriteOverlay:"nucleo_gemelo",descripcion:"Dos gotas del mismo corazón."},{id:"chorro_dividido",nombre:"Chorro Dividido",categoria:"modificador",slot:"tragado",rareza:"comun",precio:3,stats:{},mults:{},tags:["divide"],procs:[{efecto:"dividir_en_3",base:.2,porSuerte:.03,tope:.5}],spriteOverlay:"tragado_bifurcador",descripcion:"El chorro se parte en dos al impactar. A veces en tres."},{id:"burbujas_traviesas",nombre:"Burbujas Traviesas",categoria:"modificador",slot:"tragado",rareza:"comun",precio:3,stats:{},mults:{dano:.7},tags:["burbuja"],procs:[{efecto:"burbuja_gigante",base:.05,porSuerte:.02,tope:.25}],spriteOverlay:"tragado_burbujas",descripcion:"Lentas, flotonas y con malas intenciones."},{id:"libro_multidisparo",nombre:"Libro de Multidisparo",categoria:"usable",slot:"usable",rareza:"rara",precio:7,stats:{},mults:{},tags:[],procs:[],usable:{efecto:"multidisparo",recargaTicks:1200,duracionTicks:300},spriteOverlay:"usable_libro",descripcion:"Capítulo 3: cómo disparar tres veces (Espacio)."},{id:"trebol_de_alcantarilla",nombre:"Trébol de Alcantarilla",categoria:"pasivo",slot:"nucleo",rareza:"comun",precio:3,stats:{suerte:2},mults:{},tags:[],procs:[],spriteOverlay:"nucleo_trebol",descripcion:"Creció donde nadie miraba. Da suerte igual."},{id:"manos_de_ladron",nombre:"Manos de Ladrón",categoria:"pasivo",slot:"brazos",rareza:"comun",precio:4,stats:{suerte:1},mults:{},tags:["iman_monedas"],procs:[],unlockable:!0,spriteOverlay:"brazos_ladron",descripcion:"Dedos largos: lo brillante viene solo a ti."},{id:"herradura_del_ahogado",nombre:"Herradura del Ahogado",categoria:"pasivo",slot:"cabeza",rareza:"rara",precio:8,stats:{suerte:3,corazones:-1},mults:{},tags:[],procs:[],unlockable:!0,spriteOverlay:"cabeza_herradura",descripcion:"Da mucha suerte. A su dueño anterior no."},{id:"punta_de_lanza",nombre:"Punta de Lanza",categoria:"pasivo",slot:"brazos",rareza:"comun",precio:4,stats:{dano:2,velProyectil:2},mults:{},tags:[],procs:[],spriteOverlay:"brazos_lanza",descripcion:"Afilada por generaciones de sapos descuidados."},{id:"pulmones_de_buzo",nombre:"Pulmones de Buzo",categoria:"pasivo",slot:"nucleo",rareza:"comun",precio:3,stats:{alcance:-1},mults:{cadencia:1.25},tags:[],procs:[],spriteOverlay:"nucleo_pulmones",descripcion:"Respira hondo, escupe seguido, apunta cerca."},{id:"caparazon_de_tortuga",nombre:"Caparazón de Tortuga",categoria:"pasivo",slot:"cabeza",rareza:"rara",precio:8,stats:{armaduraPorSala:2,velMovimiento:-.5},mults:{},tags:[],procs:[],spriteOverlay:"cabeza_caparazon",descripcion:"Su dueña llegó a los 200 años. Por algo será."},{id:"anillo_de_marea",nombre:"Anillo de Marea",categoria:"pasivo",slot:"nucleo",rareza:"rara",precio:8,stats:{suerte:1},mults:{},tags:[],procs:[{efecto:"critico",base:.05,porSuerte:.02,tope:.2}],spriteOverlay:"nucleo_anillo",descripcion:"Sube y baja con la marea. A veces, arrasa."},{id:"chorro_a_presion",nombre:"Chorro a Presión",categoria:"modificador",slot:"tragado",rareza:"rara",precio:9,stats:{},mults:{velProyectil:1.5,dano:1.2,cadencia:.85},tags:["empuje"],procs:[],spriteOverlay:"tragado_presion",descripcion:"Tragaste una manguera de bombero. Se nota."},{id:"medalla_oxidada",nombre:"Medalla Oxidada",categoria:"pasivo",slot:"nucleo",rareza:"comun",precio:3,stats:{corazones:1},mults:{},tags:[],procs:[],spriteOverlay:"nucleo_medalla",descripcion:"Alguien fue valiente antes que tú. Te presta un poco."},{id:"aletas_de_carpa",nombre:"Aletas de Carpa",categoria:"pasivo",slot:"piernas",rareza:"comun",precio:4,stats:{velMovimiento:.8,velProyectil:1},mults:{},tags:[],procs:[],spriteOverlay:"piernas_aletas",descripcion:"Nadan solas. Tú solo apunta."},{id:"silbato_del_pantano",nombre:"Silbato del Pantano",categoria:"usable",slot:"usable",rareza:"rara",precio:7,stats:{},mults:{},tags:[],procs:[],usable:{efecto:"prisa",recargaTicks:900,duracionTicks:300},spriteOverlay:"usable_silbato",descripcion:"Suena a huida digna. Corres el doble de digno."},{id:"corona_del_rey_sapo",nombre:"Corona del Rey Sapo",categoria:"pasivo",slot:"cabeza",rareza:"legendaria",precio:15,stats:{dano:3,velMovimiento:-.6},mults:{cadencia:1.15},tags:[],procs:[],unlockable:!0,spriteOverlay:"cabeza_corona",descripcion:"Pesa como un reino. Escupe como un rey."},{id:"perla_negra",nombre:"Perla Negra",categoria:"pasivo",slot:"nucleo",rareza:"rara",precio:9,stats:{suerte:2},mults:{},tags:[],procs:[{efecto:"critico",base:.08,porSuerte:.02,tope:.3}],unlockable:!0,spriteOverlay:"nucleo_perla",descripcion:"Creció alrededor de algo que nadie quiere nombrar."},{id:"escudo_de_caracol",nombre:"Escudo de Caracol",categoria:"usable",slot:"usable",rareza:"rara",precio:8,stats:{},mults:{},tags:[],procs:[],usable:{efecto:"escudo",recargaTicks:1200,duracionTicks:150},unlockable:!0,spriteOverlay:"usable_caracol",descripcion:"Préstamo de un caracol generoso. Devuélvelo entero."},{id:"guantes_de_rana",nombre:"Guantes de Rana",categoria:"pasivo",slot:"brazos",rareza:"comun",precio:4,stats:{},mults:{cadencia:1.2},tags:[],procs:[],unlockable:!0,spriteOverlay:"brazos_rana",descripcion:"Pegajosos por fuera, rapidísimos por dentro."}],m_={items:p_},g_=["dano","cadencia","alcance","velProyectil","velMovimiento","suerte","corazones","proyectiles","armaduraPorSala"];function __(n,e){const t=n,i=r=>{throw new Error(`items.json[${e}] (${String(t?.id??"?")}): ${r}`)};(typeof t.id!="string"||!t.id)&&i("id inválido"),(typeof t.nombre!="string"||!t.nombre)&&i("nombre inválido"),["pasivo","modificador","usable","gema"].includes(t.categoria)||i(`categoria inválida: ${String(t.categoria)}`),["comun","rara","legendaria"].includes(t.rareza)||i(`rareza inválida: ${String(t.rareza)}`),(typeof t.precio!="number"||t.precio<=0)&&i("precio inválido");for(const r of["stats","mults"]){const s=t[r];(typeof s!="object"||s===null)&&i(`${r} debe ser objeto`);for(const[a,o]of Object.entries(s))g_.includes(a)||i(`${r}.${a} no es un stat conocido`),(typeof o!="number"||!Number.isFinite(o))&&i(`${r}.${a} no numérico`),r==="mults"&&o<=0&&i(`mults.${a} debe ser > 0`)}(!Array.isArray(t.tags)||t.tags.some(r=>typeof r!="string"))&&i("tags debe ser string[]"),Array.isArray(t.procs)||i("procs debe ser array");for(const r of t.procs){typeof r.efecto!="string"&&i("proc sin efecto");for(const s of["base","porSuerte","tope"]){const a=r[s];(typeof a!="number"||a<0||a>1)&&i(`proc.${s} fuera de [0,1]`)}r.base>r.tope&&i("proc.base > proc.tope")}if(t.categoria==="usable"){const r=t.usable??{};typeof r.efecto!="string"&&i("usable sin efecto"),(typeof r.recargaTicks!="number"||r.recargaTicks<=0)&&i("usable.recargaTicks inválido"),(typeof r.duracionTicks!="number"||r.duracionTicks<0)&&i("usable.duracionTicks inválido")}return t}function x_(){const n=m_.items;if(!Array.isArray(n)||n.length===0)throw new Error("items.json: lista de items vacía");const e=new Map;return n.forEach((t,i)=>{const r=__(t,i);if(e.has(r.id))throw new Error(`items.json: id duplicado ${r.id}`);e.set(r.id,r)}),e}const Li=x_(),v_=[...Li.values()].filter(n=>!n.unlockable).map(n=>n.id);function an(n){const e=Li.get(n);if(!e)throw new Error(`Item desconocido: ${n}`);return e}function ur(n,e){return n.some(t=>an(t).tags.includes(e))}function M_(n){const e=[];for(const t of n)e.push(...an(t).procs);return e}const y_=[{id:"vacia",obstacles:[],spawns:[[4,2.5],[11,2.5],[4,6.5],[11,6.5],[7.5,2],[7.5,7]]},{id:"pilares_esquinas",obstacles:[{x:3,y:2,w:1,h:1},{x:11,y:2,w:1,h:1},{x:3,y:6,w:1,h:1},{x:11,y:6,w:1,h:1}],spawns:[[7.5,2],[7.5,7],[2,4.5],[13,4.5],[5.5,4.5],[9.5,4.5]]},{id:"bloque_central",obstacles:[{x:6,y:3.5,w:3,h:2}],spawns:[[3,2.5],[12,2.5],[3,6.5],[12,6.5]]},{id:"columnas_dobles",obstacles:[{x:4,y:3,w:1,h:3},{x:10,y:3,w:1,h:3}],spawns:[[2.5,2],[12.5,2],[2.5,7],[12.5,7],[7.5,4.5]]},{id:"esquinas_diagonales",obstacles:[{x:2.5,y:1.5,w:2,h:1.5},{x:10.5,y:6,w:2,h:1.5}],spawns:[[11.5,2],[3.5,7],[7.5,4.5],[13,4.5]]},{id:"pasillo_partido",obstacles:[{x:2.5,y:4,w:3,h:1},{x:9.5,y:4,w:3,h:1}],spawns:[[3.5,2],[11.5,2],[3.5,7],[11.5,7]]},{id:"celdas_sueltas",obstacles:[{x:4,y:2.5,w:1,h:1},{x:10,y:2.5,w:1,h:1},{x:4,y:5.5,w:1,h:1},{x:10,y:5.5,w:1,h:1}],spawns:[[7.5,2],[7.5,7],[2,4.5],[13,4.5]]},{id:"islas_gemelas",obstacles:[{x:2.5,y:2,w:2,h:2},{x:10.5,y:5,w:2,h:2}],spawns:[[12,2],[3,7],[7.5,4.5],[7.5,7]]},{id:"espina_central",obstacles:[{x:7,y:2.8,w:1,h:3.4}],spawns:[[3.5,2.5],[3.5,6.5],[11.5,2.5],[11.5,6.5]]},{id:"dientes",obstacles:[{x:3,y:3,w:1,h:1},{x:5.5,y:5,w:1,h:1},{x:9,y:2.8,w:1,h:1},{x:11.5,y:5,w:1,h:1}],spawns:[[2,6.5],[13,2],[7.5,7],[10.5,6.5]]},{id:"murallas_laterales",obstacles:[{x:3,y:2,w:1,h:2},{x:3,y:5.5,w:1,h:2},{x:11,y:2,w:1,h:2},{x:11,y:5.5,w:1,h:2}],spawns:[[7.5,2],[7.5,7],[1.8,4.5],[13.2,4.5],[7.5,4.5]]},{id:"anillo_roto",obstacles:[{x:5,y:2.8,w:2,h:1},{x:8.5,y:2.8,w:2,h:1},{x:5,y:5.2,w:2,h:1},{x:8.5,y:5.2,w:2,h:1}],spawns:[[7.5,4.5],[2.5,2],[12.5,2],[2.5,7],[12.5,7]]},{id:"cuello_botella",obstacles:[{x:4.5,y:1,w:1,h:2.2},{x:4.5,y:5.8,w:1,h:2.2},{x:9,y:3.2,w:1,h:2.6}],spawns:[[3,4.5],[12,2.5],[12,6.5],[11,4.5]]},{id:"escombros",obstacles:[{x:2.5,y:5.8,w:1.5,h:1},{x:5.5,y:2.8,w:1,h:1.5},{x:9.5,y:6,w:1.5,h:1},{x:11.5,y:2.2,w:1,h:1}],spawns:[[7.5,4.5],[3.5,2.5],[11.5,4.2],[4.5,6.8]]}],S_={templates:y_};function b_(n){let e=2166136261;for(let t=0;t<n.length;t++)e^=n.charCodeAt(t),e=Math.imul(e,16777619);return e>>>0}function Di(n){let e=n>>>0;return function(){e=e+1831565813|0;let t=Math.imul(e^e>>>15,1|e);return t=t+Math.imul(t^t>>>7,61|t)^t,((t^t>>>14)>>>0)/4294967296}}function E_(n){const e=t=>Di((n^b_(t))>>>0);return{mapgen:e("mapgen"),ai:e("ai"),drops:e("drops"),procs:e("procs")}}function _r(n,e,t){return e+n()*(t-e)}function T_(){const n=S_.templates;if(!Array.isArray(n)||n.length<12)throw new Error("el_pozo.json: se esperan al menos 12 plantillas (PLAN F1.2)");for(const e of n)if(!e.id||!Array.isArray(e.obstacles)||!Array.isArray(e.spawns))throw new Error(`plantilla malformada: ${e.id??"?"}`);return n}const No=T_();function Xs(n){const e=No.find(t=>t.id===n);if(!e)throw new Error(`plantilla desconocida: ${n}`);return e}const yi=11,Lr=[{dx:0,dy:-1,door:"n",opp:"s"},{dx:1,dy:0,door:"e",opp:"w"},{dx:0,dy:1,door:"s",opp:"n"},{dx:-1,dy:0,door:"w",opp:"e"}];function tr(n,e){return e*yi+n}function w_(n){return 4+n}function Fo(n,e){const t=new Map,i=[],r=(d,h,x)=>{const b={id:i.length,gx:d,gy:h,kind:x,doors:{n:-1,e:-1,s:-1,w:-1},templateId:"vacia",seed:Math.floor(n()*4294967295)>>>0,cleared:x==="start"||x==="treasure"||x==="shop",visited:x==="start",looted:!1,locked:x==="treasure",sold:[],drops:[],props:null};return i.push(b),t.set(tr(d,h),b),b},s=r(Math.floor(yi/2),Math.floor(yi/2),"start"),a=w_(e);let o=0,l=0;for(;o<a&&l++<500;){const d=i[Math.floor(n()*i.length)],h=Lr[Math.floor(n()*4)],x=d.gx+h.dx,b=d.gy+h.dy;if(x<0||b<0||x>=yi||b>=yi||t.has(tr(x,b)))continue;let m=0;for(const p of Lr)t.has(tr(x+p.dx,b+p.dy))&&m++;m>1||(r(x,b,"normal"),o++)}const c=["boss","treasure","shop"];for(const d of c){const h=[];for(const b of i)if(!(b.kind!=="normal"&&b.kind!=="start"))for(const m of Lr){const p=b.gx+m.dx,S=b.gy+m.dy;if(p<0||S<0||p>=yi||S>=yi||t.has(tr(p,S)))continue;let P=0;for(const v of Lr)t.has(tr(p+v.dx,S+v.dy))&&P++;P===1&&h.push({gx:p,gy:S,host:b})}if(h.length===0)throw new Error(`mapgen: sin hueco para la sala ${d} (nivel ${e})`);let x;if(d==="boss"){let b=-1,m=h[0];for(const p of h){const S=Math.abs(p.gx-s.gx)+Math.abs(p.gy-s.gy);S>b&&(b=S,m=p)}x=m}else x=h[Math.floor(n()*h.length)];r(x.gx,x.gy,d)}for(const d of i)for(const h of Lr){const x=t.get(tr(d.gx+h.dx,d.gy+h.dy));x&&(d.doors[h.door]=x.id)}for(const d of i)d.kind==="normal"&&(d.templateId=No[Math.floor(n()*No.length)].id);const u=i.filter(d=>d.kind==="normal"),f=u[Math.floor(n()*u.length)].id;return{level:e,rooms:i,current:s.id,trapdoorOpen:!1,keyRoomId:f}}function A_(n,e=v_){const t=Di(n.seed^24301),i=[...e],r=[];for(let s=0;s<3&&i.length;s++)r.push(i.splice(Math.floor(t()*i.length),1)[0]);return r}function R_(n,e){return e==="boss"?(n+Rc)*e_:e==="normal"?n+Rc:0}function C_(n,e,t){const i=n();if(t==="sapo_doble"||t==="gorko")return null;let r=0;for(const s of Object.keys(Uo)){const a=Uo[s];if(r+=Math.min(a.chanceTope,a.chanceBase+a.chancePorNivel*(e-1)),i<r)return s}return null}function P_(n,e){if(n.kind==="boss"&&e===wi)return[{kind:"gorko",x:it/2,y:Qe/2-1.5,variant:null}];const t=R_(e,n.kind);if(t<=0)return[];const i=Di(n.seed),s=Xs(n.templateId).spawns.map(([d,h])=>({x:d,y:h}));for(let d=s.length-1;d>0;d--){const h=Math.floor(i()*(d+1));[s[d],s[h]]=[s[h],s[d]]}const a=Object.entries(t_),o=Math.min(...a.map(([,d])=>d)),l=[];let c=t,u=0,f=0;for(;c>=o&&u<24;){const d=a.filter(([p,S])=>S<=c&&(p!=="sapo_doble"||f<i_));if(d.length===0)break;const[h,x]=d[Math.floor(i()*d.length)];h==="sapo_doble"&&f++;const b=s[u%s.length],m=u>=s.length?.6:0;l.push({kind:h,x:b.x+(i()*2-1)*m,y:b.y+(i()*2-1)*m,variant:C_(i,e,h)}),c-=x,u++}return l}function I_(n){const e={},t={};for(const i of n){const r=an(i);for(const[s,a]of Object.entries(r.stats))e[s]=(e[s]??0)+a;for(const[s,a]of Object.entries(r.mults))t[s]=(t[s]??1)*a}return{flat:e,mult:t}}function Xd(n,e){return Math.min(e.max,Math.max(e.min,n))}function nr(n,e,t,i){return Xd((n+(t.flat[e]??0))*(t.mult[e]??1),i)}function Wr(n){const e=I_(n);return{maxHalfHearts:Xd(vt.maxHalfHearts+(e.flat.corazones??0)*2,vi.halfHearts),damage:nr(vt.damage,"dano",e,vi.damage),fireRate:nr(vt.fireRate,"cadencia",e,vi.fireRate),range:nr(vt.range,"alcance",e,vi.range),shotSpeed:nr(vt.shotSpeed,"velProyectil",e,vi.shotSpeed),moveSpeed:nr(vt.moveSpeed,"velMovimiento",e,vi.moveSpeed),luck:nr(vt.luck,"suerte",e,vi.luck),projectiles:1+(e.flat.proyectiles??0),armorPerRoom:e.flat.armaduraPorSala??0}}function qd(n,e){return Math.min(n.tope,n.base+e*n.porSuerte)}function Yd(){return{up:!1,down:!1,left:!1,right:!1,fire:!1,dash:!1,use:!1,use2:!1,interact:!1,aimX:0,aimY:0}}function Oo(n){return[...Li.values()].filter(e=>!e.unlockable||n.config.unlockedItems.includes(e.id)).map(e=>e.id)}const Is="0.1.0",gn=1,_n=1,xn=it-1,vn=Qe-1;function Dc(n,e){const t=E_(n),i={usableSlots:e?.usableSlots??1,unlockedItems:e?.unlockedItems??[],resume:e?.resume??null},r={version:Is,seed:n,tick:0,status:"playing",config:i,player:{x:3.5,y:Qe/2,kx:0,ky:0,halfHearts:vt.maxHalfHearts,maxHalfHearts:vt.maxHalfHearts,armor:0,keys:0,crystals:0,iframes:0,fireCooldown:0,aimX:1,aimY:0,deathTick:0,items:[],usable:null,usable2:null,dashTicks:0,dashCooldown:0,dashDirX:1,dashDirY:0},stats:Wr([]),floor:Fo(t.mapgen,1),obstacles:[],enemies:[],shots:[],puddles:[],pickups:[],drops:[],chest:null,props:[],events:[],nextId:2},s=i.resume;if(s&&s.nivel>1){const a=Math.min(s.nivel,wi);for(let l=2;l<=a;l++)r.floor=Fo(t.mapgen,l);const o=r.player;o.items=[...s.items],r.stats=Wr(o.items),o.maxHalfHearts=r.stats.maxHalfHearts,o.halfHearts=Math.max(1,Math.min(s.halfHearts,o.maxHalfHearts)),o.crystals=Math.min(Wd,Math.max(0,s.crystals)),o.keys=Math.max(0,s.keys);for(const[l,c]of[["usable",s.usable],["usable2",s.usable2]])c&&Li.has(c)&&(o[l]={itemId:c,cooldown:0,activeTicks:0})}return r.obstacles=[...Xs(r.floor.rooms[r.floor.current].templateId).obstacles],{state:r,step(a){k_(r,a??Yd(),t)},hash(){return nx(r)}}}const L_={sapo_escupidor:Vt.hp,renacuajo:Xt.hp,mosca_gorda:oi.hp,babosa_acorazada:ci.hp,sapo_doble:ft.hp,gorko:Fe.hp};function Pi(n){return D_(n.kind)*n.sizeMult}function D_(n){switch(n){case"sapo_escupidor":return Vt.radius;case"renacuajo":return Xt.radius;case"mosca_gorda":return oi.radius;case"babosa_acorazada":return ci.radius;case"sapo_doble":return ft.radius;case"gorko":return Fe.radius}}function U_(n){switch(n){case"sapo_escupidor":return Vt.contactDamage;case"renacuajo":return Xt.contactDamage;case"mosca_gorda":return oi.contactDamage;case"babosa_acorazada":return ci.contactDamage;case"sapo_doble":return ft.contactDamage;case"gorko":return Fe.contactDamage}}function $d(n,e,t,i,r=1,s=null){const a=it/2-t,o=Qe/2-i,l=Math.hypot(a,o)||1,c=s?Uo[s]:null,u=e==="gorko"?1:r,f=(1+Ca.hpPorNivel*(u-1))*(c?.hpMult??1),d=Math.round(L_[e]*f);return{id:n,kind:e,x:t,y:i,kx:0,ky:0,hp:d,maxHp:d,fsm:"idle",timer:0,targetX:t,targetY:i,wanderX:t,wanderY:i,facingX:a/l,facingY:o/l,swallowTarget:-1,swallowCooldown:0,attackCycle:0,phase2:!1,speedMult:(1+Ca.velPorNivel*(u-1))*(c?.velMult??1),sizeMult:c?.sizeMult??1,dmgPlus:(u>=Ca.danoExtraDesdeNivel?1:0)+(c?.danoPlus??0),variant:s}}const vs=.8;function al(n,e,t){const i=n.floor.current,r=n.floor.rooms[e];i!==e&&(n.floor.rooms[i].drops=n.drops.map(a=>({kind:a.kind,x:a.x,y:a.y})),n.floor.rooms[i].props=n.props.map(a=>({kind:a.kind,x:a.x,y:a.y,hp:a.hp,loot:a.loot}))),n.floor.current=e,n.obstacles=[...Xs(r.templateId).obstacles],n.shots.length=0,n.puddles.length=0,n.pickups.length=0,n.drops.length=0;for(const a of r.drops)n.drops.push({id:n.nextId++,kind:a.kind,x:a.x,y:a.y});r.drops=[],r.props===null&&(r.props=N_(r)),n.props=r.props.map(a=>({id:n.nextId++,...a}));const s=n.player;if(t==="n"?(s.x=it/2,s.y=Qe-1-vs):t==="s"?(s.x=it/2,s.y=1+vs):t==="e"?(s.x=1+vs,s.y=Qe/2):t==="w"?(s.x=it-1-vs,s.y=Qe/2):(s.x=it/2,s.y=Qe/2+1.5),s.kx=s.ky=0,n.enemies.length=0,r.visited=!0,!r.cleared)for(const a of P_(r,n.floor.level))n.enemies.push($d(n.nextId++,a.kind,a.x,a.y,n.floor.level,a.variant));if(r.kind==="treasure"&&!r.looted){const a=Di(r.seed),o=Oo(n),l=o[Math.floor(a()*o.length)];n.pickups.push({id:n.nextId++,itemId:l,x:it/2,y:Qe/2})}r.kind==="shop"&&(A_(r,Oo(n)).filter(o=>!r.sold.includes(o)).forEach((o,l)=>{const[c,u]=Ic[l%Ic.length];n.pickups.push({id:n.nextId++,itemId:o,x:c,y:u,price:an(o).precio})}),n.obstacles.push({...c_,invisible:!0})),t&&Ze(n,{type:"room_changed",from:i,to:e,dir:t,tick:n.tick})}function N_(n){if(n.kind!=="normal")return[];const e=Di(n.seed^805502);if(e()>di.chancePerRoom)return[];const t=Xs(n.templateId),i=1+Math.floor(e()*di.maxPerRoom),r=[];for(let s=0;s<i;s++)for(let a=0;a<10;a++){const o=2+e()*(it-4),l=2+e()*(Qe-4),c=Math.abs(o-it/2)<nn+.8||Math.abs(l-Qe/2)<nn+.8,u=t.obstacles.some(d=>o>d.x-.5&&o<d.x+d.w+.5&&l>d.y-.5&&l<d.y+d.h+.5),f=r.some(d=>Mt(d.x,d.y,o,l)<1.2);if(!(c||u||f)){r.push({kind:"crate",x:o,y:l,hp:di.hp,loot:e()<di.lootHeart?"heart":"nada"});break}}return r}function F_(n,e){if(n.floor.level>=wi){n.status="victory",Ze(n,{type:"victory",tick:n.tick});return}n.floor=Fo(e.mapgen,n.floor.level+1),al(n,n.floor.current),Ze(n,{type:"level_started",level:n.floor.level,tick:n.tick})}function ol(n,e,t,i){for(const r of i){const s=It(n,r.x,r.x+r.w),a=It(e,r.y,r.y+r.h),o=n-s,l=e-a,c=o*o+l*l;if(!(c>=t*t))if(c>1e-9){const u=Math.sqrt(c);n=s+o/u*t,e=a+l/u*t}else{const u=n-r.x,f=r.x+r.w-n,d=e-r.y,h=r.y+r.h-e,x=Math.min(u,f,d,h);x===u?n=r.x-t:x===f?n=r.x+r.w+t:x===d?e=r.y-t:e=r.y+r.h+t}}return{x:n,y:e}}function O_(n,e,t){for(const i of t)if(n>=i.x&&n<=i.x+i.w&&e>=i.y&&e<=i.y+i.h)return!0;return!1}function k_(n,e,t){if(n.events=[],n.tick++,n.status!=="playing"){Nc(n),Fc(n);return}B_(n,e,t),G_(n,t),Nc(n),Fc(n),J_(n,t),ex(n)}function B_(n,e,t){const i=n.player,r=(M,w)=>{if(M&&(M.cooldown>0&&M.cooldown--,M.activeTicks>0&&M.activeTicks--,w&&M.cooldown===0)){const E=an(M.itemId);M.activeTicks=E.usable.duracionTicks,M.cooldown=E.usable.recargaTicks,Ze(n,{type:"usable_activated",itemId:M.itemId,tick:n.tick})}};r(i.usable,e.use),r(i.usable2,e.use2),i.dashCooldown>0&&i.dashCooldown--;let s=(e.right?1:0)-(e.left?1:0),a=(e.down?1:0)-(e.up?1:0);if(s!==0&&a!==0){const M=1/Math.SQRT2;s*=M,a*=M}if(e.dash&&i.dashTicks===0&&i.dashCooldown===0&&ur(i.items,"dash")){const M=s!==0||a!==0?s:i.aimX,w=s!==0||a!==0?a:i.aimY,E=Math.hypot(M,w)||1;i.dashDirX=M/E,i.dashDirY=w/E,i.dashTicks=Ir.ticks,i.dashCooldown=Ir.cooldownTicks,i.iframes=Math.max(i.iframes,Ir.iframeTicks),Ze(n,{type:"dash_used",tick:n.tick})}const o=i.x,l=i.y;if(i.dashTicks>0)i.dashTicks--,i.x+=(i.dashDirX*Ir.speed+i.kx)*xt,i.y+=(i.dashDirY*Ir.speed+i.ky)*xt;else{const M=n.stats.moveSpeed*(Kd(n,"prisa")?u_:1);i.x+=(s*M+i.kx)*xt,i.y+=(a*M+i.ky)*xt}i.kx*=Bs,i.ky*=Bs,Math.abs(i.kx)<.05&&(i.kx=0),Math.abs(i.ky)<.05&&(i.ky=0);const c=n.floor.rooms[n.floor.current],u=c.cleared,f=M=>!u||M<0?!1:!n.floor.rooms[M].locked||i.keys>0,d=Math.abs(i.x-it/2)<nn,h=Math.abs(i.y-Qe/2)<nn,x=vt.radius,b=f(c.doors.n)&&d?_n-.5:_n+x,m=f(c.doors.s)&&d?vn+.5:vn-x,p=f(c.doors.w)&&h?gn-.5:gn+x,S=f(c.doors.e)&&h?xn+.5:xn-x;i.x=It(i.x,p,S),i.y=It(i.y,b,m);const P=ol(i.x,i.y,x,n.obstacles);i.x=P.x,i.y=P.y;for(const M of n.props){const w=Mt(i.x,i.y,M.x,M.y),E=x+di.radius;w<E&&w>1e-4&&(i.x=M.x+(i.x-M.x)/w*E,i.y=M.y+(i.y-M.y)/w*E)}const v=(M,w)=>{const E=n.floor.rooms[M];E.locked&&(E.locked=!1,i.keys--,Ze(n,{type:"door_unlocked",roomId:M,tick:n.tick})),al(n,M,w)};if(i.y<_n-.25&&c.doors.n>=0){v(c.doors.n,"n");return}if(i.y>vn+.25&&c.doors.s>=0){v(c.doors.s,"s");return}if(i.x<gn-.25&&c.doors.w>=0){v(c.doors.w,"w");return}if(i.x>xn+.25&&c.doors.e>=0){v(c.doors.e,"e");return}if(n.floor.trapdoorOpen&&c.kind==="boss"&&Mt(i.x,i.y,it/2,Qe/2)<h_){F_(n,t);return}(i.x!==o||i.y!==l)&&n.tick%Q0===0&&ur(i.items,"rastro_charcos")&&n.puddles.push({x:i.x,y:i.y+vt.radius*.6,ttl:j0});const C=e.aimX-i.x,A=e.aimY-i.y,L=Math.hypot(C,A);L>.001&&(i.aimX=C/L,i.aimY=A/L),i.fireCooldown>0&&i.fireCooldown--,e.fire&&i.fireCooldown===0&&(z_(n,t),i.fireCooldown=Math.round(Ci/n.stats.fireRate),Ze(n,{type:"shot_fired",owner:"player",tick:n.tick}));for(let M=n.pickups.length-1;M>=0;M--){const w=n.pickups[M],E=Mt(i.x,i.y,w.x,w.y);if(!w.price&&E<vt.radius+.35)Uc(n,M);else if(w.price&&e.interact&&E<d_&&i.crystals>=w.price){const D=w.price,z=w.itemId;i.crystals-=D,n.floor.rooms[n.floor.current].sold.push(z),w.price=0,Uc(n,M),Ze(n,{type:"item_bought",itemId:z,price:D,crystalsLeft:i.crystals,tick:n.tick})}}const _=ur(i.items,"iman_monedas")?Cc*2.2:Cc;for(let M=n.drops.length-1;M>=0;M--){const w=n.drops[M];if(w.kind==="heart"&&i.halfHearts>=i.maxHalfHearts)continue;const E=Mt(i.x,i.y,w.x,w.y);if(E<_&&E>1e-6&&(w.x+=(i.x-w.x)/E*Pc*xt,w.y+=(i.y-w.y)/E*Pc*xt),!(E>=o_)){switch(w.kind){case"heart":i.halfHearts=Math.min(i.maxHalfHearts,i.halfHearts+s_),Ze(n,{type:"heart_collected",halfHeartsLeft:i.halfHearts,tick:n.tick});break;case"key":i.keys++,Ze(n,{type:"key_collected",keys:i.keys,tick:n.tick});break;case"crystal":case"crystal_med":case"crystal_big":{const D=a_[w.kind];i.crystals=Math.min(Wd,i.crystals+D),Ze(n,{type:"crystal_collected",value:D,total:i.crystals,tick:n.tick});break}}n.drops.splice(M,1)}}n.chest&&!n.chest.opened&&n.chest.roomId===n.floor.current&&Mt(i.x,i.y,n.chest.x,n.chest.y)<vt.radius+f_&&(n.chest.opened=!0,n.chest.reward==="cristales"&&n.drops.push({id:n.nextId++,kind:"crystal_big",x:n.chest.x,y:n.chest.y+.7}),Ze(n,{type:"chest_opened",reward:n.chest.reward,tick:n.tick})),H_(n)}function z_(n,e){const t=n.player,i=ur(t.items,"burbuja"),r=[];ur(t.items,"divide")&&r.push("divide"),i&&r.push("burbuja");let s=n.stats.projectiles;for(const c of[t.usable,t.usable2])c&&c.activeTicks>0&&an(c.itemId).usable.efecto==="multidisparo"&&(s+=2);const a=n.stats.shotSpeed*(i?ar.speedMult:1),o=K0+(ur(t.items,"empuje")?Z0:0),l=Math.atan2(t.aimY,t.aimX);for(let c=0;c<s;c++){const u=l+(c-(s-1)/2)*J0,f=Math.cos(u),d=Math.sin(u);let h=dr*(i?ar.radiusMult:1),x=n.stats.damage;i&&ll(n,e,"burbuja_gigante")&&(h=dr*ar.giantRadiusMult,x*=ar.giantDamageMult),n.shots.push({id:n.nextId++,owner:"player",x:t.x+f*(vt.radius+h),y:t.y+d*(vt.radius+h),vx:f*a,vy:d*a,damage:x,traveled:0,maxRange:n.stats.range,radius:h,knockback:o,tags:r,fragment:!1})}}function ll(n,e,t){const i=M_(n.player.items).find(a=>a.efecto===t);if(!i)return!1;const r=qd(i,n.stats.luck),s=e.procs()<r;return s&&Ze(n,{type:"proc_triggered",efecto:t,tick:n.tick}),s}function Uc(n,e){const t=n.player,i=n.pickups[e],r=an(i.itemId);if(r.categoria==="usable")if(!t.usable)t.usable={itemId:i.itemId,cooldown:0,activeTicks:0},n.pickups.splice(e,1);else if(n.config.usableSlots>=2&&!t.usable2)t.usable2={itemId:i.itemId,cooldown:0,activeTicks:0},n.pickups.splice(e,1);else{const s=t.usable;t.usable={itemId:i.itemId,cooldown:0,activeTicks:0},i.itemId=s.itemId}else{t.items.push(i.itemId),n.pickups.splice(e,1);const s=n.floor.rooms[n.floor.current];s.kind==="treasure"&&(s.looted=!0);const a=n.stats;n.stats=Wr(t.items);const o=n.stats.maxHalfHearts-a.maxHalfHearts;t.maxHalfHearts=n.stats.maxHalfHearts,o>0&&(t.halfHearts+=o),t.halfHearts=Math.min(t.halfHearts,t.maxHalfHearts);const l=n.stats.armorPerRoom-a.armorPerRoom;l>0&&(t.armor=Math.min($0,t.armor+l*2))}Ze(n,{type:"item_picked",itemId:r.id,tick:n.tick})}function H_(n){const e=n.player;if(e.iframes>0&&(e.iframes--,e.iframes===0)){let t=!1;for(const i of n.enemies){const r=Mt(e.x,e.y,i.x,i.y),s=vt.radius+Pi(i);if(r<s){const a=r>.001?(e.x-i.x)/r:1,o=r>.001?(e.y-i.y)/r:0;e.x=It(i.x+a*(s+.05),gn+vt.radius,xn-vt.radius),e.y=It(i.y+o*(s+.05),_n+vt.radius,vn-vt.radius),t=!0}}Ze(n,{type:"iframes_ended",separated:t,tick:n.tick})}}function G_(n,e){const t=[];for(const i of n.enemies){switch(i.x+=i.kx*xt,i.y+=i.ky*xt,i.kx*=Bs,i.ky*=Bs,i.kind){case"sapo_escupidor":V_(n,i,e);break;case"renacuajo":W_(n,i);break;case"mosca_gorda":X_(n,i,e);break;case"babosa_acorazada":q_(n,i);break;case"sapo_doble":Y_(n,i,t);break;case"gorko":$_(n,i,e,t);break}const r=Pi(i);if(i.x=It(i.x,gn+r,xn-r),i.y=It(i.y,_n+r,vn-r),i.kind!=="mosca_gorda"){const s=ol(i.x,i.y,r,n.obstacles);i.x=s.x,i.y=s.y;for(const a of n.props){const o=Mt(i.x,i.y,a.x,a.y),l=r+di.radius;o<l&&o>1e-4&&(i.x=a.x+(i.x-a.x)/o*l,i.y=a.y+(i.y-a.y)/o*l)}}}Z_(n),t.length&&(n.enemies=n.enemies.filter(i=>!t.includes(i.id)))}function V_(n,e,t){const i=n.player,r=Mt(e.x,e.y,i.x,i.y);switch(e.fsm){case"idle":{if(e.timer>0&&e.timer--,r<=Vt.attackRange&&e.timer===0){e.fsm="aim",e.timer=Vt.telegraphTicks,e.targetX=i.x,e.targetY=i.y,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}n.tick%45===0&&(r<=Vt.aggroRange?(e.wanderX=i.x,e.wanderY=i.y):(e.wanderX=It(e.x+_r(t.ai,-2,2),gn+1,xn-1),e.wanderY=It(e.y+_r(t.ai,-2,2),_n+1,vn-1)));const s=Mt(e.x,e.y,e.wanderX,e.wanderY);s>.2&&(e.x+=(e.wanderX-e.x)/s*Vt.moveSpeed*e.speedMult*xt,e.y+=(e.wanderY-e.y)/s*Vt.moveSpeed*e.speedMult*xt);break}case"aim":{e.timer--,e.timer<=0&&(e.fsm="shoot");break}case"shoot":{zs(n,e,e.targetX,e.targetY,0,Vt.spitSpeed,Vt.spitDamage),Ze(n,{type:"shot_fired",owner:"enemy",tick:n.tick}),e.fsm="cool",e.timer=Vt.cooldownTicks;break}case"cool":{e.timer--,e.timer<=0&&(e.fsm="idle",e.timer=12);break}default:e.fsm="idle"}}function W_(n,e){const t=n.player;switch(e.fsm){case"idle":{if(e.timer>0&&e.timer--,e.timer===0&&Mt(e.x,e.y,t.x,t.y)<=Xt.aggroRange){e.fsm="windup",e.timer=Xt.windupTicks;const i=t.x-e.x,r=t.y-e.y,s=Math.hypot(i,r)||1;e.facingX=i/s,e.facingY=r/s,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick})}break}case"windup":{e.timer--,e.timer<=0&&(e.fsm="hop",e.timer=Xt.hopTicks);break}case"hop":{e.x+=e.facingX*Xt.hopSpeed*e.speedMult*xt,e.y+=e.facingY*Xt.hopSpeed*e.speedMult*xt,e.timer--,e.timer<=0&&(e.fsm="idle",e.timer=Xt.pauseTicks);break}default:e.fsm="idle",e.timer=Xt.pauseTicks}}function X_(n,e,t){const i=n.player;n.tick%oi.retargetTicks===0&&(e.wanderX=It(i.x+_r(t.ai,-2.2,oi.wobble),gn+.5,xn-.5),e.wanderY=It(i.y+_r(t.ai,-2.2,oi.wobble),_n+.5,vn-.5));const r=e.wanderX-e.x,s=e.wanderY-e.y,a=Math.hypot(r,s);a>.15&&(e.x+=r/a*oi.speed*e.speedMult*xt,e.y+=s/a*oi.speed*e.speedMult*xt,e.facingX=r/a,e.facingY=s/a)}function q_(n,e){const t=n.player,i=Math.atan2(t.y-e.y,t.x-e.x),r=Math.atan2(e.facingY,e.facingX);let s=i-r;for(;s>Math.PI;)s-=2*Math.PI;for(;s<-Math.PI;)s+=2*Math.PI;const a=It(s,-.02,ci.turnRadPerTick),o=r+a;e.facingX=Math.cos(o),e.facingY=Math.sin(o),Mt(e.x,e.y,t.x,t.y)<=ci.aggroRange&&(e.x+=e.facingX*ci.speed*e.speedMult*xt,e.y+=e.facingY*ci.speed*e.speedMult*xt)}function Y_(n,e,t){const i=n.player,r=Mt(e.x,e.y,i.x,i.y);switch(e.swallowCooldown>0&&e.swallowCooldown--,e.fsm){case"idle":{e.timer>0&&e.timer--;const s=K_(n,e);if(e.hp<e.maxHp&&e.swallowCooldown===0&&s){const a=Mt(e.x,e.y,s.x,s.y);if(a<=ft.swallowRange){e.fsm="swallow_aim",e.timer=ft.swallowTelegraphTicks,e.swallowTarget=s.id,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}const o=a||1;e.x+=(s.x-e.x)/o*ft.moveSpeed*e.speedMult*xt,e.y+=(s.y-e.y)/o*ft.moveSpeed*e.speedMult*xt;break}if(r<=ft.attackRange&&e.timer===0){e.fsm="aim",e.timer=ft.telegraphTicks,e.targetX=i.x,e.targetY=i.y,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}r<=ft.aggroRange&&r>2&&(e.x+=(i.x-e.x)/r*ft.moveSpeed*e.speedMult*xt,e.y+=(i.y-e.y)/r*ft.moveSpeed*e.speedMult*xt);break}case"aim":{e.timer--,e.timer<=0&&(e.fsm="shoot");break}case"shoot":{zs(n,e,e.targetX,e.targetY,-.16,ft.spitSpeed,ft.spitDamage),zs(n,e,e.targetX,e.targetY,ft.spitSpreadRad,ft.spitSpeed,ft.spitDamage),Ze(n,{type:"shot_fired",owner:"enemy",tick:n.tick}),e.fsm="cool",e.timer=ft.cooldownTicks;break}case"swallow_aim":{if(e.timer--,e.timer<=0){const s=n.enemies.find(a=>a.id===e.swallowTarget);if(s&&Mt(e.x,e.y,s.x,s.y)<=ft.swallowRange*1.3){t.push(s.id);const a=Math.min(ft.healPerSwallow,e.maxHp-e.hp);e.hp+=a,Ze(n,{type:"elite_swallowed",enemyId:e.id,victimId:s.id,healed:a,tick:n.tick})}e.swallowTarget=-1,e.swallowCooldown=ft.swallowCooldownTicks,e.fsm="cool",e.timer=24}break}case"cool":{e.timer--,e.timer<=0&&(e.fsm="idle",e.timer=10);break}default:e.fsm="idle"}}function $_(n,e,t,i){const r=n.player;if(!e.phase2&&e.hp<=e.maxHp/2){e.phase2=!0,e.fsm="cool",e.timer=30,Ze(n,{type:"gorko_phase2",hp:e.hp,tick:n.tick});return}switch(e.fsm){case"idle":{if(e.timer>0){e.timer--;const o=Mt(e.x,e.y,r.x,r.y);o>2.5&&(e.x+=(r.x-e.x)/o*Fe.moveSpeed*xt,e.y+=(r.y-e.y)/o*Fe.moveSpeed*xt);break}const s=e.attackCycle++;if(e.phase2){const o=n.enemies.find(l=>l.kind==="renacuajo");if(s%2===0&&o){i.push(o.id),Ze(n,{type:"elite_swallowed",enemyId:e.id,victimId:o.id,healed:0,tick:n.tick}),e.fsm="volley",e.timer=Fe.volleyAimTicks,e.targetX=r.x,e.targetY=r.y,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}if(s%2===0){e.fsm="summon",e.timer=Fe.summonTicks,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}e.fsm="jump_aim",e.timer=Fe.jumpAimTicks,e.targetX=r.x,e.targetY=r.y,Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}const a=s%3;a===0?(e.fsm="jump_aim",e.timer=Fe.jumpAimTicks,e.targetX=r.x,e.targetY=r.y):a===1?(e.fsm="aim",e.timer=Fe.tongueAimTicks,e.targetX=r.x,e.targetY=r.y):(e.fsm="summon",e.timer=Fe.summonTicks),Ze(n,{type:"telegraph_started",enemyId:e.id,tick:n.tick});break}case"jump_aim":{e.timer--,e.timer<=0&&(e.fsm="airborne",e.timer=Fe.airborneTicks);break}case"airborne":{if(e.timer--,e.timer<=0){e.x=It(e.targetX,gn+Fe.radius,xn-Fe.radius),e.y=It(e.targetY,_n+Fe.radius,vn-Fe.radius);const s=ol(e.x,e.y,Fe.radius,n.obstacles);e.x=s.x,e.y=s.y,n.player.iframes===0&&Mt(r.x,r.y,e.x,e.y)<Fe.slamRadius+vt.radius&&ko(n,Fe.slamDamage,e.x,e.y,"aplastamiento:gorko"),e.fsm="cool",e.timer=Fe.idleTicks}break}case"aim":{e.timer--,e.timer<=0&&(e.fsm="shoot");break}case"shoot":{const s=Math.atan2(e.targetY-e.y,e.targetX-e.x);n.shots.push({id:n.nextId++,owner:"enemy",x:e.x+Math.cos(s)*(Fe.radius+Fe.tongueRadius),y:e.y+Math.sin(s)*(Fe.radius+Fe.tongueRadius),vx:Math.cos(s)*Fe.tongueSpeed,vy:Math.sin(s)*Fe.tongueSpeed,damage:Fe.tongueDamage,traveled:0,maxRange:Fe.tongueRange,radius:Fe.tongueRadius,knockback:0,tags:["lengua"],fragment:!1}),Ze(n,{type:"shot_fired",owner:"enemy",tick:n.tick}),e.fsm="cool",e.timer=Fe.idleTicks;break}case"summon":{if(e.timer--,e.timer<=0){const s=n.enemies.filter(o=>o.kind==="renacuajo").length,a=Math.min(Fe.summonCount,Fe.maxTadpoles-s);for(let o=0;o<a;o++){const l=It(e.x+_r(t.ai,-2,2),gn+1,xn-1),c=It(e.y+_r(t.ai,-2,2),_n+1,vn-1);n.enemies.push($d(n.nextId++,"renacuajo",l,c))}e.fsm="cool",e.timer=Fe.idleTicks}break}case"volley":{if(e.timer--,e.timer<=0){const s=Math.atan2(e.targetY-e.y,e.targetX-e.x);for(let a=0;a<Fe.volleyCount;a++){const o=(a-(Fe.volleyCount-1)/2)*(Fe.volleySpreadRad/(Fe.volleyCount-1));zs(n,e,e.x+Math.cos(s+o),e.y+Math.sin(s+o),0,Fe.volleySpitSpeed,Fe.volleyDamage)}Ze(n,{type:"shot_fired",owner:"enemy",tick:n.tick}),e.fsm="belly",e.timer=Fe.bellyTicks}break}case"belly":{e.timer--,e.timer<=0&&(e.fsm="idle",e.timer=Fe.idleTicks);break}case"cool":{e.timer--,e.timer<=0&&(e.fsm="idle",e.timer=Fe.idleTicks);break}default:e.fsm="idle",e.timer=Fe.idleTicks}}function K_(n,e){let t=null,i=ft.swallowSeekRange;for(const r of n.enemies){if(r.id===e.id||r.kind==="sapo_doble")continue;const s=Mt(e.x,e.y,r.x,r.y);s<i&&(i=s,t=r)}return t}function zs(n,e,t,i,r,s,a){const o=Math.atan2(i-e.y,t-e.x)+r,l=Math.cos(o),c=Math.sin(o),u=Pi(e);n.shots.push({id:n.nextId++,owner:"enemy",x:e.x+l*(u+dr),y:e.y+c*(u+dr),vx:l*s,vy:c*s,damage:a,traveled:0,maxRange:12,radius:dr,knockback:0,tags:[],fragment:!1})}function Z_(n){for(let e=0;e<n.enemies.length;e++)for(let t=e+1;t<n.enemies.length;t++){const i=n.enemies[e],r=n.enemies[t];if(i.fsm==="airborne"||r.fsm==="airborne")continue;const s=(Pi(i)+Pi(r))*.95,a=r.x-i.x,o=r.y-i.y,l=Math.hypot(a,o);if(l>=s)continue;const c=l>1e-6?a/l:Math.cos(i.id*2.399),u=l>1e-6?o/l:Math.sin(i.id*2.399),f=n_*xt*.5;i.x-=c*f,i.y-=u*f,r.x+=c*f,r.y+=u*f}}function Nc(n){for(let e=n.shots.length-1;e>=0;e--){const t=n.shots[e];if(t.owner==="player"&&t.tags.includes("burbuja")&&n.enemies.length){let s=null,a=ar.homingRange;for(const o of n.enemies){const l=Mt(t.x,t.y,o.x,o.y);l<a&&(a=l,s=o)}if(s){const o=Math.atan2(t.vy,t.vx);let c=Math.atan2(s.y-t.y,s.x-t.x)-o;for(;c>Math.PI;)c-=2*Math.PI;for(;c<-Math.PI;)c+=2*Math.PI;const u=It(c,-.05,ar.turnRadPerTick),f=Math.hypot(t.vx,t.vy);t.vx=Math.cos(o+u)*f,t.vy=Math.sin(o+u)*f}}t.x+=t.vx*xt,t.y+=t.vy*xt,t.traveled+=Math.hypot(t.vx,t.vy)*xt;const i=t.x<gn||t.x>xn||t.y<_n||t.y>vn||O_(t.x,t.y,n.obstacles),r=t.traveled>=t.maxRange;(i||r)&&(t.owner==="player"&&n.puddles.push({x:It(t.x,gn+.2,xn-.2),y:It(t.y,_n+.2,vn-.2),ttl:Ps}),n.shots.splice(e,1))}}function Fc(n){for(let e=n.puddles.length-1;e>=0;e--)--n.puddles[e].ttl<=0&&n.puddles.splice(e,1)}function J_(n,e){const t=n.player;for(let i=n.shots.length-1;i>=0;i--){const r=n.shots[i];if(r.owner==="player")for(let s=n.props.length-1;s>=0;s--){const a=n.props[s];if(!(Mt(r.x,r.y,a.x,a.y)>=r.radius+di.radius)){a.hp-=r.damage,n.puddles.push({x:r.x,y:r.y,ttl:Ps/2}),n.shots.splice(i,1),a.hp<=0&&(a.loot==="heart"&&n.drops.push({id:n.nextId++,kind:"heart",x:a.x,y:a.y}),Ze(n,{type:"prop_broken",kind:a.kind,loot:a.loot,tick:n.tick}),n.props.splice(s,1));break}}}for(let i=n.shots.length-1;i>=0;i--){const r=n.shots[i];if(r.owner==="player"){for(const s of n.enemies)if(!(s.kind==="gorko"&&s.fsm==="airborne")&&Mt(r.x,r.y,s.x,s.y)<r.radius+Pi(s)){if(s.kind==="babosa_acorazada"){const l=Math.hypot(r.vx,r.vy)||1;if(r.vx/l*s.facingX+r.vy/l*s.facingY<ci.backDot){n.puddles.push({x:r.x,y:r.y,ttl:Ps/3}),n.shots.splice(i,1),Ze(n,{type:"shot_blocked",enemyId:s.id,tick:n.tick});break}}let a=r.damage;ll(n,e,"critico")&&(a*=2),s.kind==="gorko"&&s.fsm==="belly"&&(a=Math.round(a*Fe.bellyDamageMult)),s.hp-=a;const o=Math.hypot(r.vx,r.vy)||1;s.kx+=r.vx/o*r.knockback,s.ky+=r.vy/o*r.knockback,n.puddles.push({x:r.x,y:r.y,ttl:Ps/2}),r.tags.includes("divide")&&!r.fragment&&j_(n,r,e),n.shots.splice(i,1),Ze(n,{type:"enemy_hit",enemyId:s.id,damage:a,hpLeft:Math.max(0,s.hp),tick:n.tick});break}}}for(let i=n.enemies.length-1;i>=0;i--){const r=n.enemies[i];r.hp<=0&&(n.enemies.splice(i,1),Q_(n,r,e),Ze(n,{type:"enemy_killed",enemyId:r.id,kind:r.kind,tick:n.tick}))}if(t.iframes===0){for(const i of n.enemies)if(!(i.kind==="gorko"&&i.fsm==="airborne")&&Mt(t.x,t.y,i.x,i.y)<vt.radius+Pi(i)){ko(n,U_(i.kind)+i.dmgPlus,i.x,i.y,"contacto:"+i.kind);break}}if(t.iframes===0)for(let i=n.shots.length-1;i>=0;i--){const r=n.shots[i];if(r.owner==="enemy"&&Mt(r.x,r.y,t.x,t.y)<r.radius+vt.radius){n.shots.splice(i,1),ko(n,r.damage,r.x,r.y,"escupitajo");break}}}function Q_(n,e,t){const i=()=>(t.drops()-.5)*.5;if(e.kind!=="gorko"){if(e.kind==="sapo_doble"){const r=t.drops(),s=r<Pa.big?"crystal_big":r<Pa.big+Pa.med?"crystal_med":"crystal";n.drops.push({id:n.nextId++,kind:s,x:e.x+i(),y:e.y+i()});return}t.drops()<r_.heart&&n.drops.push({id:n.nextId++,kind:"heart",x:e.x+i(),y:e.y+i()})}}function j_(n,e,t){const r=ll(n,t,"dividir_en_3")?[-.9,0,Pr.angleRad]:[-.9,Pr.angleRad],s=Math.atan2(e.vy,e.vx),a=Math.hypot(e.vx,e.vy)||1;for(const o of r){const l=s+o;n.shots.push({id:n.nextId++,owner:"player",x:e.x,y:e.y,vx:Math.cos(l)*a,vy:Math.sin(l)*a,damage:Math.max(1,Math.round(e.damage*Pr.damageMult)),traveled:0,maxRange:Pr.range,radius:e.radius*Pr.radiusMult,knockback:e.knockback*.5,tags:[],fragment:!0})}Ze(n,{type:"shot_split",count:r.length,tick:n.tick})}function Kd(n,e){for(const t of[n.player.usable,n.player.usable2])if(t&&t.activeTicks>0&&an(t.itemId).usable.efecto===e)return!0;return!1}function ko(n,e,t,i,r){const s=n.player;if(Kd(n,"escudo"))return;const a=Math.min(s.armor,e);a>0&&(s.armor-=a,Ze(n,{type:"armor_absorbed",amount:a,armorLeft:s.armor,tick:n.tick}));const o=e-a;s.halfHearts=Math.max(0,s.halfHearts-o),s.iframes=q0;const l=Mt(s.x,s.y,t,i),c=l>.001?(s.x-t)/l:1,u=l>.001?(s.y-i)/l:0;s.kx+=c*Ac,s.ky+=u*Ac,o>0&&Ze(n,{type:"damage_taken",amount:o,halfHeartsLeft:s.halfHearts,source:r,tick:n.tick})}function ex(n){if(n.player.halfHearts<=0&&n.status==="playing"){n.status="dead",n.player.deathTick=n.tick,Ze(n,{type:"player_died",tick:n.tick});return}const e=n.floor.rooms[n.floor.current];if(n.enemies.length===0&&!e.cleared&&n.status==="playing"&&(e.cleared=!0,Ze(n,{type:"room_cleared",tick:n.tick}),e.id===n.floor.keyRoomId&&n.drops.push({id:n.nextId++,kind:"key",x:it/2,y:Qe/2}),e.kind==="boss"&&!n.floor.trapdoorOpen&&(n.floor.trapdoorOpen=!0,Ze(n,{type:"trapdoor_opened",tick:n.tick}),n.drops.push({id:n.nextId++,kind:"crystal_med",x:it/2-1,y:Qe/2+1.2}),n.drops.push({id:n.nextId++,kind:"heart",x:it/2+1,y:Qe/2+1.2}),n.drops.push({id:n.nextId++,kind:"heart",x:it/2,y:Qe/2+1.8}),n.floor.level===wi))){n.drops.push({id:n.nextId++,kind:"crystal_big",x:it/2,y:Qe/2-1.4});const t=Oo(n),i=[...Li.values()].filter(a=>t.includes(a.id)&&(a.rareza==="legendaria"||a.slot==="nucleo")),r=Di(e.seed^45141),s=i[Math.floor(r()*i.length)];n.pickups.push({id:n.nextId++,itemId:s.id,x:it/2-1.6,y:Qe/2-1.4}),n.chest={roomId:e.id,x:it/2+1.6,y:Qe/2-1.4,opened:!1,reward:tx(n,e.seed)}}}function tx(n,e){const t=Di(e^49395),i=[];for(const a of Li.values())a.unlockable&&!n.config.unlockedItems.includes(a.id)&&i.push([a.id,Lc[a.rareza]]);if(n.config.usableSlots<2&&i.push(["slot_usable_2",Lc.legendaria]),i.length===0)return"cristales";const r=i.reduce((a,[,o])=>a+o,0);let s=t()*r;for(const[a,o]of i)if(s-=o,s<=0)return a;return i[i.length-1][0]}function Ze(n,e){n.events.push(e)}function It(n,e,t){return n<e?e:n>t?t:n}function Mt(n,e,t,i){return Math.hypot(t-n,i-e)}function nx(n){const e=s=>Math.round(s*1e6)/1e6,t={t:n.tick,st:n.status,p:[e(n.player.x),e(n.player.y),n.player.halfHearts,n.player.iframes],it:n.player.items.join(","),ar:n.player.armor,us:n.player.usable?[n.player.usable.itemId,n.player.usable.cooldown,n.player.usable.activeTicks]:null,us2:n.player.usable2?[n.player.usable2.itemId,n.player.usable2.cooldown,n.player.usable2.activeTicks]:null,cf:[n.config.usableSlots,n.config.unlockedItems.join(","),n.config.resume?[n.config.resume.nivel,n.config.resume.items.join(",")]:null],da:[n.player.dashTicks,n.player.dashCooldown],pk:n.pickups.map(s=>[s.id,s.itemId]),fl:[n.floor.level,n.floor.current,n.floor.trapdoorOpen?1:0,n.floor.rooms.map(s=>(s.cleared?1:0)+(s.visited?2:0)+(s.locked?4:0)).join("")],ec:[n.player.keys,n.player.crystals,n.drops.map(s=>`${s.kind}${e(s.x)}`).join(",")],ch:n.chest?[n.chest.roomId,n.chest.opened?1:0,n.chest.reward]:null,pr:n.props.map(s=>[s.kind,e(s.x),s.hp]),e:n.enemies.map(s=>[s.id,e(s.x),e(s.y),s.hp,s.fsm,s.timer]),sh:n.shots.map(s=>[s.id,s.owner,e(s.x),e(s.y),e(s.traveled)]),pu:n.puddles.length},i=JSON.stringify(t);let r=2166136261;for(let s=0;s<i.length;s++)r^=i.charCodeAt(s),r=Math.imul(r,16777619);return(r>>>0).toString(16).padStart(8,"0")}function ix(n,e){const t={version:e,seed:()=>n.sim.state.seed,state:()=>structuredClone(n.sim.state),hash:()=>n.sim.hash(),press:(i,r)=>n.press(i,r/1e3*Ci),aimAt:(i,r)=>n.aimAt(i,r),clearAim:()=>n.clearAim(),tick:i=>n.tick(i),pause:i=>{n.paused=i},isPaused:()=>n.paused,reset:i=>n.reset(i),telemetry:()=>structuredClone(n.telemetry),clearTelemetry:()=>{n.telemetry.length=0},goto:i=>al(n.sim.state,i),heal:()=>{const i=n.sim.state.player;i.halfHearts=i.maxHalfHearts},grant:i=>{const r=n.sim.state;r.player.items.push(i),r.stats=Wr(r.player.items),r.player.maxHalfHearts=r.stats.maxHalfHearts},clear:()=>{n.sim.state.enemies.length=0}};return window.__game=t,t}const Ia=1e3/Ci,rx=5;function sx(n,e){let t=e,i=Dc(n,t),r=0,s=0;const a={up:0,down:0,left:0,right:0,fire:0,dash:0,use:0,use2:0,interact:0};let o=null;const l={sim:i,live:Yd(),paused:!1,telemetry:[],frame(f){if(l.paused)return[];if(s>0)return s--,[];r+=Math.min(f,Ia*rx);const d=[];for(;r>=Ia;)r-=Ia,d.push(...u());return d},tick(f){const d=[];for(let h=0;h<f;h++)d.push(...u());return d},press(f,d){a[f]=Math.max(a[f],Math.max(0,Math.round(d)))},aimAt(f,d){o={x:f,y:d}},clearAim(){o=null},freeze(f){s=Math.max(s,f)},reset(f,d){d&&(t=d),i=Dc(f??i.state.seed,t),l.sim=i,r=0,s=0,l.telemetry.length=0,Object.keys(a).forEach(h=>a[h]=0),o=null}};function c(){const f={...l.live};return Object.keys(a).forEach(d=>{a[d]>0&&(f[d]=!0,a[d]--)}),o&&(f.aimX=o.x,f.aimY=o.y),f}function u(){i.step(c());const f=i.state.events;return f.length&&l.telemetry.push(...f),f}return l}const Bo=1,Oc="kai_save";function kc(){return{version:Bo,cristales:0,desbloqueos:[],slimepedia:[],expedicion:null}}function ax(n){const e=n;return!e||typeof e.seed!="number"||typeof e.nivel!="number"||e.nivel<1||!Array.isArray(e.items)||e.items.some(t=>typeof t!="string")||typeof e.halfHearts!="number"?null:{seed:e.seed>>>0,nivel:Math.floor(e.nivel),items:e.items,usable:typeof e.usable=="string"?e.usable:null,usable2:typeof e.usable2=="string"?e.usable2:null,halfHearts:Math.max(1,Math.floor(e.halfHearts)),crystals:typeof e.crystals=="number"?Math.max(0,Math.floor(e.crystals)):0,keys:typeof e.keys=="number"?Math.max(0,Math.floor(e.keys)):0}}function ox(n){const e=typeof localStorage<"u"?localStorage:(()=>{const r=new Map;return{getItem:s=>r.get(s)??null,setItem:(s,a)=>void r.set(s,a)}})();let t=kc();try{const r=e.getItem(Oc);if(r){const s=JSON.parse(r);s&&s.version===Bo&&typeof s.cristales=="number"&&Array.isArray(s.desbloqueos)&&(t={version:Bo,cristales:Math.max(0,Math.floor(s.cristales)),desbloqueos:s.desbloqueos.filter(a=>typeof a=="string"),slimepedia:Array.isArray(s.slimepedia)?s.slimepedia.filter(a=>typeof a=="string"):[],expedicion:ax(s.expedicion)})}}catch{t=kc()}const i={data:t,persist(){e.setItem(Oc,JSON.stringify(i.data))},harvest(r){r>0&&(i.data.cristales+=r,i.persist())},unlock(r){return i.has(r)?!1:(i.data.desbloqueos.push(r),i.persist(),!0)},has(r){return i.data.desbloqueos.includes(r)},saveExpedition(r){i.data.expedicion=r,i.persist()}};return i}function zo(n){return{usableSlots:n.has("slot_usable_2")?2:1,unlockedItems:n.data.desbloqueos.filter(e=>e.startsWith("item_")).map(e=>e.slice(5))}}const Zd="kai_audio",Bc={titulo:"assets/music/titulo.ogg",ambiente:"assets/music/ambiente.ogg"},lx="assets/music/gameover.ogg",zc={dano:["impactPunch_medium_000","impactPunch_medium_001"],dano_fuerte:["impactPunch_heavy_000","impactPunch_heavy_001"],caja:["impactPlank_medium_000","impactPlank_medium_001","impactPlank_medium_002"],roca:["impactMining_000","impactMining_001"],cristal:["impactGlass_light_000","impactGlass_light_001","impactGlass_light_002"],armadura:["impactPlate_light_000","impactPlate_light_001"]};function cx(){try{const n=localStorage.getItem(Zd);if(n){const e=JSON.parse(n);return{volume:typeof e.volume=="number"?Math.min(1,Math.max(0,e.volume)):.8,muted:!!e.muted}}}catch{}return{volume:.8,muted:!1}}function dx(n){const e=cx(),t=new AudioContext,i=t.createGain();i.gain.value=e.muted?0:e.volume,i.connect(t.destination);const r=()=>{t.state==="suspended"&&t.resume()};window.addEventListener("pointerdown",r),window.addEventListener("keydown",r);const s=new Map;async function a(M,w){try{const D=await(await fetch(w)).arrayBuffer();s.set(M,await t.decodeAudioData(D))}catch{}}for(const[M,w]of Object.entries(Bc))a(`music:${M}`,w);a("music:gameover",lx);for(const[M,w]of Object.entries(zc))w.forEach((E,D)=>void a(`${M}:${D}`,`assets/sfx/${E}.ogg`));const o=new Map,l=new Set;function c(M){const w=s.get(`music:${M}`);if(!w)return null;let E=o.get(M);if(E||(E=t.createGain(),E.gain.value=0,E.connect(i),o.set(M,E)),!l.has(M)&&t.state==="running"){const D=t.createBufferSource();D.buffer=w,D.loop=!0,D.connect(E),D.start(),l.add(M)}return E}function u(M){const w=t.currentTime;for(const E of Object.keys(Bc))c(E)?.gain.setTargetAtTime(M[E]??0,w,.9)}let f=!1;function d(){const M=s.get("music:gameover");if(!M||f)return;f=!0;const w=t.createBufferSource();w.buffer=M;const E=t.createGain();E.gain.value=.4,w.connect(E),E.connect(i),w.start()}function h(M,w){const E=zc[M].length,D=s.get(`${M}:${Math.floor(Math.random()*E)}`);if(!D)return;const z=t.createBufferSource();z.buffer=D,z.playbackRate.value=.92+Math.random()*.16;const W=t.createGain();W.gain.value=w,z.connect(W),W.connect(i),z.start()}const x=(()=>{const M=t.createBuffer(1,t.sampleRate,t.sampleRate),w=M.getChannelData(0);for(let E=0;E<w.length;E++)w[E]=Math.random()*2-1;return M})();function b(M,w){const E=t.createGain(),D=t.currentTime;return E.gain.setValueAtTime(1e-4,D),E.gain.exponentialRampToValueAtTime(Math.max(2e-4,M),D+.008),E.gain.exponentialRampToValueAtTime(1e-4,D+w),E.connect(i),E}function m(M,w,E,D,z,W=30){const k=t.createOscillator();k.type=M;const $=t.currentTime;k.frequency.setValueAtTime(w,$),k.frequency.exponentialRampToValueAtTime(Math.max(20,E),$+D),k.detune.value=(Math.random()*2-1)*W,k.connect(b(z,D)),k.start($),k.stop($+D+.02)}function p(M,w,E,D=1){const z=t.createBufferSource();z.buffer=x,z.playbackRate.value=.7+Math.random()*.6;const W=t.createBiquadFilter();W.type="bandpass",W.frequency.value=M,W.Q.value=D,z.connect(W),W.connect(b(E,w)),z.start(),z.stop(t.currentTime+w+.02)}function S(M,w,E){M.forEach((D,z)=>{const W=t.createOscillator();W.type="triangle";const k=t.currentTime+z*w*.8;W.frequency.value=D;const $=t.createGain();$.gain.setValueAtTime(1e-4,k),$.gain.exponentialRampToValueAtTime(E,k+.01),$.gain.exponentialRampToValueAtTime(1e-4,k+w),$.connect(i),W.connect($),W.start(k),W.stop(k+w+.02)})}const P=new Map;function v(M,w){const E=performance.now();return(P.get(M)??0)+w>E?!1:(P.set(M,E),!0)}function C(M){switch(M.type){case"shot_fired":M.owner==="player"?v("shot",45)&&m("sine",640,220,.09,.1):v("eshot",60)&&m("square",240,140,.12,.05);break;case"enemy_hit":v("hit",40)&&p(900,.07,.12,2);break;case"shot_blocked":v("block",80)&&h("armadura",.14);break;case"enemy_killed":p(500,.18,.16,1.2),m("sine",300,80,.2,.1);break;case"damage_taken":h(M.amount>=2?"dano_fuerte":"dano",.5);break;case"armor_absorbed":h("armadura",.4);break;case"prop_broken":h("caja",.45);break;case"dash_used":p(1600,.14,.09,.6);break;case"telegraph_started":v("tele",150)&&m("sine",880,660,.08,.045);break;case"heart_collected":S([392,523.25],.09,.16);break;case"crystal_collected":v("crystal",70)&&h("cristal",.35);break;case"key_collected":S([659.3,880],.08,.1);break;case"door_unlocked":m("square",220,320,.12,.1,4);break;case"item_picked":case"item_bought":S([523.25,659.3,784,1046.5],.1,.22),h("cristal",.28);break;case"usable_activated":m("triangle",440,880,.14,.11);break;case"proc_triggered":M.efecto==="critico"&&v("crit",90)&&p(2400,.06,.1,3);break;case"room_cleared":S([261.6,392],.12,.09);break;case"trapdoor_opened":m("sine",120,50,.5,.14);break;case"level_started":m("sine",80,45,.8,.16),p(300,.6,.07,.5);break;case"gorko_phase2":m("sawtooth",90,40,.7,.14),p(150,.5,.12,.7);break;case"elite_swallowed":m("sine",500,90,.3,.12);break;case"chest_opened":S([523.25,659.3,784,1046.5,1318.5],.1,.2);break;case"victory":S([392,523.25,659.3,784,1046.5],.14,.13);break;case"player_died":d();break}}const A=document.createElement("button");A.className="audio-toggle";const L=()=>{A.textContent=e.muted?"🔇":"🔊"};L(),A.addEventListener("pointerdown",M=>{M.stopPropagation(),_()}),window.addEventListener("keydown",M=>{M.code==="KeyM"&&_()}),n.appendChild(A);function _(){e.muted=!e.muted,i.gain.linearRampToValueAtTime(e.muted?0:e.volume,t.currentTime+.08),localStorage.setItem(Zd,JSON.stringify(e)),L()}return{onEvents(M){if(!(e.muted||t.state!=="running"))for(const w of M)C(w)},update(M){if(t.state!=="running")return;if(document.body.classList.contains("at-title")){u({titulo:.32});return}if(M.status==="dead"){u({});return}if(M.status==="victory"){u({ambiente:.12});return}f=!1,u({ambiente:M.tick>0?.32:0})}}}function ux(n,e,t,i){const r=document.createElement("div");r.className="screens",n.appendChild(r);let s=!1,a=!1,o=!1,l=0,c=null,u=null;function f(){s=!0,e.paused=!0,document.body.classList.add("at-title");const S=t.data.expedicion,P=S?`<button class="title-continue">▶ Continuar expedición — nivel ${S.nivel} de ${wi}</button>`:"";r.innerHTML=`
  ...
  `,n.appendChild(i);const r=i.querySelector(".hud-hearts"),s=i.querySelector(".hud-toasts"),a=i.querySelector(".hud-items"),o=i.querySelector(".hud-stats"),l=i.querySelector(".hud-near"),c=i.querySelector(".hud-minimap"),u=i.querySelector(".hud-wallet"),f=i.querySelector(".hud-boss"),d=[...i.querySelectorAll(".hud-usable")],h=[...i.querySelectorAll(".hud-usable-icon")],x=[...i.querySelectorAll(".hud-usable-cd")],b=i.querySelector(".hud-center"),m=i.querySelector(".hud-msg"),p=i.querySelector(".hud-sub"),S=i.querySelector(".hud-seed");let P=-1,v=-1,C=-1,A="",L=-1;const _=["",""],M=[-1,-1];let w="",E="",D="",z="",W="",k="",$=null,G=!0;window.addEventListener("keydown",Z=>{Z.code==="Tab"&&(Z.preventDefault(),G=!G,o.hidden=!G)});function Q(Z,oe){const he=document.createElement("div");for(he.className="hud-toast"+(oe==="delta"?" hud-toast-delta":""),he.textContent=Z,s.appendChild(he);s.children.length>6;)s.firstChild?.remove();setTimeout(()=>he.remove(),2600)}function ae(Z,oe="#e24b4a",he="#f6a5a4"){const $e=`<path d="${ed}" fill="rgba(0,0,0,0.45)" stroke="rgba(0,0,0,0.6)" stroke-width="1"/>`,ot=Z===1?' style="clip-path: inset(0 50% 0 0)"':"",Oe=Z>0?`<path d="${ed}" fill="${oe}"${ot}/><path d="M6 6.2 A2.4 2.4 0 0 1 9 4.8" stroke="${he}" stroke-width="1.4" fill="none"${ot}/>`:"";return`<svg viewBox="0 0 20 18" class="hud-heart">${$e}${Oe}</svg>`}return{update(Z){const oe=Z.player.halfHearts,he=Z.player.maxHalfHearts,$e=Z.player.armor;if(oe!==P||he!==v||$e!==C){P=oe,v=he,C=$e;const N=Math.ceil(he/2);let I="";for(let R=0;R<N;R++)I+=ae(Math.min(2,Math.max(0,oe-R*2)));for(let R=0;R<Math.ceil($e/2);R++)I+=ae(Math.min(2,Math.max(0,$e-R*2)),"#9fb8c8","#dfeef7");r.innerHTML=I}if([Z.player.usable,Z.player.usable2].forEach((N,I)=>{const R=N?.itemId??"";if(R!==_[I]&&(_[I]=R,d[I].hidden=!N,N&&(h[I].src=Ls(N.itemId))),N){const F=Math.ceil(N.cooldown/Ci);F!==M[I]&&(M[I]=F,x[I].textContent=F>0?String(F):""),d[I].classList.toggle("ready",N.cooldown===0),d[I].classList.toggle("active",N.activeTicks>0)}}),Z.status!==A)if(A=Z.status,b.classList.toggle("has-msg",Z.status!=="playing"),Z.status==="victory"){const N=t(),I=N.filter(ye=>ye.type==="enemy_killed").length,R=N.filter(ye=>ye.type==="damage_taken").length,F=N.filter(ye=>ye.type==="heart_collected").length,ne=N.filter(ye=>ye.type==="item_bought").length,ie=Math.floor(Z.tick/3600),de=Math.floor(Z.tick%3600/60);m.textContent="¡El Pozo superado!",p.innerHTML=`<div class="hud-run-summary"><div>tiempo <b>${ie}:${String(de).padStart(2,"0")}</b></div><div>abatidos <b>${I}</b> · golpes recibidos <b>${R}</b></div><div>items <b>${Z.player.items.length}</b> · compras <b>${ne}</b> · corazones <b>${F}</b></div><div>cristales <b class="hud-wallet-crystal">◆ ${Z.player.crystals}</b></div><div style="margin-top:6px">R para otra run</div></div>`}else Z.status==="dead"?(m.textContent="Kai se derritió…",p.textContent="R para reintentar"):(m.textContent="",p.textContent="");const ot=Z.player.items.join(",");if(ot!==w){const N=Z.player.items.length>w.split(",").filter(Boolean).length;if(w=ot,a.innerHTML=Z.player.items.map(I=>{const R=an(I),F=`<b>${R.nombre}</b>`+Yx(R,Z.stats.luck).map(ne=>`<div>· ${ne}</div>`).join("");return`<div class="hud-item"><img src="${Ls(I)}" alt="${R.nombre}" /><div class="hud-item-tip">${F}</div></div>`}).join(""),N&&$){const I=an(Z.player.items[Z.player.items.length-1]).nombre;Q(I);for(const R of jc($,Z.stats))Q(R,"delta")}}$={...Z.stats};const Oe=Z.stats,ee=[Oe.maxHalfHearts,Oe.damage,Oe.fireRate,Oe.range,Oe.shotSpeed,Oe.moveSpeed,Oe.luck,Oe.projectiles].join("|");if(ee!==E){E=ee;const N=[["❤️","Vida",Bn(Oe.maxHalfHearts/2),"corazones máximos"],["⚔️","Daño",Bn(Oe.damage),"daño por proyectil"],["💧","Caudal",`${Bn(Oe.fireRate)}/s`,"disparos por segundo (cadencia)"],["🏹","Alcance",Bn(Oe.range),"tiles antes de caer en charco"],["💨","Presión",Bn(Oe.shotSpeed),"velocidad del proyectil"],["👢","Velocidad",Bn(Oe.moveSpeed),"velocidad de movimiento"],["🍀","Suerte",Bn(Oe.luck),"escala los procs y la calidad de drops"],["🔱","Chorros",Bn(Oe.projectiles),"proyectiles por disparo"]];o.innerHTML='<div class="hud-stats-title">stats · Tab</div>'+N.map(([I,R,F,ne])=>`<div class="hud-stats-row" title="${ne}"><span class="hud-stats-icon">${I}</span><span class="hud-stats-name">${R}</span><span class="hud-stats-value">${F}</span></div>`).join("")}let ce=null,le=1.25;for(const N of Z.pickups){const I=Math.hypot(N.x-Z.player.x,N.y-Z.player.y);I<le&&(le=I,ce=N)}const ke=ce?`${ce.id}:${ce.itemId}:${ce.price?Z.player.crystals>=ce.price?"ok":"no":""}`:"";if(ke!==D&&(D=ke,l.hidden=!ce,ce)){const N=an(ce.itemId),I=eu(N,Z.stats.luck).map(ne=>`<div>· ${ne}</div>`).join("");let R="";if(N.categoria!=="usable"){const ne=Wr([...Z.player.items,ce.itemId]),ie=jc(Z.stats,ne);R=ie.length?ie.map(de=>`<div class="hud-near-diff">${de}</div>`).join(""):""}const F=ce.price?`<div class="hud-near-price ${Z.player.crystals>=ce.price?"ok":"no"}">◆ ${ce.price} cristales — ${Z.player.crystals>=ce.price?"pulsa E para comprar":"no te alcanza"}</div>`:"";l.innerHTML=`<img src="${Ls(N.id)}" alt="" /><div><b>${N.nombre}</b> <span class="hud-near-rar">${qx[N.rareza]}</span>${F}${R}${I}<i>«${N.descripcion}»</i></div>`}const Ge=`${Z.player.crystals}:${Z.player.keys}`;Ge!==W&&(W=Ge,u.innerHTML=`<span class="hud-wallet-crystal">◆</span> ${Z.player.crystals}`+(Z.player.keys>0?` &nbsp;<span class="hud-wallet-key">⚷</span> ${Z.player.keys}`:""));const Ue=Z.enemies.some(N=>N.kind==="gorko"),mt=`${Z.seed}:${Z.floor.level}`;Ue&&k!==mt&&(k=mt,f.hidden=!1,f.innerHTML='<div class="hud-boss-name">GORKO</div><div class="hud-boss-sub">el Sapo Glotón</div>',setTimeout(()=>{f.hidden=!0},2800));const Ye=`${Z.floor.level}:${Z.floor.current}:`+Z.floor.rooms.map(N=>(N.visited?"v":".")+(N.cleared?"c":".")).join("");if(Ye!==z){z=Ye;const N=Z.floor.rooms.filter(Se=>Se.visited),I=new Set;for(const Se of N){I.add(Se.id);for(const Ae of Object.values(Se.doors))Ae>=0&&I.add(Ae)}const R=Z.floor.rooms.filter(Se=>I.has(Se.id)),F=Math.min(...R.map(Se=>Se.gx)),ne=Math.min(...R.map(Se=>Se.gy)),ie={treasure:"♦",shop:"$",boss:"☠"},de=19;c.innerHTML=R.map(Se=>{const Ae=["hud-map-cell",Se.id===Z.floor.current?"current":"",Se.visited?"visited":"known",Se.cleared?"cleared":""].filter(Boolean).join(" "),T=Se.visited||Se.kind!=="boss"?ie[Se.kind]??"":ie.boss;return`<div class="${Ae}" style="left:${(Se.gx-F)*de}px;top:${(Se.gy-ne)*de}px">${T}</div>`}).join("");const ye=(Math.max(...R.map(Se=>Se.gx))-F+1)*de,U=(Math.max(...R.map(Se=>Se.gy))-ne+1)*de;c.style.width=`${ye}px`,c.style.height=`${U}px`}const st=Z.seed*10+Z.floor.level;st!==L&&(L=st,S.textContent=`seed ${Z.seed} · nivel ${Z.floor.level} · sim v${e}`)},onEvents(Z){for(const oe of Z)if(oe.type==="proc_triggered"&&oe.efecto==="critico")Q("¡Crítico!");else if(oe.type==="usable_activated"){const he=Li.get(oe.itemId);Q(`¡${he?.nombre??"Usable"}!`)}else oe.type==="item_bought"?Q(`Comprado: −${oe.price} ◆`,"delta"):oe.type==="key_collected"?Q("Llave del tesoro","delta"):oe.type==="door_unlocked"&&Q("El tesoro se abre…","delta")}}}const td={KeyW:"up",ArrowUp:"up",KeyS:"down",ArrowDown:"down",KeyA:"left",ArrowLeft:"left",KeyD:"right",ArrowRight:"right"};function Kx(n,e,t){const i=n.live,r=new Kf,s=new We,a=new si(new V(0,1,0),0),o=new V;let l=!1,c=!1,u=!1;window.addEventListener("keydown",h=>{const x=td[h.code];x?(i[x]=!0,h.preventDefault()):h.code==="Space"?(u=!0,i.use=u||c,h.preventDefault()):h.code==="ShiftLeft"||h.code==="ShiftRight"?i.dash=!0:h.code==="KeyE"?i.interact=!0:h.code==="KeyQ"?i.use2=!0:h.code==="KeyR"&&!h.repeat&&n.reset()}),window.addEventListener("keyup",h=>{const x=td[h.code];x&&(i[x]=!1),h.code==="Space"&&(u=!1,i.use=u||c),(h.code==="ShiftLeft"||h.code==="ShiftRight")&&(i.dash=!1),h.code==="KeyE"&&(i.interact=!1),h.code==="KeyQ"&&(i.use2=!1)}),window.addEventListener("blur",()=>{i.up=i.down=i.left=i.right=!1,l=c=u=!1,i.fire=i.dash=i.use=i.interact=!1}),e.addEventListener("contextmenu",h=>h.preventDefault());function f(h){const x=e.getBoundingClientRect();x.width===0||x.height===0||(s.set((h.clientX-x.left)/x.width*2-1,-((h.clientY-x.top)/x.height)*2+1),r.setFromCamera(s,t),r.ray.intersectPlane(a,o)&&(i.aimX=o.x,i.aimY=o.z))}const d=()=>document.body.classList.contains("touch-mode");window.addEventListener("pointermove",h=>{d()||f(h)}),window.addEventListener("pointerdown",h=>{d()||(h.button===0?(l=!0,i.fire=!0,f(h)):h.button===2&&(c=!0,i.use=u||c))}),window.addEventListener("pointerup",h=>{d()||(h.button===0?(l=!1,i.fire=l):h.button===2&&(c=!1,i.use=u||c))})}const Zx=[[3.5,1],[it-3.5,1]],Oa=1;function Jx(n){n.add(new qf(16767398,.55));const e=Zx.map(([i,r])=>{const s=new jl(Be.torch,12,11,2);s.position.set(i,Oa,r+.35),n.add(s);const a=new ri(new zn({map:Qx(),blending:Ba,depthWrite:!1}));return a.position.set(i,Oa+.08,r+.18),a.scale.set(.32,.5,1),n.add(a),{light:s,flame:a,baseY:Oa}}),t=new jl(Be.shine,3.2,5,2);return t.position.set(3.5,.7,Qe/2),n.add(t),{update(i){const r=.8+.2*Math.sin(i.tick*.31)*Math.sin(i.tick*.13);for(const a of e)a.light.intensity=12*r,a.flame.scale.set(.32,.5*(.85+.3*r),1),a.flame.position.y=a.baseY+.08+.02*r;const s=i.player;if(t.position.set(s.x,.7,s.y),i.status==="dead"){const a=i.tick-s.deathTick;t.intensity=Math.floor(a/14)%2===0?1.8:.6}else t.intensity=3.2}}}function Qx(){const[n,e]=Nt(16,24),t=e.createRadialGradient(8,14,1,8,14,10);return t.addColorStop(0,at(Be.torchBright)),t.addColorStop(.45,at(Be.torch)),t.addColorStop(1,"rgba(232,161,60,0)"),e.fillStyle=t,e.fillRect(0,0,16,24),e.fillStyle=at(Be.torch),e.beginPath(),e.moveTo(8,2),e.quadraticCurveTo(12,10,8,16),e.quadraticCurveTo(4,10,8,2),e.fill(),e.fillStyle=at(Be.torchBright),e.beginPath(),e.ellipse(8,13,2.4,4,0,0,Math.PI*2),e.fill(),Ft(n)}const jx={1:16777215,2:15919832,3:13625544,4:15519936,5:12563672},nd=40,ev=55,ka=1.15,tv=1.45,nv=1.9,id=.1,rd=.6,iv=1.15,rv=.9,sv=.45;function av(){const n=new yf;n.background=new et(Be.dungeonBg);const e=new tl(Be.dungeonBg,14,30);n.fog=e;const t=ov(n),i=new V(it/2,0,Qe/2),r=new Jt(nd,1,.1,100),s=new V,a=Pl.degToRad(ev),o=new V(i.x,0,i.z);let l=20,c=it/2,u=Qe/2,f=960,d=576,h=!1;function x(){s.set(o.x,l*Math.sin(a),o.z+l*Math.cos(a)),r.position.copy(s),r.lookAt(o)}function b(S,P){f=S,d=P,r.aspect=S/Math.max(1,P);const v=Math.tan(Pl.degToRad(nd/2)),C=v*r.aspect,A=(it/2+ka)/C,L=(Qe/2+ka)*Math.sin(a)/v+(Qe/2+ka)*Math.cos(a);h=document.body.classList.contains("touch-mode"),l=Math.max(A,L)/(h?nv:tv),c=C*l,u=v*l/Math.sin(a),e.near=l-2,e.far=l+15,x(),r.updateProjectionMatrix()}function m(S,P,v){const C=P-rd,A=v-P+rd;return C>=A?v/2:Math.min(A,Math.max(C,S))}function p(S){document.body.classList.contains("touch-mode")!==h&&b(f,d);const P=m(S.player.x,c,it),v=m(S.player.y,u,Qe);o.x+=(P-o.x)*id,o.z+=(v-o.z)*id,x()}return{scene:n,camera:r,center:i,cameraHome:s,resize:b,updateRoom:S=>{t.update(S),p(S)}}}function ov(n){const e=it-2,t=Qe-2,i=xx(e,t),r=new Nr({map:i.texture,roughness:.92,metalness:0}),s=new Ct(new In(e,t),r);s.rotation.x=-Math.PI/2,s.position.set(it/2,0,Qe/2),n.add(s);const a=new Map;function o(_){const M=Math.max(1,Math.round(_));let w=a.get(M);return w||(w=new Nr({map:Vc(M,2),roughness:1,metalness:0}),a.set(M,w)),w}const l=new Map;function c(_){const M=Math.max(1,Math.round(_));let w=l.get(M);return w||(w=new Nr({map:Vc(M,1),roughness:1,metalness:0}),l.set(M,w)),w}const u=new Gn({map:Wc(!0),transparent:!0,alphaTest:.1,side:fn}),f=new Gn({map:Wc(!1),transparent:!0,alphaTest:.1,side:fn}),d=new Nr({color:13211950,roughness:.35,metalness:.4}),h=new Gn({map:vx(),transparent:!0}),x=new Gn({color:Be.torch}),b=new sr;n.add(b);const m=[];let p=null,S="";function P(){for(const _ of[...b.children])b.remove(_),_.traverse(M=>{M instanceof Ct&&M.geometry.dispose()});m.length=0,p=null}function v(_,M,w,E,D,z){const W=new Ct(new hi(_,M,w),z);return W.position.set(E,M/2,D),b.add(W),W}function C(_,M){const w=_==="n"||_==="s",E=w?it/2:Qe/2,D=_==="n"?.5:_==="s"?Qe-.5:_==="w"?.5:it-.5,z=.3,W=M*1.1+.2,k=.22,$=nn*2,G=nn-z/2;w?(v(z,W,1,E-G,D,o(1)),v(z,W,1,E+G,D,o(1))):(v(1,W,z,D,E-G,o(1)),v(1,W,z,D,E+G,o(1)));const Q=new Ct(new hi(w?$:1,k,w?1:$),o(2));Q.position.set(w?E:D,W+k/2,w?D:E),b.add(Q);const ae=$-z*2+.08,Z=W*.97,oe=new Ct(new In(ae,Z),u);return w?(oe.position.set(E,Z/2,D),_==="s"&&(oe.rotation.y=Math.PI)):(oe.position.set(D,Z/2,E),oe.rotation.y=_==="w"?Math.PI/2:-Math.PI/2),b.add(oe),oe}function A(_,M){const w=_==="n"?iv:_==="s"?sv:rv,E=_==="n"||_==="s",D=_==="n"?.5:Qe-.5,z=_==="w"?.5:it-.5,W=E?it/2:Qe/2,k=E?it:Qe-2,$=E?0:1;if(!M){E?v(k,w,1,it/2,D,o(k)):v(1,w,k,z,Qe/2,o(k));return}const G=W-nn-$,Q=$+k-(W+nn);let ae;E?(v(G,w,1,$+G/2,D,o(G)),v(Q,w,1,W+nn+Q/2,D,o(Q)),ae=v(nn*2,w*.8,.4,W,D,d)):(v(1,w,G,z,$+G/2,o(G)),v(1,w,Q,z,W+nn+Q/2,o(Q)),ae=v(.4,w*.8,nn*2,z,W,d)),ae.visible=!1,m.push({side:_,leaf:C(_,w),grate:ae})}function L(_){P();const M=_.floor.rooms[_.floor.current],w=jx[_.floor.level]??16777215;r.color.setHex(w),i.repaint(M.seed),A("n",M.doors.n>=0),A("s",M.doors.s>=0),A("e",M.doors.e>=0),A("w",M.doors.w>=0);for(const E of _.obstacles)E.invisible||v(E.w,.55,E.h,E.x+E.w/2,E.y+E.h/2,c(E.w));if(M.kind==="boss"){const E=new sr,D=new Ct(new In(1.1,1.1),h);D.rotation.x=-Math.PI/2,D.position.set(it/2,.012,Qe/2);const z=new Ct(new rl(.62,.72,20),x);z.rotation.x=-Math.PI/2,z.position.set(it/2,.013,Qe/2),E.add(D,z),E.visible=!1,b.add(E),p=E}for(const E of a.values())E.color.setHex(w);for(const E of l.values())E.color.setHex(w),E.color.multiplyScalar(1.18)}return{update(_){const M=`${_.seed}:${_.floor.level}:${_.floor.current}`;M!==S&&(S=M,L(_));const w=_.floor.rooms[_.floor.current];for(const E of m){const D=w.doors[E.side],z=D>=0&&_.floor.rooms[D].locked;E.leaf.material=w.cleared?u:f,E.grate.visible=w.cleared&&z}p&&(p.visible=_.floor.trapdoorOpen)}}}function lv(n,e){const t=ox(),i=sx(e,zo(t));ix(i,Is);const r=new X0({antialias:!1});r.setPixelRatio(1),n.appendChild(r.domElement);const s=av(),a=Jx(s.scene),o=Ux(s.scene,mx());Kx(i,r.domElement,s.camera);const l=$x(n,Is,()=>i.telemetry),c=px(i,s),u=dx(n),f=ux(n,i,t,Is);let d=null;function h(p){if(p&&!d&&(d=hx(n,i)),document.body.classList.toggle("touch-mode",p),!p){const S=i.live;S.left=S.right=S.up=S.down=S.fire=!1}}fx()?h(!0):new URLSearchParams(location.search).get("touch")!=="0"&&(window.addEventListener("touchstart",()=>h(!0)),window.addEventListener("pointermove",p=>{p.pointerType==="mouse"&&document.body.classList.contains("touch-mode")&&h(!1)}));function x(){const p=n.clientWidth||960,S=n.clientHeight||576;r.setSize(p,S),s.resize(p,S)}new ResizeObserver(x).observe(n),x();let b=performance.now();function m(p){const S=p-b;b=p;const P=i.frame(S);c.onEvents(P),l.onEvents(P),u.onEvents(P),s.updateRoom(i.sim.state),a.update(i.sim.state),o.update(i.sim.state),l.update(i.sim.state),f.update(i.sim.state),u.update(i.sim.state),d?.update(i.sim.state),c.update(S,s.camera),r.render(s.scene,s.camera),requestAnimationFrame(m)}requestAnimationFrame(m)}const cv=new URLSearchParams(location.search),sd=cv.get("seed"),tu=sd!==null?Number(sd)>>>0:Date.now()>>>0;lv(document.getElementById("game"),tu);console.info(`%cKai · Fase 0.5 · seed=${tu} · API de tester en window.__game`,"color:#e8a13c");

...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function Im(n,e,t){const i=new Float32Array(Mi),r=new z(0,1,0);return new Pn({name:"SphericalGaussianBlur",defines:{n:Mi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ks(),fragmentShader:`
	...
	`}class Cd extends Rn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Sd(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),u=new Ut(l,c),f=new Ad(-1,1,1,-1,0,1);let d=null,h=null,_=!1,S,m=null,p=[],A=!1;this.setSize=function(w,v){a.setSize(w,v),o.setSize(w,v);for(let E=0;E<p.length;E++){const b=p[E];b.setSize&&b.setSize(w,v)}},this.setEffects=function(w){p=w,A=p.length>0&&p[0].isRenderPass===!0;const v=a.width,E=a.height;for(let b=0;b<p.length;b++){const C=p[b];C.setSize&&C.setSize(v,E)}},this.begin=function(w,v){if(_||w.toneMapping===wn&&p.length===0)return!1;if(m=v,v!==null){const E=v.width,b=v.height;(a.width!==E||a.height!==b)&&this.setSize(E,b)}return A===!1&&w.setRenderTarget(a),S=w.toneMapping,w.toneMapping=wn,!0},this.hasRenderPass=function(){return A},this.end=function(w,v){w.toneMapping=S,_=!0;let E=a,b=o;for(let C=0;C<p.length;C++){const x=p[C];if(x.enabled!==!1&&(x.render(w,b,E,v),x.needsSwap!==!1)){const y=E;E=b,b=y}}if(d!==w.outputColorSpace||h!==w.toneMapping){d=w.outputColorSpace,h=w.toneMapping,c.defines={},it.getTransfer(d)===dt&&(c.defines.SRGB_TRANSFER="");const C=Bm[h];C&&(c.defines[C]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=E.texture,w.setRenderTarget(m),w.render(u,f),m=null,_=!1},this.isCompositing=function(){return _},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),l.dispose(),c.dispose()}}const Pd=new Nt,To=new ur(1,1),Id=new md,Ld=new ef,Dd=new Sd,rc=[],sc=[],ac=new Float32Array(16),oc=new Float32Array(9),lc=new Float32Array(4);function gr(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=rc[r];if(s===void 0&&(s=new Float32Array(r),rc[r]=s),e!==0){i.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(s,o)}return s}function It(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Lt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Bs(n,e){let t=sc[e];t===void 0&&(t=new Int32Array(e),sc[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Hm(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Gm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;n.uniform2fv(this.addr,e),Lt(t,e)}}function Vm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(It(t,e))return;n.uniform3fv(this.addr,e),Lt(t,e)}}function Wm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;n.uniform4fv(this.addr,e),Lt(t,e)}}function Xm(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(It(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Lt(t,e)}else{if(It(t,i))return;lc.set(i),n.uniformMatrix2fv(this.addr,!1,lc),Lt(t,i)}}function Ym(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(It(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Lt(t,e)}else{if(It(t,i))return;oc.set(i),n.uniformMatrix3fv(this.addr,!1,oc),Lt(t,i)}}function qm(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(It(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Lt(t,e)}else{if(It(t,i))return;ac.set(i),n.uniformMatrix4fv(this.addr,!1,ac),Lt(t,i)}}function $m(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function Km(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;n.uniform2iv(this.addr,e),Lt(t,e)}}function Zm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;n.uniform3iv(this.addr,e),Lt(t,e)}}function Jm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;n.uniform4iv(this.addr,e),Lt(t,e)}}function Qm(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function jm(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(It(t,e))return;n.uniform2uiv(this.addr,e),Lt(t,e)}}function eg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(It(t,e))return;n.uniform3uiv(this.addr,e),Lt(t,e)}}function tg(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(It(t,e))return;n.uniform4uiv(this.addr,e),Lt(t,e)}}function ng(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(To.compareFunction=t.isReversedDepthBuffer()?Go:Ho,s=To):s=Pd,t.setTexture2D(e||s,r)}function ig(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||Ld,r)}function rg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||Dd,r)}function sg(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||Id,r)}function ag(n){switch(n){case 5126:return Hm;case 35664:return Gm;case 35665:return Vm;case 35666:return Wm;case 35674:return Xm;case 35675:return Ym;case 35676:return qm;case 5124:case 35670:return $m;case 35667:case 35671:return Km;case 35668:case 35672:return Zm;case 35669:case 35673:return Jm;case 5125:return Qm;case 36294:return jm;case 36295:return eg;case 36296:return tg;case 35678:case 36198:case 36298:case 36306:case 35682:return ng;case 35679:case 36299:case 36307:return ig;case 35680:case 36300:case 36308:case 36293:return rg;case 36289:case 36303:case 36311:case 36292:return sg}}function og(n,e){n.uniform1fv(this.addr,e)}function lg(n,e){const t=gr(e,this.size,2);n.uniform2fv(this.addr,t)}function cg(n,e){const t=gr(e,this.size,3);n.uniform3fv(this.addr,t)}function dg(n,e){const t=gr(e,this.size,4);n.uniform4fv(this.addr,t)}function ug(n,e){const t=gr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function fg(n,e){const t=gr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function hg(n,e){const t=gr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function pg(n,e){n.uniform1iv(this.addr,e)}function mg(n,e){n.uniform2iv(this.addr,e)}function gg(n,e){n.uniform3iv(this.addr,e)}function _g(n,e){n.uniform4iv(this.addr,e)}function xg(n,e){n.uniform1uiv(this.addr,e)}function vg(n,e){n.uniform2uiv(this.addr,e)}function Mg(n,e){n.uniform3uiv(this.addr,e)}function Sg(n,e){n.uniform4uiv(this.addr,e)}function yg(n,e,t){const i=this.cache,r=e.length,s=Bs(t,r);It(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));let a;this.type===n.SAMPLER_2D_SHADOW?a=To:a=Pd;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function bg(n,e,t){const i=this.cache,r=e.length,s=Bs(t,r);It(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||Ld,s[a])}function Eg(n,e,t){const i=this.cache,r=e.length,s=Bs(t,r);It(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||Dd,s[a])}function Tg(n,e,t){const i=this.cache,r=e.length,s=Bs(t,r);It(i,s)||(n.uniform1iv(this.addr,s),Lt(i,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||Id,s[a])}function Ag(n){switch(n){case 5126:return og;case 35664:return lg;case 35665:return cg;case 35666:return dg;case 35674:return ug;case 35675:return fg;case 35676:return hg;case 5124:case 35670:return pg;case 35667:case 35671:return mg;case 35668:case 35672:return gg;case 35669:case 35673:return _g;case 5125:return xg;case 36294:return vg;case 36295:return Mg;case 36296:return Sg;case 35678:case 36198:case 36298:case 36306:case 35682:return yg;case 35679:case 36299:case 36307:return bg;case 35680:case 36300:case 36308:case 36293:return Eg;case 36289:case 36303:case 36311:case 36292:return Tg}}class wg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=ag(t.type)}}class Rg{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Ag(t.type)}}class Cg{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],i)}}}const Sa=/(\w+)(\])?(\[|\.)?/g;function cc(n,e){n.seq.push(e),n.map[e.id]=e}function Pg(n,e,t){const i=n.name,r=i.length;for(Sa.lastIndex=0;;){const s=Sa.exec(i),a=Sa.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){cc(t,c===void 0?new wg(o,n,e):new Rg(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new Cg(o),cc(t,f)),t=f}}}class Ts{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);Pg(o,l,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&i.push(a)}return i}}function dc(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const Ig=37297;let Lg=0;function Dg(n,e){const t=n.split(`
...
#define LOW_PRECISION`),e}const qg={[Ms]:"SHADOWMAP_TYPE_PCF",[Lr]:"SHADOWMAP_TYPE_VSM"};function $g(n){return qg[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Kg={[bi]:"ENVMAP_TYPE_CUBE",[dr]:"ENVMAP_TYPE_CUBE",[Os]:"ENVMAP_TYPE_CUBE_UV"};function Zg(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":Kg[n.envMapMode]||"ENVMAP_TYPE_CUBE"}const Jg={[dr]:"ENVMAP_MODE_REFRACTION"};function Qg(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":Jg[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}const jg={[Qc]:"ENVMAP_BLENDING_MULTIPLY",[xu]:"ENVMAP_BLENDING_MIX",[vu]:"ENVMAP_BLENDING_ADD"};function e_(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":jg[n.combine]||"ENVMAP_BLENDING_NONE"}function t_(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function n_(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=$g(t),c=Zg(t),u=Qg(t),f=e_(t),d=t_(t),h=Bg(t),_=zg(s),S=r.createProgram();let m,p,A=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      </div>`,r.querySelector(".title-play").addEventListener("click",()=>{const _=r.querySelector(".title-seed").value.trim(),S=_?Number(_)>>>0:Math.floor(Math.random()*4294967295)>>>0;u(S)})}function u(_){e.reset(_,zd(t)),o=null,f(),e.paused=!1}function f(){s=!1,a=!1,r.innerHTML=""}function d(_){return _==="slot_usable_2"?"2º slot de usable (tecla Q)":_==="cristales"?null:pn(_).nombre}function h(_){a=!0;const S=_.status==="victory";let m="";if(_.chest?.opened){const p=d(_.chest.reward);m=p?`<div class="refuge-chest">📦 Cofre del Nido: <b>${p}</b><div class="refuge-desc">desbloqueado PARA SIEMPRE — ya está en el pool</div></div>`:'<div class="refuge-chest">📦 Cofre del Nido: cristales<div class="refuge-desc">ya lo has desbloqueado todo</div></div>'}else S&&(m='<div class="refuge-chest refuge-chest-missed">El cofre del Nido se quedó sin abrir…</div>');r.innerHTML=`
  ...
  `,n.appendChild(i);const r=i.querySelector(".hud-hearts"),s=i.querySelector(".hud-toasts"),a=i.querySelector(".hud-items"),o=i.querySelector(".hud-stats"),l=i.querySelector(".hud-near"),c=i.querySelector(".hud-minimap"),u=i.querySelector(".hud-wallet"),f=i.querySelector(".hud-boss"),d=[...i.querySelectorAll(".hud-usable")],h=[...i.querySelectorAll(".hud-usable-icon")],_=[...i.querySelectorAll(".hud-usable-cd")],S=i.querySelector(".hud-center"),m=i.querySelector(".hud-msg"),p=i.querySelector(".hud-sub"),A=i.querySelector(".hud-seed");let w=-1,v=-1,E=-1,b="",C=-1;const x=["",""],y=[-1,-1];let I="",P="",F="",$="",ie="",H="",j=null,X=!0;window.addEventListener("keydown",Z=>{Z.code==="Tab"&&(Z.preventDefault(),X=!X,o.hidden=!X)});function te(Z,de){const he=document.createElement("div");for(he.className="hud-toast"+(de==="delta"?" hud-toast-delta":""),he.textContent=Z,s.appendChild(he);s.children.length>6;)s.firstChild?.remove();setTimeout(()=>he.remove(),2600)}function oe(Z,de="#e24b4a",he="#f6a5a4"){const Ke=`<path d="${Yc}" fill="rgba(0,0,0,0.45)" stroke="rgba(0,0,0,0.6)" stroke-width="1"/>`,st=Z===1?' style="clip-path: inset(0 50% 0 0)"':"",Oe=Z>0?`<path d="${Yc}" fill="${de}"${st}/><path d="M6 6.2 A2.4 2.4 0 0 1 9 4.8" stroke="${he}" stroke-width="1.4" fill="none"${st}/>`:"";return`<svg viewBox="0 0 20 18" class="hud-heart">${Ke}${Oe}</svg>`}return{update(Z){const de=Z.player.halfHearts,he=Z.player.maxHalfHearts,Ke=Z.player.armor;if(de!==w||he!==v||Ke!==E){w=de,v=he,E=Ke;const Y=Math.ceil(he/2);let G="";for(let se=0;se<Y;se++)G+=oe(Math.min(2,Math.max(0,de-se*2)));for(let se=0;se<Math.ceil(Ke/2);se++)G+=oe(Math.min(2,Math.max(0,Ke-se*2)),"#9fb8c8","#dfeef7");r.innerHTML=G}if([Z.player.usable,Z.player.usable2].forEach((Y,G)=>{const se=Y?.itemId??"";if(se!==x[G]&&(x[G]=se,d[G].hidden=!Y,Y&&(h[G].src=ws(Y.itemId))),Y){const pe=Math.ceil(Y.cooldown/Ai);pe!==y[G]&&(y[G]=pe,_[G].textContent=pe>0?String(pe):""),d[G].classList.toggle("ready",Y.cooldown===0),d[G].classList.toggle("active",Y.activeTicks>0)}}),Z.status!==b)if(b=Z.status,S.classList.toggle("has-msg",Z.status!=="playing"),Z.status==="victory"){const Y=t(),G=Y.filter(Ve=>Ve.type==="enemy_killed").length,se=Y.filter(Ve=>Ve.type==="damage_taken").length,pe=Y.filter(Ve=>Ve.type==="heart_collected").length,Te=Y.filter(Ve=>Ve.type==="item_bought").length,Re=Math.floor(Z.tick/3600),Pe=Math.floor(Z.tick%3600/60);m.textContent="¡El Pozo superado!",p.innerHTML=`<div class="hud-run-summary"><div>tiempo <b>${Re}:${String(Pe).padStart(2,"0")}</b></div><div>abatidos <b>${G}</b> · golpes recibidos <b>${se}</b></div><div>items <b>${Z.player.items.length}</b> · compras <b>${Te}</b> · corazones <b>${pe}</b></div><div>cristales <b class="hud-wallet-crystal">◆ ${Z.player.crystals}</b></div><div style="margin-top:6px">R para otra run</div></div>`}else Z.status==="dead"?(m.textContent="Kai se derritió…",p.textContent="R para reintentar"):(m.textContent="",p.textContent="");const st=Z.player.items.join(",");if(st!==I){const Y=Z.player.items.length>I.split(",").filter(Boolean).length;if(I=st,a.innerHTML=Z.player.items.map(G=>{const se=pn(G),pe=`<b>${se.nombre}</b>`+Tx(se,Z.stats.luck).map(Te=>`<div>· ${Te}</div>`).join("");return`<div class="hud-item"><img src="${ws(G)}" alt="${se.nombre}" /><div class="hud-item-tip">${pe}</div></div>`}).join(""),Y&&j){const G=pn(Z.player.items[Z.player.items.length-1]).nombre;te(G);for(const se of Xc(j,Z.stats))te(se,"delta")}}j={...Z.stats};const Oe=Z.stats,ee=[Oe.maxHalfHearts,Oe.damage,Oe.fireRate,Oe.range,Oe.shotSpeed,Oe.moveSpeed,Oe.luck,Oe.projectiles].join("|");if(ee!==P){P=ee;const Y=[["❤️","Vida",Fn(Oe.maxHalfHearts/2),"corazones máximos"],["⚔️","Daño",Fn(Oe.damage),"daño por proyectil"],["💧","Caudal",`${Fn(Oe.fireRate)}/s`,"disparos por segundo (cadencia)"],["🏹","Alcance",Fn(Oe.range),"tiles antes de caer en charco"],["💨","Presión",Fn(Oe.shotSpeed),"velocidad del proyectil"],["👢","Velocidad",Fn(Oe.moveSpeed),"velocidad de movimiento"],["🍀","Suerte",Fn(Oe.luck),"escala los procs y la calidad de drops"],["🔱","Chorros",Fn(Oe.projectiles),"proyectiles por disparo"]];o.innerHTML='<div class="hud-stats-title">stats · Tab</div>'+Y.map(([G,se,pe,Te])=>`<div class="hud-stats-row" title="${Te}"><span class="hud-stats-icon">${G}</span><span class="hud-stats-name">${se}</span><span class="hud-stats-value">${pe}</span></div>`).join("")}let le=null,ce=1.25;for(const Y of Z.pickups){const G=Math.hypot(Y.x-Z.player.x,Y.y-Z.player.y);G<ce&&(ce=G,le=Y)}const ke=le?`${le.id}:${le.itemId}:${le.price?Z.player.crystals>=le.price?"ok":"no":""}`:"";if(ke!==F&&(F=ke,l.hidden=!le,le)){const Y=pn(le.itemId),G=Gd(Y,Z.stats.luck).map(Te=>`<div>· ${Te}</div>`).join("");let se="";if(Y.categoria!=="usable"){const Te=zs([...Z.player.items,le.itemId]),Re=Xc(Z.stats,Te);se=Re.length?Re.map(Pe=>`<div class="hud-near-diff">${Pe}</div>`).join(""):""}const pe=le.price?`<div class="hud-near-price ${Z.player.crystals>=le.price?"ok":"no"}">◆ ${le.price} cristales — ${Z.player.crystals>=le.price?"pulsa E para comprar":"no te alcanza"}</div>`:"";l.innerHTML=`<img src="${ws(Y.id)}" alt="" /><div><b>${Y.nombre}</b> <span class="hud-near-rar">${Ex[Y.rareza]}</span>${pe}${se}${G}<i>«${Y.descripcion}»</i></div>`}const Ge=`${Z.player.crystals}:${Z.player.keys}`;Ge!==ie&&(ie=Ge,u.innerHTML=`<span class="hud-wallet-crystal">◆</span> ${Z.player.crystals}`+(Z.player.keys>0?` &nbsp;<span class="hud-wallet-key">⚷</span> ${Z.player.keys}`:""));const O=Z.enemies.some(Y=>Y.kind==="gorko"),U=`${Z.seed}:${Z.floor.level}`;O&&H!==U&&(H=U,f.hidden=!1,f.innerHTML='<div class="hud-boss-name">GORKO</div><div class="hud-boss-sub">el Sapo Glotón</div>',setTimeout(()=>{f.hidden=!0},2800));const R=`${Z.floor.level}:${Z.floor.current}:`+Z.floor.rooms.map(Y=>(Y.visited?"v":".")+(Y.cleared?"c":".")).join("");if(R!==$){$=R;const Y=Z.floor.rooms.filter(We=>We.visited),G=new Set;for(const We of Y){G.add(We.id);for(const Je of Object.values(We.doors))Je>=0&&G.add(Je)}const se=Z.floor.rooms.filter(We=>G.has(We.id)),pe=Math.min(...se.map(We=>We.gx)),Te=Math.min(...se.map(We=>We.gy)),Re={treasure:"♦",shop:"$",boss:"☠"},Pe=14;c.innerHTML=se.map(We=>{const Je=["hud-map-cell",We.id===Z.floor.current?"current":"",We.visited?"visited":"known",We.cleared?"cleared":""].filter(Boolean).join(" "),T=We.visited||We.kind!=="boss"?Re[We.kind]??"":Re.boss;return`<div class="${Je}" style="left:${(We.gx-pe)*Pe}px;top:${(We.gy-Te)*Pe}px">${T}</div>`}).join("");const Ve=(Math.max(...se.map(We=>We.gx))-pe+1)*Pe,L=(Math.max(...se.map(We=>We.gy))-Te+1)*Pe;c.style.width=`${Ve}px`,c.style.height=`${L}px`}const N=Z.seed*10+Z.floor.level;N!==C&&(C=N,A.textContent=`seed ${Z.seed} · nivel ${Z.floor.level} · sim v${e}`)},onEvents(Z){for(const de of Z)if(de.type==="proc_triggered"&&de.efecto==="critico")te("¡Crítico!");else if(de.type==="usable_activated"){const he=_r.get(de.itemId);te(`¡${he?.nombre??"Usable"}!`)}else de.type==="item_bought"?te(`Comprado: −${de.price} ◆`,"delta"):de.type==="key_collected"?te("Llave del tesoro","delta"):de.type==="door_unlocked"&&te("El tesoro se abre…","delta")}}}const qc={KeyW:"up",ArrowUp:"up",KeyS:"down",ArrowDown:"down",KeyA:"left",ArrowLeft:"left",KeyD:"right",ArrowRight:"right"};function wx(n,e,t){const i=n.live,r=new kf,s=new Ye,a=new jn(new z(0,1,0),0),o=new z;let l=!1,c=!1,u=!1;window.addEventListener("keydown",h=>{const _=qc[h.code];_?(i[_]=!0,h.preventDefault()):h.code==="Space"?(u=!0,i.use=u||c,h.preventDefault()):h.code==="ShiftLeft"||h.code==="ShiftRight"?i.dash=!0:h.code==="KeyE"?i.interact=!0:h.code==="KeyQ"?i.use2=!0:h.code==="KeyR"&&!h.repeat&&n.reset()}),window.addEventListener("keyup",h=>{const _=qc[h.code];_&&(i[_]=!1),h.code==="Space"&&(u=!1,i.use=u||c),(h.code==="ShiftLeft"||h.code==="ShiftRight")&&(i.dash=!1),h.code==="KeyE"&&(i.interact=!1),h.code==="KeyQ"&&(i.use2=!1)}),window.addEventListener("blur",()=>{i.up=i.down=i.left=i.right=!1,l=c=u=!1,i.fire=i.dash=i.use=i.interact=!1}),e.addEventListener("contextmenu",h=>h.preventDefault());function f(h){const _=e.getBoundingClientRect();_.width===0||_.height===0||(s.set((h.clientX-_.left)/_.width*2-1,-((h.clientY-_.top)/_.height)*2+1),r.setFromCamera(s,t),r.ray.intersectPlane(a,o)&&(i.aimX=o.x,i.aimY=o.z))}const d=()=>document.body.classList.contains("touch-mode");window.addEventListener("pointermove",h=>{d()||f(h)}),window.addEventListener("pointerdown",h=>{d()||(h.button===0?(l=!0,i.fire=!0,f(h)):h.button===2&&(c=!0,i.use=u||c))}),window.addEventListener("pointerup",h=>{d()||(h.button===0?(l=!1,i.fire=l):h.button===2&&(c=!1,i.use=u||c))})}const Rx=[[3.5,1],[lt-3.5,1]],Ia=1;function Cx(n){n.add(new Nf(16767398,.55));const e=Rx.map(([i,r])=>{const s=new ql(Be.torch,12,11,2);s.position.set(i,Ia,r+.35),n.add(s);const a=new vi(new ni({map:Px(),blending:Da,depthWrite:!1}));return a.position.set(i,Ia+.08,r+.18),a.scale.set(.32,.5,1),n.add(a),{light:s,flame:a,baseY:Ia}}),t=new ql(Be.shine,3.2,5,2);return t.position.set(3.5,.7,at/2),n.add(t),{update(i){const r=.8+.2*Math.sin(i.tick*.31)*Math.sin(i.tick*.13);for(const a of e)a.light.intensity=12*r,a.flame.scale.set(.32,.5*(.85+.3*r),1),a.flame.position.y=a.baseY+.08+.02*r;const s=i.player;if(t.position.set(s.x,.7,s.y),i.status==="dead"){const a=i.tick-s.deathTick;t.intensity=Math.floor(a/14)%2===0?1.8:.6}else t.intensity=3.2}}}function Px(){const[n,e]=Xt(16,24),t=e.createRadialGradient(8,14,1,8,14,10);return t.addColorStop(0,ot(Be.torchBright)),t.addColorStop(.45,ot(Be.torch)),t.addColorStop(1,"rgba(232,161,60,0)"),e.fillStyle=t,e.fillRect(0,0,16,24),e.fillStyle=ot(Be.torch),e.beginPath(),e.moveTo(8,2),e.quadraticCurveTo(12,10,8,16),e.quadraticCurveTo(4,10,8,2),e.fill(),e.fillStyle=ot(Be.torchBright),e.beginPath(),e.ellipse(8,13,2.4,4,0,0,Math.PI*2),e.fill(),Yt(n)}const Ix={1:16777215,2:15919832,3:13625544,4:15519936,5:12563672},$c=40,Lx=55,La=1.15,Dx=1.45,Ux=1.9,Kc=.1,Zc=.6,Nx=1.15,Fx=.9,Ox=.45;function kx(){const n=new cf;n.background=new tt(Be.dungeonBg);const e=new Yo(Be.dungeonBg,14,30);n.fog=e;const t=Bx(n),i=new z(lt/2,0,at/2),r=new Qt($c,1,.1,100),s=new z,a=El.degToRad(Lx),o=new z(i.x,0,i.z);let l=20,c=lt/2,u=at/2,f=960,d=576,h=!1;function _(){s.set(o.x,l*Math.sin(a),o.z+l*Math.cos(a)),r.position.copy(s),r.lookAt(o)}function S(A,w){f=A,d=w,r.aspect=A/Math.max(1,w);const v=Math.tan(El.degToRad($c/2)),E=v*r.aspect,b=(lt/2+La)/E,C=(at/2+La)*Math.sin(a)/v+(at/2+La)*Math.cos(a);h=document.body.classList.contains("touch-mode"),l=Math.max(b,C)/(h?Ux:Dx),c=E*l,u=v*l/Math.sin(a),e.near=l-2,e.far=l+15,_(),r.updateProjectionMatrix()}function m(A,w,v){const E=w-Zc,b=v-w+Zc;return E>=b?v/2:Math.min(b,Math.max(E,A))}function p(A){document.body.classList.contains("touch-mode")!==h&&S(f,d);const w=m(A.player.x,c,lt),v=m(A.player.y,u,at);o.x+=(w-o.x)*Kc,o.z+=(v-o.z)*Kc,_()}return{scene:n,camera:r,center:i,cameraHome:s,resize:S,updateRoom:A=>{t.update(A),p(A)}}}function Bx(n){const e=lt-2,t=at-2,i=new tr({map:j0(e,t),roughness:.92,metalness:0}),r=new Ut(new li(e,t),i);r.rotation.x=-Math.PI/2,r.position.set(lt/2,0,at/2),n.add(r);const s=new tr({map:Nc(15,2),roughness:1,metalness:0}),a=new tr({map:Nc(3,1),roughness:1,metalness:0,color:12167312}),o=new tr({color:1511434,roughness:.6}),l=new tr({color:13211950,roughness:.35,metalness:.4}),c=new Ti({color:197121}),u=new Ti({color:Be.torch}),f=new nr;n.add(f);const d=[];let h=null,_="";function S(){for(const w of[...f.children])f.remove(w),w.traverse(v=>{v instanceof Ut&&v.geometry.dispose()});d.length=0,h=null}function m(w,v,E,b,C,x){const y=new Ut(new Ci(w,v,E),x);return y.position.set(b,v/2,C),f.add(y),y}function p(w,v){const E=w==="n"?Nx:w==="s"?Ox:Fx,b=w==="n"||w==="s",C=w==="n"?.5:at-.5,x=w==="w"?.5:lt-.5,y=b?lt/2:at/2,I=b?lt:at-2,P=b?0:1;if(!v){b?m(I,E,1,lt/2,C,s):m(1,E,I,x,at/2,s);return}const F=y-ei-P,$=P+I-(y+ei);b?(m(F,E,1,P+F/2,C,s),m($,E,1,y+ei+$/2,C,s),d.push({side:w,mesh:m(ei*2,E*.8,.4,y,C,o)})):(m(1,E,F,x,P+F/2,s),m(1,E,$,x,y+ei+$/2,s),d.push({side:w,mesh:m(.4,E*.8,ei*2,x,y,o)}))}function A(w){S();const v=w.floor.rooms[w.floor.current],E=Ix[w.floor.level]??16777215;i.color.setHex(E),s.color.setHex(E),p("n",v.doors.n>=0),p("s",v.doors.s>=0),p("e",v.doors.e>=0),p("w",v.doors.w>=0);for(const b of w.obstacles)b.invisible||m(b.w,.55,b.h,b.x+b.w/2,b.y+b.h/2,a);if(v.kind==="boss"){const b=new nr,C=new Ut(new Ko(.5,20),c);C.rotation.x=-Math.PI/2,C.position.set(lt/2,.012,at/2);const x=new Ut(new Zo(.5,.62,20),u);x.rotation.x=-Math.PI/2,x.position.set(lt/2,.013,at/2),b.add(C,x),b.visible=!1,f.add(b),h=b}}return{update(w){const v=`${w.seed}:${w.floor.level}:${w.floor.current}`;v!==_&&(_=v,A(w));const E=w.floor.rooms[w.floor.current];for(const b of d){const C=E.doors[b.side],x=C>=0&&w.floor.rooms[C].locked;b.mesh.visible=!E.cleared||x,b.mesh.material=x&&E.cleared?l:o}h&&(h.visible=w.floor.trapdoorOpen)}}}function zx(n,e){const t=q0(),i=Y0(e,zd(t));W0(i,As);const r=new U_({antialias:!1});r.setPixelRatio(1),n.appendChild(r.domElement);const s=kx(),a=Cx(s.scene),o=hx(s.scene,Q0());wx(i,r.domElement,s.camera);const l=Ax(n,As,()=>i.telemetry),c=J0(i,s),u=$0(n,i,t,As);let f=null;function d(m){if(m&&!f&&(f=Z0(n,i)),document.body.classList.toggle("touch-mode",m),!m){const p=i.live;p.left=p.right=p.up=p.down=p.fire=!1}}K0()?d(!0):new URLSearchParams(location.search).get("touch")!=="0"&&(window.addEventListener("touchstart",()=>d(!0)),window.addEventListener("pointermove",m=>{m.pointerType==="mouse"&&document.body.classList.contains("touch-mode")&&d(!1)}));function h(){const m=n.clientWidth||960,p=n.clientHeight||576;r.setSize(m,p),s.resize(m,p)}new ResizeObserver(h).observe(n),h();let _=performance.now();function S(m){const p=m-_;_=m;const A=i.frame(p);c.onEvents(A),l.onEvents(A),s.updateRoom(i.sim.state),a.update(i.sim.state),o.update(i.sim.state),l.update(i.sim.state),u.update(i.sim.state),f?.update(i.sim.state),c.update(p,s.camera),r.render(s.scene,s.camera),requestAnimationFrame(S)}requestAnimationFrame(S)}const Hx=new URLSearchParams(location.search),Jc=Hx.get("seed"),Vd=Jc!==null?Number(Jc)>>>0:Date.now()>>>0;zx(document.getElementById("game"),Vd);console.info(`%cKai · Fase 0.5 · seed=${Vd} · API de tester en window.__game`,"color:#e8a13c");

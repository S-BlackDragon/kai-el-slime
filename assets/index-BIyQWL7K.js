...
}`,qx=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],Yx=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],Ju=new $e,nr=new B,So=new B;function Kx(i,e,t){let n=new ac;const s=new Xe,r=new Xe,a=new gt,o=new Lp,l=new Dp,c={},d=t.maxTextureSize,h={[ri]:jt,[jt]:ri,[On]:On},u=new Wn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Xe},radius:{value:4}},vertexShader:Wx,fragmentShader:Xx}),f=u.clone();f.defines.HORIZONTAL_PASS=1;const g=new en;g.setAttribute("position",new Jt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new At(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ua;let p=this.type;this.render=function(T,w,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||T.length===0)return;this.type===$h&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=ua);const y=i.getRenderTarget(),P=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),N=i.state;N.setBlending(ii),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const V=p!==this.type;V&&w.traverse(function(q){q.material&&(Array.isArray(q.material)?q.material.forEach(O=>O.needsUpdate=!0):q.material.needsUpdate=!0)});for(let q=0,O=T.length;q<O;q++){const Y=T[q],G=Y.shadow;if(G===void 0){Ie("WebGLShadowMap:",Y,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const Q=G.getFrameExtents();s.multiply(Q),r.copy(G.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/Q.x),s.x=r.x*Q.x,G.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/Q.y),s.y=r.y*Q.y,G.mapSize.y=r.y));const ae=i.state.buffers.depth.getReversed();if(G.camera._reversedDepth=ae,G.map===null||V===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===lr){if(Y.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new Vn(s.x,s.y,{format:qi,type:ai,minFilter:Rt,magFilter:Rt,generateMipmaps:!1}),G.map.texture.name=Y.name+".shadowMap",G.map.depthTexture=new Fs(s.x,s.y,hn),G.map.depthTexture.name=Y.name+".shadowMapDepth",G.map.depthTexture.format=oi,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=bt,G.map.depthTexture.magFilter=bt}else Y.isPointLight?(G.map=new xh(s.x),G.map.depthTexture=new wp(s.x,Gn)):(G.map=new Vn(s.x,s.y),G.map.depthTexture=new Fs(s.x,s.y,Gn)),G.map.depthTexture.name=Y.name+".shadowMap",G.map.depthTexture.format=oi,this.type===ua?(G.map.depthTexture.compareFunction=ae?Ql:jl,G.map.depthTexture.minFilter=Rt,G.map.depthTexture.magFilter=Rt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=bt,G.map.depthTexture.magFilter=bt);G.camera.updateProjectionMatrix()}const Z=G.map.isWebGLCubeRenderTarget?6:1;for(let ue=0;ue<Z;ue++){if(G.map.isWebGLCubeRenderTarget)i.setRenderTarget(G.map,ue),i.clear();else{ue===0&&(i.setRenderTarget(G.map),i.clear());const fe=G.getViewport(ue);a.set(r.x*fe.x,r.y*fe.y,r.x*fe.z,r.y*fe.w),N.viewport(a)}if(Y.isPointLight){const fe=G.camera,Je=G.matrix,ct=Y.distance||fe.far;ct!==fe.far&&(fe.far=ct,fe.updateProjectionMatrix()),nr.setFromMatrixPosition(Y.matrixWorld),fe.position.copy(nr),So.copy(fe.position),So.add(qx[ue]),fe.up.copy(Yx[ue]),fe.lookAt(So),fe.updateMatrixWorld(),Je.makeTranslation(-nr.x,-nr.y,-nr.z),Ju.multiplyMatrices(fe.projectionMatrix,fe.matrixWorldInverse),G._frustum.setFromProjectionMatrix(Ju,fe.coordinateSystem,fe.reversedDepth)}else G.updateMatrices(Y);n=G.getFrustum(),v(w,x,G.camera,Y,this.type)}G.isPointLightShadow!==!0&&this.type===lr&&b(G,x),G.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(y,P,R)};function b(T,w){const x=e.update(M);u.defines.VSM_SAMPLES!==T.blurSamples&&(u.defines.VSM_SAMPLES=T.blurSamples,f.defines.VSM_SAMPLES=T.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new Vn(s.x,s.y,{format:qi,type:ai})),u.uniforms.shadow_pass.value=T.map.depthTexture,u.uniforms.resolution.value=T.mapSize,u.uniforms.radius.value=T.radius,i.setRenderTarget(T.mapPass),i.clear(),i.renderBufferDirect(w,null,x,u,M,null),f.uniforms.shadow_pass.value=T.mapPass.texture,f.uniforms.resolution.value=T.mapSize,f.uniforms.radius.value=T.radius,i.setRenderTarget(T.map),i.clear(),i.renderBufferDirect(w,null,x,f,M,null)}function C(T,w,x,y){let P=null;const R=x.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(R!==void 0)P=R;else if(P=x.isPointLight===!0?l:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const N=P.uuid,V=w.uuid;let q=c[N];q===void 0&&(q={},c[N]=q);let O=q[V];O===void 0&&(O=P.clone(),q[V]=O,w.addEventListener("dispose",E)),P=O}if(P.visible=w.visible,P.wireframe=w.wireframe,y===lr?P.side=w.shadowSide!==null?w.shadowSide:w.side:P.side=w.shadowSide!==null?w.shadowSide:h[w.side],P.alphaMap=w.alphaMap,P.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,P.map=w.map,P.clipShadows=w.clipShadows,P.clippingPlanes=w.clippingPlanes,P.clipIntersection=w.clipIntersection,P.displacementMap=w.displacementMap,P.displacementScale=w.displacementScale,P.displacementBias=w.displacementBias,P.wireframeLinewidth=w.wireframeLinewidth,P.linewidth=w.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const N=i.properties.get(P);N.light=x}return P}function v(T,w,x,y,P){if(T.visible===!1)return;if(T.layers.test(w.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&P===lr)&&(!T.frustumCulled||n.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,T.matrixWorld);const V=e.update(T),q=T.material;if(Array.isArray(q)){const O=V.groups;for(let Y=0,G=O.length;Y<G;Y++){const Q=O[Y],ae=q[Q.materialIndex];if(ae&&ae.visible){const Z=C(T,ae,y,P);T.onBeforeShadow(i,T,w,x,V,Z,Q),i.renderBufferDirect(x,null,V,Z,T,Q),T.onAfterShadow(i,T,w,x,V,Z,Q)}}}else if(q.visible){const O=C(T,q,y,P);T.onBeforeShadow(i,T,w,x,V,O,null),i.renderBufferDirect(x,null,V,O,T,null),T.onAfterShadow(i,T,w,x,V,O,null)}}const N=T.children;for(let V=0,q=N.length;V<q;V++)v(N[V],w,x,y,P)}function E(T){T.target.removeEventListener("dispose",E);for(const x in c){const y=c[x],P=T.target.uuid;P in y&&(y[P].dispose(),delete y[P])}}}function $x(i,e){function t(){let k=!1;const he=new gt;let te=null;const _e=new gt(0,0,0,0);return{setMask:function(Te){te!==Te&&!k&&(i.colorMask(Te,Te,Te,Te),te=Te)},setLocked:function(Te){k=Te},setClear:function(Te,re,Pe,Re,Ct){Ct===!0&&(Te*=Re,re*=Re,Pe*=Re),he.set(Te,re,Pe,Re),_e.equals(he)===!1&&(i.clearColor(Te,re,Pe,Re),_e.copy(he))},reset:function(){k=!1,te=null,_e.set(-1,0,0,0)}}}function n(){let k=!1,he=!1,te=null,_e=null,Te=null;return{setReversed:function(re){if(he!==re){const Pe=e.get("EXT_clip_control");re?Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.ZERO_TO_ONE_EXT):Pe.clipControlEXT(Pe.LOWER_LEFT_EXT,Pe.NEGATIVE_ONE_TO_ONE_EXT),he=re;const Re=Te;Te=null,this.setClear(Re)}},getReversed:function(){return he},setTest:function(re){re?oe(i.DEPTH_TEST):Be(i.DEPTH_TEST)},setMask:function(re){te!==re&&!k&&(i.depthMask(re),te=re)},setFunc:function(re){if(he&&(re=Lf[re]),_e!==re){switch(re){case Bo:i.depthFunc(i.NEVER);break;case zo:i.depthFunc(i.ALWAYS);break;case Ho:i.depthFunc(i.LESS);break;case Ls:i.depthFunc(i.LEQUAL);break;case Vo:i.depthFunc(i.EQUAL);break;case Go:i.depthFunc(i.GEQUAL);break;case Wo:i.depthFunc(i.GREATER);break;case Xo:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_e=re}},setLocked:function(re){k=re},setClear:function(re){Te!==re&&(Te=re,he&&(re=1-re),i.clearDepth(re))},reset:function(){k=!1,te=null,_e=null,Te=null,he=!1}}}function s(){let k=!1,he=null,te=null,_e=null,Te=null,re=null,Pe=null,Re=null,Ct=null;return{setTest:function(yt){k||(yt?oe(i.STENCIL_TEST):Be(i.STENCIL_TEST))},setMask:function(yt){he!==yt&&!k&&(i.stencilMask(yt),he=yt)},setFunc:function(yt,Pn,In){(te!==yt||_e!==Pn||Te!==In)&&(i.stencilFunc(yt,Pn,In),te=yt,_e=Pn,Te=In)},setOp:function(yt,Pn,In){(re!==yt||Pe!==Pn||Re!==In)&&(i.stencilOp(yt,Pn,In),re=yt,Pe=Pn,Re=In)},setLocked:function(yt){k=yt},setClear:function(yt){Ct!==yt&&(i.clearStencil(yt),Ct=yt)},reset:function(){k=!1,he=null,te=null,_e=null,Te=null,re=null,Pe=null,Re=null,Ct=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let d={},h={},u={},f=new WeakMap,g=[],M=null,m=!1,p=null,b=null,C=null,v=null,E=null,T=null,w=null,x=new Ge(0,0,0),y=0,P=!1,R=null,N=null,V=null,q=null,O=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,Q=0;const ae=i.getParameter(i.VERSION);ae.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(ae)[1]),G=Q>=1):ae.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(ae)[1]),G=Q>=2);let Z=null,ue={};const fe=i.getParameter(i.SCISSOR_BOX),Je=i.getParameter(i.VIEWPORT),ct=new gt().fromArray(fe),ke=new gt().fromArray(Je);function ee(k,he,te,_e){const Te=new Uint8Array(4),re=i.createTexture();i.bindTexture(k,re),i.texParameteri(k,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(k,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Pe=0;Pe<te;Pe++)k===i.TEXTURE_3D||k===i.TEXTURE_2D_ARRAY?i.texImage3D(he,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,Te):i.texImage2D(he+Pe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Te);return re}const le={};le[i.TEXTURE_2D]=ee(i.TEXTURE_2D,i.TEXTURE_2D,1),le[i.TEXTURE_CUBE_MAP]=ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),le[i.TEXTURE_2D_ARRAY]=ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),le[i.TEXTURE_3D]=ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),oe(i.DEPTH_TEST),a.setFunc(Ls),I(!1),F(Ic),oe(i.CULL_FACE),U(ii);function oe(k){d[k]!==!0&&(i.enable(k),d[k]=!0)}function Be(k){d[k]!==!1&&(i.disable(k),d[k]=!1)}function We(k,he){return u[k]!==he?(i.bindFramebuffer(k,he),u[k]=he,k===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=he),k===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=he),!0):!1}function Ue(k,he){let te=g,_e=!1;if(k){te=f.get(he),te===void 0&&(te=[],f.set(he,te));const Te=k.textures;if(te.length!==Te.length||te[0]!==i.COLOR_ATTACHMENT0){for(let re=0,Pe=Te.length;re<Pe;re++)te[re]=i.COLOR_ATTACHMENT0+re;te.length=Te.length,_e=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,_e=!0);_e&&i.drawBuffers(te)}function vt(k){return M!==k?(i.useProgram(k),M=k,!0):!1}const Ze={[zi]:i.FUNC_ADD,[Jh]:i.FUNC_SUBTRACT,[jh]:i.FUNC_REVERSE_SUBTRACT};Ze[Qh]=i.MIN,Ze[ef]=i.MAX;const ot={[tf]:i.ZERO,[nf]:i.ONE,[sf]:i.SRC_COLOR,[Oo]:i.SRC_ALPHA,[uf]:i.SRC_ALPHA_SATURATE,[lf]:i.DST_COLOR,[af]:i.DST_ALPHA,[rf]:i.ONE_MINUS_SRC_COLOR,[ko]:i.ONE_MINUS_SRC_ALPHA,[cf]:i.ONE_MINUS_DST_COLOR,[of]:i.ONE_MINUS_DST_ALPHA,[df]:i.CONSTANT_COLOR,[hf]:i.ONE_MINUS_CONSTANT_COLOR,[ff]:i.CONSTANT_ALPHA,[pf]:i.ONE_MINUS_CONSTANT_ALPHA};function U(k,he,te,_e,Te,re,Pe,Re,Ct,yt){if(k===ii){m===!0&&(Be(i.BLEND),m=!1);return}if(m===!1&&(oe(i.BLEND),m=!0),k!==Zh){if(k!==p||yt!==P){if((b!==zi||E!==zi)&&(i.blendEquation(i.FUNC_ADD),b=zi,E=zi),yt)switch(k){case ws:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fo:i.blendFunc(i.ONE,i.ONE);break;case Lc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Dc:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ve("WebGLState: Invalid blending: ",k);break}else switch(k){case ws:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Fo:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Lc:Ve("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Dc:Ve("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ve("WebGLState: Invalid blending: ",k);break}C=null,v=null,T=null,w=null,x.set(0,0,0),y=0,p=k,P=yt}return}Te=Te||he,re=re||te,Pe=Pe||_e,(he!==b||Te!==E)&&(i.blendEquationSeparate(Ze[he],Ze[Te]),b=he,E=Te),(te!==C||_e!==v||re!==T||Pe!==w)&&(i.blendFuncSeparate(ot[te],ot[_e],ot[re],ot[Pe]),C=te,v=_e,T=re,w=Pe),(Re.equals(x)===!1||Ct!==y)&&(i.blendColor(Re.r,Re.g,Re.b,Ct),x.copy(Re),y=Ct),p=k,P=!1}function L(k,he){k.side===On?Be(i.CULL_FACE):oe(i.CULL_FACE);let te=k.side===jt;he&&(te=!te),I(te),k.blending===ws&&k.transparent===!1?U(ii):U(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),a.setFunc(k.depthFunc),a.setTest(k.depthTest),a.setMask(k.depthWrite),r.setMask(k.colorWrite);const _e=k.stencilWrite;o.setTest(_e),_e&&(o.setMask(k.stencilWriteMask),o.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),o.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),ie(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?oe(i.SAMPLE_ALPHA_TO_COVERAGE):Be(i.SAMPLE_ALPHA_TO_COVERAGE)}function I(k){R!==k&&(k?i.frontFace(i.CW):i.frontFace(i.CCW),R=k)}function F(k){k!==Yh?(oe(i.CULL_FACE),k!==N&&(k===Ic?i.cullFace(i.BACK):k===Kh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Be(i.CULL_FACE),N=k}function ne(k){k!==V&&(G&&i.lineWidth(k),V=k)}function ie(k,he,te){k?(oe(i.POLYGON_OFFSET_FILL),(q!==he||O!==te)&&(q=he,O=te,a.getReversed()&&(he=-he),i.polygonOffset(he,te))):Be(i.POLYGON_OFFSET_FILL)}function ce(k){k?oe(i.SCISSOR_TEST):Be(i.SCISSOR_TEST)}function Me(k){k===void 0&&(k=i.TEXTURE0+Y-1),Z!==k&&(i.activeTexture(k),Z=k)}function D(k,he,te){te===void 0&&(Z===null?te=i.TEXTURE0+Y-1:te=Z);let _e=ue[te];_e===void 0&&(_e={type:void 0,texture:void 0},ue[te]=_e),(_e.type!==k||_e.texture!==he)&&(Z!==te&&(i.activeTexture(te),Z=te),i.bindTexture(k,he||le[k]),_e.type=k,_e.texture=he)}function Se(){const k=ue[Z];k!==void 0&&k.type!==void 0&&(i.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function Ae(){try{i.compressedTexImage2D(...arguments)}catch(k){Ve("WebGLState:",k)}}function A(){try{i.compressedTexImage3D(...arguments)}catch(k){Ve("WebGLState:",k)}}function _(){try{i.texSubImage2D(...arguments)}catch(k){Ve("WebGLState:",k)}}function H(){try{i.texSubImage3D(...arguments)}catch(k){Ve("WebGLState:",k)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(k){Ve("WebGLState:",k)}}function J(){try{i.compressedTexSubImage3D(...arguments)}catch(k){Ve("WebGLState:",k)}}function de(){try{i.texStorage2D(...arguments)}catch(k){Ve("WebGLState:",k)}}function pe(){try{i.texStorage3D(...arguments)}catch(k){Ve("WebGLState:",k)}}function j(){try{i.texImage2D(...arguments)}catch(k){Ve("WebGLState:",k)}}function se(){try{i.texImage3D(...arguments)}catch(k){Ve("WebGLState:",k)}}function me(k){return h[k]!==void 0?h[k]:i.getParameter(k)}function Le(k,he){h[k]!==he&&(i.pixelStorei(k,he),h[k]=he)}function xe(k){ct.equals(k)===!1&&(i.scissor(k.x,k.y,k.z,k.w),ct.copy(k))}function ge(k){ke.equals(k)===!1&&(i.viewport(k.x,k.y,k.z,k.w),ke.copy(k))}function Fe(k,he){let te=c.get(he);te===void 0&&(te=new WeakMap,c.set(he,te));let _e=te.get(k);_e===void 0&&(_e=i.getUniformBlockIndex(he,k.name),te.set(k,_e))}function He(k,he){const _e=c.get(he).get(k);l.get(he)!==_e&&(i.uniformBlockBinding(he,_e,k.__bindingPointIndex),l.set(he,_e))}function Ye(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},h={},Z=null,ue={},u={},f=new WeakMap,g=[],M=null,m=!1,p=null,b=null,C=null,v=null,E=null,T=null,w=null,x=new Ge(0,0,0),y=0,P=!1,R=null,N=null,V=null,q=null,O=null,ct.set(0,0,i.canvas.width,i.canvas.height),ke.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:oe,disable:Be,bindFramebuffer:We,drawBuffers:Ue,useProgram:vt,setBlending:U,setMaterial:L,setFlipSided:I,setCullFace:F,setLineWidth:ne,setPolygonOffset:ie,setScissorTest:ce,activeTexture:Me,bindTexture:D,unbindTexture:Se,compressedTexImage2D:Ae,compressedTexImage3D:A,texImage2D:j,texImage3D:se,pixelStorei:Le,getParameter:me,updateUBOMapping:Fe,uniformBlockBinding:He,texStorage2D:de,texStorage3D:pe,texSubImage2D:_,texSubImage3D:H,compressedTexSubImage2D:W,compressedTexSubImage3D:J,scissor:xe,viewport:ge,reset:Ye}}function Zx(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Xe,d=new WeakMap,h=new Set;let u;const f=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(A,_){return g?new OffscreenCanvas(A,_):yr("canvas")}function m(A,_,H){let W=1;const J=Ae(A);if((J.width>H||J.height>H)&&(W=H/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const de=Math.floor(W*J.width),pe=Math.floor(W*J.height);u===void 0&&(u=M(de,pe));const j=_?M(de,pe):u;return j.width=de,j.height=pe,j.getContext("2d").drawImage(A,0,0,de,pe),Ie("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+de+"x"+pe+")."),j}else return"data"in A&&Ie("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),A;return A}function p(A){return A.generateMipmaps}function b(A){i.generateMipmap(A)}function C(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(A,_,H,W,J,de=!1){if(A!==null){if(i[A]!==void 0)return i[A];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let pe;W&&(pe=e.get("EXT_texture_norm16"),pe||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=_;if(_===i.RED&&(H===i.FLOAT&&(j=i.R32F),H===i.HALF_FLOAT&&(j=i.R16F),H===i.UNSIGNED_BYTE&&(j=i.R8),H===i.UNSIGNED_SHORT&&pe&&(j=pe.R16_EXT),H===i.SHORT&&pe&&(j=pe.R16_SNORM_EXT)),_===i.RED_INTEGER&&(H===i.UNSIGNED_BYTE&&(j=i.R8UI),H===i.UNSIGNED_SHORT&&(j=i.R16UI),H===i.UNSIGNED_INT&&(j=i.R32UI),H===i.BYTE&&(j=i.R8I),H===i.SHORT&&(j=i.R16I),H===i.INT&&(j=i.R32I)),_===i.RG&&(H===i.FLOAT&&(j=i.RG32F),H===i.HALF_FLOAT&&(j=i.RG16F),H===i.UNSIGNED_BYTE&&(j=i.RG8),H===i.UNSIGNED_SHORT&&pe&&(j=pe.RG16_EXT),H===i.SHORT&&pe&&(j=pe.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(H===i.UNSIGNED_BYTE&&(j=i.RG8UI),H===i.UNSIGNED_SHORT&&(j=i.RG16UI),H===i.UNSIGNED_INT&&(j=i.RG32UI),H===i.BYTE&&(j=i.RG8I),H===i.SHORT&&(j=i.RG16I),H===i.INT&&(j=i.RG32I)),_===i.RGB_INTEGER&&(H===i.UNSIGNED_BYTE&&(j=i.RGB8UI),H===i.UNSIGNED_SHORT&&(j=i.RGB16UI),H===i.UNSIGNED_INT&&(j=i.RGB32UI),H===i.BYTE&&(j=i.RGB8I),H===i.SHORT&&(j=i.RGB16I),H===i.INT&&(j=i.RGB32I)),_===i.RGBA_INTEGER&&(H===i.UNSIGNED_BYTE&&(j=i.RGBA8UI),H===i.UNSIGNED_SHORT&&(j=i.RGBA16UI),H===i.UNSIGNED_INT&&(j=i.RGBA32UI),H===i.BYTE&&(j=i.RGBA8I),H===i.SHORT&&(j=i.RGBA16I),H===i.INT&&(j=i.RGBA32I)),_===i.RGB&&(H===i.UNSIGNED_SHORT&&pe&&(j=pe.RGB16_EXT),H===i.SHORT&&pe&&(j=pe.RGB16_SNORM_EXT),H===i.UNSIGNED_INT_5_9_9_9_REV&&(j=i.RGB9_E5),H===i.UNSIGNED_INT_10F_11F_11F_REV&&(j=i.R11F_G11F_B10F)),_===i.RGBA){const se=de?ba:it.getTransfer(J);H===i.FLOAT&&(j=i.RGBA32F),H===i.HALF_FLOAT&&(j=i.RGBA16F),H===i.UNSIGNED_BYTE&&(j=se===dt?i.SRGB8_ALPHA8:i.RGBA8),H===i.UNSIGNED_SHORT&&pe&&(j=pe.RGBA16_EXT),H===i.SHORT&&pe&&(j=pe.RGBA16_SNORM_EXT),H===i.UNSIGNED_SHORT_4_4_4_4&&(j=i.RGBA4),H===i.UNSIGNED_SHORT_5_5_5_1&&(j=i.RGB5_A1)}return(j===i.R16F||j===i.R32F||j===i.RG16F||j===i.RG32F||j===i.RGBA16F||j===i.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function E(A,_){let H;return A?_===null||_===Gn||_===gr?H=i.DEPTH24_STENCIL8:_===hn?H=i.DEPTH32F_STENCIL8:_===mr&&(H=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Gn||_===gr?H=i.DEPTH_COMPONENT24:_===hn?H=i.DEPTH_COMPONENT32F:_===mr&&(H=i.DEPTH_COMPONENT16),H}function T(A,_){return p(A)===!0||A.isFramebufferTexture&&A.minFilter!==bt&&A.minFilter!==Rt?Math.log2(Math.max(_.width,_.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?_.mipmaps.length:1}function w(A){const _=A.target;_.removeEventListener("dispose",w),y(_),_.isVideoTexture&&d.delete(_),_.isHTMLTexture&&h.delete(_)}function x(A){const _=A.target;_.removeEventListener("dispose",x),R(_)}function y(A){const _=n.get(A);if(_.__webglInit===void 0)return;const H=A.source,W=f.get(H);if(W){const J=W[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&P(A),Object.keys(W).length===0&&f.delete(H)}n.remove(A)}function P(A){const _=n.get(A);i.deleteTexture(_.__webglTexture);const H=A.source,W=f.get(H);delete W[_.__cacheKey],a.memory.textures--}function R(A){const _=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(_.__webglFramebuffer[W]))for(let J=0;J<_.__webglFramebuffer[W].length;J++)i.deleteFramebuffer(_.__webglFramebuffer[W][J]);else i.deleteFramebuffer(_.__webglFramebuffer[W]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[W])}else{if(Array.isArray(_.__webglFramebuffer))for(let W=0;W<_.__webglFramebuffer.length;W++)i.deleteFramebuffer(_.__webglFramebuffer[W]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let W=0;W<_.__webglColorRenderbuffer.length;W++)_.__webglColorRenderbuffer[W]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[W]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const H=A.textures;for(let W=0,J=H.length;W<J;W++){const de=n.get(H[W]);de.__webglTexture&&(i.deleteTexture(de.__webglTexture),a.memory.textures--),n.remove(H[W])}n.remove(A)}let N=0;function V(){N=0}function q(){return N}function O(A){N=A}function Y(){const A=N;return A>=s.maxTextures&&Ie("WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+s.maxTextures),N+=1,A}function G(A){const _=[];return _.push(A.wrapS),_.push(A.wrapT),_.push(A.wrapR||0),_.push(A.magFilter),_.push(A.minFilter),_.push(A.anisotropy),_.push(A.internalFormat),_.push(A.format),_.push(A.type),_.push(A.generateMipmaps),_.push(A.premultiplyAlpha),_.push(A.flipY),_.push(A.unpackAlignment),_.push(A.colorSpace),_.join()}function Q(A,_){const H=n.get(A);if(A.isVideoTexture&&D(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&H.__version!==A.version){const W=A.image;if(W===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{Be(H,A,_);return}}else A.isExternalTexture&&(H.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,H.__webglTexture,i.TEXTURE0+_)}function ae(A,_){const H=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&H.__version!==A.version){Be(H,A,_);return}else A.isExternalTexture&&(H.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,H.__webglTexture,i.TEXTURE0+_)}function Z(A,_){const H=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&H.__version!==A.version){Be(H,A,_);return}t.bindTexture(i.TEXTURE_3D,H.__webglTexture,i.TEXTURE0+_)}function ue(A,_){const H=n.get(A);if(A.isCubeDepthTexture!==!0&&A.version>0&&H.__version!==A.version){We(H,A,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture,i.TEXTURE0+_)}const fe={[Ns]:i.REPEAT,[kn]:i.CLAMP_TO_EDGE,[ya]:i.MIRRORED_REPEAT},Je={[bt]:i.NEAREST,[Xd]:i.NEAREST_MIPMAP_NEAREST,[cr]:i.NEAREST_MIPMAP_LINEAR,[Rt]:i.LINEAR,[da]:i.LINEAR_MIPMAP_NEAREST,[ti]:i.LINEAR_MIPMAP_LINEAR},ct={[Sf]:i.NEVER,[Af]:i.ALWAYS,[bf]:i.LESS,[jl]:i.LEQUAL,[Tf]:i.EQUAL,[Ql]:i.GEQUAL,[Ef]:i.GREATER,[wf]:i.NOTEQUAL};function ke(A,_){if(_.type===hn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Rt||_.magFilter===da||_.magFilter===cr||_.magFilter===ti||_.minFilter===Rt||_.minFilter===da||_.minFilter===cr||_.minFilter===ti)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,fe[_.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,fe[_.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,fe[_.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,Je[_.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,Je[_.minFilter]),_.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,ct[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===bt||_.minFilter!==cr&&_.minFilter!==ti||_.type===hn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ee(A,_){let H=!1;A.__webglInit===void 0&&(A.__webglInit=!0,_.addEventListener("dispose",w));const W=_.source;let J=f.get(W);J===void 0&&(J={},f.set(W,J));const de=G(_);if(de!==A.__cacheKey){J[de]===void 0&&(J[de]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,H=!0),J[de].usedTimes++;const pe=J[A.__cacheKey];pe!==void 0&&(J[A.__cacheKey].usedTimes--,pe.usedTimes===0&&P(_)),A.__cacheKey=de,A.__webglTexture=J[de].texture}return H}function le(A,_,H){return Math.floor(Math.floor(A/H)/_)}function oe(A,_,H,W){const de=A.updateRanges;if(de.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,H,W,_.data);else{de.sort((Le,xe)=>Le.start-xe.start);let pe=0;for(let Le=1;Le<de.length;Le++){const xe=de[pe],ge=de[Le],Fe=xe.start+xe.count,He=le(ge.start,_.width,4),Ye=le(xe.start,_.width,4);ge.start<=Fe+1&&He===Ye&&le(ge.start+ge.count-1,_.width,4)===He?xe.count=Math.max(xe.count,ge.start+ge.count-xe.start):(++pe,de[pe]=ge)}de.length=pe+1;const j=t.getParameter(i.UNPACK_ROW_LENGTH),se=t.getParameter(i.UNPACK_SKIP_PIXELS),me=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Le=0,xe=de.length;Le<xe;Le++){const ge=de[Le],Fe=Math.floor(ge.start/4),He=Math.ceil(ge.count/4),Ye=Fe%_.width,k=Math.floor(Fe/_.width),he=He,te=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ye),t.pixelStorei(i.UNPACK_SKIP_ROWS,k),t.texSubImage2D(i.TEXTURE_2D,0,Ye,k,he,te,H,W,_.data)}A.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,j),t.pixelStorei(i.UNPACK_SKIP_PIXELS,se),t.pixelStorei(i.UNPACK_SKIP_ROWS,me)}}function Be(A,_,H){let W=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(W=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(W=i.TEXTURE_3D);const J=ee(A,_),de=_.source;t.bindTexture(W,A.__webglTexture,i.TEXTURE0+H);const pe=n.get(de);if(de.version!==pe.__version||J===!0){if(t.activeTexture(i.TEXTURE0+H),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const te=it.getPrimaries(it.workingColorSpace),_e=_.colorSpace===bi?null:it.getPrimaries(_.colorSpace),Te=_.colorSpace===bi||te===_e?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te)}t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let se=m(_.image,!1,s.maxTextureSize);se=Se(_,se);const me=r.convert(_.format,_.colorSpace),Le=r.convert(_.type);let xe=v(_.internalFormat,me,Le,_.normalized,_.colorSpace,_.isVideoTexture);ke(W,_);let ge;const Fe=_.mipmaps,He=_.isVideoTexture!==!0,Ye=pe.__version===void 0||J===!0,k=de.dataReady,he=T(_,se);if(_.isDepthTexture)xe=E(_.format===Vi,_.type),Ye&&(He?t.texStorage2D(i.TEXTURE_2D,1,xe,se.width,se.height):t.texImage2D(i.TEXTURE_2D,0,xe,se.width,se.height,0,me,Le,null));else if(_.isDataTexture)if(Fe.length>0){He&&Ye&&t.texStorage2D(i.TEXTURE_2D,he,xe,Fe[0].width,Fe[0].height);for(let te=0,_e=Fe.length;te<_e;te++)ge=Fe[te],He?k&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,ge.width,ge.height,me,Le,ge.data):t.texImage2D(i.TEXTURE_2D,te,xe,ge.width,ge.height,0,me,Le,ge.data);_.generateMipmaps=!1}else He?(Ye&&t.texStorage2D(i.TEXTURE_2D,he,xe,se.width,se.height),k&&oe(_,se,me,Le)):t.texImage2D(i.TEXTURE_2D,0,xe,se.width,se.height,0,me,Le,se.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){He&&Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,he,xe,Fe[0].width,Fe[0].height,se.depth);for(let te=0,_e=Fe.length;te<_e;te++)if(ge=Fe[te],_.format!==fn)if(me!==null)if(He){if(k)if(_.layerUpdates.size>0){const Te=Ru(ge.width,ge.height,_.format,_.type);for(const re of _.layerUpdates){const Pe=ge.data.subarray(re*Te/ge.data.BYTES_PER_ELEMENT,(re+1)*Te/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,re,ge.width,ge.height,1,me,Pe)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,ge.width,ge.height,se.depth,me,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,te,xe,ge.width,ge.height,se.depth,0,ge.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?k&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,ge.width,ge.height,se.depth,me,Le,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,te,xe,ge.width,ge.height,se.depth,0,me,Le,ge.data)}else{He&&Ye&&t.texStorage2D(i.TEXTURE_2D,he,xe,Fe[0].width,Fe[0].height);for(let te=0,_e=Fe.length;te<_e;te++)ge=Fe[te],_.format!==fn?me!==null?He?k&&t.compressedTexSubImage2D(i.TEXTURE_2D,te,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,te,xe,ge.width,ge.height,0,ge.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?k&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,ge.width,ge.height,me,Le,ge.data):t.texImage2D(i.TEXTURE_2D,te,xe,ge.width,ge.height,0,me,Le,ge.data)}else if(_.isDataArrayTexture)if(He){if(Ye&&t.texStorage3D(i.TEXTURE_2D_ARRAY,he,xe,se.width,se.height,se.depth),k)if(_.layerUpdates.size>0){const te=Ru(se.width,se.height,_.format,_.type);for(const _e of _.layerUpdates){const Te=se.data.subarray(_e*te/se.data.BYTES_PER_ELEMENT,(_e+1)*te/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_e,se.width,se.height,1,me,Le,Te)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,me,Le,se.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,se.width,se.height,se.depth,0,me,Le,se.data);else if(_.isData3DTexture)He?(Ye&&t.texStorage3D(i.TEXTURE_3D,he,xe,se.width,se.height,se.depth),k&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,me,Le,se.data)):t.texImage3D(i.TEXTURE_3D,0,xe,se.width,se.height,se.depth,0,me,Le,se.data);else if(_.isFramebufferTexture){if(Ye)if(He)t.texStorage2D(i.TEXTURE_2D,he,xe,se.width,se.height);else{let te=se.width,_e=se.height;for(let Te=0;Te<he;Te++)t.texImage2D(i.TEXTURE_2D,Te,xe,te,_e,0,me,Le,null),te>>=1,_e>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){const te=i.canvas;if(te.hasAttribute("layoutsubtree")||te.setAttribute("layoutsubtree","true"),se.parentNode!==te){te.appendChild(se),h.add(_),te.onpaint=_e=>{const Te=_e.changedElements;for(const re of h)Te.includes(re.image)&&(re.needsUpdate=!0)},te.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,se);else{const Te=i.RGBA,re=i.RGBA,Pe=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Te,re,Pe,se)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(He&&Ye){const te=Ae(Fe[0]);t.texStorage2D(i.TEXTURE_2D,he,xe,te.width,te.height)}for(let te=0,_e=Fe.length;te<_e;te++)ge=Fe[te],He?k&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,me,Le,ge):t.texImage2D(i.TEXTURE_2D,te,xe,me,Le,ge);_.generateMipmaps=!1}else if(He){if(Ye){const te=Ae(se);t.texStorage2D(i.TEXTURE_2D,he,xe,te.width,te.height)}k&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,Le,se)}else t.texImage2D(i.TEXTURE_2D,0,xe,me,Le,se);p(_)&&b(W),pe.__version=de.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function We(A,_,H){if(_.image.length!==6)return;const W=ee(A,_),J=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+H);const de=n.get(J);if(J.version!==de.__version||W===!0){t.activeTexture(i.TEXTURE0+H);const pe=it.getPrimaries(it.workingColorSpace),j=_.colorSpace===bi?null:it.getPrimaries(_.colorSpace),se=_.colorSpace===bi||pe===j?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,se);const me=_.isCompressedTexture||_.image[0].isCompressedTexture,Le=_.image[0]&&_.image[0].isDataTexture,xe=[];for(let re=0;re<6;re++)!me&&!Le?xe[re]=m(_.image[re],!0,s.maxCubemapSize):xe[re]=Le?_.image[re].image:_.image[re],xe[re]=Se(_,xe[re]);const ge=xe[0],Fe=r.convert(_.format,_.colorSpace),He=r.convert(_.type),Ye=v(_.internalFormat,Fe,He,_.normalized,_.colorSpace),k=_.isVideoTexture!==!0,he=de.__version===void 0||W===!0,te=J.dataReady;let _e=T(_,ge);ke(i.TEXTURE_CUBE_MAP,_);let Te;if(me){k&&he&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ye,ge.width,ge.height);for(let re=0;re<6;re++){Te=xe[re].mipmaps;for(let Pe=0;Pe<Te.length;Pe++){const Re=Te[Pe];_.format!==fn?Fe!==null?k?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,0,0,Re.width,Re.height,Fe,Re.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,Ye,Re.width,Re.height,0,Re.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,0,0,Re.width,Re.height,Fe,He,Re.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe,Ye,Re.width,Re.height,0,Fe,He,Re.data)}}}else{if(Te=_.mipmaps,k&&he){Te.length>0&&_e++;const re=Ae(xe[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ye,re.width,re.height)}for(let re=0;re<6;re++)if(Le){k?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,xe[re].width,xe[re].height,Fe,He,xe[re].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Ye,xe[re].width,xe[re].height,0,Fe,He,xe[re].data);for(let Pe=0;Pe<Te.length;Pe++){const Ct=Te[Pe].image[re].image;k?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,0,0,Ct.width,Ct.height,Fe,He,Ct.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,Ye,Ct.width,Ct.height,0,Fe,He,Ct.data)}}else{k?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,0,0,Fe,He,xe[re]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,0,Ye,Fe,He,xe[re]);for(let Pe=0;Pe<Te.length;Pe++){const Re=Te[Pe];k?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,0,0,Fe,He,Re.image[re]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+re,Pe+1,Ye,Fe,He,Re.image[re])}}}p(_)&&b(i.TEXTURE_CUBE_MAP),de.__version=J.version,_.onUpdate&&_.onUpdate(_)}A.__version=_.version}function Ue(A,_,H,W,J,de){const pe=r.convert(H.format,H.colorSpace),j=r.convert(H.type),se=v(H.internalFormat,pe,j,H.normalized,H.colorSpace),me=n.get(_),Le=n.get(H);if(Le.__renderTarget=_,!me.__hasExternalTextures){const xe=Math.max(1,_.width>>de),ge=Math.max(1,_.height>>de);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?t.texImage3D(J,de,se,xe,ge,_.depth,0,pe,j,null):t.texImage2D(J,de,se,xe,ge,0,pe,j,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),Me(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,W,J,Le.__webglTexture,0,ce(_)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,W,J,Le.__webglTexture,de),t.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(A,_,H){if(i.bindRenderbuffer(i.RENDERBUFFER,A),_.depthBuffer){const W=_.depthTexture,J=W&&W.isDepthTexture?W.type:null,de=E(_.stencilBuffer,J),pe=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Me(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ce(_),de,_.width,_.height):H?i.renderbufferStorageMultisample(i.RENDERBUFFER,ce(_),de,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,de,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,pe,i.RENDERBUFFER,A)}else{const W=_.textures;for(let J=0;J<W.length;J++){const de=W[J],pe=r.convert(de.format,de.colorSpace),j=r.convert(de.type),se=v(de.internalFormat,pe,j,de.normalized,de.colorSpace);Me(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ce(_),se,_.width,_.height):H?i.renderbufferStorageMultisample(i.RENDERBUFFER,ce(_),se,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,se,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ze(A,_,H){const W=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const J=n.get(_.depthTexture);if(J.__renderTarget=_,(!J.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),W){if(J.__webglInit===void 0&&(J.__webglInit=!0,_.depthTexture.addEventListener("dispose",w)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),ke(i.TEXTURE_CUBE_MAP,_.depthTexture);const me=r.convert(_.depthTexture.format),Le=r.convert(_.depthTexture.type);let xe;_.depthTexture.format===oi?xe=i.DEPTH_COMPONENT24:_.depthTexture.format===Vi&&(xe=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,xe,_.width,_.height,0,me,Le,null)}}else Q(_.depthTexture,0);const de=J.__webglTexture,pe=ce(_),j=W?i.TEXTURE_CUBE_MAP_POSITIVE_X+H:i.TEXTURE_2D,se=_.depthTexture.format===Vi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===oi)Me(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,se,j,de,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,se,j,de,0);else if(_.depthTexture.format===Vi)Me(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,se,j,de,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,se,j,de,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function ot(A){const _=n.get(A),H=A.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==A.depthTexture){const W=A.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),W){const J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=W}if(A.depthTexture&&!_.__autoAllocateDepthBuffer)if(H)for(let W=0;W<6;W++)Ze(_.__webglFramebuffer[W],A,W);else{const W=A.texture.mipmaps;W&&W.length>0?Ze(_.__webglFramebuffer[0],A,0):Ze(_.__webglFramebuffer,A,0)}else if(H){_.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[W]),_.__webglDepthbuffer[W]===void 0)_.__webglDepthbuffer[W]=i.createRenderbuffer(),vt(_.__webglDepthbuffer[W],A,!1);else{const J=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=_.__webglDepthbuffer[W];i.bindRenderbuffer(i.RENDERBUFFER,de),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,de)}}else{const W=A.texture.mipmaps;if(W&&W.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),vt(_.__webglDepthbuffer,A,!1);else{const J=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,de),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,de)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function U(A,_,H){const W=n.get(A);_!==void 0&&Ue(W.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),H!==void 0&&ot(A)}function L(A){const _=A.texture,H=n.get(A),W=n.get(_);A.addEventListener("dispose",x);const J=A.textures,de=A.isWebGLCubeRenderTarget===!0,pe=J.length>1;if(pe||(W.__webglTexture===void 0&&(W.__webglTexture=i.createTexture()),W.__version=_.version,a.memory.textures++),de){H.__webglFramebuffer=[];for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0){H.__webglFramebuffer[j]=[];for(let se=0;se<_.mipmaps.length;se++)H.__webglFramebuffer[j][se]=i.createFramebuffer()}else H.__webglFramebuffer[j]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){H.__webglFramebuffer=[];for(let j=0;j<_.mipmaps.length;j++)H.__webglFramebuffer[j]=i.createFramebuffer()}else H.__webglFramebuffer=i.createFramebuffer();if(pe)for(let j=0,se=J.length;j<se;j++){const me=n.get(J[j]);me.__webglTexture===void 0&&(me.__webglTexture=i.createTexture(),a.memory.textures++)}if(A.samples>0&&Me(A)===!1){H.__webglMultisampledFramebuffer=i.createFramebuffer(),H.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let j=0;j<J.length;j++){const se=J[j];H.__webglColorRenderbuffer[j]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,H.__webglColorRenderbuffer[j]);const me=r.convert(se.format,se.colorSpace),Le=r.convert(se.type),xe=v(se.internalFormat,me,Le,se.normalized,se.colorSpace,A.isXRRenderTarget===!0),ge=ce(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,xe,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+j,i.RENDERBUFFER,H.__webglColorRenderbuffer[j])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(H.__webglDepthRenderbuffer=i.createRenderbuffer(),vt(H.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(de){t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),ke(i.TEXTURE_CUBE_MAP,_);for(let j=0;j<6;j++)if(_.mipmaps&&_.mipmaps.length>0)for(let se=0;se<_.mipmaps.length;se++)Ue(H.__webglFramebuffer[j][se],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,se);else Ue(H.__webglFramebuffer[j],A,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);p(_)&&b(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let j=0,se=J.length;j<se;j++){const me=J[j],Le=n.get(me);let xe=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(xe=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(xe,Le.__webglTexture),ke(xe,me),Ue(H.__webglFramebuffer,A,me,i.COLOR_ATTACHMENT0+j,xe,0),p(me)&&b(xe)}t.unbindTexture()}else{let j=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(j=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(j,W.__webglTexture),ke(j,_),_.mipmaps&&_.mipmaps.length>0)for(let se=0;se<_.mipmaps.length;se++)Ue(H.__webglFramebuffer[se],A,_,i.COLOR_ATTACHMENT0,j,se);else Ue(H.__webglFramebuffer,A,_,i.COLOR_ATTACHMENT0,j,0);p(_)&&b(j),t.unbindTexture()}A.depthBuffer&&ot(A)}function I(A){const _=A.textures;for(let H=0,W=_.length;H<W;H++){const J=_[H];if(p(J)){const de=C(A),pe=n.get(J).__webglTexture;t.bindTexture(de,pe),b(de),t.unbindTexture()}}}const F=[],ne=[];function ie(A){if(A.samples>0){if(Me(A)===!1){const _=A.textures,H=A.width,W=A.height;let J=i.COLOR_BUFFER_BIT;const de=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pe=n.get(A),j=_.length>1;if(j)for(let me=0;me<_.length;me++)t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const se=A.texture.mipmaps;se&&se.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let me=0;me<_.length;me++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),j){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const Le=n.get(_[me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Le,0)}i.blitFramebuffer(0,0,H,W,0,0,H,W,J,i.NEAREST),l===!0&&(F.length=0,ne.length=0,F.push(i.COLOR_ATTACHMENT0+me),A.depthBuffer&&A.resolveDepthBuffer===!1&&(F.push(de),ne.push(de),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ne)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,F))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),j)for(let me=0;me<_.length;me++){t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const Le=n.get(_[me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,Le,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const _=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function ce(A){return Math.min(s.maxSamples,A.samples)}function Me(A){const _=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function D(A){const _=a.render.frame;d.get(A)!==_&&(d.set(A,_),A.update())}function Se(A,_){const H=A.colorSpace,W=A.format,J=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||H!==an&&H!==bi&&(it.getTransfer(H)===dt?(W!==fn||J!==rn)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ve("WebGLTextures: Unsupported texture color space:",H)),_}function Ae(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=Y,this.resetTextureUnits=V,this.getTextureUnits=q,this.setTextureUnits=O,this.setTexture2D=Q,this.setTexture2DArray=ae,this.setTexture3D=Z,this.setTextureCube=ue,this.rebindTextures=U,this.setupRenderTarget=L,this.updateRenderTargetMipmap=I,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=ot,this.setupFrameBufferTexture=Ue,this.useMultisampledRTT=Me,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Jx(i,e){function t(n,s=bi){let r;const a=it.getTransfer(s);if(n===rn)return i.UNSIGNED_BYTE;if(n===ql)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Yl)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Kd)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===$d)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===qd)return i.BYTE;if(n===Yd)return i.SHORT;if(n===mr)return i.UNSIGNED_SHORT;if(n===Xl)return i.INT;if(n===Gn)return i.UNSIGNED_INT;if(n===hn)return i.FLOAT;if(n===ai)return i.HALF_FLOAT;if(n===Zd)return i.ALPHA;if(n===Jd)return i.RGB;if(n===fn)return i.RGBA;if(n===oi)return i.DEPTH_COMPONENT;if(n===Vi)return i.DEPTH_STENCIL;if(n===Kl)return i.RED;if(n===$l)return i.RED_INTEGER;if(n===qi)return i.RG;if(n===Zl)return i.RG_INTEGER;if(n===Jl)return i.RGBA_INTEGER;if(n===ha||n===fa||n===pa||n===ma)if(a===dt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ha)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===fa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===pa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===ma)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ha)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===fa)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===pa)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===ma)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===qo||n===Yo||n===Ko||n===$o)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===qo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Yo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ko)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===$o)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Zo||n===Jo||n===jo||n===Qo||n===el||n===Ma||n===tl)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Zo||n===Jo)return a===dt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===jo)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Qo)return r.COMPRESSED_R11_EAC;if(n===el)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ma)return r.COMPRESSED_RG11_EAC;if(n===tl)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===nl||n===il||n===sl||n===rl||n===al||n===ol||n===ll||n===cl||n===ul||n===dl||n===hl||n===fl||n===pl||n===ml)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===nl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===il)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===sl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===rl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===al)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===ol)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ll)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===cl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ul)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===dl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===hl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===fl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===pl)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ml)return a===dt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===gl||n===_l||n===xl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===gl)return a===dt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===_l)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===xl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===vl||n===yl||n===Sa||n===Ml)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===vl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===yl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Sa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ml)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===gr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const jx=`
void main() {

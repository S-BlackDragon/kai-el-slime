...
`)}const Fv={[gh]:"Linear",[_h]:"Reinhard",[xh]:"Cineon",[vh]:"ACESFilmic",[Mh]:"AgX",[Sh]:"Neutral",[yh]:"Custom"};function kv(i,e){const t=Fv[e];return t===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const xa=new F;function Bv(){rt.getLuminanceCoefficients(xa);const i=xa.x.toFixed(4),e=xa.y.toFixed(4),t=xa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(gr).join(`
`)),a=ec(a),a=bd(a,t),a=Td(a,t),o=ec(o),o=bd(o,t),o=Td(o,t),a=Ed(a),o=Ed(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`)+`
`+m);const E=b+g+a,x=b+m+o,A=yd(s,s.VERTEX_SHADER,E),R=yd(s,s.FRAGMENT_SHADER,x);s.attachShader(y,A),s.attachShader(y,R),t.index0AttributeName!==void 0?s.bindAttribLocation(y,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function T(P){if(i.debug.checkShaderErrors){const w=s.getProgramInfoLog(y)||"",k=s.getShaderInfoLog(A)||"",V=s.getShaderInfoLog(R)||"",D=w.trim(),X=k.trim(),z=V.trim();let q=!0,te=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,y,A,R);else{const Z=Sd(s,A,"vertex"),oe=Sd(s,R,"fragment");Ge("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
Program Info Log: `+D+`
`+Z+`
`+oe)}else D!==""?Ie("WebGLProgram: Program Info Log:",D):(X===""||z==="")&&(te=!1);te&&(P.diagnostics={runnable:q,programLog:D,vertexShader:{log:X,prefix:g},fragmentShader:{log:z,prefix:m}})}s.deleteShader(A),s.deleteShader(R),v=new Pa(s,y),M=Vv(s,y)}let v;this.getUniforms=function(){return v===void 0&&T(this),v};let M;this.getAttributes=function(){return M===void 0&&T(this),M};let I=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(y,Lv)),I},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(y),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Dv++,this.cacheKey=e,this.usedTimes=1,this.program=y,this.vertexShader=A,this.fragmentShader=R,this}let sy=0;class ry{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){const s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new ay(e),t.set(e,n)),n}}class ay{constructor(e){this.id=sy++,this.code=e,this.usedTimes=0}}function oy(i){return i===Ki||i===Oa||i===Fa}function ly(i,e,t,n,s,r){const a=new Rc,o=new ry,l=new Set,c=[],u=new Map,d=n.logarithmicDepthBuffer;let h=n.precision;const f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function p(v){return l.add(v),v===0?"uv":`uv${v}`}function y(v,M,I,P,w,k){const V=P.fog,D=w.geometry,X=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?P.environment:null,z=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap,q=e.get(v.envMap||X,z),te=q&&q.mapping===Ka?q.image.height:null,Z=f[v.type];v.precision!==null&&(h=n.getMaxPrecision(v.precision),h!==v.precision&&Ie("WebGLProgram.getParameters:",v.precision,"not supported, using",h,"instead."));const oe=D.morphAttributes.position||D.morphAttributes.normal||D.morphAttributes.color,he=oe!==void 0?oe.length:0;let Qe=0;D.morphAttributes.position!==void 0&&(Qe=1),D.morphAttributes.normal!==void 0&&(Qe=2),D.morphAttributes.color!==void 0&&(Qe=3);let ct,Be,ne,ue;if(Z){const Ce=Bn[Z];ct=Ce.vertexShader,Be=Ce.fragmentShader}else{ct=v.vertexShader,Be=v.fragmentShader;const Ce=o.getVertexShaderStage(v),Ct=o.getFragmentShaderStage(v);o.update(v,Ce,Ct),ne=Ce.id,ue=Ct.id}const ce=i.getRenderTarget(),ze=i.state.buffers.depth.getReversed(),Xe=w.isInstancedMesh===!0,Oe=w.isBatchedMesh===!0,vt=!!v.map,je=!!v.matcap,ot=!!q,O=!!v.aoMap,N=!!v.lightMap,L=!!v.bumpMap&&v.wireframe===!1,B=!!v.normalMap,ee=!!v.displacementMap,ie=!!v.emissiveMap,le=!!v.metalnessMap,xe=!!v.roughnessMap,U=v.anisotropy>0,Se=v.clearcoat>0,Re=v.dispersion>0,C=v.iridescence>0,_=v.sheen>0,W=v.transmission>0,Y=U&&!!v.anisotropyMap,j=Se&&!!v.clearcoatMap,de=Se&&!!v.clearcoatNormalMap,pe=Se&&!!v.clearcoatRoughnessMap,Q=C&&!!v.iridescenceMap,re=C&&!!v.iridescenceThicknessMap,me=_&&!!v.sheenColorMap,De=_&&!!v.sheenRoughnessMap,ve=!!v.specularMap,ge=!!v.specularColorMap,Fe=!!v.specularIntensityMap,Ve=W&&!!v.transmissionMap,Ze=W&&!!v.thicknessMap,H=!!v.gradientMap,fe=!!v.alphaMap,se=v.alphaTest>0,_e=!!v.alphaHash,Ee=!!v.extensions;let ae=Gn;v.toneMapped&&(ce===null||ce.isXRRenderTarget===!0)&&(ae=i.toneMapping);const Le={shaderID:Z,shaderType:v.type,shaderName:v.name,vertexShader:ct,fragmentShader:Be,defines:v.defines,customVertexShaderID:ne,customFragmentShaderID:ue,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:h,batching:Oe,batchingColor:Oe&&w._colorsTexture!==null,instancing:Xe,instancingColor:Xe&&w.instanceColor!==null,instancingMorph:Xe&&w.morphTexture!==null,outputColorSpace:ce===null?i.outputColorSpace:ce.isXRRenderTarget===!0?ce.texture.colorSpace:rt.workingColorSpace,alphaToCoverage:!!v.alphaToCoverage,map:vt,matcap:je,envMap:ot,envMapMode:ot&&q.mapping,envMapCubeUVHeight:te,aoMap:O,lightMap:N,bumpMap:L,normalMap:B,displacementMap:ee,emissiveMap:ie,normalMapObjectSpace:B&&v.normalMapType===pp,normalMapTangentSpace:B&&v.normalMapType===Gl,packedNormalMap:B&&v.normalMapType===Gl&&oy(v.normalMap.format),metalnessMap:le,roughnessMap:xe,anisotropy:U,anisotropyMap:Y,clearcoat:Se,clearcoatMap:j,clearcoatNormalMap:de,clearcoatRoughnessMap:pe,dispersion:Re,iridescence:C,iridescenceMap:Q,iridescenceThicknessMap:re,sheen:_,sheenColorMap:me,sheenRoughnessMap:De,specularMap:ve,specularColorMap:ge,specularIntensityMap:Fe,transmission:W,transmissionMap:Ve,thicknessMap:Ze,gradientMap:H,opaque:v.transparent===!1&&v.blending===Ps&&v.alphaToCoverage===!1,alphaMap:fe,alphaTest:se,alphaHash:_e,combine:v.combine,mapUv:vt&&p(v.map.channel),aoMapUv:O&&p(v.aoMap.channel),lightMapUv:N&&p(v.lightMap.channel),bumpMapUv:L&&p(v.bumpMap.channel),normalMapUv:B&&p(v.normalMap.channel),displacementMapUv:ee&&p(v.displacementMap.channel),emissiveMapUv:ie&&p(v.emissiveMap.channel),metalnessMapUv:le&&p(v.metalnessMap.channel),roughnessMapUv:xe&&p(v.roughnessMap.channel),anisotropyMapUv:Y&&p(v.anisotropyMap.channel),clearcoatMapUv:j&&p(v.clearcoatMap.channel),clearcoatNormalMapUv:de&&p(v.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:pe&&p(v.clearcoatRoughnessMap.channel),iridescenceMapUv:Q&&p(v.iridescenceMap.channel),iridescenceThicknessMapUv:re&&p(v.iridescenceThicknessMap.channel),sheenColorMapUv:me&&p(v.sheenColorMap.channel),sheenRoughnessMapUv:De&&p(v.sheenRoughnessMap.channel),specularMapUv:ve&&p(v.specularMap.channel),specularColorMapUv:ge&&p(v.specularColorMap.channel),specularIntensityMapUv:Fe&&p(v.specularIntensityMap.channel),transmissionMapUv:Ve&&p(v.transmissionMap.channel),thicknessMapUv:Ze&&p(v.thicknessMap.channel),alphaMapUv:fe&&p(v.alphaMap.channel),vertexTangents:!!D.attributes.tangent&&(B||U),vertexNormals:!!D.attributes.normal,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!D.attributes.color&&D.attributes.color.itemSize===4,pointsUvs:w.isPoints===!0&&!!D.attributes.uv&&(vt||fe),fog:!!V,useFog:v.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:v.wireframe===!1&&(v.flatShading===!0||D.attributes.normal===void 0&&B===!1&&(v.isMeshLambertMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isMeshPhysicalMaterial)),sizeAttenuation:v.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:ze,skinning:w.isSkinnedMesh===!0,hasPositionAttribute:D.attributes.position!==void 0,morphTargets:D.morphAttributes.position!==void 0,morphNormals:D.morphAttributes.normal!==void 0,morphColors:D.morphAttributes.color!==void 0,morphTargetsCount:he,morphTextureStride:Qe,numDirLights:M.directional.length,numPointLights:M.point.length,numSpotLights:M.spot.length,numSpotLightMaps:M.spotLightMap.length,numRectAreaLights:M.rectArea.length,numHemiLights:M.hemi.length,numDirLightShadows:M.directionalShadowMap.length,numPointLightShadows:M.pointShadowMap.length,numSpotLightShadows:M.spotShadowMap.length,numSpotLightShadowsWithMaps:M.numSpotLightShadowsWithMaps,numLightProbes:M.numLightProbes,numLightProbeGrids:k.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:v.dithering,shadowMapEnabled:i.shadowMap.enabled&&I.length>0,shadowMapType:i.shadowMap.type,toneMapping:ae,decodeVideoTexture:vt&&v.map.isVideoTexture===!0&&rt.getTransfer(v.map.colorSpace)===ht,decodeVideoTextureEmissive:ie&&v.emissiveMap.isVideoTexture===!0&&rt.getTransfer(v.emissiveMap.colorSpace)===ht,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===zn,flipSided:v.side===nn,useDepthPacking:v.depthPacking>=0,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionClipCullDistance:Ee&&v.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(Ee&&v.extensions.multiDraw===!0||Oe)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:v.customProgramCacheKey()};return Le.vertexUv1s=l.has(1),Le.vertexUv2s=l.has(2),Le.vertexUv3s=l.has(3),l.clear(),Le}function g(v){const M=[];if(v.shaderID?M.push(v.shaderID):(M.push(v.customVertexShaderID),M.push(v.customFragmentShaderID)),v.defines!==void 0)for(const I in v.defines)M.push(I),M.push(v.defines[I]);return v.isRawShaderMaterial===!1&&(m(M,v),b(M,v),M.push(i.outputColorSpace)),M.push(v.customProgramCacheKey),M.join()}function m(v,M){v.push(M.precision),v.push(M.outputColorSpace),v.push(M.envMapMode),v.push(M.envMapCubeUVHeight),v.push(M.mapUv),v.push(M.alphaMapUv),v.push(M.lightMapUv),v.push(M.aoMapUv),v.push(M.bumpMapUv),v.push(M.normalMapUv),v.push(M.displacementMapUv),v.push(M.emissiveMapUv),v.push(M.metalnessMapUv),v.push(M.roughnessMapUv),v.push(M.anisotropyMapUv),v.push(M.clearcoatMapUv),v.push(M.clearcoatNormalMapUv),v.push(M.clearcoatRoughnessMapUv),v.push(M.iridescenceMapUv),v.push(M.iridescenceThicknessMapUv),v.push(M.sheenColorMapUv),v.push(M.sheenRoughnessMapUv),v.push(M.specularMapUv),v.push(M.specularColorMapUv),v.push(M.specularIntensityMapUv),v.push(M.transmissionMapUv),v.push(M.thicknessMapUv),v.push(M.combine),v.push(M.fogExp2),v.push(M.sizeAttenuation),v.push(M.morphTargetsCount),v.push(M.morphAttributeCount),v.push(M.numDirLights),v.push(M.numPointLights),v.push(M.numSpotLights),v.push(M.numSpotLightMaps),v.push(M.numHemiLights),v.push(M.numRectAreaLights),v.push(M.numDirLightShadows),v.push(M.numPointLightShadows),v.push(M.numSpotLightShadows),v.push(M.numSpotLightShadowsWithMaps),v.push(M.numLightProbes),v.push(M.shadowMapType),v.push(M.toneMapping),v.push(M.numClippingPlanes),v.push(M.numClipIntersection),v.push(M.depthPacking)}function b(v,M){a.disableAll(),M.instancing&&a.enable(0),M.instancingColor&&a.enable(1),M.instancingMorph&&a.enable(2),M.matcap&&a.enable(3),M.envMap&&a.enable(4),M.normalMapObjectSpace&&a.enable(5),M.normalMapTangentSpace&&a.enable(6),M.clearcoat&&a.enable(7),M.iridescence&&a.enable(8),M.alphaTest&&a.enable(9),M.vertexColors&&a.enable(10),M.vertexAlphas&&a.enable(11),M.vertexUv1s&&a.enable(12),M.vertexUv2s&&a.enable(13),M.vertexUv3s&&a.enable(14),M.vertexTangents&&a.enable(15),M.anisotropy&&a.enable(16),M.alphaHash&&a.enable(17),M.batching&&a.enable(18),M.dispersion&&a.enable(19),M.batchingColor&&a.enable(20),M.gradientMap&&a.enable(21),M.packedNormalMap&&a.enable(22),M.vertexNormals&&a.enable(23),v.push(a.mask),a.disableAll(),M.fog&&a.enable(0),M.useFog&&a.enable(1),M.flatShading&&a.enable(2),M.logarithmicDepthBuffer&&a.enable(3),M.reversedDepthBuffer&&a.enable(4),M.skinning&&a.enable(5),M.morphTargets&&a.enable(6),M.morphNormals&&a.enable(7),M.morphColors&&a.enable(8),M.premultipliedAlpha&&a.enable(9),M.shadowMapEnabled&&a.enable(10),M.doubleSided&&a.enable(11),M.flipSided&&a.enable(12),M.useDepthPacking&&a.enable(13),M.dithering&&a.enable(14),M.transmission&&a.enable(15),M.sheen&&a.enable(16),M.opaque&&a.enable(17),M.pointsUvs&&a.enable(18),M.decodeVideoTexture&&a.enable(19),M.decodeVideoTextureEmissive&&a.enable(20),M.alphaToCoverage&&a.enable(21),M.numLightProbeGrids>0&&a.enable(22),M.hasPositionAttribute&&a.enable(23),v.push(a.mask)}function E(v){const M=f[v.type];let I;if(M){const P=Bn[M];I=Qm.clone(P.uniforms)}else I=v.uniforms;return I}function x(v,M){let I=u.get(M);return I!==void 0?++I.usedTimes:(I=new iy(i,M,v,s),c.push(I),u.set(M,I)),I}function A(v){if(--v.usedTimes===0){const M=c.indexOf(v);c[M]=c[c.length-1],c.pop(),u.delete(v.cacheKey),v.destroy()}}function R(v){o.remove(v)}function T(){o.dispose()}return{getParameters:y,getProgramCacheKey:g,getUniforms:E,acquireProgram:x,releaseProgram:A,releaseShaderCache:R,programs:c,dispose:T}}function cy(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function uy(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function wd(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function Rd(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h){let f=0;return h.isInstancedMesh&&(f+=2),h.isSkinnedMesh&&(f+=1),f}function o(h,f,p,y,g,m){let b=i[e];return b===void 0?(b={id:h.id,object:h,geometry:f,material:p,materialVariant:a(h),groupOrder:y,renderOrder:h.renderOrder,z:g,group:m},i[e]=b):(b.id=h.id,b.object=h,b.geometry=f,b.material=p,b.materialVariant=a(h),b.groupOrder=y,b.renderOrder=h.renderOrder,b.z=g,b.group=m),e++,b}function l(h,f,p,y,g,m){const b=o(h,f,p,y,g,m);p.transmission>0?n.push(b):p.transparent===!0?s.push(b):t.push(b)}function c(h,f,p,y,g,m){const b=o(h,f,p,y,g,m);p.transmission>0?n.unshift(b):p.transparent===!0?s.unshift(b):t.unshift(b)}function u(h,f,p){t.length>1&&t.sort(h||uy),n.length>1&&n.sort(f||wd),s.length>1&&s.sort(f||wd),p&&(t.reverse(),n.reverse(),s.reverse())}function d(){for(let h=e,f=i.length;h<f;h++){const p=i[h];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:d,sort:u}}function dy(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new Rd,i.set(n,[a])):s>=r.length?(a=new Rd,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function hy(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new F,color:new We};break;case"SpotLight":t={position:new F,direction:new F,color:new We,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new F,color:new We,distance:0,decay:0};break;case"HemisphereLight":t={direction:new F,skyColor:new We,groundColor:new We};break;case"RectAreaLight":t={color:new We,position:new F,halfWidth:new F,halfHeight:new F};break}return i[e.id]=t,t}}}function fy(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Te,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let py=0;function my(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function gy(i){const e=new hy,t=fy(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new F);const s=new F,r=new $e,a=new $e;function o(c){let u=0,d=0,h=0;for(let M=0;M<9;M++)n.probe[M].set(0,0,0);let f=0,p=0,y=0,g=0,m=0,b=0,E=0,x=0,A=0,R=0,T=0;c.sort(my);for(let M=0,I=c.length;M<I;M++){const P=c[M],w=P.color,k=P.intensity,V=P.distance;let D=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===Ki?D=P.shadow.map.texture:D=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)u+=w.r*k,d+=w.g*k,h+=w.b*k;else if(P.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(P.sh.coefficients[X],k);T++}else if(P.isDirectionalLight){const X=e.get(P);if(X.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const z=P.shadow,q=t.get(P);q.shadowIntensity=z.intensity,q.shadowBias=z.bias,q.shadowNormalBias=z.normalBias,q.shadowRadius=z.radius,q.shadowMapSize=z.mapSize,n.directionalShadow[f]=q,n.directionalShadowMap[f]=D,n.directionalShadowMatrix[f]=P.shadow.matrix,b++}n.directional[f]=X,f++}else if(P.isSpotLight){const X=e.get(P);X.position.setFromMatrixPosition(P.matrixWorld),X.color.copy(w).multiplyScalar(k),X.distance=V,X.coneCos=Math.cos(P.angle),X.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),X.decay=P.decay,n.spot[y]=X;const z=P.shadow;if(P.map&&(n.spotLightMap[A]=P.map,A++,z.updateMatrices(P),P.castShadow&&R++),n.spotLightMatrix[y]=z.matrix,P.castShadow){const q=t.get(P);q.shadowIntensity=z.intensity,q.shadowBias=z.bias,q.shadowNormalBias=z.normalBias,q.shadowRadius=z.radius,q.shadowMapSize=z.mapSize,n.spotShadow[y]=q,n.spotShadowMap[y]=D,x++}y++}else if(P.isRectAreaLight){const X=e.get(P);X.color.copy(w).multiplyScalar(k),X.halfWidth.set(P.width*.5,0,0),X.halfHeight.set(0,P.height*.5,0),n.rectArea[g]=X,g++}else if(P.isPointLight){const X=e.get(P);if(X.color.copy(P.color).multiplyScalar(P.intensity),X.distance=P.distance,X.decay=P.decay,P.castShadow){const z=P.shadow,q=t.get(P);q.shadowIntensity=z.intensity,q.shadowBias=z.bias,q.shadowNormalBias=z.normalBias,q.shadowRadius=z.radius,q.shadowMapSize=z.mapSize,q.shadowCameraNear=z.camera.near,q.shadowCameraFar=z.camera.far,n.pointShadow[p]=q,n.pointShadowMap[p]=D,n.pointShadowMatrix[p]=P.shadow.matrix,E++}n.point[p]=X,p++}else if(P.isHemisphereLight){const X=e.get(P);X.skyColor.copy(P.color).multiplyScalar(k),X.groundColor.copy(P.groundColor).multiplyScalar(k),n.hemi[m]=X,m++}}g>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ye.LTC_FLOAT_1,n.rectAreaLTC2=ye.LTC_FLOAT_2):(n.rectAreaLTC1=ye.LTC_HALF_1,n.rectAreaLTC2=ye.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=d,n.ambient[2]=h;const v=n.hash;(v.directionalLength!==f||v.pointLength!==p||v.spotLength!==y||v.rectAreaLength!==g||v.hemiLength!==m||v.numDirectionalShadows!==b||v.numPointShadows!==E||v.numSpotShadows!==x||v.numSpotMaps!==A||v.numLightProbes!==T)&&(n.directional.length=f,n.spot.length=y,n.rectArea.length=g,n.point.length=p,n.hemi.length=m,n.directionalShadow.length=b,n.directionalShadowMap.length=b,n.pointShadow.length=E,n.pointShadowMap.length=E,n.spotShadow.length=x,n.spotShadowMap.length=x,n.directionalShadowMatrix.length=b,n.pointShadowMatrix.length=E,n.spotLightMatrix.length=x+A-R,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=R,n.numLightProbes=T,v.directionalLength=f,v.pointLength=p,v.spotLength=y,v.rectAreaLength=g,v.hemiLength=m,v.numDirectionalShadows=b,v.numPointShadows=E,v.numSpotShadows=x,v.numSpotMaps=A,v.numLightProbes=T,n.version=py++)}function l(c,u){let d=0,h=0,f=0,p=0,y=0;const g=u.matrixWorldInverse;for(let m=0,b=c.length;m<b;m++){const E=c[m];if(E.isDirectionalLight){const x=n.directional[d];x.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),x.direction.sub(s),x.direction.transformDirection(g),d++}else if(E.isSpotLight){const x=n.spot[f];x.position.setFromMatrixPosition(E.matrixWorld),x.position.applyMatrix4(g),x.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),x.direction.sub(s),x.direction.transformDirection(g),f++}else if(E.isRectAreaLight){const x=n.rectArea[p];x.position.setFromMatrixPosition(E.matrixWorld),x.position.applyMatrix4(g),a.identity(),r.copy(E.matrixWorld),r.premultiply(g),a.extractRotation(r),x.halfWidth.set(E.width*.5,0,0),x.halfHeight.set(0,E.height*.5,0),x.halfWidth.applyMatrix4(a),x.halfHeight.applyMatrix4(a),p++}else if(E.isPointLight){const x=n.point[h];x.position.setFromMatrixPosition(E.matrixWorld),x.position.applyMatrix4(g),h++}else if(E.isHemisphereLight){const x=n.hemi[y];x.direction.setFromMatrixPosition(E.matrixWorld),x.direction.transformDirection(g),y++}}}return{setup:o,setupView:l,state:n}}function Cd(i){const e=new gy(i),t=[],n=[],s=[];function r(h){d.camera=h,t.length=0,n.length=0,s.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function l(h){s.push(h)}function c(){e.setup(t)}function u(h){e.setupView(t,h)}const d={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:c,setupLightsView:u,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function _y(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new Cd(i),e.set(s,[o])):r>=a.length?(o=new Cd(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const xy=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,yy=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],My=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],Pd=new $e,or=new F,Vo=new F;function Sy(i,e,t){let n=new Lc;const s=new Te,r=new Te,a=new gt,o=new ig,l=new sg,c={},u=t.maxTextureSize,d={[li]:nn,[nn]:li,[zn]:zn},h=new qn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:xy,fragmentShader:vy}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const p=new tn;p.setAttribute("position",new en(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new It(p,h),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ta;let m=this.type;this.render=function(R,T,v){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||R.length===0)return;this.type===Hf&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Ta);const M=i.getRenderTarget(),I=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),w=i.state;w.setBlending(ai),w.buffers.depth.getReversed()===!0?w.buffers.color.setClear(0,0,0,0):w.buffers.color.setClear(1,1,1,1),w.buffers.depth.setTest(!0),w.setScissorTest(!1);const k=m!==this.type;k&&T.traverse(function(V){V.material&&(Array.isArray(V.material)?V.material.forEach(D=>D.needsUpdate=!0):V.material.needsUpdate=!0)});for(let V=0,D=R.length;V<D;V++){const X=R[V],z=X.shadow;if(z===void 0){Ie("WebGLShadowMap:",X,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;s.copy(z.mapSize);const q=z.getFrameExtents();s.multiply(q),r.copy(z.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/q.x),s.x=r.x*q.x,z.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/q.y),s.y=r.y*q.y,z.mapSize.y=r.y));const te=i.state.buffers.depth.getReversed();if(z.camera._reversedDepth=te,z.map===null||k===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===fr){if(X.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new Wn(s.x,s.y,{format:Ki,type:ci,minFilter:Rt,magFilter:Rt,generateMipmaps:!1}),z.map.texture.name=X.name+".shadowMap",z.map.depthTexture=new zs(s.x,s.y,mn),z.map.depthTexture.name=X.name+".shadowMapDepth",z.map.depthTexture.format=ui,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=wt,z.map.depthTexture.magFilter=wt}else X.isPointLight?(z.map=new uf(s.x),z.map.depthTexture=new vm(s.x,Xn)):(z.map=new Wn(s.x,s.y),z.map.depthTexture=new zs(s.x,s.y,Xn)),z.map.depthTexture.name=X.name+".shadowMap",z.map.depthTexture.format=ui,this.type===Ta?(z.map.depthTexture.compareFunction=te?Ec:Tc,z.map.depthTexture.minFilter=Rt,z.map.depthTexture.magFilter=Rt):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=wt,z.map.depthTexture.magFilter=wt);z.camera.updateProjectionMatrix()}const Z=z.map.isWebGLCubeRenderTarget?6:1;for(let oe=0;oe<Z;oe++){if(z.map.isWebGLCubeRenderTarget)i.setRenderTarget(z.map,oe),i.clear();else{oe===0&&(i.setRenderTarget(z.map),i.clear());const he=z.getViewport(oe);a.set(r.x*he.x,r.y*he.y,r.x*he.z,r.y*he.w),w.viewport(a)}if(X.isPointLight){const he=z.camera,Qe=z.matrix,ct=X.distance||he.far;ct!==he.far&&(he.far=ct,he.updateProjectionMatrix()),or.setFromMatrixPosition(X.matrixWorld),he.position.copy(or),Vo.copy(he.position),Vo.add(yy[oe]),he.up.copy(My[oe]),he.lookAt(Vo),he.updateMatrixWorld(),Qe.makeTranslation(-or.x,-or.y,-or.z),Pd.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Pd,he.coordinateSystem,he.reversedDepth)}else z.updateMatrices(X);n=z.getFrustum(),x(T,v,z.camera,X,this.type)}z.isPointLightShadow!==!0&&this.type===fr&&b(z,v),z.needsUpdate=!1}m=this.type,g.needsUpdate=!1,i.setRenderTarget(M,I,P)};function b(R,T){const v=e.update(y);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,f.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Wn(s.x,s.y,{format:Ki,type:ci})),h.uniforms.shadow_pass.value=R.map.depthTexture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(T,null,v,h,y,null),f.uniforms.shadow_pass.value=R.mapPass.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(T,null,v,f,y,null)}function E(R,T,v,M){let I=null;const P=v.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(P!==void 0)I=P;else if(I=v.isPointLight===!0?l:o,i.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0||T.alphaToCoverage===!0){const w=I.uuid,k=T.uuid;let V=c[w];V===void 0&&(V={},c[w]=V);let D=V[k];D===void 0&&(D=I.clone(),V[k]=D,T.addEventListener("dispose",A)),I=D}if(I.visible=T.visible,I.wireframe=T.wireframe,M===fr?I.side=T.shadowSide!==null?T.shadowSide:T.side:I.side=T.shadowSide!==null?T.shadowSide:d[T.side],I.alphaMap=T.alphaMap,I.alphaTest=T.alphaToCoverage===!0?.5:T.alphaTest,I.map=T.map,I.clipShadows=T.clipShadows,I.clippingPlanes=T.clippingPlanes,I.clipIntersection=T.clipIntersection,I.displacementMap=T.displacementMap,I.displacementScale=T.displacementScale,I.displacementBias=T.displacementBias,I.wireframeLinewidth=T.wireframeLinewidth,I.linewidth=T.linewidth,v.isPointLight===!0&&I.isMeshDistanceMaterial===!0){const w=i.properties.get(I);w.light=v}return I}function x(R,T,v,M,I){if(R.visible===!1)return;if(R.layers.test(T.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&I===fr)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(v.matrixWorldInverse,R.matrixWorld);const k=e.update(R),V=R.material;if(Array.isArray(V)){const D=k.groups;for(let X=0,z=D.length;X<z;X++){const q=D[X],te=V[q.materialIndex];if(te&&te.visible){const Z=E(R,te,M,I);R.onBeforeShadow(i,R,T,v,k,Z,q),i.renderBufferDirect(v,null,k,Z,R,q),R.onAfterShadow(i,R,T,v,k,Z,q)}}}else if(V.visible){const D=E(R,V,M,I);R.onBeforeShadow(i,R,T,v,k,D,null),i.renderBufferDirect(v,null,k,D,R,null),R.onAfterShadow(i,R,T,v,k,D,null)}}const w=R.children;for(let k=0,V=w.length;k<V;k++)x(w[k],T,v,M,I)}function A(R){R.target.removeEventListener("dispose",A);for(const v in c){const M=c[v],I=R.target.uuid;I in M&&(M[I].dispose(),delete M[I])}}}function by(i,e){function t(){let H=!1;const fe=new gt;let se=null;const _e=new gt(0,0,0,0);return{setMask:function(Ee){se!==Ee&&!H&&(i.colorMask(Ee,Ee,Ee,Ee),se=Ee)},setLocked:function(Ee){H=Ee},setClear:function(Ee,ae,Le,Ce,Ct){Ct===!0&&(Ee*=Ce,ae*=Ce,Le*=Ce),fe.set(Ee,ae,Le,Ce),_e.equals(fe)===!1&&(i.clearColor(Ee,ae,Le,Ce),_e.copy(fe))},reset:function(){H=!1,se=null,_e.set(-1,0,0,0)}}}function n(){let H=!1,fe=!1,se=null,_e=null,Ee=null;return{setReversed:function(ae){if(fe!==ae){const Le=e.get("EXT_clip_control");ae?Le.clipControlEXT(Le.LOWER_LEFT_EXT,Le.ZERO_TO_ONE_EXT):Le.clipControlEXT(Le.LOWER_LEFT_EXT,Le.NEGATIVE_ONE_TO_ONE_EXT),fe=ae;const Ce=Ee;Ee=null,this.setClear(Ce)}},getReversed:function(){return fe},setTest:function(ae){ae?ce(i.DEPTH_TEST):ze(i.DEPTH_TEST)},setMask:function(ae){se!==ae&&!H&&(i.depthMask(ae),se=ae)},setFunc:function(ae){if(fe&&(ae=Ep[ae]),_e!==ae){switch(ae){case rl:i.depthFunc(i.NEVER);break;case al:i.depthFunc(i.ALWAYS);break;case ol:i.depthFunc(i.LESS);break;case Os:i.depthFunc(i.LEQUAL);break;case ll:i.depthFunc(i.EQUAL);break;case cl:i.depthFunc(i.GEQUAL);break;case ul:i.depthFunc(i.GREATER);break;case dl:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}_e=ae}},setLocked:function(ae){H=ae},setClear:function(ae){Ee!==ae&&(Ee=ae,fe&&(ae=1-ae),i.clearDepth(ae))},reset:function(){H=!1,se=null,_e=null,Ee=null,fe=!1}}}function s(){let H=!1,fe=null,se=null,_e=null,Ee=null,ae=null,Le=null,Ce=null,Ct=null;return{setTest:function(yt){H||(yt?ce(i.STENCIL_TEST):ze(i.STENCIL_TEST))},setMask:function(yt){fe!==yt&&!H&&(i.stencilMask(yt),fe=yt)},setFunc:function(yt,Dn,Nn){(se!==yt||_e!==Dn||Ee!==Nn)&&(i.stencilFunc(yt,Dn,Nn),se=yt,_e=Dn,Ee=Nn)},setOp:function(yt,Dn,Nn){(ae!==yt||Le!==Dn||Ce!==Nn)&&(i.stencilOp(yt,Dn,Nn),ae=yt,Le=Dn,Ce=Nn)},setLocked:function(yt){H=yt},setClear:function(yt){Ct!==yt&&(i.clearStencil(yt),Ct=yt)},reset:function(){H=!1,fe=null,se=null,_e=null,Ee=null,ae=null,Le=null,Ce=null,Ct=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let u={},d={},h={},f=new WeakMap,p=[],y=null,g=!1,m=null,b=null,E=null,x=null,A=null,R=null,T=null,v=new We(0,0,0),M=0,I=!1,P=null,w=null,k=null,V=null,D=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,q=0;const te=i.getParameter(i.VERSION);te.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(te)[1]),z=q>=1):te.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),z=q>=2);let Z=null,oe={};const he=i.getParameter(i.SCISSOR_BOX),Qe=i.getParameter(i.VIEWPORT),ct=new gt().fromArray(he),Be=new gt().fromArray(Qe);function ne(H,fe,se,_e){const Ee=new Uint8Array(4),ae=i.createTexture();i.bindTexture(H,ae),i.texParameteri(H,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(H,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Le=0;Le<se;Le++)H===i.TEXTURE_3D||H===i.TEXTURE_2D_ARRAY?i.texImage3D(fe,0,i.RGBA,1,1,_e,0,i.RGBA,i.UNSIGNED_BYTE,Ee):i.texImage2D(fe+Le,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Ee);return ae}const ue={};ue[i.TEXTURE_2D]=ne(i.TEXTURE_2D,i.TEXTURE_2D,1),ue[i.TEXTURE_CUBE_MAP]=ne(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ue[i.TEXTURE_2D_ARRAY]=ne(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ue[i.TEXTURE_3D]=ne(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ce(i.DEPTH_TEST),a.setFunc(Os),L(!1),B(au),ce(i.CULL_FACE),O(ai);function ce(H){u[H]!==!0&&(i.enable(H),u[H]=!0)}function ze(H){u[H]!==!1&&(i.disable(H),u[H]=!1)}function Xe(H,fe){return h[H]!==fe?(i.bindFramebuffer(H,fe),h[H]=fe,H===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=fe),H===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=fe),!0):!1}function Oe(H,fe){let se=p,_e=!1;if(H){se=f.get(fe),se===void 0&&(se=[],f.set(fe,se));const Ee=H.textures;if(se.length!==Ee.length||se[0]!==i.COLOR_ATTACHMENT0){for(let ae=0,Le=Ee.length;ae<Le;ae++)se[ae]=i.COLOR_ATTACHMENT0+ae;se.length=Ee.length,_e=!0}}else se[0]!==i.BACK&&(se[0]=i.BACK,_e=!0);_e&&i.drawBuffers(se)}function vt(H){return y!==H?(i.useProgram(H),y=H,!0):!1}const je={[Vi]:i.FUNC_ADD,[Gf]:i.FUNC_SUBTRACT,[Wf]:i.FUNC_REVERSE_SUBTRACT};je[Xf]=i.MIN,je[qf]=i.MAX;const ot={[Yf]:i.ZERO,[Kf]:i.ONE,[$f]:i.SRC_COLOR,[il]:i.SRC_ALPHA,[tp]:i.SRC_ALPHA_SATURATE,[Qf]:i.DST_COLOR,[Jf]:i.DST_ALPHA,[Zf]:i.ONE_MINUS_SRC_COLOR,[sl]:i.ONE_MINUS_SRC_ALPHA,[ep]:i.ONE_MINUS_DST_COLOR,[jf]:i.ONE_MINUS_DST_ALPHA,[np]:i.CONSTANT_COLOR,[ip]:i.ONE_MINUS_CONSTANT_COLOR,[sp]:i.CONSTANT_ALPHA,[rp]:i.ONE_MINUS_CONSTANT_ALPHA};function O(H,fe,se,_e,Ee,ae,Le,Ce,Ct,yt){if(H===ai){g===!0&&(ze(i.BLEND),g=!1);return}if(g===!1&&(ce(i.BLEND),g=!0),H!==Vf){if(H!==m||yt!==I){if((b!==Vi||A!==Vi)&&(i.blendEquation(i.FUNC_ADD),b=Vi,A=Vi),yt)switch(H){case Ps:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nl:i.blendFunc(i.ONE,i.ONE);break;case ou:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case lu:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ge("WebGLState: Invalid blending: ",H);break}else switch(H){case Ps:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case nl:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case ou:Ge("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case lu:Ge("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ge("WebGLState: Invalid blending: ",H);break}E=null,x=null,R=null,T=null,v.set(0,0,0),M=0,m=H,I=yt}return}Ee=Ee||fe,ae=ae||se,Le=Le||_e,(fe!==b||Ee!==A)&&(i.blendEquationSeparate(je[fe],je[Ee]),b=fe,A=Ee),(se!==E||_e!==x||ae!==R||Le!==T)&&(i.blendFuncSeparate(ot[se],ot[_e],ot[ae],ot[Le]),E=se,x=_e,R=ae,T=Le),(Ce.equals(v)===!1||Ct!==M)&&(i.blendColor(Ce.r,Ce.g,Ce.b,Ct),v.copy(Ce),M=Ct),m=H,I=!1}function N(H,fe){H.side===zn?ze(i.CULL_FACE):ce(i.CULL_FACE);let se=H.side===nn;fe&&(se=!se),L(se),H.blending===Ps&&H.transparent===!1?O(ai):O(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),a.setFunc(H.depthFunc),a.setTest(H.depthTest),a.setMask(H.depthWrite),r.setMask(H.colorWrite);const _e=H.stencilWrite;o.setTest(_e),_e&&(o.setMask(H.stencilWriteMask),o.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),o.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),ie(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?ce(i.SAMPLE_ALPHA_TO_COVERAGE):ze(i.SAMPLE_ALPHA_TO_COVERAGE)}function L(H){P!==H&&(H?i.frontFace(i.CW):i.frontFace(i.CCW),P=H)}function B(H){H!==Bf?(ce(i.CULL_FACE),H!==w&&(H===au?i.cullFace(i.BACK):H===zf?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ze(i.CULL_FACE),w=H}function ee(H){H!==k&&(z&&i.lineWidth(H),k=H)}function ie(H,fe,se){H?(ce(i.POLYGON_OFFSET_FILL),(V!==fe||D!==se)&&(V=fe,D=se,a.getReversed()&&(fe=-fe),i.polygonOffset(fe,se))):ze(i.POLYGON_OFFSET_FILL)}function le(H){H?ce(i.SCISSOR_TEST):ze(i.SCISSOR_TEST)}function xe(H){H===void 0&&(H=i.TEXTURE0+X-1),Z!==H&&(i.activeTexture(H),Z=H)}function U(H,fe,se){se===void 0&&(Z===null?se=i.TEXTURE0+X-1:se=Z);let _e=oe[se];_e===void 0&&(_e={type:void 0,texture:void 0},oe[se]=_e),(_e.type!==H||_e.texture!==fe)&&(Z!==se&&(i.activeTexture(se),Z=se),i.bindTexture(H,fe||ue[H]),_e.type=H,_e.texture=fe)}function Se(){const H=oe[Z];H!==void 0&&H.type!==void 0&&(i.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function Re(){try{i.compressedTexImage2D(...arguments)}catch(H){Ge("WebGLState:",H)}}function C(){try{i.compressedTexImage3D(...arguments)}catch(H){Ge("WebGLState:",H)}}function _(){try{i.texSubImage2D(...arguments)}catch(H){Ge("WebGLState:",H)}}function W(){try{i.texSubImage3D(...arguments)}catch(H){Ge("WebGLState:",H)}}function Y(){try{i.compressedTexSubImage2D(...arguments)}catch(H){Ge("WebGLState:",H)}}function j(){try{i.compressedTexSubImage3D(...arguments)}catch(H){Ge("WebGLState:",H)}}function de(){try{i.texStorage2D(...arguments)}catch(H){Ge("WebGLState:",H)}}function pe(){try{i.texStorage3D(...arguments)}catch(H){Ge("WebGLState:",H)}}function Q(){try{i.texImage2D(...arguments)}catch(H){Ge("WebGLState:",H)}}function re(){try{i.texImage3D(...arguments)}catch(H){Ge("WebGLState:",H)}}function me(H){return d[H]!==void 0?d[H]:i.getParameter(H)}function De(H,fe){d[H]!==fe&&(i.pixelStorei(H,fe),d[H]=fe)}function ve(H){ct.equals(H)===!1&&(i.scissor(H.x,H.y,H.z,H.w),ct.copy(H))}function ge(H){Be.equals(H)===!1&&(i.viewport(H.x,H.y,H.z,H.w),Be.copy(H))}function Fe(H,fe){let se=c.get(fe);se===void 0&&(se=new WeakMap,c.set(fe,se));let _e=se.get(H);_e===void 0&&(_e=i.getUniformBlockIndex(fe,H.name),se.set(H,_e))}function Ve(H,fe){const _e=c.get(fe).get(H);l.get(fe)!==_e&&(i.uniformBlockBinding(fe,_e,H.__bindingPointIndex),l.set(fe,_e))}function Ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),u={},d={},Z=null,oe={},h={},f=new WeakMap,p=[],y=null,g=!1,m=null,b=null,E=null,x=null,A=null,R=null,T=null,v=new We(0,0,0),M=0,I=!1,P=null,w=null,k=null,V=null,D=null,ct.set(0,0,i.canvas.width,i.canvas.height),Be.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ce,disable:ze,bindFramebuffer:Xe,drawBuffers:Oe,useProgram:vt,setBlending:O,setMaterial:N,setFlipSided:L,setCullFace:B,setLineWidth:ee,setPolygonOffset:ie,setScissorTest:le,activeTexture:xe,bindTexture:U,unbindTexture:Se,compressedTexImage2D:Re,compressedTexImage3D:C,texImage2D:Q,texImage3D:re,pixelStorei:De,getParameter:me,updateUBOMapping:Fe,uniformBlockBinding:Ve,texStorage2D:de,texStorage3D:pe,texSubImage2D:_,texSubImage3D:W,compressedTexSubImage2D:Y,compressedTexSubImage3D:j,scissor:ve,viewport:ge,reset:Ze}}function Ty(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Te,u=new WeakMap,d=new Set;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(C,_){return p?new OffscreenCanvas(C,_):Cr("canvas")}function g(C,_,W){let Y=1;const j=Re(C);if((j.width>W||j.height>W)&&(Y=W/Math.max(j.width,j.height)),Y<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const de=Math.floor(Y*j.width),pe=Math.floor(Y*j.height);h===void 0&&(h=y(de,pe));const Q=_?y(de,pe):h;return Q.width=de,Q.height=pe,Q.getContext("2d").drawImage(C,0,0,de,pe),Ie("WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+de+"x"+pe+")."),Q}else return"data"in C&&Ie("WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),C;return C}function m(C){return C.generateMipmaps}function b(C){i.generateMipmap(C)}function E(C){return C.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?i.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function x(C,_,W,Y,j,de=!1){if(C!==null){if(i[C]!==void 0)return i[C];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let pe;Y&&(pe=e.get("EXT_texture_norm16"),pe||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Q=_;if(_===i.RED&&(W===i.FLOAT&&(Q=i.R32F),W===i.HALF_FLOAT&&(Q=i.R16F),W===i.UNSIGNED_BYTE&&(Q=i.R8),W===i.UNSIGNED_SHORT&&pe&&(Q=pe.R16_EXT),W===i.SHORT&&pe&&(Q=pe.R16_SNORM_EXT)),_===i.RED_INTEGER&&(W===i.UNSIGNED_BYTE&&(Q=i.R8UI),W===i.UNSIGNED_SHORT&&(Q=i.R16UI),W===i.UNSIGNED_INT&&(Q=i.R32UI),W===i.BYTE&&(Q=i.R8I),W===i.SHORT&&(Q=i.R16I),W===i.INT&&(Q=i.R32I)),_===i.RG&&(W===i.FLOAT&&(Q=i.RG32F),W===i.HALF_FLOAT&&(Q=i.RG16F),W===i.UNSIGNED_BYTE&&(Q=i.RG8),W===i.UNSIGNED_SHORT&&pe&&(Q=pe.RG16_EXT),W===i.SHORT&&pe&&(Q=pe.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(W===i.UNSIGNED_BYTE&&(Q=i.RG8UI),W===i.UNSIGNED_SHORT&&(Q=i.RG16UI),W===i.UNSIGNED_INT&&(Q=i.RG32UI),W===i.BYTE&&(Q=i.RG8I),W===i.SHORT&&(Q=i.RG16I),W===i.INT&&(Q=i.RG32I)),_===i.RGB_INTEGER&&(W===i.UNSIGNED_BYTE&&(Q=i.RGB8UI),W===i.UNSIGNED_SHORT&&(Q=i.RGB16UI),W===i.UNSIGNED_INT&&(Q=i.RGB32UI),W===i.BYTE&&(Q=i.RGB8I),W===i.SHORT&&(Q=i.RGB16I),W===i.INT&&(Q=i.RGB32I)),_===i.RGBA_INTEGER&&(W===i.UNSIGNED_BYTE&&(Q=i.RGBA8UI),W===i.UNSIGNED_SHORT&&(Q=i.RGBA16UI),W===i.UNSIGNED_INT&&(Q=i.RGBA32UI),W===i.BYTE&&(Q=i.RGBA8I),W===i.SHORT&&(Q=i.RGBA16I),W===i.INT&&(Q=i.RGBA32I)),_===i.RGB&&(W===i.UNSIGNED_SHORT&&pe&&(Q=pe.RGB16_EXT),W===i.SHORT&&pe&&(Q=pe.RGB16_SNORM_EXT),W===i.UNSIGNED_INT_5_9_9_9_REV&&(Q=i.RGB9_E5),W===i.UNSIGNED_INT_10F_11F_11F_REV&&(Q=i.R11F_G11F_B10F)),_===i.RGBA){const re=de?Ba:rt.getTransfer(j);W===i.FLOAT&&(Q=i.RGBA32F),W===i.HALF_FLOAT&&(Q=i.RGBA16F),W===i.UNSIGNED_BYTE&&(Q=re===ht?i.SRGB8_ALPHA8:i.RGBA8),W===i.UNSIGNED_SHORT&&pe&&(Q=pe.RGBA16_EXT),W===i.SHORT&&pe&&(Q=pe.RGBA16_SNORM_EXT),W===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),W===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function A(C,_){let W;return C?_===null||_===Xn||_===Er?W=i.DEPTH24_STENCIL8:_===mn?W=i.DEPTH32F_STENCIL8:_===Tr&&(W=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===Xn||_===Er?W=i.DEPTH_COMPONENT24:_===mn?W=i.DEPTH_COMPONENT32F:_===Tr&&(W=i.DEPTH_COMPONENT16),W}function R(C,_){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==wt&&C.minFilter!==Rt?Math.log2(Math.max(_.width,_.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?_.mipmaps.length:1}function T(C){const _=C.target;_.removeEventListener("dispose",T),M(_),_.isVideoTexture&&u.delete(_),_.isHTMLTexture&&d.delete(_)}function v(C){const _=C.target;_.removeEventListener("dispose",v),P(_)}function M(C){const _=n.get(C);if(_.__webglInit===void 0)return;const W=C.source,Y=f.get(W);if(Y){const j=Y[_.__cacheKey];j.usedTimes--,j.usedTimes===0&&I(C),Object.keys(Y).length===0&&f.delete(W)}n.remove(C)}function I(C){const _=n.get(C);i.deleteTexture(_.__webglTexture);const W=C.source,Y=f.get(W);delete Y[_.__cacheKey],a.memory.textures--}function P(C){const _=n.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),n.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(_.__webglFramebuffer[Y]))for(let j=0;j<_.__webglFramebuffer[Y].length;j++)i.deleteFramebuffer(_.__webglFramebuffer[Y][j]);else i.deleteFramebuffer(_.__webglFramebuffer[Y]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[Y])}else{if(Array.isArray(_.__webglFramebuffer))for(let Y=0;Y<_.__webglFramebuffer.length;Y++)i.deleteFramebuffer(_.__webglFramebuffer[Y]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let Y=0;Y<_.__webglColorRenderbuffer.length;Y++)_.__webglColorRenderbuffer[Y]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[Y]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}const W=C.textures;for(let Y=0,j=W.length;Y<j;Y++){const de=n.get(W[Y]);de.__webglTexture&&(i.deleteTexture(de.__webglTexture),a.memory.textures--),n.remove(W[Y])}n.remove(C)}let w=0;function k(){w=0}function V(){return w}function D(C){w=C}function X(){const C=w;return C>=s.maxTextures&&Ie("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),w+=1,C}function z(C){const _=[];return _.push(C.wrapS),_.push(C.wrapT),_.push(C.wrapR||0),_.push(C.magFilter),_.push(C.minFilter),_.push(C.anisotropy),_.push(C.internalFormat),_.push(C.format),_.push(C.type),_.push(C.generateMipmaps),_.push(C.premultiplyAlpha),_.push(C.flipY),_.push(C.unpackAlignment),_.push(C.colorSpace),_.join()}function q(C,_){const W=n.get(C);if(C.isVideoTexture&&U(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&W.__version!==C.version){const Y=C.image;if(Y===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{ze(W,C,_);return}}else C.isExternalTexture&&(W.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,W.__webglTexture,i.TEXTURE0+_)}function te(C,_){const W=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&W.__version!==C.version){ze(W,C,_);return}else C.isExternalTexture&&(W.__webglTexture=C.sourceTexture?C.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,W.__webglTexture,i.TEXTURE0+_)}function Z(C,_){const W=n.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&W.__version!==C.version){ze(W,C,_);return}t.bindTexture(i.TEXTURE_3D,W.__webglTexture,i.TEXTURE0+_)}function oe(C,_){const W=n.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&W.__version!==C.version){Xe(W,C,_);return}t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture,i.TEXTURE0+_)}const he={[ks]:i.REPEAT,[Hn]:i.CLAMP_TO_EDGE,[Ua]:i.MIRRORED_REPEAT},Qe={[wt]:i.NEAREST,[Th]:i.NEAREST_MIPMAP_NEAREST,[pr]:i.NEAREST_MIPMAP_LINEAR,[Rt]:i.LINEAR,[Ea]:i.LINEAR_MIPMAP_NEAREST,[ii]:i.LINEAR_MIPMAP_LINEAR},ct={[mp]:i.NEVER,[yp]:i.ALWAYS,[gp]:i.LESS,[Tc]:i.LEQUAL,[_p]:i.EQUAL,[Ec]:i.GEQUAL,[xp]:i.GREATER,[vp]:i.NOTEQUAL};function Be(C,_){if(_.type===mn&&e.has("OES_texture_float_linear")===!1&&(_.magFilter===Rt||_.magFilter===Ea||_.magFilter===pr||_.magFilter===ii||_.minFilter===Rt||_.minFilter===Ea||_.minFilter===pr||_.minFilter===ii)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(C,i.TEXTURE_WRAP_S,he[_.wrapS]),i.texParameteri(C,i.TEXTURE_WRAP_T,he[_.wrapT]),(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)&&i.texParameteri(C,i.TEXTURE_WRAP_R,he[_.wrapR]),i.texParameteri(C,i.TEXTURE_MAG_FILTER,Qe[_.magFilter]),i.texParameteri(C,i.TEXTURE_MIN_FILTER,Qe[_.minFilter]),_.compareFunction&&(i.texParameteri(C,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(C,i.TEXTURE_COMPARE_FUNC,ct[_.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===wt||_.minFilter!==pr&&_.minFilter!==ii||_.type===mn&&e.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){const W=e.get("EXT_texture_filter_anisotropic");i.texParameterf(C,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function ne(C,_){let W=!1;C.__webglInit===void 0&&(C.__webglInit=!0,_.addEventListener("dispose",T));const Y=_.source;let j=f.get(Y);j===void 0&&(j={},f.set(Y,j));const de=z(_);if(de!==C.__cacheKey){j[de]===void 0&&(j[de]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,W=!0),j[de].usedTimes++;const pe=j[C.__cacheKey];pe!==void 0&&(j[C.__cacheKey].usedTimes--,pe.usedTimes===0&&I(_)),C.__cacheKey=de,C.__webglTexture=j[de].texture}return W}function ue(C,_,W){return Math.floor(Math.floor(C/W)/_)}function ce(C,_,W,Y){const de=C.updateRanges;if(de.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,W,Y,_.data);else{de.sort((De,ve)=>De.start-ve.start);let pe=0;for(let De=1;De<de.length;De++){const ve=de[pe],ge=de[De],Fe=ve.start+ve.count,Ve=ue(ge.start,_.width,4),Ze=ue(ve.start,_.width,4);ge.start<=Fe+1&&Ve===Ze&&ue(ge.start+ge.count-1,_.width,4)===Ve?ve.count=Math.max(ve.count,ge.start+ge.count-ve.start):(++pe,de[pe]=ge)}de.length=pe+1;const Q=t.getParameter(i.UNPACK_ROW_LENGTH),re=t.getParameter(i.UNPACK_SKIP_PIXELS),me=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let De=0,ve=de.length;De<ve;De++){const ge=de[De],Fe=Math.floor(ge.start/4),Ve=Math.ceil(ge.count/4),Ze=Fe%_.width,H=Math.floor(Fe/_.width),fe=Ve,se=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Ze),t.pixelStorei(i.UNPACK_SKIP_ROWS,H),t.texSubImage2D(i.TEXTURE_2D,0,Ze,H,fe,se,W,Y,_.data)}C.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,Q),t.pixelStorei(i.UNPACK_SKIP_PIXELS,re),t.pixelStorei(i.UNPACK_SKIP_ROWS,me)}}function ze(C,_,W){let Y=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(Y=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(Y=i.TEXTURE_3D);const j=ne(C,_),de=_.source;t.bindTexture(Y,C.__webglTexture,i.TEXTURE0+W);const pe=n.get(de);if(de.version!==pe.__version||j===!0){if(t.activeTexture(i.TEXTURE0+W),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){const se=rt.getPrimaries(rt.workingColorSpace),_e=_.colorSpace===Si?null:rt.getPrimaries(_.colorSpace),Ee=_.colorSpace===Si||se===_e?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee)}t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let re=g(_.image,!1,s.maxTextureSize);re=Se(_,re);const me=r.convert(_.format,_.colorSpace),De=r.convert(_.type);let ve=x(_.internalFormat,me,De,_.normalized,_.colorSpace,_.isVideoTexture);Be(Y,_);let ge;const Fe=_.mipmaps,Ve=_.isVideoTexture!==!0,Ze=pe.__version===void 0||j===!0,H=de.dataReady,fe=R(_,re);if(_.isDepthTexture)ve=A(_.format===Wi,_.type),Ze&&(Ve?t.texStorage2D(i.TEXTURE_2D,1,ve,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,ve,re.width,re.height,0,me,De,null));else if(_.isDataTexture)if(Fe.length>0){Ve&&Ze&&t.texStorage2D(i.TEXTURE_2D,fe,ve,Fe[0].width,Fe[0].height);for(let se=0,_e=Fe.length;se<_e;se++)ge=Fe[se],Ve?H&&t.texSubImage2D(i.TEXTURE_2D,se,0,0,ge.width,ge.height,me,De,ge.data):t.texImage2D(i.TEXTURE_2D,se,ve,ge.width,ge.height,0,me,De,ge.data);_.generateMipmaps=!1}else Ve?(Ze&&t.texStorage2D(i.TEXTURE_2D,fe,ve,re.width,re.height),H&&ce(_,re,me,De)):t.texImage2D(i.TEXTURE_2D,0,ve,re.width,re.height,0,me,De,re.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ve&&Ze&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,ve,Fe[0].width,Fe[0].height,re.depth);for(let se=0,_e=Fe.length;se<_e;se++)if(ge=Fe[se],_.format!==gn)if(me!==null)if(Ve){if(H)if(_.layerUpdates.size>0){const Ee=od(ge.width,ge.height,_.format,_.type);for(const ae of _.layerUpdates){const Le=ge.data.subarray(ae*Ee/ge.data.BYTES_PER_ELEMENT,(ae+1)*Ee/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,se,0,0,ae,ge.width,ge.height,1,me,Le)}_.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,se,0,0,0,ge.width,ge.height,re.depth,me,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,se,ve,ge.width,ge.height,re.depth,0,ge.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ve?H&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,se,0,0,0,ge.width,ge.height,re.depth,me,De,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,se,ve,ge.width,ge.height,re.depth,0,me,De,ge.data)}else{Ve&&Ze&&t.texStorage2D(i.TEXTURE_2D,fe,ve,Fe[0].width,Fe[0].height);for(let se=0,_e=Fe.length;se<_e;se++)ge=Fe[se],_.format!==gn?me!==null?Ve?H&&t.compressedTexSubImage2D(i.TEXTURE_2D,se,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,se,ve,ge.width,ge.height,0,ge.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ve?H&&t.texSubImage2D(i.TEXTURE_2D,se,0,0,ge.width,ge.height,me,De,ge.data):t.texImage2D(i.TEXTURE_2D,se,ve,ge.width,ge.height,0,me,De,ge.data)}else if(_.isDataArrayTexture)if(Ve){if(Ze&&t.texStorage3D(i.TEXTURE_2D_ARRAY,fe,ve,re.width,re.height,re.depth),H)if(_.layerUpdates.size>0){const se=od(re.width,re.height,_.format,_.type);for(const _e of _.layerUpdates){const Ee=re.data.subarray(_e*se/re.data.BYTES_PER_ELEMENT,(_e+1)*se/re.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,_e,re.width,re.height,1,me,De,Ee)}_.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,me,De,re.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ve,re.width,re.height,re.depth,0,me,De,re.data);else if(_.isData3DTexture)Ve?(Ze&&t.texStorage3D(i.TEXTURE_3D,fe,ve,re.width,re.height,re.depth),H&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,me,De,re.data)):t.texImage3D(i.TEXTURE_3D,0,ve,re.width,re.height,re.depth,0,me,De,re.data);else if(_.isFramebufferTexture){if(Ze)if(Ve)t.texStorage2D(i.TEXTURE_2D,fe,ve,re.width,re.height);else{let se=re.width,_e=re.height;for(let Ee=0;Ee<fe;Ee++)t.texImage2D(i.TEXTURE_2D,Ee,ve,se,_e,0,me,De,null),se>>=1,_e>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){const se=i.canvas;if(se.hasAttribute("layoutsubtree")||se.setAttribute("layoutsubtree","true"),re.parentNode!==se){se.appendChild(re),d.add(_),se.onpaint=_e=>{const Ee=_e.changedElements;for(const ae of d)Ee.includes(ae.image)&&(ae.needsUpdate=!0)},se.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,re);else{const Ee=i.RGBA,ae=i.RGBA,Le=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,Ee,ae,Le,re)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Fe.length>0){if(Ve&&Ze){const se=Re(Fe[0]);t.texStorage2D(i.TEXTURE_2D,fe,ve,se.width,se.height)}for(let se=0,_e=Fe.length;se<_e;se++)ge=Fe[se],Ve?H&&t.texSubImage2D(i.TEXTURE_2D,se,0,0,me,De,ge):t.texImage2D(i.TEXTURE_2D,se,ve,me,De,ge);_.generateMipmaps=!1}else if(Ve){if(Ze){const se=Re(re);t.texStorage2D(i.TEXTURE_2D,fe,ve,se.width,se.height)}H&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,De,re)}else t.texImage2D(i.TEXTURE_2D,0,ve,me,De,re);m(_)&&b(Y),pe.__version=de.version,_.onUpdate&&_.onUpdate(_)}C.__version=_.version}function Xe(C,_,W){if(_.image.length!==6)return;const Y=ne(C,_),j=_.source;t.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+W);const de=n.get(j);if(j.version!==de.__version||Y===!0){t.activeTexture(i.TEXTURE0+W);const pe=rt.getPrimaries(rt.workingColorSpace),Q=_.colorSpace===Si?null:rt.getPrimaries(_.colorSpace),re=_.colorSpace===Si||pe===Q?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,re);const me=_.isCompressedTexture||_.image[0].isCompressedTexture,De=_.image[0]&&_.image[0].isDataTexture,ve=[];for(let ae=0;ae<6;ae++)!me&&!De?ve[ae]=g(_.image[ae],!0,s.maxCubemapSize):ve[ae]=De?_.image[ae].image:_.image[ae],ve[ae]=Se(_,ve[ae]);const ge=ve[0],Fe=r.convert(_.format,_.colorSpace),Ve=r.convert(_.type),Ze=x(_.internalFormat,Fe,Ve,_.normalized,_.colorSpace),H=_.isVideoTexture!==!0,fe=de.__version===void 0||Y===!0,se=j.dataReady;let _e=R(_,ge);Be(i.TEXTURE_CUBE_MAP,_);let Ee;if(me){H&&fe&&t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ze,ge.width,ge.height);for(let ae=0;ae<6;ae++){Ee=ve[ae].mipmaps;for(let Le=0;Le<Ee.length;Le++){const Ce=Ee[Le];_.format!==gn?Fe!==null?H?se&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,0,0,Ce.width,Ce.height,Fe,Ce.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,Ze,Ce.width,Ce.height,0,Ce.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):H?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,0,0,Ce.width,Ce.height,Fe,Ve,Ce.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le,Ze,Ce.width,Ce.height,0,Fe,Ve,Ce.data)}}}else{if(Ee=_.mipmaps,H&&fe){Ee.length>0&&_e++;const ae=Re(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,_e,Ze,ae.width,ae.height)}for(let ae=0;ae<6;ae++)if(De){H?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,ve[ae].width,ve[ae].height,Fe,Ve,ve[ae].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,ve[ae].width,ve[ae].height,0,Fe,Ve,ve[ae].data);for(let Le=0;Le<Ee.length;Le++){const Ct=Ee[Le].image[ae].image;H?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,0,0,Ct.width,Ct.height,Fe,Ve,Ct.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,Ze,Ct.width,Ct.height,0,Fe,Ve,Ct.data)}}else{H?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,0,0,Fe,Ve,ve[ae]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0,Ze,Fe,Ve,ve[ae]);for(let Le=0;Le<Ee.length;Le++){const Ce=Ee[Le];H?se&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,0,0,Fe,Ve,Ce.image[ae]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Le+1,Ze,Fe,Ve,Ce.image[ae])}}}m(_)&&b(i.TEXTURE_CUBE_MAP),de.__version=j.version,_.onUpdate&&_.onUpdate(_)}C.__version=_.version}function Oe(C,_,W,Y,j,de){const pe=r.convert(W.format,W.colorSpace),Q=r.convert(W.type),re=x(W.internalFormat,pe,Q,W.normalized,W.colorSpace),me=n.get(_),De=n.get(W);if(De.__renderTarget=_,!me.__hasExternalTextures){const ve=Math.max(1,_.width>>de),ge=Math.max(1,_.height>>de);j===i.TEXTURE_3D||j===i.TEXTURE_2D_ARRAY?t.texImage3D(j,de,re,ve,ge,_.depth,0,pe,Q,null):t.texImage2D(j,de,re,ve,ge,0,pe,Q,null)}t.bindFramebuffer(i.FRAMEBUFFER,C),xe(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Y,j,De.__webglTexture,0,le(_)):(j===i.TEXTURE_2D||j>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,Y,j,De.__webglTexture,de),t.bindFramebuffer(i.FRAMEBUFFER,null)}function vt(C,_,W){if(i.bindRenderbuffer(i.RENDERBUFFER,C),_.depthBuffer){const Y=_.depthTexture,j=Y&&Y.isDepthTexture?Y.type:null,de=A(_.stencilBuffer,j),pe=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;xe(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,le(_),de,_.width,_.height):W?i.renderbufferStorageMultisample(i.RENDERBUFFER,le(_),de,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,de,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,pe,i.RENDERBUFFER,C)}else{const Y=_.textures;for(let j=0;j<Y.length;j++){const de=Y[j],pe=r.convert(de.format,de.colorSpace),Q=r.convert(de.type),re=x(de.internalFormat,pe,Q,de.normalized,de.colorSpace);xe(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,le(_),re,_.width,_.height):W?i.renderbufferStorageMultisample(i.RENDERBUFFER,le(_),re,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,re,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function je(C,_,W){const Y=_.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,C),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const j=n.get(_.depthTexture);if(j.__renderTarget=_,(!j.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),Y){if(j.__webglInit===void 0&&(j.__webglInit=!0,_.depthTexture.addEventListener("dispose",T)),j.__webglTexture===void 0){j.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),Be(i.TEXTURE_CUBE_MAP,_.depthTexture);const me=r.convert(_.depthTexture.format),De=r.convert(_.depthTexture.type);let ve;_.depthTexture.format===ui?ve=i.DEPTH_COMPONENT24:_.depthTexture.format===Wi&&(ve=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ve,_.width,_.height,0,me,De,null)}}else q(_.depthTexture,0);const de=j.__webglTexture,pe=le(_),Q=Y?i.TEXTURE_CUBE_MAP_POSITIVE_X+W:i.TEXTURE_2D,re=_.depthTexture.format===Wi?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===ui)xe(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,re,Q,de,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,re,Q,de,0);else if(_.depthTexture.format===Wi)xe(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,re,Q,de,0,pe):i.framebufferTexture2D(i.FRAMEBUFFER,re,Q,de,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function ot(C){const _=n.get(C),W=C.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==C.depthTexture){const Y=C.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),Y){const j=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,Y.removeEventListener("dispose",j)};Y.addEventListener("dispose",j),_.__depthDisposeCallback=j}_.__boundDepthTexture=Y}if(C.depthTexture&&!_.__autoAllocateDepthBuffer)if(W)for(let Y=0;Y<6;Y++)je(_.__webglFramebuffer[Y],C,Y);else{const Y=C.texture.mipmaps;Y&&Y.length>0?je(_.__webglFramebuffer[0],C,0):je(_.__webglFramebuffer,C,0)}else if(W){_.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[Y]),_.__webglDepthbuffer[Y]===void 0)_.__webglDepthbuffer[Y]=i.createRenderbuffer(),vt(_.__webglDepthbuffer[Y],C,!1);else{const j=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=_.__webglDepthbuffer[Y];i.bindRenderbuffer(i.RENDERBUFFER,de),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,de)}}else{const Y=C.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),vt(_.__webglDepthbuffer,C,!1);else{const j=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,de),i.framebufferRenderbuffer(i.FRAMEBUFFER,j,i.RENDERBUFFER,de)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function O(C,_,W){const Y=n.get(C);_!==void 0&&Oe(Y.__webglFramebuffer,C,C.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),W!==void 0&&ot(C)}function N(C){const _=C.texture,W=n.get(C),Y=n.get(_);C.addEventListener("dispose",v);const j=C.textures,de=C.isWebGLCubeRenderTarget===!0,pe=j.length>1;if(pe||(Y.__webglTexture===void 0&&(Y.__webglTexture=i.createTexture()),Y.__version=_.version,a.memory.textures++),de){W.__webglFramebuffer=[];for(let Q=0;Q<6;Q++)if(_.mipmaps&&_.mipmaps.length>0){W.__webglFramebuffer[Q]=[];for(let re=0;re<_.mipmaps.length;re++)W.__webglFramebuffer[Q][re]=i.createFramebuffer()}else W.__webglFramebuffer[Q]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){W.__webglFramebuffer=[];for(let Q=0;Q<_.mipmaps.length;Q++)W.__webglFramebuffer[Q]=i.createFramebuffer()}else W.__webglFramebuffer=i.createFramebuffer();if(pe)for(let Q=0,re=j.length;Q<re;Q++){const me=n.get(j[Q]);me.__webglTexture===void 0&&(me.__webglTexture=i.createTexture(),a.memory.textures++)}if(C.samples>0&&xe(C)===!1){W.__webglMultisampledFramebuffer=i.createFramebuffer(),W.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,W.__webglMultisampledFramebuffer);for(let Q=0;Q<j.length;Q++){const re=j[Q];W.__webglColorRenderbuffer[Q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,W.__webglColorRenderbuffer[Q]);const me=r.convert(re.format,re.colorSpace),De=r.convert(re.type),ve=x(re.internalFormat,me,De,re.normalized,re.colorSpace,C.isXRRenderTarget===!0),ge=le(C);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ve,C.width,C.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Q,i.RENDERBUFFER,W.__webglColorRenderbuffer[Q])}i.bindRenderbuffer(i.RENDERBUFFER,null),C.depthBuffer&&(W.__webglDepthRenderbuffer=i.createRenderbuffer(),vt(W.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(de){t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),Be(i.TEXTURE_CUBE_MAP,_);for(let Q=0;Q<6;Q++)if(_.mipmaps&&_.mipmaps.length>0)for(let re=0;re<_.mipmaps.length;re++)Oe(W.__webglFramebuffer[Q][re],C,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,re);else Oe(W.__webglFramebuffer[Q],C,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0);m(_)&&b(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(pe){for(let Q=0,re=j.length;Q<re;Q++){const me=j[Q],De=n.get(me);let ve=i.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ve=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,De.__webglTexture),Be(ve,me),Oe(W.__webglFramebuffer,C,me,i.COLOR_ATTACHMENT0+Q,ve,0),m(me)&&b(ve)}t.unbindTexture()}else{let Q=i.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Q=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Q,Y.__webglTexture),Be(Q,_),_.mipmaps&&_.mipmaps.length>0)for(let re=0;re<_.mipmaps.length;re++)Oe(W.__webglFramebuffer[re],C,_,i.COLOR_ATTACHMENT0,Q,re);else Oe(W.__webglFramebuffer,C,_,i.COLOR_ATTACHMENT0,Q,0);m(_)&&b(Q),t.unbindTexture()}C.depthBuffer&&ot(C)}function L(C){const _=C.textures;for(let W=0,Y=_.length;W<Y;W++){const j=_[W];if(m(j)){const de=E(C),pe=n.get(j).__webglTexture;t.bindTexture(de,pe),b(de),t.unbindTexture()}}}const B=[],ee=[];function ie(C){if(C.samples>0){if(xe(C)===!1){const _=C.textures,W=C.width,Y=C.height;let j=i.COLOR_BUFFER_BIT;const de=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,pe=n.get(C),Q=_.length>1;if(Q)for(let me=0;me<_.length;me++)t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,pe.__webglMultisampledFramebuffer);const re=C.texture.mipmaps;re&&re.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglFramebuffer);for(let me=0;me<_.length;me++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(j|=i.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(j|=i.STENCIL_BUFFER_BIT)),Q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const De=n.get(_[me]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,De,0)}i.blitFramebuffer(0,0,W,Y,0,0,W,Y,j,i.NEAREST),l===!0&&(B.length=0,ee.length=0,B.push(i.COLOR_ATTACHMENT0+me),C.depthBuffer&&C.resolveDepthBuffer===!1&&(B.push(de),ee.push(de),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ee)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,B))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Q)for(let me=0;me<_.length;me++){t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.RENDERBUFFER,pe.__webglColorRenderbuffer[me]);const De=n.get(_[me]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,pe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+me,i.TEXTURE_2D,De,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,pe.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const _=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function le(C){return Math.min(s.maxSamples,C.samples)}function xe(C){const _=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function U(C){const _=a.render.frame;u.get(C)!==_&&(u.set(C,_),C.update())}function Se(C,_){const W=C.colorSpace,Y=C.format,j=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||W!==cn&&W!==Si&&(rt.getTransfer(W)===ht?(Y!==gn||j!==on)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ge("WebGLTextures: Unsupported texture color space:",W)),_}function Re(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=k,this.getTextureUnits=V,this.setTextureUnits=D,this.setTexture2D=q,this.setTexture2DArray=te,this.setTexture3D=Z,this.setTextureCube=oe,this.rebindTextures=O,this.setupRenderTarget=N,this.updateRenderTargetMipmap=L,this.updateMultisampleRenderTarget=ie,this.setupDepthRenderbuffer=ot,this.setupFrameBufferTexture=Oe,this.useMultisampledRTT=xe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Ey(i,e){function t(n,s=Si){let r;const a=rt.getTransfer(s);if(n===on)return i.UNSIGNED_BYTE;if(n===_c)return i.UNSIGNED_SHORT_4_4_4_4;if(n===xc)return i.UNSIGNED_SHORT_5_5_5_1;if(n===wh)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Rh)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Eh)return i.BYTE;if(n===Ah)return i.SHORT;if(n===Tr)return i.UNSIGNED_SHORT;if(n===gc)return i.INT;if(n===Xn)return i.UNSIGNED_INT;if(n===mn)return i.FLOAT;if(n===ci)return i.HALF_FLOAT;if(n===Ch)return i.ALPHA;if(n===Ph)return i.RGB;if(n===gn)return i.RGBA;if(n===ui)return i.DEPTH_COMPONENT;if(n===Wi)return i.DEPTH_STENCIL;if(n===vc)return i.RED;if(n===yc)return i.RED_INTEGER;if(n===Ki)return i.RG;if(n===Mc)return i.RG_INTEGER;if(n===Sc)return i.RGBA_INTEGER;if(n===Aa||n===wa||n===Ra||n===Ca)if(a===ht)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Aa)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===wa)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ra)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ca)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Aa)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===wa)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ra)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ca)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===hl||n===fl||n===pl||n===ml)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===hl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===fl)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===pl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ml)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===gl||n===_l||n===xl||n===vl||n===yl||n===Oa||n===Ml)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===gl||n===_l)return a===ht?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===xl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===vl)return r.COMPRESSED_R11_EAC;if(n===yl)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Oa)return r.COMPRESSED_RG11_EAC;if(n===Ml)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Sl||n===bl||n===Tl||n===El||n===Al||n===wl||n===Rl||n===Cl||n===Pl||n===Il||n===Ll||n===Dl||n===Nl||n===Ul)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Sl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===bl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Tl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===El)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Al)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===wl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Rl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Cl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Pl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Il)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ll)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Dl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Nl)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Ul)return a===ht?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ol||n===Fl||n===kl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Ol)return a===ht?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Fl)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===kl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Bl||n===zl||n===Fa||n===Hl)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Bl)return r.COMPRESSED_RED_RGTC1_EXT;if(n===zl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Fa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Hl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Er?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Ay=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      <div class="screen screen-title">
        ...
        <div class="title-row">
          ...
          <button class="title-play">${T?"Nueva expedición":"Entrar al Pozo"}</button>
        </div>
      ...
      </div>`,s.querySelector(".title-play").addEventListener("click",()=>{const M=s.querySelector(".title-seed").value.trim(),I=M?Number(M)>>>0:Math.floor(Math.random()*4294967295)>>>0;p(I)}),s.querySelector(".title-continue")?.addEventListener("click",()=>{const M=t.data.expedicion;M&&(e.reset(M.seed,{...cc(t),resume:{...M}}),d=null,u=0,c=!1,y(),e.paused=!1)})}function p(T){e.reset(T,cc(t)),d=null,u=0,c=!1,y(),e.paused=!1}function y(){r=!1,a=!1,o=!1,document.body.classList.remove("at-title"),s.innerHTML=""}function g(T){t.saveExpedition({seed:T.seed,nivel:T.floor.level,items:[...T.player.items],usable:T.player.usable?.itemId??null,usable2:T.player.usable2?.itemId??null,halfHearts:T.player.halfHearts,crystals:T.player.crystals,keys:T.player.keys})}function m(T){e.paused=!0;const v=T.floor.level,M=Array.from({length:wi},(I,P)=>`<div class="level-seg ${P<v-1?"done":P===v-1?"current":""}"></div>`).join("");s.innerHTML=`
      <div class="screen screen-level">
        <div class="level-name">EL POZO</div>
        <div class="level-sub">nivel ${v} de ${wi}</div>
        <div class="level-bar">${M}</div>
      ...
      </div>`,s.querySelector(".level-go").addEventListener("click",()=>{y(),e.paused=!1}),s.querySelector(".level-exit").addEventListener("click",()=>{c=!0,f()})}function b(T){if(T==="slot_usable_2")return{iconHtml:'<span class="roulette-emoji">🎒</span>',nombre:"2º slot de usable",desc:"Un hueco más en el cinturón: lleva DOS usables a la vez (tecla Q).",rareza:"legendaria"};if(T==="cristales")return{iconHtml:'<span class="roulette-emoji">💎</span>',nombre:"Cristales",desc:"Ya lo has desbloqueado todo — el Nido te paga en cristales.",rareza:"comun"};const v=ln(T);return{iconHtml:`<img src="${br(T)}" alt="" />`,nombre:v.nombre,desc:v.descripcion,rareza:v.rareza}}function E(T,v){const M=[...Li.values()].filter(w=>w.id!==T),I=ic,P=[];for(;P.length<v&&M.length>0;){const w=M.reduce((D,X)=>D+(I[X.rareza]??1),0);let k=Math.random()*w,V=M.length-1;for(let D=0;D<M.length;D++)if(k-=I[M[D].rareza]??1,k<=0){V=D;break}P.push(b(M[V].id)),M.splice(V,1)}return P}function x(T){if(!T.chest)return;o=!0,e.paused=!0;const v=b(T.chest.reward),M=E(T.chest.reward,4),I=Math.floor(Math.random()*5);M.splice(I,0,v),s.innerHTML=`
      <div class="screen screen-roulette">
        <div class="roulette-title">📦 COFRE DEL NIDO</div>
        <div class="roulette-row">
          ${M.map(z=>`<div class="roulette-cell">${z.iconHtml}</div>`).join("")}
        </div>
        <div class="roulette-result">
          <div class="roulette-name rareza-${v.rareza}">${v.nombre}</div>
          <div class="roulette-desc">${v.desc}</div>
          <div class="roulette-forever">desbloqueado PARA SIEMPRE — ya está en el pool</div>
          <button class="roulette-go">Continuar</button>
        </div>
      </div>`;const P=[...s.querySelectorAll(".roulette-cell")],w=s.querySelector(".roulette-result");w.style.visibility="hidden",s.querySelector(".roulette-go").addEventListener("click",()=>{y(),e.paused=!1});const V=20+I+5*Math.floor(Math.random()*2);let D=0;const X=()=>{if(o){if(P.forEach((z,q)=>z.classList.toggle("lit",q===D%5)),D++,D<=V){const z=D/V;window.setTimeout(X,55+620*z*z*z);return}window.setTimeout(()=>{o&&(P[I].classList.add("win"),w.style.visibility="")},420)}};X()}function A(T){return T==="slot_usable_2"?"2º slot de usable (tecla Q)":T==="cristales"?null:ln(T).nombre}function R(T){a=!0;const v=T.status==="victory";let M="";if(T.chest?.opened){const I=A(T.chest.reward);M=I?`<div class="refuge-chest">📦 Cofre del Nido: <b>${I}</b><div class="refuge-desc">desbloqueado PARA SIEMPRE — ya está en el pool</div></div>`:'<div class="refuge-chest">📦 Cofre del Nido: cristales<div class="refuge-desc">ya lo has desbloqueado todo</div></div>'}else v&&(M='<div class="refuge-chest refuge-chest-missed">El cofre del Nido se quedó sin abrir…</div>');s.innerHTML=`
      <div class="screen screen-refuge">
        <div class="refuge-title">${v?"El refugio celebra tu victoria":"El refugio te recoge"}</div>
        ${M}
        <div class="refuge-actions">
          <button class="refuge-again">Nueva run</button>
          <button class="refuge-same">Repetir seed ${T.seed}</button>
        </div>
      </div>`,s.querySelector(".refuge-again").addEventListener("click",()=>{p(Math.floor(Math.random()*4294967295)>>>0)}),s.querySelector(".refuge-same").addEventListener("click",()=>{p(T.seed)})}return f(),{update(T){if(r&&!c&&(T.tick>0||!e.paused)&&y(),T.status==="playing"&&T.floor.level!==u){const I=u;u=T.floor.level,g(T),I>=1&&T.floor.level>I&&m(T)}const v=!!T.chest?.opened;v&&!l&&T.tick>0&&x(T),l=v;const M=T.status==="dead"||T.status==="victory";if(M&&d!==e.sim){if(d=e.sim,t.saveExpedition(null),T.chest?.opened&&T.chest.reward!=="cristales"){const I=T.chest.reward;t.unlock(I==="slot_usable_2"?I:`item_${I}`)}h!==null&&clearTimeout(h),h=window.setTimeout(()=>{e.sim===d&&!a&&R(T)},2400)}!M&&a&&y()}}}const hr=12,sh=42,rh=6;function ub(){const i=new URLSearchParams(location.search).get("touch");return i==="1"?!0:i==="0"?!1:window.matchMedia("(pointer: coarse) and (hover: none)").matches}function db(i,e){const t=e.live,n=document.createElement("div");if(n.className="touch",n.innerHTML=`
  ...
  `,i.appendChild(n);const s=n.querySelector(".hud-hearts"),r=n.querySelector(".hud-toasts"),a=n.querySelector(".hud-items"),o=n.querySelector(".hud-stats"),l=n.querySelector(".hud-near"),c=n.querySelector(".hud-minimap"),u=n.querySelector(".hud-wallet"),d=n.querySelector(".hud-boss"),h=[...n.querySelectorAll(".hud-usable")],f=[...n.querySelectorAll(".hud-usable-icon")],p=[...n.querySelectorAll(".hud-usable-cd")],y=n.querySelector(".hud-center"),g=n.querySelector(".hud-msg"),m=n.querySelector(".hud-sub"),b=n.querySelector(".hud-seed");let E=-1,x=-1,A=-1,R="",T=-1;const v=["",""],M=[-1,-1];let I="",P="",w="",k="",V="",D="",X=null,z=!0;window.addEventListener("keydown",Z=>{Z.code==="Tab"&&(Z.preventDefault(),z=!z,o.hidden=!z)});function q(Z,oe){const he=document.createElement("div");for(he.className="hud-toast"+(oe==="delta"?" hud-toast-delta":""),he.textContent=Z,r.appendChild(he);r.children.length>6;)r.firstChild?.remove();setTimeout(()=>he.remove(),2600)}function te(Z,oe="#e24b4a",he="#f6a5a4"){const Qe=`<path d="${ch}" fill="rgba(0,0,0,0.45)" stroke="rgba(0,0,0,0.6)" stroke-width="1"/>`,ct=Z===1?' style="clip-path: inset(0 50% 0 0)"':"",Be=Z>0?`<path d="${ch}" fill="${oe}"${ct}/><path d="M6 6.2 A2.4 2.4 0 0 1 9 4.8" stroke="${he}" stroke-width="1.4" fill="none"${ct}/>`:"";return`<svg viewBox="0 0 20 18" class="hud-heart">${Qe}${Be}</svg>`}return{update(Z){const oe=Z.player.halfHearts,he=Z.player.maxHalfHearts,Qe=Z.player.armor;if(oe!==E||he!==x||Qe!==A){E=oe,x=he,A=Qe;const O=Math.ceil(he/2);let N="";for(let L=0;L<O;L++)N+=te(Math.min(2,Math.max(0,oe-L*2)));for(let L=0;L<Math.ceil(Qe/2);L++)N+=te(Math.min(2,Math.max(0,Qe-L*2)),"#9fb8c8","#dfeef7");s.innerHTML=N}if([Z.player.usable,Z.player.usable2].forEach((O,N)=>{const L=O?.itemId??"";if(L!==v[N]&&(v[N]=L,h[N].hidden=!O,O&&(f[N].src=br(O.itemId))),O){const B=Math.ceil(O.cooldown/Zi);B!==M[N]&&(M[N]=B,p[N].textContent=B>0?String(B):""),h[N].classList.toggle("ready",O.cooldown===0),h[N].classList.toggle("active",O.activeTicks>0)}}),Z.status!==R)if(R=Z.status,y.classList.toggle("has-msg",Z.status!=="playing"),Z.status==="victory"){const O=t(),N=O.filter(xe=>xe.type==="enemy_killed").length,L=O.filter(xe=>xe.type==="damage_taken").length,B=O.filter(xe=>xe.type==="heart_collected").length,ee=O.filter(xe=>xe.type==="item_bought").length,ie=Math.floor(Z.tick/3600),le=Math.floor(Z.tick%3600/60);g.textContent="¡El Pozo superado!",m.innerHTML=`<div class="hud-run-summary"><div>tiempo <b>${ie}:${String(le).padStart(2,"0")}</b></div><div>abatidos <b>${N}</b> · golpes recibidos <b>${L}</b></div><div>items <b>${Z.player.items.length}</b> · compras <b>${ee}</b> · corazones <b>${B}</b></div><div>cristales <b class="hud-wallet-crystal">◆ ${Z.player.crystals}</b></div><div style="margin-top:6px">R para otra run</div></div>`}else Z.status==="dead"?(g.textContent="Kai se derritió…",m.textContent="R para reintentar"):(g.textContent="",m.textContent="");const ct=Z.player.items.join(",");if(ct!==I){const O=Z.player.items.length>I.split(",").filter(Boolean).length;if(I=ct,a.innerHTML=Z.player.items.map(N=>{const L=ln(N),B=`<b>${L.nombre}</b>`+gb(L,Z.stats.luck).map(ee=>`<div>· ${ee}</div>`).join("");return`<div class="hud-item"><img src="${br(N)}" alt="${L.nombre}" /><div class="hud-item-tip">${B}</div></div>`}).join(""),O&&X){const N=ln(Z.player.items[Z.player.items.length-1]).nombre;q(N);for(const L of lh(X,Z.stats))q(L,"delta")}}X={...Z.stats};const Be=Z.stats,ne=[Be.maxHalfHearts,Be.damage,Be.fireRate,Be.range,Be.shotSpeed,Be.moveSpeed,Be.luck,Be.projectiles].join("|");if(ne!==P){P=ne;const O=[["❤️","Vida",ni(Be.maxHalfHearts/2),"corazones máximos"],["⚔️","Daño",ni(Be.damage),"daño por proyectil"],["💧","Caudal",`${ni(Be.fireRate)}/s`,"disparos por segundo (cadencia)"],["🏹","Alcance",ni(Be.range),"tiles antes de caer en charco"],["💨","Presión",ni(Be.shotSpeed),"velocidad del proyectil"],["👢","Velocidad",ni(Be.moveSpeed),"velocidad de movimiento"],["🍀","Suerte",ni(Be.luck),"escala los procs y la calidad de drops"],["🔱","Chorros",ni(Be.projectiles),"proyectiles por disparo"]];o.innerHTML='<div class="hud-stats-title">stats · Tab</div>'+O.map(([N,L,B,ee])=>`<div class="hud-stats-row" title="${ee}"><span class="hud-stats-icon">${N}</span><span class="hud-stats-name">${L}</span><span class="hud-stats-value">${B}</span></div>`).join("")}let ue=null,ce=1.25;for(const O of Z.pickups){const N=Math.hypot(O.x-Z.player.x,O.y-Z.player.y);N<ce&&(ce=N,ue=O)}const ze=ue?`${ue.id}:${ue.itemId}:${ue.price?Z.player.crystals>=ue.price?"ok":"no":""}`:"";if(ze!==w&&(w=ze,l.hidden=!ue,ue)){const O=ln(ue.itemId),N=Pf(O,Z.stats.luck).map(ee=>`<div>· ${ee}</div>`).join("");let L="";if(O.categoria!=="usable"){const ee=Or([...Z.player.items,ue.itemId]),ie=lh(Z.stats,ee);L=ie.length?ie.map(le=>`<div class="hud-near-diff">${le}</div>`).join(""):""}const B=ue.price?`<div class="hud-near-price ${Z.player.crystals>=ue.price?"ok":"no"}">◆ ${ue.price} cristales — ${Z.player.crystals>=ue.price?"pulsa E para comprar":"no te alcanza"}</div>`:"";l.innerHTML=`<img src="${br(O.id)}" alt="" /><div><b>${O.nombre}</b> <span class="hud-near-rar">${mb[O.rareza]}</span>${B}${L}${N}<i>«${O.descripcion}»</i></div>`}const Xe=`${Z.player.crystals}:${Z.player.keys}`;Xe!==V&&(V=Xe,u.innerHTML=`<span class="hud-wallet-crystal">◆</span> ${Z.player.crystals}`+(Z.player.keys>0?` &nbsp;<span class="hud-wallet-key">⚷</span> ${Z.player.keys}`:""));const Oe=Z.enemies.some(O=>O.kind==="gorko"),vt=`${Z.seed}:${Z.floor.level}`;Oe&&D!==vt&&(D=vt,d.hidden=!1,d.innerHTML='<div class="hud-boss-name">GORKO</div><div class="hud-boss-sub">el Sapo Glotón</div>',setTimeout(()=>{d.hidden=!0},2800));const je=`${Z.floor.level}:${Z.floor.current}:`+Z.floor.rooms.map(O=>(O.visited?"v":".")+(O.cleared?"c":".")).join("");if(je!==k){k=je;const O=Z.floor.rooms.filter(Se=>Se.visited),N=new Set;for(const Se of O){N.add(Se.id);for(const Re of Object.values(Se.doors))Re>=0&&N.add(Re)}const L=Z.floor.rooms.filter(Se=>N.has(Se.id)),B=Math.min(...L.map(Se=>Se.gx)),ee=Math.min(...L.map(Se=>Se.gy)),ie={treasure:"♦",shop:"$",boss:"☠"},le=19;c.innerHTML=L.map(Se=>{const Re=["hud-map-cell",Se.id===Z.floor.current?"current":"",Se.visited?"visited":"known",Se.cleared?"cleared":""].filter(Boolean).join(" "),C=Se.visited||Se.kind!=="boss"?ie[Se.kind]??"":ie.boss;return`<div class="${Re}" style="left:${(Se.gx-B)*le}px;top:${(Se.gy-ee)*le}px">${C}</div>`}).join("");const xe=(Math.max(...L.map(Se=>Se.gx))-B+1)*le,U=(Math.max(...L.map(Se=>Se.gy))-ee+1)*le;c.style.width=`${xe}px`,c.style.height=`${U}px`}const ot=Z.seed*10+Z.floor.level;ot!==T&&(T=ot,b.textContent=`seed ${Z.seed} · nivel ${Z.floor.level} · sim v${e}`)},onEvents(Z){for(const oe of Z)if(oe.type==="proc_triggered"&&oe.efecto==="critico")q("¡Crítico!");else if(oe.type==="usable_activated"){const he=Li.get(oe.itemId);q(`¡${he?.nombre??"Usable"}!`)}else oe.type==="item_bought"?q(`Comprado: −${oe.price} ◆`,"delta"):oe.type==="key_collected"?q("Llave del tesoro","delta"):oe.type==="door_unlocked"&&q("El tesoro se abre…","delta")}}}const uh={KeyW:"up",ArrowUp:"up",KeyS:"down",ArrowDown:"down",KeyA:"left",ArrowLeft:"left",KeyD:"right",ArrowRight:"right"};function xb(i,e,t){const n=i.live,s=new kg,r=new Te,a=new Mi(new F(0,1,0),0),o=new F;let l=!1,c=!1,u=!1;window.addEventListener("keydown",f=>{const p=uh[f.code];p?(n[p]=!0,f.preventDefault()):f.code==="Space"?(u=!0,n.use=u||c,f.preventDefault()):f.code==="ShiftLeft"||f.code==="ShiftRight"?n.dash=!0:f.code==="KeyE"?n.interact=!0:f.code==="KeyQ"?n.use2=!0:f.code==="KeyR"&&!f.repeat&&i.reset()}),window.addEventListener("keyup",f=>{const p=uh[f.code];p&&(n[p]=!1),f.code==="Space"&&(u=!1,n.use=u||c),(f.code==="ShiftLeft"||f.code==="ShiftRight")&&(n.dash=!1),f.code==="KeyE"&&(n.interact=!1),f.code==="KeyQ"&&(n.use2=!1)}),window.addEventListener("blur",()=>{n.up=n.down=n.left=n.right=!1,l=c=u=!1,n.fire=n.dash=n.use=n.interact=!1}),e.addEventListener("contextmenu",f=>f.preventDefault());function d(f){const p=e.getBoundingClientRect();p.width===0||p.height===0||(r.set((f.clientX-p.left)/p.width*2-1,-((f.clientY-p.top)/p.height)*2+1),s.setFromCamera(r,t),s.ray.intersectPlane(a,o)&&(n.aimX=o.x,n.aimY=o.z))}const h=()=>document.body.classList.contains("touch-mode");window.addEventListener("pointermove",f=>{h()||d(f)}),window.addEventListener("pointerdown",f=>{h()||(f.button===0?(l=!0,n.fire=!0,d(f)):f.button===2&&(c=!0,n.use=u||c))}),window.addEventListener("pointerup",f=>{h()||(f.button===0?(l=!1,n.fire=l):f.button===2&&(c=!1,n.use=u||c))})}const vb=[[3.5,1],[Ye-3.5,1]],el=1;function yb(i){i.add(new Mg(16767398,.7));const e=new of(9414856,.22);e.position.set(Ye/2,6,qe+8),e.target.position.set(Ye/2,0,qe/2),i.add(e,e.target);const t=vb.map(([s,r])=>{const a=new Jl(He.torch,12,11,2);a.position.set(s,el,r+.35),i.add(a);const o=new Rs(new Xi({map:Mb(),blending:nl,depthWrite:!1}));return o.position.set(s,el+.08,r+.18),o.scale.set(.32,.5,1),i.add(o),{light:a,flame:o,baseY:el}}),n=new Jl(He.shine,3.2,5,2);return n.position.set(3.5,.7,qe/2),i.add(n),{update(s){const r=.8+.2*Math.sin(s.tick*.31)*Math.sin(s.tick*.13);for(const o of t)o.light.intensity=12*r,o.flame.scale.set(.32,.5*(.85+.3*r),1),o.flame.position.y=o.baseY+.08+.02*r;const a=s.player;if(n.position.set(a.x,.7,a.y),s.status==="dead"){const o=s.tick-a.deathTick;n.intensity=Math.floor(o/14)%2===0?1.8:.6}else n.intensity=3.2}}}function Mb(){const[i,e]=qt(16,24),t=e.createRadialGradient(8,14,1,8,14,10);return t.addColorStop(0,lt(He.torchBright)),t.addColorStop(.45,lt(He.torch)),t.addColorStop(1,"rgba(232,161,60,0)"),e.fillStyle=t,e.fillRect(0,0,16,24),e.fillStyle=lt(He.torch),e.beginPath(),e.moveTo(8,2),e.quadraticCurveTo(12,10,8,16),e.quadraticCurveTo(4,10,8,2),e.fill(),e.fillStyle=lt(He.torchBright),e.beginPath(),e.ellipse(8,13,2.4,4,0,0,Math.PI*2),e.fill(),Yt(i)}const pc={},Xc=[];{const i=new Wc,e=(t,n)=>{i.load(n,s=>{pc[t]={scene:s.scene,animations:s.animations};for(const r of Xc)r()})};e("puerta","assets/models/portal_puerta.glb"),e("reja","assets/models/portal_reja.glb")}let Na=null;new Wc().load("assets/models/trampilla_escalera.glb",e=>{Na=e.scene;for(const t of Xc)t()});const Sb={1:16777215,2:15919832,3:13625544,4:15519936,5:12563672},dh=40,bb=55,tl=1.15,Tb=1.45,Eb=1.9,hh=.1,fh=.6,Ab=1.15,wb=.9,Rb=.45;function Cb(){const i=new tm;i.background=new We(He.dungeonBg);const e=new Cc(He.dungeonBg,14,30);i.fog=e;const t=Pb(i),n=new F(Ye/2,0,qe/2),s=new jt(dh,1,.1,100),r=new F,a=Xl.degToRad(bb),o=new F(n.x,0,n.z);let l=20,c=Ye/2,u=qe/2,d=960,h=576,f=!1;function p(){r.set(o.x,l*Math.sin(a),o.z+l*Math.cos(a)),s.position.copy(r),s.lookAt(o)}function y(b,E){d=b,h=E,s.aspect=b/Math.max(1,E);const x=Math.tan(Xl.degToRad(dh/2)),A=x*s.aspect,R=(Ye/2+tl)/A,T=(qe/2+tl)*Math.sin(a)/x+(qe/2+tl)*Math.cos(a);f=document.body.classList.contains("touch-mode"),l=Math.max(R,T)/(f?Eb:Tb),c=A*l,u=x*l/Math.sin(a),e.near=l-2,e.far=l+15,p(),s.updateProjectionMatrix()}function g(b,E,x){const A=E-fh,R=x-E+fh;return A>=R?x/2:Math.min(R,Math.max(A,b))}function m(b){document.body.classList.contains("touch-mode")!==f&&y(d,h);const E=g(b.player.x,c,Ye),x=g(b.player.y,u,qe);o.x+=(E-o.x)*hh,o.z+=(x-o.z)*hh,p()}return{scene:i,camera:s,center:n,cameraHome:r,resize:y,updateRoom:b=>{t.update(b),m(b)}}}function Pb(i){const e=kS(Ye,qe),t=new qi({map:e.texture,roughness:.92,metalness:0}),n=new Pi(Ye,qe),s=1.7,r=new $h;r.moveTo(-Ye/2,-qe/2),r.lineTo(Ye/2,-qe/2),r.lineTo(Ye/2,qe/2),r.lineTo(-Ye/2,qe/2);const a=new Kl;a.moveTo(-s/2,-s/2),a.lineTo(s/2,-s/2),a.lineTo(s/2,s/2),a.lineTo(-s/2,s/2),r.holes.push(a);const o=new Fc(r);{const M=o.attributes.uv,I=o.attributes.position;for(let P=0;P<M.count;P++)M.setXY(P,(I.getX(P)+Ye/2)/Ye,(I.getY(P)+qe/2)/qe)}const l=new It(n,t);l.rotation.x=-Math.PI/2,l.position.set(Ye/2,0,qe/2),i.add(l);const c=new Map;function u(M){const I=Math.max(1,Math.round(M));let P=c.get(I);return P||(P=new qi({map:Jd(I,2),roughness:1,metalness:0}),c.set(I,P)),P}const d=new Map;function h(M){const I=Math.max(1,Math.round(M));let P=d.get(I);return P||(P=new qi({map:Jd(I,1),roughness:1,metalness:0}),d.set(I,P)),P}const f=new _n({color:He.torch}),p=new An;i.add(p);const y=[],g=new Bg;let m=null,b="";Xc.push(()=>{b=""});function E(){for(const M of[...p.children])p.remove(M),M.traverse(I=>{I instanceof It&&I.geometry.dispose()});y.length=0,m=null}function x(M,I,P,w,k,V){const D=new It(new Ci(M,I,P),V);return D.position.set(w,I/2,k),p.add(D),D}function A(M,I){const P=M==="n"?Ab:M==="s"?Rb:wb,w=M==="n"||M==="s",k=M==="n"?.5:qe-.5,V=M==="w"?.5:Ye-.5,D=w?Ye/2:qe/2,X=w?Ye:qe-2,z=w?0:1;if(!I){w?x(X,P,1,Ye/2,k,u(X)):x(1,P,X,V,qe/2,u(X));return}const q=D-Ai-z,te=z+X-(D+Ai);w?(x(q,P,1,z+q/2,k,u(q)),x(te,P,1,D+Ai+te/2,k,u(te))):(x(1,P,q,V,z+q/2,u(q)),x(1,P,te,V,D+Ai+te/2,u(te)))}function R(M,I){const P=I==="puerta"?pc.puerta:pc.reja;if(!P)return;const w=P.scene.clone(!0),V=new Qt().setFromObject(P.scene).getSize(new F),D=2.6/Math.max(.001,V.x);w.scale.setScalar(D);const X=new Qt().setFromObject(w),z=X.getCenter(new F);w.position.sub(new F(z.x,X.min.y,z.z));const q=new An;q.add(w);const Z=M==="n"||M==="s"?Ye/2:qe/2;M==="n"&&q.position.set(Z,0,.55),M==="s"&&q.position.set(Z,0,qe-.55),M==="e"&&(q.position.set(Ye-.55,0,Z),q.rotation.y=-Math.PI/2),M==="w"&&(q.position.set(.55,0,Z),q.rotation.y=Math.PI/2),p.add(q);const oe={side:M,variant:I,wrapper:q,mixer:null,clips:null,barsNode:null,barsY0:0,open:null};I==="puerta"&&P.animations.length?(oe.mixer=new Fg(w),oe.clips=P.animations):(w.traverse(he=>{he.name==="gate"&&(oe.barsNode=he)}),oe.barsNode&&(oe.barsY0=oe.barsNode.position.y)),y.push(oe)}function T(M,I,P){if(M.mixer&&M.clips){const w=Wa.findByName(M.clips,I?"open":"close");if(!w)return;M.mixer.stopAllAction();const k=M.mixer.clipAction(w);k.setLoop(Ih,1),k.clampWhenFinished=!0,k.play(),P&&M.mixer.update(w.duration)}}function v(M){E();const I=M.floor.rooms[M.floor.current],P=Sb[M.floor.level]??16777215;t.color.setHex(P),e.repaint(I.seed);for(const w of["n","s","e","w"]){const k=I.doors[w];if(A(w,k>=0),k>=0){const V=M.floor.rooms[k].locked;R(w,V?"reja":"puerta")}}for(const w of M.obstacles)w.invisible||x(w.w,.55,w.h,w.x+w.w/2,w.y+w.h/2,h(w.w));if(I.kind==="boss"){const w=new An,k=new It(new Ci(1.7,.05,1.7),new _n({color:262657}));if(k.position.set(Ye/2,-1.3,qe/2),w.add(k),Na){const D=Na.clone(!0),z=new Qt().setFromObject(Na).getSize(new F),q=1.55/Math.max(.001,Math.max(z.x,z.z));D.scale.setScalar(q);const te=new Qt().setFromObject(D),Z=te.getCenter(new F);D.position.sub(new F(Z.x,te.min.y,Z.z)),D.position.y-=z.y*q-.04,w.add(D),D.position.x+=Ye/2,D.position.z+=qe/2}const V=new It(new Oc(.95,1.05,24),f);V.rotation.x=-Math.PI/2,V.position.set(Ye/2,.013,qe/2),w.add(V),w.visible=!1,p.add(w),m=w}for(const w of c.values())w.color.setHex(P);for(const w of d.values())w.color.setHex(P),w.color.multiplyScalar(1.18)}return{update(M){const I=`${M.seed}:${M.floor.level}:${M.floor.current}`;I!==b&&(b=I,v(M));const P=g.getDelta(),w=M.floor.rooms[M.floor.current];for(const D of y){const X=w.doors[D.side],z=X>=0&&M.floor.rooms[X].locked,q=w.cleared&&!z;if(D.variant==="puerta")D.open===null?T(D,q,!0):q!==D.open&&T(D,q,!1),D.mixer?.update(P);else if(D.barsNode){const te=D.barsY0+(q?.9:0);D.open===null?D.barsNode.position.y=te:D.barsNode.position.y+=(te-D.barsNode.position.y)*.08}D.open=q}m&&(m.visible=M.floor.trapdoorOpen);const V=w.kind==="boss"&&M.floor.trapdoorOpen?o:n;l.geometry!==V&&(l.geometry=V)}}}function Ib(i,e){const t=JM(),n=$M(e,cc(t));YM(n,La);const s=new Uy({antialias:!1});s.setPixelRatio(1),i.appendChild(s.domElement);const r=Cb(),a=yb(r.scene),o=QS(r.scene,US());xb(n,s.domElement,r.camera);const l=_b(i,La,()=>n.telemetry),c=hb(n,r),u=eS(i),d=cb(i,n,t,La);let h=null;function f(m){if(m&&!h&&(h=db(i,n)),document.body.classList.toggle("touch-mode",m),!m){const b=n.live;b.left=b.right=b.up=b.down=b.fire=!1}}ub()?f(!0):new URLSearchParams(location.search).get("touch")!=="0"&&(window.addEventListener("touchstart",()=>f(!0)),window.addEventListener("pointermove",m=>{m.pointerType==="mouse"&&document.body.classList.contains("touch-mode")&&f(!1)}));function p(){const m=i.clientWidth||960,b=i.clientHeight||576;s.setSize(m,b),r.resize(m,b)}new ResizeObserver(p).observe(i),p();let y=performance.now();function g(m){const b=m-y;y=m;const E=n.frame(b);c.onEvents(E),l.onEvents(E),u.onEvents(E),r.updateRoom(n.sim.state),a.update(n.sim.state),o.update(n.sim.state),l.update(n.sim.state),d.update(n.sim.state),u.update(n.sim.state),h?.update(n.sim.state),c.update(b,r.camera),s.render(r.scene,r.camera),requestAnimationFrame(g)}requestAnimationFrame(g)}const Lb=new URLSearchParams(location.search),ph=Lb.get("seed"),If=ph!==null?Number(ph)>>>0:Date.now()>>>0;Ib(document.getElementById("game"),If);console.info(`%cKai · Fase 0.5 · seed=${If} · API de tester en window.__game`,"color:#e8a13c");
